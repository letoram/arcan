...
/* represents a visual context. should be only one but in a potential
 * future multithread- multicontext world we should atleast prepare
 * it all for a OGL- style context management */
