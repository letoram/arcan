...
local symtable = {};
 ...
 symtable[33] = "EXCLAIM";
 symtable["EXCLAIM"] = 33;
 symtable[34] = "QUOTEDBL";
 symtable["QUOTEDBL"] = 34;
 symtable[35] = "HASH";
 symtable["HASH"] = 35;
 symtable[36] = "DOLLAR";
 symtable["DOLLAR"] = 36;
 symtable[38] = "AMPERSAND";
 symtable["AMPERSAND"] = 38;
 symtable[39] = "QUOTE";
 symtable["QUOTE"] = 39;
 symtable[40] = "LEFTPAREN";
 symtable["LEFTPAREN"] = 40;
 symtable[41] = "RIGHTPAREN";
 symtable["RIGHTPAREN"] = 41;
 symtable[42] = "ASTERISK";
 ...
 symtable[62] = "GREATER";
 symtable["GREATER"] = 62;
 symtable[63] = "QUESTION";
 symtable["QUESTION"] = 63;
 symtable[64] = "AT";
 symtable["AT"] = 64;
 symtable[91] = "LEFTBRACKET";
 symtable["LEFTBRACKET"] = 91;
 symtable[92] = "BACKSLASH";
 symtable["BACKSLASH"] = 92;
 symtable[93] = "RIGHTBRACKET";
 symtable["RIGHTBRACKET"] = 93;
 symtable[94] = "CARET";
 symtable["CARET"] = 94;
 symtable[95] = "UNDERSCORE";
 symtable["UNDERSCORE"] = 95;
 symtable[96] = "BACKQUOTE";
