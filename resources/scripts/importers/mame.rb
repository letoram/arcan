class Mame
	...
	def set_defaults(options, cmdopts)
		...
		@mameargs[0] << "#{options[:targetpath]}/_mame/cfg"
		@mameargs[0] << "-nvram_directory"
		@mameargs[0] << "#{options[:targetpath]}/_mame/nvram"
		@mameargs[0] << "-memcard_directory"
		@mameargs[0] << "#{options[:targetpath]}/_mame/memcard"
		@mameargs[0] << "-input_directory"
		@mameargs[0] << "#{options[:targetpath]}/_mame/input"
		@mameargs[0] << "-state_directory"
		@mameargs[0] << "#{options[:targetpath]}/_mame/state"
		@mameargs[0] << "-snapshot_directory"
		@mameargs[0] << "#{options[:targetpath]}/_mame/snapshot"
		@mameargs[0] << "-diff_directory"
		@mameargs[0] << "#{options[:targetpath]}/_mame/diff"
		@mameargs[0] << "-comment_directory"
		@mameargs[0] << "#{options[:targetpath]}/_mame/comment"
