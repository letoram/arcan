...
local function gridledetail_freeview(axis, mag)
	...
	move3d_model(detailview.model.vid, detailview.startpos.x + dx,
		detailview.startpos.y + dy, detailview.startpos.z + dz, 20 + settings.transitiondelay);
...
-- just use this to make sure we don't load models before the animation has finished.  
...
-- regular dispatch-input, but we override MENU/etc. to support switching between fullscreen and not
