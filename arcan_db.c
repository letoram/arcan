...
/* DDL Tables,
 * used for creating new databases and assessing the integrity of a supplied database
 * this file is generated by the db_revisions/buildsource.rb script and uses a list of
 * template databases to generate a track history of database formats, and then allow
 * an "upgrade sequence" */

#include "arcan_db_queries.h"
