...
#define ARCAN_FRAMESERVER_ACACHE_LIMIT 12
#define ARCAN_FRAMESERVER_ACACHE_MINIMUM 4
#define ARCAN_FRAMESERVER_FEEDSYNCH_THRESHOLD 15
#define ARCAN_FRAMESERVER_DEFAULT_VTHRESH_SKIP 100
#define ARCAN_FRAMESERVER_DEFAULT_VTHRESH_WAIT 50
#define ARCAN_FRAMESERVER_ABUFFER_SIZE 4096 * 4
#define ARCAN_FRAMESERVER_IGNORE_SKIP_THRESH 400
