...
enum tui_attr_flags {
	...
	TUI_ATTR_GLYPH_INDEXED = 1024,
	TUI_ATTR_AGLYPH_INDEXED = 2048,
	TUI_ATTR_BORDER_RIGHT = 4096,
	TUI_ATTR_BORDER_DOWN = 8192,
	TUI_ATTR_BORDER_LEFT = 16384,
	TUI_ATTR_BORDER_TOP = 32768,
