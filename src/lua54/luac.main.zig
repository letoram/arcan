...
const struct_unnamed_9 = extern struct {
    ...
    unnamed_0: union_unnamed_10 = std.mem.zeroes(union_unnamed_10),
};
...
pub const struct_sigaction = extern struct {
    unnamed_0: union_unnamed_14 = std.mem.zeroes(union_unnamed_14),
...
pub const struct_TString = extern struct {
    ...
    u: union_unnamed_15 = std.mem.zeroes(union_unnamed_15),
...
pub const struct_NodeKey_16 = extern struct {
    value_: Value = std.mem.zeroes(Value),
    tt_: lu_byte = std.mem.zeroes(lu_byte),
...
const union_unnamed_20 = extern union {
    ...
    nyield: c_int,
    nres: c_int,
    transferinfo: struct_unnamed_21,
};
pub const struct_CallInfo = extern struct {
    ...
    u: union_unnamed_17 = std.mem.zeroes(union_unnamed_17),
    u2: union_unnamed_20 = std.mem.zeroes(union_unnamed_20),
...
pub const struct_UpVal = extern struct {
    ...
    tt: lu_byte = std.mem.zeroes(lu_byte),
    marked: lu_byte = std.mem.zeroes(lu_byte),
    v: union_unnamed_22 = std.mem.zeroes(union_unnamed_22),
    u: union_unnamed_23 = std.mem.zeroes(union_unnamed_23),
};
...
pub const struct_luaL_Buffer = extern struct {
    ...
    init: union_unnamed_25 = std.mem.zeroes(union_unnamed_25),
};
...
pub const struct_Udata0 = extern struct {
    ...
    len: usize = std.mem.zeroes(usize),
    metatable: [*c]struct_Table = std.mem.zeroes([*c]struct_Table),
    bindata: union_unnamed_27 = std.mem.zeroes(union_unnamed_27),
};
...
pub fn PrintFunction(arg_f: [*c]const Proto, arg_full: c_int) callconv(.c) void {
    var f = arg_f;
    _ = &f;
    var full = arg_full;
    _ = &full;
...
pub var listing: c_int = 0;
pub var dumping: c_int = 1;
pub var stripping: c_int = 0;
pub var Output: [8:0]u8 = "luac.out";
pub var output: [*c]const u8 = @as([*c]u8, @ptrCast(@alignCast(&Output[@as(usize, @intCast(0))])));
pub var progname: [*c]const u8 = "luac";
pub var tmname: [*c][*c]TString = std.mem.zeroes([*c][*c]TString);
pub fn fatal(arg_message: [*c]const u8) callconv(.c) void {
...
// /src/cosmopolitan/third_party/lua/luac.main.c:71:13: warning: unable to translate function, demoted to extern
pub extern fn cannot(arg_what: [*c]const u8) callconv(.c) void;
pub fn usage(arg_message: [*c]const u8) callconv(.c) void {
    var message = arg_message;
    _ = &message;
    if (@as(c_int, @bitCast(@as(c_uint, message.*))) == @as(c_int, '-')) {
        _ = fprintf(stderr, "%s: unrecognized option '%s'\n", progname, message);
    } else {
        _ = fprintf(stderr, "%s: %s\n", progname, message);
    }
    _ = fprintf(stderr, "usage: %s [options] [filenames]\nAvailable options are:\n  -l       list (use -l -l for full listing)\n  -o name  output to file 'name' (default is \"%s\")\n  -p       parse only\n  -s       strip debug information\n  -v       show version information\n  --       stop handling options\n  -        stop handling options and process stdin\n", progname, @as([*c]u8, @ptrCast(@alignCast(&Output[@as(usize, @intCast(0))]))));
    exit(@as(c_int, 1));
}
pub fn doargs(arg_argc: c_int, arg_argv: [*c][*c]u8) callconv(.c) c_int {
    var argc = arg_argc;
    _ = &argc;
    var argv = arg_argv;
    _ = &argv;
    ...
    var version: c_int = 0;
    _ = &version;
    if ((argv[@as(c_uint, @intCast(@as(c_int, 0)))] != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (@as(c_int, @bitCast(@as(c_uint, argv[@as(c_uint, @intCast(@as(c_int, 0)))].*))) != @as(c_int, 0))) {
        progname = argv[@as(c_uint, @intCast(@as(c_int, 0)))];
    }
    {
        i = 1;
        while (i < argc) : (i += 1) {
            if (@as(c_int, @bitCast(@as(c_uint, (blk: {
            ...
            }).*.*))) != @as(c_int, '-')) break else if (strcmp((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, "--") == @as(c_int, 0)) {
                i += 1;
                ...
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, "-") == @as(c_int, 0)) break else if (strcmp((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, "-l") == @as(c_int, 0)) {
                listing += 1;
                ...
                if (((output == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, output.*))) == @as(c_int, 0))) or ((@as(c_int, @bitCast(@as(c_uint, output.*))) == @as(c_int, '-')) and (@as(c_int, @bitCast(@as(c_uint, output[@as(c_uint, @intCast(@as(c_int, 1)))]))) != @as(c_int, 0)))) {
    ...
    if ((i == argc) and ((listing != 0) or !(dumping != 0))) {
        dumping = 0;
        (blk: {
            const tmp = blk_1: {
                const ref = &i;
            ...
            if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* = @as([*c]u8, @ptrCast(@alignCast(&Output[@as(usize, @intCast(0))])));
    }
    if (version != 0) {
        _ = printf("%s\n", "Lua 5.4.6  Copyright (C) 1994-2023 Lua.org, PUC-Rio");
        if (version == (argc - @as(c_int, 1))) {
            exit(@as(c_int, 0));
        }
    }
    return i;
}
pub fn reader(arg_L: [*c]lua_State, arg_ud: ?*anyopaque, arg_size: [*c]usize) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var ud = arg_ud;
    _ = &ud;
    ...
    _ = &L;
    if ((blk: {
        const ref = &@as([*c]c_int, @ptrCast(@alignCast(ud))).*;
        const tmp = ref.*;
        ref.* -= 1;
        break :blk tmp;
    }) != 0) {
        size.* = @sizeOf([20]u8) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))));
        return "(function()end)();\n";
    } else {
        size.* = 0;
        return null;
...
pub fn combine(arg_L: [*c]lua_State, arg_n: c_int) callconv(.c) [*c]const Proto {
    var L = arg_L;
    _ = &L;
    var n = arg_n;
    _ = &n;
    if (n == @as(c_int, 1)) return (blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            _ = @as(c_int, 0);
        ...
        var f: [*c]Proto = undefined;
        _ = &f;
        var i: c_int = n;
        _ = &i;
        if (lua_load(L, &reader, @as(?*anyopaque, @ptrCast(&i)), "=(luac)", null) != @as(c_int, 0)) {
            fatal(lua_tolstring(L, -@as(c_int, 1), null));
        }
        f = (blk: {
            _ = @as(c_int, 0);
            break :blk blk_1: {
        ...
        }).*.p;
        {
            ...
            while (i < n) : (i += 1) {
                (blk: {
                    ...
                    break :blk blk_1: {
                        _ = @as(c_int, 0);
                        break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&(L.*.top.p + @as(usize, @bitCast(@as(isize, @intCast((i - n) - @as(c_int, 1)))))).*.val).*.value_.gc))).*.cl.l;
                    };
                }).*.p;
                if ((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk f.*.p + @as(usize, @intCast(tmp)) else break :blk f.*.p - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*.*.sizeupvalues > @as(c_int, 0)) {
                    (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk f.*.p + @as(usize, @intCast(tmp)) else break :blk f.*.p - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.*.upvalues[@as(c_uint, @intCast(@as(c_int, 0)))].instack = 0;
                }
            }
        }
        return f;
...
pub fn writer(arg_L: [*c]lua_State, arg_p: ?*const anyopaque, arg_size: usize, arg_u: ?*anyopaque) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p = arg_p;
    _ = &p;
    ...
    _ = &u;
    _ = &L;
    return @intFromBool((fwrite(p, size, @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(?*FILE, @ptrCast(u))) != @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) and (size != @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))));
}
pub fn pmain(arg_L: [*c]lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var argc: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(lua_tointegerx(L, @as(c_int, 1), null)))));
    _ = &argc;
    var argv: [*c][*c]u8 = @as([*c][*c]u8, @ptrCast(@alignCast(lua_touserdata(L, @as(c_int, 2)))));
    _ = &argv;
    var f: [*c]const Proto = undefined;
    _ = &f;
    var i: c_int = undefined;
    _ = &i;
    tmname = @as([*c][*c]TString, @ptrCast(@alignCast(&L.*.l_G.*.tmname[@as(usize, @intCast(0))])));
    ...
    }
    {
        i = 0;
        while (i < argc) : (i += 1) {
            var filename: [*c]const u8 = if (strcmp((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, "-") == @as(c_int, 0)) null else (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            _ = &filename;
            if (luaL_loadfilex(L, filename, null) != @as(c_int, 0)) {
                fatal(lua_tolstring(L, -@as(c_int, 1), null));
            }
        }
    }
    f = combine(L, argc);
    if (listing != 0) {
        PrintFunction(f, @intFromBool(listing > @as(c_int, 1)));
    }
    if (dumping != 0) {
        var D: ?*FILE = if (output == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) stdout else fopen(output, "wb");
        _ = &D;
        if (D == @as(?*FILE, @ptrCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))) {
            cannot("open");
        }
        _ = @as(c_int, 0);
        _ = luaU_dump(L, f, &writer, @as(?*anyopaque, @ptrCast(D)), stripping);
        _ = @as(c_int, 0);
        if (ferror(D) != 0) {
            cannot("write");
        }
...
pub export fn main(arg_argc: c_int, arg_argv: [*c][*c]u8) c_int {
    ...
    _ = &L;
    var i: c_int = doargs(argc, argv);
    _ = &i;
    argc -= i;
    argv += @as(usize, @bitCast(@as(isize, @intCast(i))));
    if (argc <= @as(c_int, 0)) {
        usage("no input files given");
    }
    L = luaL_newstate();
    if (L == @as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        fatal("cannot create state: not enough memory");
    }
    lua_pushcclosure(L, &pmain, @as(c_int, 0));
    lua_pushinteger(L, @as(lua_Integer, @bitCast(@as(c_longlong, argc))));
    lua_pushlightuserdata(L, @as(?*anyopaque, @ptrCast(argv)));
    if (lua_pcallk(L, @as(c_int, 2), @as(c_int, 0), @as(c_int, 0), @as(lua_KContext, @bitCast(@as(c_long, @as(c_int, 0)))), null) != @as(c_int, 0)) {
        fatal(lua_tolstring(L, -@as(c_int, 1), null));
    }
    lua_close(L);
    return 0;
}
pub fn PrintString(arg_ts: [*c]const TString) callconv(.c) void {
    var ts = arg_ts;
    _ = &ts;
    var s: [*c]const u8 = @as([*c]const u8, @ptrCast(@alignCast(&ts.*.contents[@as(usize, @intCast(0))])));
    _ = &s;
    var i: usize = undefined;
    _ = &i;
    var n: usize = if (@as(c_int, @bitCast(@as(c_uint, ts.*.tt))) == (@as(c_int, 4) | (@as(c_int, 0) << @intCast(4)))) @as(usize, @bitCast(@as(c_ulong, ts.*.shrlen))) else ts.*.u.lnglen;
    _ = &n;
    _ = printf("\"");
    {
        i = 0;
        while (i < n) : (i +%= 1) {
            var c: c_int = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(s[i])))));
            _ = &c;
            while (true) {
                switch (c) {
                    @as(c_int, 34) => {
...
pub fn PrintType(arg_f: [*c]const Proto, arg_i: c_int) callconv(.c) void {
    var f = arg_f;
    _ = &f;
    var i = arg_i;
    _ = &i;
    var o: [*c]const TValue = &(blk: {
        const tmp = i;
        if (tmp >= 0) break :blk f.*.k + @as(usize, @intCast(tmp)) else break :blk f.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*;
    _ = &o;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 63)) {
            @as(c_int, 0) => {
                _ = printf("N");
                break;
            },
            @as(c_int, 1), @as(c_int, 17) => {
                _ = printf("B");
                break;
            },
            @as(c_int, 19) => {
            ...
            @as(c_int, 4), @as(c_int, 20) => {
                ...
                _ = printf("?%d", @as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 63));
                break;
            },
        }
        break;
...
pub fn PrintConstant(arg_f: [*c]const Proto, arg_i: c_int) callconv(.c) void {
    var f = arg_f;
    _ = &f;
    var i = arg_i;
    _ = &i;
            ...
            @as(c_int, 19) => {
                {
                    ...
                    _ = &buff;
                    _ = sprintf(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))), "%.14g", blk: {
                        _ = @as(c_int, 0);
                        break :blk o.*.value_.n;
                    });
                    _ = printf("%s", @as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))));
                    if (@as(c_int, @bitCast(@as(c_uint, buff[strspn(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))), "-0123456789")]))) == @as(c_int, '\x00')) {
                        _ = printf(".0");
                    }
                    break;
                }
...
pub fn PrintCode(arg_f: [*c]const Proto) callconv(.c) void {
    var f = arg_f;
    _ = &f;
    var code: [*c]const Instruction = f.*.code;
    _ = &code;
    var pc: c_int = undefined;
    _ = &pc;
    var n: c_int = f.*.sizecode;
    _ = &n;
    {
        pc = 0;
        while (pc < n) : (pc += 1) {
            ...
            _ = &i;
            var o: OpCode = @as(c_uint, @bitCast((i >> @intCast(0)) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 7))) << @intCast(@as(c_int, 0)))));
            _ = &o;
            ...
            var ax: c_int = blk: {
                _ = @as(c_int, 0);
                break :blk @as(c_int, @bitCast((i >> @intCast(@as(c_int, 0) + @as(c_int, 7))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(((@as(c_int, 8) + @as(c_int, 8)) + @as(c_int, 1)) + @as(c_int, 8))) << @intCast(@as(c_int, 0)))));
            };
            _ = &ax;
            var bx: c_int = blk: {
                _ = @as(c_int, 0);
            ...
            var sb: c_int = (blk: {
                _ = @as(c_int, 0);
                break :blk @as(c_int, @bitCast((i >> @intCast(((@as(c_int, 0) + @as(c_int, 7)) + @as(c_int, 8)) + @as(c_int, 1))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0)))));
            }) - (((@as(c_int, 1) << @intCast(8)) - @as(c_int, 1)) >> @intCast(1));
            _ = &sb;
            var sc: c_int = (blk: {
                _ = @as(c_int, 0);
                break :blk @as(c_int, @bitCast((i >> @intCast((((@as(c_int, 0) + @as(c_int, 7)) + @as(c_int, 8)) + @as(c_int, 1)) + @as(c_int, 8))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0)))));
            ...
            var sbx: c_int = blk: {
                _ = @as(c_int, 0);
                break :blk @as(c_int, @bitCast((i >> @intCast((@as(c_int, 0) + @as(c_int, 7)) + @as(c_int, 8))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast((@as(c_int, 8) + @as(c_int, 8)) + @as(c_int, 1))) << @intCast(@as(c_int, 0))))) - (((@as(c_int, 1) << @intCast((@as(c_int, 8) + @as(c_int, 8)) + @as(c_int, 1))) - @as(c_int, 1)) >> @intCast(1));
            };
            _ = &sbx;
            var isk: c_int = blk: {
                _ = @as(c_int, 0);
            ...
            _ = &isk;
            var line: c_int = luaG_getfuncline(f, pc);
            _ = &line;
            _ = printf("\t%d\t", pc + @as(c_int, 1));
            if (line > @as(c_int, 0)) {
                _ = printf("[%d]\t", line);
            } else {
                _ = printf("[-]\t");
            }
            _ = printf("%-9s\t", opnames[o]);
            while (true) {
                switch (o) {
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 4))) => {
                        ...
                        PrintConstant(f, blk: {
                            ...
                            break :blk @as(c_int, @bitCast(((blk_1: {
                                ...
                                if (tmp >= 0) break :blk_1 code + @as(usize, @intCast(tmp)) else break :blk_1 code - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 9))) => {
                        ...
                        }).*.name != null) @as([*c]u8, @ptrCast(@alignCast(&(blk: {
                            const tmp = b;
                            if (tmp >= 0) break :blk f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*.name.*.contents[@as(usize, @intCast(0))]))) else "-");
                        break;
                    },
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 15))) => {
                        _ = printf("%d %d %d%s", a, b, c, if (isk != 0) "k" else "");
                        _ = printf("\t; %s", if ((blk: {
                            const tmp = a;
                            if (tmp >= 0) break :blk f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*.name != null) @as([*c]u8, @ptrCast(@alignCast(&(blk: {
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 19))) => {
                        ...
                        }) * (((@as(c_int, 1) << @intCast(8)) - @as(c_int, 1)) + @as(c_int, 1))));
                        break;
                    },
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 28))) => {
                        _ = printf("%d %d %d", a, b, c);
                        _ = printf("\t; ");
                        PrintConstant(f, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 29))) => {
                        _ = printf("%d %d %d", a, b, c);
                        _ = printf("\t; ");
                        PrintConstant(f, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 30))) => {
                        _ = printf("%d %d %d", a, b, c);
                        _ = printf("\t; ");
                        PrintConstant(f, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 31))) => {
                        _ = printf("%d %d %d", a, b, c);
                        _ = printf("\t; ");
                        PrintConstant(f, c);
                        break;
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 34))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 35))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 36))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 37))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 38))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 40))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 41))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 42))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 43))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 44))) => {
                        _ = printf("%d %d %d", a, b, c);
                        break;
                    },
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 46))) => {
                        _ = printf("%d %d %d", a, b, c);
                        _ = printf("\t; %s", @as([*c]u8, @ptrCast(@alignCast(&(blk: {
                            const tmp = c;
                            if (tmp >= 0) break :blk tmname + @as(usize, @intCast(tmp)) else break :blk tmname - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*.*.contents[@as(usize, @intCast(0))]))));
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 47))) => {
                        _ = printf("%d %d %d %d", a, sb, c, isk);
                        _ = printf("\t; %s", @as([*c]u8, @ptrCast(@alignCast(&(blk: {
                            const tmp = c;
                            if (tmp >= 0) break :blk tmname + @as(usize, @intCast(tmp)) else break :blk tmname - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*.*.contents[@as(usize, @intCast(0))]))));
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 68))) => {
                        ...
                        if (b == @as(c_int, 0)) {
                            ...
                            _ = printf("%d in ", b - @as(c_int, 1));
                        }
                        if (c == @as(c_int, 0)) {
                            _ = printf("all out");
                        } else {
                            _ = printf("%d out", c - @as(c_int, 1));
                        }
                        break;
                    },
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 71))) => break,
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 73))) => {
                        _ = printf("%d %d", a, bx);
                        _ = printf("\t; to %d", (pc - bx) + @as(c_int, 2));
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 74))) => {
                        _ = printf("%d %d", a, bx);
                        _ = printf("\t; exit to %d", (pc + bx) + @as(c_int, 3));
                        break;
                    },
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 77))) => {
                        _ = printf("%d %d", a, bx);
                        _ = printf("\t; to %d", (pc - bx) + @as(c_int, 2));
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 78))) => {
                        _ = printf("%d %d %d", a, b, c);
                        if (isk != 0) {
                            _ = printf("\t; %d", c + ((blk: {
                                _ = @as(c_int, 0);
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 79))) => {
                        _ = printf("%d %d", a, bx);
                        _ = printf("\t; %p", @as(?*const anyopaque, @ptrCast((blk: {
                            const tmp = bx;
                            if (tmp >= 0) break :blk f.*.p + @as(usize, @intCast(tmp)) else break :blk f.*.p - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*)));
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 80))) => {
                        _ = printf("%d %d", a, c);
                        _ = printf("\t; ");
                        if (c == @as(c_int, 0)) {
                            _ = printf("all out");
                    ...
                    @as(c_uint, @bitCast(@as(c_int, 81))) => {
                        _ = printf("%d", a);
                        break;
                    },
                    @as(c_uint, @bitCast(@as(c_int, 82))) => {
                        _ = printf("%d", ax);
                        break;
                    },
                    else => {},
...
pub fn PrintHeader(arg_f: [*c]const Proto) callconv(.c) void {
    var f = arg_f;
    _ = &f;
    var s: [*c]const u8 = if (f.*.source != null) @as([*c]u8, @ptrCast(@alignCast(&f.*.source.*.contents[@as(usize, @intCast(0))]))) else "=?";
    _ = &s;
    if ((@as(c_int, @bitCast(@as(c_uint, s.*))) == @as(c_int, '@')) or (@as(c_int, @bitCast(@as(c_uint, s.*))) == @as(c_int, '='))) {
        s += 1;
    } else if (@as(c_int, @bitCast(@as(c_uint, s.*))) == @as(c_int, @bitCast(@as(c_uint, "\x1bLua"[@as(c_uint, @intCast(@as(c_int, 0)))])))) {
        s = "(bstring)";
    } else {
        s = "(string)";
    }
    _ = printf("\n%s <%s:%d,%d> (%d instruction%s at %p)\n", if (f.*.linedefined == @as(c_int, 0)) "main" else "function", s, f.*.linedefined, f.*.lastlinedefined, f.*.sizecode, if (f.*.sizecode == @as(c_int, 1)) "" else "s", @as(?*const anyopaque, @ptrCast(f)));
    _ = printf("%d%s param%s, %d slot%s, %d upvalue%s, ", @as(c_int, @bitCast(@as(c_uint, f.*.numparams))), if (@as(c_int, @bitCast(@as(c_uint, f.*.is_vararg))) != 0) "+" else "", if (@as(c_int, @bitCast(@as(c_uint, f.*.numparams))) == @as(c_int, 1)) "" else "s", @as(c_int, @bitCast(@as(c_uint, f.*.maxstacksize))), if (@as(c_int, @bitCast(@as(c_uint, f.*.maxstacksize))) == @as(c_int, 1)) "" else "s", f.*.sizeupvalues, if (f.*.sizeupvalues == @as(c_int, 1)) "" else "s");
    _ = printf("%d local%s, %d constant%s, %d function%s\n", f.*.sizelocvars, if (f.*.sizelocvars == @as(c_int, 1)) "" else "s", f.*.sizek, if (f.*.sizek == @as(c_int, 1)) "" else "s", f.*.sizep, if (f.*.sizep == @as(c_int, 1)) "" else "s");
}
pub fn PrintDebug(arg_f: [*c]const Proto) callconv(.c) void {
    var f = arg_f;
    _ = &f;
    var i: c_int = undefined;
    _ = &i;
    ...
    _ = &n;
    n = f.*.sizek;
    _ = printf("constants (%d) for %p:\n", n, @as(?*const anyopaque, @ptrCast(f)));
    {
        i = 0;
        while (i < n) : (i += 1) {
            _ = printf("\t%d\t", i);
    ...
    n = f.*.sizelocvars;
    _ = printf("locals (%d) for %p:\n", n, @as(?*const anyopaque, @ptrCast(f)));
    {
        i = 0;
        while (i < n) : (i += 1) {
            _ = printf("\t%d\t%s\t%d\t%d\n", i, @as([*c]u8, @ptrCast(@alignCast(&(blk: {
                const tmp = i;
                if (tmp >= 0) break :blk f.*.locvars + @as(usize, @intCast(tmp)) else break :blk f.*.locvars - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.varname.*.contents[@as(usize, @intCast(0))]))), (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk f.*.locvars + @as(usize, @intCast(tmp)) else break :blk f.*.locvars - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.startpc + @as(c_int, 1), (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk f.*.locvars + @as(usize, @intCast(tmp)) else break :blk f.*.locvars - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.endpc + @as(c_int, 1));
        }
    ...
    _ = printf("upvalues (%d) for %p:\n", n, @as(?*const anyopaque, @ptrCast(f)));
    {
        ...
        while (i < n) : (i += 1) {
            _ = printf("\t%d\t%s\t%d\t%d\n", i, if ((blk: {
                ...
                const tmp = i;
                if (tmp >= 0) break :blk f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.name.*.contents[@as(usize, @intCast(0))]))) else "-", @as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.instack))), @as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.idx))));
        }
...
pub const checkliveness = @compileError("unable to translate macro: undefined identifier `isdead`");
// /src/cosmopolitan/third_party/lua/lobject.h:96:9
...
pub const lzio_h = "";
pub const lmem_h = "";
pub const luaM_error = @compileError("unable to translate macro: undefined identifier `luaD_throw`");
// /src/cosmopolitan/third_party/lua/lmem.h:8:9
...
pub const luaU_print = PrintFunction;
pub const PROGNAME = "luac";
pub const OUTPUT = PROGNAME ++ ".out";
pub const IS = @compileError("unable to translate macro: undefined identifier `argv`");
// /src/cosmopolitan/third_party/lua/luac.main.c:97:9
pub const FUNCTION = "(function()end)();\n";
pub inline fn toproto(L: anytype, i: anytype) @TypeOf(getproto(s2v(L.*.top.p + i))) {
    _ = &L;
    _ = &i;
    return getproto(s2v(L.*.top.p + i));
}
pub const UPVALNAME = @compileError("unable to translate macro: undefined identifier `f`");
// /src/cosmopolitan/third_party/lua/luac.main.c:239:9
pub const VOID = @compileError("unable to translate C expr: unexpected token 'const'");
// /src/cosmopolitan/third_party/lua/luac.main.c:240:9
pub inline fn eventname(i: anytype) @TypeOf(getstr(tmname[@as(usize, @intCast(i))])) {
    _ = &i;
    return getstr(tmname[@as(usize, @intCast(i))]);
}
pub const COMMENT = "\t; ";
pub const EXTRAARG = @compileError("unable to translate macro: undefined identifier `code`");
// /src/cosmopolitan/third_party/lua/luac.main.c:353:9
pub const EXTRAARGC = EXTRAARG * (MAXARG_C + @as(c_int, 1));
pub const ISK = @compileError("unable to translate macro: undefined identifier `isk`");
// /src/cosmopolitan/third_party/lua/luac.main.c:355:9
pub inline fn SS(x: anytype) @TypeOf(if (x == @as(c_int, 1)) "" else "s") {
    _ = &x;
    return if (x == @as(c_int, 1)) "" else "s";
}
pub inline fn S(x: anytype) @TypeOf(SS(x)) {
    _ = &x;
    return blk: {
        _ = std.zig.c_translation.cast(c_int, x);
        break :blk SS(x);
    };
}
