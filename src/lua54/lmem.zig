...
pub export fn luaM_toobig(arg_L: [*c]lua_State) noreturn {
    var L = arg_L;
    _ = &L;
    luaG_runerror(L, "memory allocation error: block too big");
}
pub export fn luaM_realloc_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_osize: usize, arg_nsize: usize) ?*anyopaque {
    var L = arg_L;
    _ = &L;
    var block = arg_block;
    _ = &block;
    ...
    var nsize = arg_nsize;
    _ = &nsize;
    var newblock: ?*anyopaque = undefined;
    _ = &newblock;
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
    _ = @as(c_int, 0);
    newblock = g.*.frealloc.?(g.*.ud, block, osize, nsize);
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool((newblock == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) and (nsize > @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
        newblock = tryagain(L, block, osize, nsize);
        if (newblock == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) return @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    }
    _ = @as(c_int, 0);
    g.*.GCdebt = @as(l_mem, @bitCast((@as(usize, @bitCast(g.*.GCdebt)) +% nsize) -% osize));
    return newblock;
}
pub export fn luaM_saferealloc_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_osize: usize, arg_nsize: usize) ?*anyopaque {
    var L = arg_L;
    _ = &L;
    var block = arg_block;
    _ = &block;
    ...
    var nsize = arg_nsize;
    _ = &nsize;
    var newblock: ?*anyopaque = luaM_realloc_(L, block, osize, nsize);
    _ = &newblock;
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool((newblock == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) and (nsize > @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
...
pub export fn luaM_free_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_osize: usize) void {
    var L = arg_L;
    _ = &L;
    var block = arg_block;
    _ = &block;
    ...
    _ = &g;
    _ = @as(c_int, 0);
    _ = g.*.frealloc.?(g.*.ud, block, osize, @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))));
    g.*.GCdebt -= @as(l_mem, @bitCast(osize));
}
pub export fn luaM_growaux_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_nelems: c_int, arg_psize: [*c]c_int, arg_size_elems: c_int, arg_limit: c_int, arg_what: [*c]const u8) ?*anyopaque {
    var L = arg_L;
    _ = &L;
    var block = arg_block;
    _ = &block;
    ...
    var newblock: ?*anyopaque = undefined;
    _ = &newblock;
    var size: c_int = psize.*;
    _ = &size;
    if ((nelems + @as(c_int, 1)) <= size) return block;
    if (size >= @divTrunc(limit, @as(c_int, 2))) {
        if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(size >= limit) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
    ...
    _ = @as(c_int, 0);
    newblock = luaM_saferealloc_(L, block, @as(usize, @bitCast(@as(c_long, psize.*))) *% @as(usize, @bitCast(@as(c_long, size_elems))), @as(usize, @bitCast(@as(c_long, size))) *% @as(usize, @bitCast(@as(c_long, size_elems))));
    psize.* = size;
    return newblock;
}
pub export fn luaM_shrinkvector_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_size: [*c]c_int, arg_final_n: c_int, arg_size_elem: c_int) ?*anyopaque {
    var L = arg_L;
    _ = &L;
    var block = arg_block;
    _ = &block;
    var size = arg_size;
    _ = &size;
    var final_n = arg_final_n;
    _ = &final_n;
    var size_elem = arg_size_elem;
    _ = &size_elem;
    var newblock: ?*anyopaque = undefined;
    _ = &newblock;
    var oldsize: usize = @as(usize, @bitCast(@as(c_long, size.* * size_elem)));
    _ = &oldsize;
    var newsize: usize = @as(usize, @bitCast(@as(c_long, final_n * size_elem)));
    _ = &newsize;
    _ = @as(c_int, 0);
...
pub export fn luaM_malloc_(arg_L: [*c]lua_State, arg_size: usize, arg_tag: c_int) ?*anyopaque {
    var L = arg_L;
    _ = &L;
    var size = arg_size;
    _ = &size;
    var tag = arg_tag;
    _ = &tag;
    if (size == @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) return @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))) else {
        var g: [*c]global_State = L.*.l_G;
        _ = &g;
        var newblock: ?*anyopaque = g.*.frealloc.?(g.*.ud, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(usize, @bitCast(@as(c_long, tag))), size);
        _ = &newblock;
        if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(newblock == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
            newblock = tryagain(L, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(usize, @bitCast(@as(c_long, tag))), size);
            if (newblock == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) {
                luaD_throw(L, @as(c_int, 4));
            }
        }
        g.*.GCdebt += @as(l_mem, @bitCast(size));
        return newblock;
    }
    return null;
}
...
pub fn tryagain(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_osize: usize, arg_nsize: usize) callconv(.c) ?*anyopaque {
    var L = arg_L;
    _ = &L;
    var block = arg_block;
    _ = &block;
    ...
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
    if (((@as(c_int, @bitCast(@as(c_uint, (&g.*.nilvalue).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) and !(g.*.gcstopem != 0)) {
        _ = @as(c_int, 0);
...
pub inline fn callfrealloc(g: anytype, block: anytype, os: anytype, ns: anytype) @TypeOf(g.*.frealloc.*(g.*.ud, block, os, ns)) {
    _ = &g;
    _ = &block;
    _ = &os;
    _ = &ns;
...
pub inline fn cantryagain(g: anytype) @TypeOf((completestate(g) != 0) and !(g.*.gcstopem != 0)) {
    _ = &g;
    return (completestate(g) != 0) and !(g.*.gcstopem != 0);
}
pub inline fn firsttry(g: anytype, block: anytype, os: anytype, ns: anytype) @TypeOf(callfrealloc(g, block, os, ns)) {
    _ = &g;
    _ = &block;
    _ = &os;
    _ = &ns;
...
pub const MINSIZEARRAY = @as(c_int, 4);
