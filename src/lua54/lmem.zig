...
pub export fn luaM_realloc_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_osize: usize, arg_nsize: usize) ?*anyopaque {
    ...
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool((newblock == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) and (nsize > @as(usize, @bitCast(@as(isize, @as(c_int, 0)))))) != @as(c_int, 0))), @as(c_long, @as(c_int, 0))) != 0) {
...
pub export fn luaM_free_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_osize: usize) void {
    ...
    _ = &g;
    _ = @as(c_int, 0);
    _ = g.*.frealloc.?(g.*.ud, block, osize, @as(usize, @bitCast(@as(isize, @as(c_int, 0)))));
...
pub export fn luaM_growaux_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_nelems: c_int, arg_psize: [*c]c_int, arg_size_elems: c_int, arg_limit: c_int, arg_what: [*c]const u8) ?*anyopaque {
    ...
    if (size >= @divTrunc(limit, @as(c_int, 2))) {
        if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(size >= limit) != @as(c_int, 0))), @as(c_long, @as(c_int, 0))) != 0) {
    ...
    _ = @as(c_int, 0);
    newblock = luaM_saferealloc_(L, block, @as(usize, @bitCast(@as(isize, psize.*))) *% @as(usize, @bitCast(@as(isize, size_elems))), @as(usize, @bitCast(@as(isize, size))) *% @as(usize, @bitCast(@as(isize, size_elems))));
    psize.* = size;
    return newblock;
}
pub export fn luaM_shrinkvector_(arg_L: [*c]lua_State, arg_block: ?*anyopaque, arg_size: [*c]c_int, arg_final_n: c_int, arg_size_elem: c_int) ?*anyopaque {
    ...
    var newblock: ?*anyopaque = undefined;
    _ = &newblock;
    var oldsize: usize = @as(usize, @bitCast(@as(isize, size.* * size_elem)));
    _ = &oldsize;
    var newsize: usize = @as(usize, @bitCast(@as(isize, final_n * size_elem)));
    _ = &newsize;
    _ = @as(c_int, 0);
...
pub export fn luaM_malloc_(arg_L: [*c]lua_State, arg_size: usize, arg_tag: c_int) ?*anyopaque {
    ...
    var tag = arg_tag;
    _ = &tag;
    if (size == @as(usize, @bitCast(@as(isize, @as(c_int, 0))))) return @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))) else {
        var g: [*c]global_State = L.*.l_G;
        _ = &g;
        var newblock: ?*anyopaque = g.*.frealloc.?(g.*.ud, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(usize, @bitCast(@as(isize, tag))), size);
        _ = &newblock;
        if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(newblock == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) != @as(c_int, 0))), @as(c_long, @as(c_int, 0))) != 0) {
            newblock = tryagain(L, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(usize, @bitCast(@as(isize, tag))), size);
