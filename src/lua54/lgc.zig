...
pub const struct_UpVal = extern struct {
    ...
    tt: lu_byte = @import("std").mem.zeroes(lu_byte),
    marked: lu_byte = @import("std").mem.zeroes(lu_byte),
    v: union_unnamed_7 = @import("std").mem.zeroes(union_unnamed_7),
...
pub const struct_CallInfo = extern struct {
    ...
    u2: union_unnamed_10 = @import("std").mem.zeroes(union_unnamed_10),
...
pub export fn luaC_fix(L: [*c]lua_State, o: [*c]GCObject) void {
    const g: [*c]global_State = L.*.l_G;
    // Clear white bits (3,4) and old bit (5): mask = ~((1<<5)|((1<<3)|(1<<4)))
    o.*.marked &= @as(lu_byte, @bitCast(@as(i8, @truncate(~@as(c_int, (1 << 5) | ((1 << 3) | (1 << 4)))))));
    // Set color to FIXEDBIT (bit 2 = 4): (marked & ~7) | 4
    o.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ~@as(c_int, 7)) | 4))));
    g.*.allgc = o.*.next;
    o.*.next = g.*.fixedgc;
    g.*.fixedgc = o;
}
pub export fn luaC_freeallobjects(L: [*c]lua_State) void {
    const g: [*c]global_State = L.*.l_G;
    g.*.gcstp = 4;
    luaC_changemode(L, 0);
    separatetobefnz(g, 1);
    callallpendingfinalizers(L);
    deletelist(L, g.*.allgc, &@as([*c]union_GCUnion, @ptrCast(@alignCast(g.*.mainthread))).*.gc);
...
pub export fn luaC_runtilstate(arg_L: [*c]lua_State, arg_statesmask: c_int) void {
    var L = arg_L;
    _ = &L;
    var statesmask = arg_statesmask;
    _ = &statesmask;
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
    while (!((statesmask & (@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, g.*.gcstate)))))) != 0)) {
        _ = singlestep(L);
    }
}
pub export fn luaC_fullgc(arg_L: [*c]lua_State, arg_isemergency: c_int) void {
    var L = arg_L;
    _ = &L;
    var isemergency = arg_isemergency;
    _ = &isemergency;
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
    _ = @as(c_int, 0);
    g.*.gcemergency = @as(lu_byte, @bitCast(@as(i8, @truncate(isemergency))));
    if (@as(c_int, @bitCast(@as(c_uint, g.*.gckind))) == @as(c_int, 0)) {
        fullinc(L, g);
    } else {
        _ = fullgen(L, g);
    }
...
pub export fn luaC_newobj(L: [*c]lua_State, tt: c_int, sz: usize) [*c]GCObject {
    return luaC_newobjdt(L, tt, sz, 0);
}
pub export fn luaC_newobjdt(L: [*c]lua_State, tt: c_int, sz: usize, offset: usize) [*c]GCObject {
    const g: [*c]global_State = L.*.l_G;
    const p: [*c]u8 = @as([*c]u8, @ptrCast(@alignCast(luaM_malloc_(L, sz, tt & 15))));
    const o: [*c]GCObject = @as([*c]GCObject, @ptrCast(@alignCast(p + offset)));
    o.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) & ((1 << @intCast(3)) | (1 << @intCast(4)))))));
    o.*.tt = @as(lu_byte, @bitCast(@as(i8, @truncate(tt))));
    o.*.next = g.*.allgc;
    g.*.allgc = o;
    return o;
}
pub export fn luaC_barrier_(L: [*c]lua_State, o: [*c]GCObject, v: [*c]GCObject) void {
    const g: [*c]global_State = L.*.l_G;
    if (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) <= 2) {
        reallymarkobject(g, v);
        if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & 7) > 1) {
            v.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, v.*.marked))) & ~@as(c_int, 7)) | 2))));
        }
    } else {
        if (@as(c_int, @bitCast(@as(c_uint, g.*.gckind))) == 0) {
            o.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ~@as(c_int, (1 << @intCast(5)) | ((1 << @intCast(3)) | (1 << @intCast(4))))) | @as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) & ((1 << @intCast(3)) | (1 << @intCast(4))))))))))))));
        }
    }
}
pub export fn luaC_barrierback_(L: [*c]lua_State, o: [*c]GCObject) void {
    const g: [*c]global_State = L.*.l_G;
    if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & 7) == 6) {
        o.*.marked &= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(~@as(c_int, (1 << @intCast(5)) | ((1 << @intCast(3)) | (1 << @intCast(4)))))))))))))));
    } else {
        linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.gc, getgclist(o), &g.*.grayagain);
    }
    if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & 7) > 1) {
        o.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ~@as(c_int, 7)) | 5))));
    }
}
pub export fn luaC_checkfinalizer(L: [*c]lua_State, o: [*c]GCObject, mt: [*c]Table) void {
    const g: [*c]global_State = L.*.l_G;
    if ((((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & (1 << @intCast(6))) != 0) or ((if (mt == @as([*c]Table, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) null else if ((@as(c_uint, @bitCast(@as(c_uint, mt.*.flags))) & (@as(c_uint, 1) << @intCast(TM_GC))) != 0) null else luaT_gettm(mt, @as(c_uint, @bitCast(TM_GC)), g.*.tmname[@as(c_uint, @intCast(TM_GC))])) == @as([*c]const TValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0))))))) or ((@as(c_int, @bitCast(@as(c_uint, g.*.gcstp))) & 4) != 0)) return else {
        var p: [*c][*c]GCObject = undefined;
        if ((3 <= @as(c_int, @bitCast(@as(c_uint, g.*.gcstate)))) and (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) <= 6)) {
            o.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ~@as(c_int, (1 << @intCast(5)) | ((1 << @intCast(3)) | (1 << @intCast(4))))) | @as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) & ((1 << @intCast(3)) | (1 << @intCast(4))))))))))))));
            if (g.*.sweepgc == (&o.*.next)) {
        ...
        o.*.next = g.*.finobj;
        g.*.finobj = o;
        o.*.marked |= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 1) << @intCast(6)))));
    }
}
pub export fn luaC_changemode(L: [*c]lua_State, newmode: c_int) void {
    const g: [*c]global_State = L.*.l_G;
    if (newmode != @as(c_int, @bitCast(@as(c_uint, g.*.gckind)))) {
        if (newmode == 1) {
            _ = entergen(L, g);
        } else {
            enterinc(g);
...
pub fn reallymarkobject(g: [*c]global_State, o: [*c]GCObject) callconv(.c) void {
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt)))) {
            4, 20 => {
                o.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ~@as(c_int, (1 << @intCast(3)) | (1 << @intCast(4)))) | (1 << @intCast(5))))));
                break;
            },
            9 => {
                const uv: [*c]UpVal = &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.upv;
                if (uv.*.v.p != (&uv.*.u.value)) {
                    uv.*.marked &= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(~@as(c_int, (1 << @intCast(5)) | ((1 << @intCast(3)) | (1 << @intCast(4)))))))))))))));
                } else {
                    uv.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, uv.*.marked))) & ~@as(c_int, (1 << @intCast(3)) | (1 << @intCast(4)))) | (1 << @intCast(5))))));
                }
                if (((@as(c_int, @bitCast(@as(c_uint, uv.*.v.p.*.tt_))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, uv.*.v.p.*.value_.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
                    reallymarkobject(g, uv.*.v.p.*.value_.gc);
                }
                break;
            },
            7 => {
                const u: [*c]Udata = &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.u;
                if (@as(c_int, @bitCast(@as(c_uint, u.*.nuvalue))) == 0) {
                    if (u.*.metatable != null) {
                        if ((@as(c_int, @bitCast(@as(c_uint, u.*.metatable.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0) {
                            reallymarkobject(g, &@as([*c]union_GCUnion, @ptrCast(@alignCast(u.*.metatable))).*.gc);
                        }
                    }
                    u.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, u.*.marked))) & ~@as(c_int, (1 << @intCast(3)) | (1 << @intCast(4)))) | (1 << @intCast(5))))));
                    break;
                }
                linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.gc, getgclist(o), &g.*.gray);
                break;
            },
            6, 38, 5, 8, 10 => {
                linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.gc, getgclist(o), &g.*.gray);
...
pub fn atomic(L: [*c]lua_State) callconv(.c) lu_mem {
    const g: [*c]global_State = L.*.l_G;
    var work: lu_mem = 0;
    var origweak: [*c]GCObject = undefined;
    var origall: [*c]GCObject = undefined;
    const grayagain: [*c]GCObject = g.*.grayagain;
    g.*.grayagain = null;
    g.*.gcstate = 2;
    if ((@as(c_int, @bitCast(@as(c_uint, L.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0) {
        reallymarkobject(g, &@as([*c]union_GCUnion, @ptrCast(@alignCast(L))).*.gc);
    }
    if (((@as(c_int, @bitCast(@as(c_uint, (&g.*.l_registry).*.tt_))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (&g.*.l_registry).*.value_.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
    ...
    luaS_clearcache(g);
    g.*.currentwhite = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) ^ ((1 << @intCast(3)) | (1 << @intCast(4)))))));
    return work;
}
pub fn entersweep(L: [*c]lua_State) callconv(.c) void {
    const g: [*c]global_State = L.*.l_G;
    g.*.gcstate = 3;
    g.*.sweepgc = sweeptolive(L, &g.*.allgc);
}
pub fn getgclist(o: [*c]GCObject) callconv(.c) [*c][*c]GCObject {
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt)))) {
            5 => return &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.h.gclist,
            6 => return &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.cl.l.gclist,
            38 => return &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.cl.c.gclist,
            8 => return &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.th.gclist,
            10 => return &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.p.gclist,
            7 => {
                const u: [*c]Udata = &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.u;
                return &u.*.gclist;
            },
...
pub fn linkgclist_(o: [*c]GCObject, pnext: [*c][*c]GCObject, list: [*c][*c]GCObject) callconv(.c) void {
    pnext.* = list.*;
    list.* = o;
    o.*.marked &= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(~@as(c_int, (1 << @intCast(5)) | ((1 << @intCast(3)) | (1 << @intCast(4)))))))))))))));
}
pub fn clearkey(n: [*c]Node) callconv(.c) void {
    if ((@as(c_int, @bitCast(@as(c_uint, n.*.u.key_tt))) & (1 << @intCast(6))) != 0) {
        n.*.u.key_tt = @as(lu_byte, @bitCast(@as(i8, @truncate(9 + 2))));
    }
}
pub fn iscleared(g: [*c]global_State, o: [*c]const GCObject) callconv(.c) c_int {
    if (o == @as([*c]const GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) return 0 else if ((@as(c_int, @bitCast(@as(c_uint, o.*.tt))) & 15) == 4) {
        if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0) {
            reallymarkobject(g, &@as([*c]union_GCUnion, @ptrCast(@constCast(@volatileCast(o)))).*.gc);
        }
        return 0;
    } else return @as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)));
    return 0;
}
pub fn markmt(g: [*c]global_State) callconv(.c) void {
    var i: c_int = 0;
    while (i < 9) : (i += 1) {
        if (g.*.mt[@as(c_uint, @intCast(i))] != null) {
            if ((@as(c_int, @bitCast(@as(c_uint, g.*.mt[@as(c_uint, @intCast(i))].*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0) {
                reallymarkobject(g, &@as([*c]union_GCUnion, @ptrCast(@alignCast(g.*.mt[@as(c_uint, @intCast(i))]))).*.gc);
            }
        }
    }
}
pub fn markbeingfnz(g: [*c]global_State) callconv(.c) lu_mem {
    var o: [*c]GCObject = g.*.tobefnz;
    var count: lu_mem = 0;
    while (o != @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) : (o = o.*.next) {
        count +%= 1;
        if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0) {
            reallymarkobject(g, &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.gc);
        }
    }
    return count;
}
pub fn remarkupvals(g: [*c]global_State) callconv(.c) c_int {
    var thread: [*c]lua_State = undefined;
    var p: [*c][*c]lua_State = &g.*.twups;
    var work: c_int = 0;
    while ((blk: {
        const tmp = p.*;
        thread = tmp;
        break :blk tmp;
    }) != @as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) {
        work += 1;
        if (!((@as(c_int, @bitCast(@as(c_uint, thread.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0) and (thread.*.openupval != @as([*c]UpVal, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0))))))) {
            p = &thread.*.twups;
        } else {
            var uv: [*c]UpVal = undefined;
            p.* = thread.*.twups;
            thread.*.twups = thread;
            uv = thread.*.openupval;
            while (uv != @as([*c]UpVal, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(0)))))) : (uv = uv.*.u.open.next) {
                work += 1;
                if (!((@as(c_int, @bitCast(@as(c_uint, uv.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
                    if (((@as(c_int, @bitCast(@as(c_uint, uv.*.v.p.*.tt_))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, uv.*.v.p.*.value_.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
                        reallymarkobject(g, uv.*.v.p.*.value_.gc);
                    }
                }
...
pub fn cleargraylists(g: [*c]global_State) callconv(.c) void {
    g.*.grayagain = null;
    g.*.gray = null;
    g.*.ephemeron = null;
    g.*.allweak = null;
...
pub fn restartcollection(g: [*c]global_State) callconv(.c) void {
    cleargraylists(g);
    if ((@as(c_int, @bitCast(@as(c_uint, g.*.mainthread.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0) {
        reallymarkobject(g, &@as([*c]union_GCUnion, @ptrCast(@alignCast(g.*.mainthread))).*.gc);
    }
    if (((@as(c_int, @bitCast(@as(c_uint, (&g.*.l_registry).*.tt_))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (&g.*.l_registry).*.value_.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
        reallymarkobject(g, (&g.*.l_registry).*.value_.gc);
    }
...
pub fn genlink(g: [*c]global_State, o: [*c]GCObject) callconv(.c) void {
    if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & 7) == 5) {
        linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.gc, getgclist(o), &g.*.grayagain);
    } else if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & 7) == 6) {
        o.*.marked ^= @as(lu_byte, @bitCast(@as(i8, @truncate(6 ^ 4))));
    }
}
pub fn traverseweakvalue(g: [*c]global_State, h: [*c]Table) callconv(.c) void {
    ...
    while (n < limit) : (n += 1) {
        if ((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.tt_))) & 15) == 0) {
            clearkey(n);
        } else {
            if (((@as(c_int, @bitCast(@as(c_uint, n.*.u.key_tt))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, n.*.u.key_val.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
                reallymarkobject(g, n.*.u.key_val.gc);
            }
            if (!(hasclears != 0) and (iscleared(g, if ((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.tt_))) & (1 << @intCast(6))) != 0) (&n.*.i_val).*.value_.gc else null) != 0)) {
                hasclears = 1;
            }
        }
    }
    if ((@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) == 2) and (hasclears != 0)) {
        linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(h))).*.gc, &h.*.gclist, &g.*.weak);
    } else {
        linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(h))).*.gc, &h.*.gclist, &g.*.grayagain);
    }
}
pub fn traverseephemeron(g: [*c]global_State, h: [*c]Table, inv: c_int) callconv(.c) c_int {
    var marked: c_int = 0;
    var hasclears: c_int = 0;
    var hasww: c_int = 0;
    const asize: c_uint = luaH_realasize(h);
    const nsize: c_uint = @as(c_uint, @bitCast(@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, h.*.lsizenode))))));
    {
        var i: c_uint = 0;
        while (i < asize) : (i +%= 1) {
            if (((@as(c_int, @bitCast(@as(c_uint, (&h.*.array[i]).*.tt_))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (&h.*.array[i]).*.value_.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
                marked = 1;
    ...
    }
    {
        var i: c_uint = 0;
        while (i < nsize) : (i +%= 1) {
            const n: [*c]Node = if (inv != 0) &h.*.node[(nsize -% @as(c_uint, @bitCast(@as(c_int, 1)))) -% i] else &h.*.node[i];
            if ((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.tt_))) & 15) == 0) {
                clearkey(n);
            } else if (iscleared(g, if ((@as(c_int, @bitCast(@as(c_uint, n.*.u.key_tt))) & (1 << @intCast(6))) != 0) n.*.u.key_val.gc else null) != 0) {
                hasclears = 1;
                if (((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.tt_))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.value_.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
                    hasww = 1;
                }
            } else if (((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.tt_))) & (1 << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.value_.gc.*.marked))) & ((1 << @intCast(3)) | (1 << @intCast(4)))) != 0)) {
                marked = 1;
                reallymarkobject(g, (&n.*.i_val).*.value_.gc);
            }
        }
    }
    if (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) == 0) {
        linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(h))).*.gc, &h.*.gclist, &g.*.grayagain);
    } else if (hasww != 0) {
        linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(h))).*.gc, &h.*.gclist, &g.*.ephemeron);
    } else if (hasclears != 0) {
        linkgclist_(&@as([*c]union_GCUnion, @ptrCast(@alignCast(h))).*.gc, &h.*.gclist, &g.*.allweak);
    } else {
        genlink(g, &@as([*c]union_GCUnion, @ptrCast(@alignCast(h))).*.gc);
    }
    return marked;
}
...
pub fn traversetable(arg_g: [*c]global_State, arg_h: [*c]Table) callconv(.c) lu_mem {
    var g = arg_g;
    _ = &g;
    var h = arg_h;
    _ = &h;
    var weakkey: [*c]const u8 = undefined;
    _ = &weakkey;
    var weakvalue: [*c]const u8 = undefined;
    _ = &weakvalue;
    var mode: [*c]const TValue = if (h.*.metatable == @as([*c]struct_Table, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) null else if ((@as(c_uint, @bitCast(@as(c_uint, h.*.metatable.*.flags))) & (@as(c_uint, 1) << @intCast(TM_MODE))) != 0) null else luaT_gettm(h.*.metatable, @as(c_uint, @bitCast(TM_MODE)), g.*.tmname[@as(c_uint, @intCast(TM_MODE))]);
    _ = &mode;
    {
        if (h.*.metatable != null) {
            if ((@as(c_int, @bitCast(@as(c_uint, h.*.metatable.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                reallymarkobject(g, blk: {
                    _ = @as(c_int, 0);
                    break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(h.*.metatable))).*.gc;
                });
            }
        }
    }
    if (((mode != null) and ((@as(c_int, @bitCast(@as(c_uint, mode.*.tt_))) & @as(c_int, 15)) == @as(c_int, 4))) and ((blk: {
        _ = blk_1: {
            _ = blk_2: {
                const tmp = strchr(@as([*c]u8, @ptrCast(@alignCast(&(blk_3: {
                    _ = @as(c_int, 0);
                    break :blk_3 blk_4: {
                        _ = @as(c_int, 0);
                        break :blk_4 &@as([*c]union_GCUnion, @ptrCast(@alignCast(mode.*.value_.gc))).*.ts;
                    };
                }).*.contents[@as(usize, @intCast(0))]))), @as(c_int, 'k'));
                weakkey = tmp;
                break :blk_2 tmp;
            };
            break :blk_1 blk_2: {
                ...
                }).*.contents[@as(usize, @intCast(0))]))), @as(c_int, 'v'));
                weakvalue = tmp;
                break :blk_2 tmp;
            };
        };
        break :blk (weakkey != null) or (weakvalue != null);
    }))) {
        if (!(weakkey != null)) {
            traverseweakvalue(g, h);
        } else if (!(weakvalue != null)) {
            _ = traverseephemeron(g, h, @as(c_int, 0));
        } else {
            linkgclist_(blk: {
                _ = @as(c_int, 0);
...
pub fn traverseudata(arg_g: [*c]global_State, arg_u: [*c]Udata) callconv(.c) c_int {
    ...
    {
        if (u.*.metatable != null) {
            if ((@as(c_int, @bitCast(@as(c_uint, u.*.metatable.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                reallymarkobject(g, blk: {
                    _ = @as(c_int, 0);
                    break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(u.*.metatable))).*.gc;
                });
            }
        }
    }
    {
        i = 0;
        while (i < @as(c_int, @bitCast(@as(c_uint, u.*.nuvalue)))) : (i += 1) {
            _ = blk: {
                _ = g.*.mainthread;
                break :blk if (!((@as(c_int, @bitCast(@as(c_uint, (&u.*.uv[@as(c_uint, @intCast(i))].uv).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) or (((@as(c_int, @bitCast(@as(c_uint, (&u.*.uv[@as(c_uint, @intCast(i))].uv).*.tt_))) & @as(c_int, 63)) == @as(c_int, @bitCast(@as(c_uint, (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 (&u.*.uv[@as(c_uint, @intCast(i))].uv).*.value_.gc;
                }).*.tt)))) and ((g.*.mainthread == @as([*c]struct_lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 (&u.*.uv[@as(c_uint, @intCast(i))].uv).*.value_.gc;
                }).*.marked))) & (@as(c_int, @bitCast(@as(c_uint, g.*.mainthread.*.l_G.*.currentwhite))) ^ ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))) != 0)))) @as(c_int, 0) else @as(c_int, 0);
            };
            if (((@as(c_int, @bitCast(@as(c_uint, (&u.*.uv[@as(c_uint, @intCast(i))].uv).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                _ = @as(c_int, 0);
                break :blk (&u.*.uv[@as(c_uint, @intCast(i))].uv).*.value_.gc;
            }).*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) {
                reallymarkobject(g, blk: {
                    _ = @as(c_int, 0);
                    break :blk (&u.*.uv[@as(c_uint, @intCast(i))].uv).*.value_.gc;
                });
    ...
    genlink(g, blk: {
        _ = @as(c_int, 0);
        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(u))).*.gc;
    });
    return @as(c_int, 1) + @as(c_int, @bitCast(@as(c_uint, u.*.nuvalue)));
}
pub fn traverseproto(arg_g: [*c]global_State, arg_f: [*c]Proto) callconv(.c) c_int {
    var g = arg_g;
    _ = &g;
    var f = arg_f;
    _ = &f;
    ...
    {
        if (f.*.source != null) {
            if ((@as(c_int, @bitCast(@as(c_uint, f.*.source.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                reallymarkobject(g, blk: {
                    _ = @as(c_int, 0);
    ...
    }
    {
        ...
        while (i < f.*.sizek) : (i += 1) {
            _ = blk: {
                _ = g.*.mainthread;
                break :blk if (!((@as(c_int, @bitCast(@as(c_uint, (&(blk_1: {
                    const tmp = i;
                    if (tmp >= 0) break :blk_1 f.*.k + @as(usize, @intCast(tmp)) else break :blk_1 f.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) or (((@as(c_int, @bitCast(@as(c_uint, (&(blk_1: {
                    const tmp = i;
                    if (tmp >= 0) break :blk_1 f.*.k + @as(usize, @intCast(tmp)) else break :blk_1 f.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*).*.tt_))) & @as(c_int, 63)) == @as(c_int, @bitCast(@as(c_uint, (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 (&(blk_2: {
                        const tmp = i;
                        if (tmp >= 0) break :blk_2 f.*.k + @as(usize, @intCast(tmp)) else break :blk_2 f.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*).*.value_.gc;
                }).*.tt)))) and ((g.*.mainthread == @as([*c]struct_lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 (&(blk_2: {
            ...
            }).*).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                _ = @as(c_int, 0);
                break :blk (&(blk_1: {
                    const tmp = i;
                    if (tmp >= 0) break :blk_1 f.*.k + @as(usize, @intCast(tmp)) else break :blk_1 f.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        ...
        while (i < f.*.sizeupvalues) : (i += 1) {
            if ((blk: {
                ...
                if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*.name.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                    reallymarkobject(g, blk: {
                        _ = @as(c_int, 0);
                        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast((blk_1: {
                            const tmp = i;
                            if (tmp >= 0) break :blk_1 f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk_1 f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*.name))).*.gc;
                    });
                }
            }
            ...
            if ((blk: {
                ...
                if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                    ...
                    reallymarkobject(g, blk: {
                        ...
                        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast((blk_1: {
                            const tmp = i;
                            if (tmp >= 0) break :blk_1 f.*.p + @as(usize, @intCast(tmp)) else break :blk_1 f.*.p - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*))).*.gc;
                    });
                }
            }
        ...
        while (i < f.*.sizelocvars) : (i += 1) {
            if ((blk: {
                ...
                if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk f.*.locvars + @as(usize, @intCast(tmp)) else break :blk f.*.locvars - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*.varname.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                    reallymarkobject(g, blk: {
                        _ = @as(c_int, 0);
                        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast((blk_1: {
                            const tmp = i;
                            if (tmp >= 0) break :blk_1 f.*.locvars + @as(usize, @intCast(tmp)) else break :blk_1 f.*.locvars - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*.varname))).*.gc;
                    });
                }
            }
    ...
    return (((@as(c_int, 1) + f.*.sizek) + f.*.sizeupvalues) + f.*.sizep) + f.*.sizelocvars;
}
pub fn traverseCclosure(arg_g: [*c]global_State, arg_cl: [*c]CClosure) callconv(.c) c_int {
    var g = arg_g;
    _ = &g;
    var cl = arg_cl;
    _ = &cl;
    ...
    {
        i = 0;
        while (i < @as(c_int, @bitCast(@as(c_uint, cl.*.nupvalues)))) : (i += 1) {
            _ = blk: {
                _ = g.*.mainthread;
                break :blk if (!((@as(c_int, @bitCast(@as(c_uint, (&@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(i))]).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) or (((@as(c_int, @bitCast(@as(c_uint, (&@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(i))]).*.tt_))) & @as(c_int, 63)) == @as(c_int, @bitCast(@as(c_uint, (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 (&@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(i))]).*.value_.gc;
                }).*.tt)))) and ((g.*.mainthread == @as([*c]struct_lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 (&@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(i))]).*.value_.gc;
                }).*.marked))) & (@as(c_int, @bitCast(@as(c_uint, g.*.mainthread.*.l_G.*.currentwhite))) ^ ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))) != 0)))) @as(c_int, 0) else @as(c_int, 0);
            };
            if (((@as(c_int, @bitCast(@as(c_uint, (&@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(i))]).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                _ = @as(c_int, 0);
                break :blk (&@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(i))]).*.value_.gc;
            }).*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) {
                reallymarkobject(g, blk: {
                    _ = @as(c_int, 0);
                    break :blk (&@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(i))]).*.value_.gc;
    ...
    return @as(c_int, 1) + @as(c_int, @bitCast(@as(c_uint, cl.*.nupvalues)));
}
pub fn traverseLclosure(arg_g: [*c]global_State, arg_cl: [*c]LClosure) callconv(.c) c_int {
    var g = arg_g;
    _ = &g;
    var cl = arg_cl;
    _ = &cl;
    ...
    {
        if (cl.*.p != null) {
            if ((@as(c_int, @bitCast(@as(c_uint, cl.*.p.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                reallymarkobject(g, blk: {
                    _ = @as(c_int, 0);
                    break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(cl.*.p))).*.gc;
                });
            }
        }
    }
    {
        i = 0;
        while (i < @as(c_int, @bitCast(@as(c_uint, cl.*.nupvalues)))) : (i += 1) {
            var uv: [*c]UpVal = @as([*][*c]UpVal, @ptrCast(&cl.*.upvals))[@as(c_uint, @intCast(i))];
            _ = &uv;
            {
                if (uv != null) {
                    if ((@as(c_int, @bitCast(@as(c_uint, uv.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                        reallymarkobject(g, blk: {
                            _ = @as(c_int, 0);
                            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(uv))).*.gc;
                        });
                    }
                }
            }
...
pub fn traversethread(arg_g: [*c]global_State, arg_th: [*c]lua_State) callconv(.c) c_int {
    var g = arg_g;
    _ = &g;
    var th = arg_th;
    _ = &th;
    var uv: [*c]UpVal = undefined;
    _ = &uv;
    var o: StkId = th.*.stack.p;
    _ = &o;
    if (((@as(c_int, @bitCast(@as(c_uint, th.*.marked))) & @as(c_int, 7)) > @as(c_int, 1)) or (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) == @as(c_int, 0))) {
        linkgclist_(blk: {
            _ = @as(c_int, 0);
            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(th))).*.gc;
        }, &th.*.gclist, &g.*.grayagain);
    }
    if (o == @as(StkId, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 1;
    _ = @as(c_int, 0);
    while (o < th.*.top.p) : (o += 1) {
        _ = blk: {
            _ = g.*.mainthread;
            break :blk if (!((@as(c_int, @bitCast(@as(c_uint, (&o.*.val).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) or (((@as(c_int, @bitCast(@as(c_uint, (&o.*.val).*.tt_))) & @as(c_int, 63)) == @as(c_int, @bitCast(@as(c_uint, (blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 (&o.*.val).*.value_.gc;
            }).*.tt)))) and ((g.*.mainthread == @as([*c]struct_lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, (blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 (&o.*.val).*.value_.gc;
            }).*.marked))) & (@as(c_int, @bitCast(@as(c_uint, g.*.mainthread.*.l_G.*.currentwhite))) ^ ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))) != 0)))) @as(c_int, 0) else @as(c_int, 0);
        };
        if (((@as(c_int, @bitCast(@as(c_uint, (&o.*.val).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
            _ = @as(c_int, 0);
            break :blk (&o.*.val).*.value_.gc;
        }).*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) {
            reallymarkobject(g, blk: {
                _ = @as(c_int, 0);
                break :blk (&o.*.val).*.value_.gc;
    ...
    {
        uv = th.*.openupval;
        while (uv != @as([*c]UpVal, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) : (uv = uv.*.u.open.next) {
            if ((@as(c_int, @bitCast(@as(c_uint, uv.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
                reallymarkobject(g, blk: {
                    _ = @as(c_int, 0);
                    break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(uv))).*.gc;
    ...
    if (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) == @as(c_int, 2)) {
        while (o < (th.*.stack_last.p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 5))))))) : (o += 1) {
            _ = blk: {
        ...
        if (!(th.*.twups != th) and (th.*.openupval != @as([*c]UpVal, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            th.*.twups = g.*.twups;
            g.*.twups = th;
        }
...
pub fn propagatemark(arg_g: [*c]global_State) callconv(.c) lu_mem {
    var g = arg_g;
    _ = &g;
    var o: [*c]GCObject = g.*.gray;
    _ = &o;
    _ = blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            const ref = &o.*.marked;
            ref.* |= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 1) << @intCast(@as(c_int, 5))))));
            break :blk_1 ref.*;
        };
    };
    g.*.gray = getgclist(o).*;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt)))) {
            @as(c_int, 5) => return traversetable(g, blk: {
                _ = @as(c_int, 0);
    ...
    return @import("std").mem.zeroes(lu_mem);
}
pub fn propagateall(arg_g: [*c]global_State) callconv(.c) lu_mem {
    var g = arg_g;
    _ = &g;
    var tot: lu_mem = 0;
    _ = &tot;
...
pub fn convergeephemerons(arg_g: [*c]global_State) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var changed: c_int = undefined;
    _ = &changed;
    var dir: c_int = 0;
    _ = &dir;
    while (true) {
        var w: [*c]GCObject = undefined;
        _ = &w;
        var next: [*c]GCObject = g.*.ephemeron;
        _ = &next;
        g.*.ephemeron = null;
        changed = 0;
        while ((blk: {
            ...
            w = tmp;
            break :blk tmp;
        }) != @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            var h: [*c]Table = blk: {
                _ = @as(c_int, 0);
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(w))).*.h;
            };
            _ = &h;
            next = h.*.gclist;
            _ = blk: {
        ...
        dir = @intFromBool(!(dir != 0));
        if (!(changed != 0)) break;
    }
}
pub fn clearbykeys(arg_g: [*c]global_State, arg_l: [*c]GCObject) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var l = arg_l;
    _ = &l;
    while (l != null) : (l = (blk: {
        ...
        _ = &n;
        {
            n = &h.*.node[@as(c_uint, @intCast(@as(c_int, 0)))];
            while (n < limit) : (n += 1) {
                if (iscleared(g, if ((@as(c_int, @bitCast(@as(c_uint, n.*.u.key_tt))) & (@as(c_int, 1) << @intCast(6))) != 0) n.*.u.key_val.gc else null) != 0) {
                    _ = blk: {
...
pub fn clearbyvalues(arg_g: [*c]global_State, arg_l: [*c]GCObject, arg_f: [*c]GCObject) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var l = arg_l;
    _ = &l;
    ...
    while (l != f) : (l = (blk: {
        ...
        _ = &i;
        var asize: c_uint = luaH_realasize(h);
        _ = &asize;
        {
            i = 0;
            while (i < asize) : (i +%= 1) {
                var o: [*c]TValue = &h.*.array[i];
                _ = &o;
                if (iscleared(g, if ((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) blk: {
                    _ = @as(c_int, 0);
        ...
        }
        {
            n = &h.*.node[@as(c_uint, @intCast(@as(c_int, 0)))];
            while (n < limit) : (n += 1) {
                if (iscleared(g, if ((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) blk: {
                    _ = @as(c_int, 0);
                    break :blk (&n.*.i_val).*.value_.gc;
                } else null) != 0) {
                    _ = blk: {
                        const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0) | (@as(c_int, 1) << @intCast(4))))));
                        (&n.*.i_val).*.tt_ = tmp;
...
pub fn freeupval(arg_L: [*c]lua_State, arg_uv: [*c]UpVal) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var uv = arg_uv;
    _ = &uv;
    ...
    luaM_free_(L, @as(?*anyopaque, @ptrCast(uv)), @sizeOf(UpVal));
}
pub fn freeobj(arg_L: [*c]lua_State, arg_o: [*c]GCObject) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var o = arg_o;
    _ = &o;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt)))) {
            ...
            @as(c_int, 9) => {
                freeupval(L, blk: {
                    _ = @as(c_int, 0);
                    break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.upv;
                });
                break;
            },
            @as(c_int, 6) => {
                {
                    var cl: [*c]LClosure = blk: {
                        _ = @as(c_int, 0);
                        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.cl.l;
                    };
                    _ = &cl;
...
pub fn sweeplist(arg_L: [*c]lua_State, arg_p: [*c][*c]GCObject, arg_countin: c_int, arg_countout: [*c]c_int) callconv(.c) [*c][*c]GCObject {
    var L = arg_L;
    _ = &L;
    var p = arg_p;
    _ = &p;
    var countin = arg_countin;
    _ = &countin;
    var countout = arg_countout;
    _ = &countout;
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
    var ow: c_int = @as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) ^ ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))));
    _ = &ow;
    var i: c_int = undefined;
    _ = &i;
    var white: c_int = @as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))))))));
    _ = &white;
    {
        i = 0;
        while ((p.* != @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (i < countin)) : (i += 1) {
            var curr: [*c]GCObject = p.*;
            _ = &curr;
            var marked: c_int = @as(c_int, @bitCast(@as(c_uint, curr.*.marked)));
            _ = &marked;
            if ((marked & ow) != 0) {
                p.* = curr.*.next;
                freeobj(L, curr);
            } else {
                curr.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((marked & ~(((@as(c_int, 1) << @intCast(@as(c_int, 5))) | ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) | @as(c_int, 7))) | white))));
                p = &curr.*.next;
            }
        }
    }
    ...
    return if (p.* == @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) null else p;
}
pub fn sweeptolive(arg_L: [*c]lua_State, arg_p: [*c][*c]GCObject) callconv(.c) [*c][*c]GCObject {
    var L = arg_L;
    _ = &L;
    var p = arg_p;
    _ = &p;
    var old: [*c][*c]GCObject = p;
    _ = &old;
    while (true) {
        p = sweeplist(L, p, @as(c_int, 1), null);
        if (!(p == old)) break;
    }
    return p;
}
pub fn checkSizes(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    if (!(g.*.gcemergency != 0)) {
        if (g.*.strt.nuse < @divTrunc(g.*.strt.size, @as(c_int, 4))) {
            var olddebt: l_mem = g.*.GCdebt;
            _ = &olddebt;
            luaS_resize(L, @divTrunc(g.*.strt.size, @as(c_int, 2)));
            g.*.GCestimate +%= @as(lu_mem, @bitCast(g.*.GCdebt - olddebt));
        }
    }
}
pub fn udata2finalize(arg_g: [*c]global_State) callconv(.c) [*c]GCObject {
    var g = arg_g;
    _ = &g;
    var o: [*c]GCObject = g.*.tobefnz;
    _ = &o;
    ...
    _ = blk: {
        const ref = &o.*.marked;
        ref.* &= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(~(@as(c_int, 1) << @intCast(@as(c_int, 6))))))))))))));
        break :blk ref.*;
    };
    if ((@as(c_int, 3) <= @as(c_int, @bitCast(@as(c_uint, g.*.gcstate)))) and (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) <= @as(c_int, 6))) {
        _ = blk: {
            const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & ~((@as(c_int, 1) << @intCast(@as(c_int, 5))) | ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))) | @as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))))))))))));
            o.*.marked = tmp;
            break :blk tmp;
        };
    } else if ((@as(c_int, @bitCast(@as(c_uint, o.*.marked))) & @as(c_int, 7)) == @as(c_int, 3)) {
        g.*.firstold1 = o;
    }
    return o;
}
pub fn dothecall(arg_L: [*c]lua_State, arg_ud: ?*anyopaque) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var ud = arg_ud;
    _ = &ud;
    _ = &ud;
    luaD_callnoyield(L, L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))), @as(c_int, 0));
}
pub fn GCTM(arg_L: [*c]lua_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
    ...
    _ = @as(c_int, 0);
    {
        var io: [*c]TValue = &v;
        _ = &io;
        var i_g: [*c]GCObject = udata2finalize(g);
        _ = &i_g;
        io.*.value_.gc = i_g;
        _ = blk: {
            const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, i_g.*.tt))) | (@as(c_int, 1) << @intCast(6))))));
            io.*.tt_ = tmp;
            break :blk tmp;
        };
    }
    tm = luaT_gettmbyobj(L, &v, @as(c_uint, @bitCast(TM_GC)));
    if (!((@as(c_int, @bitCast(@as(c_uint, tm.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
        var status: c_int = undefined;
        _ = &status;
        var oldah: lu_byte = L.*.allowhook;
        _ = &oldah;
        var oldgcstp: c_int = @as(c_int, @bitCast(@as(c_uint, g.*.gcstp)));
        _ = &oldgcstp;
        g.*.gcstp |= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 2)))));
        L.*.allowhook = 0;
        {
...
pub fn runafewfinalizers(arg_L: [*c]lua_State, arg_n: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var n = arg_n;
    _ = &n;
    ...
    {
        i = 0;
        while ((i < n) and (g.*.tobefnz != null)) : (i += 1) {
            GCTM(L);
        }
    }
    return i;
}
pub fn callallpendingfinalizers(arg_L: [*c]lua_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
...
pub fn findlast(arg_p: [*c][*c]GCObject) callconv(.c) [*c][*c]GCObject {
    var p = arg_p;
    _ = &p;
    while (p.* != @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        p = &p.*.*.next;
    }
    return p;
}
pub fn separatetobefnz(arg_g: [*c]global_State, arg_all: c_int) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var all = arg_all;
    _ = &all;
    var curr: [*c]GCObject = undefined;
    _ = &curr;
    var p: [*c][*c]GCObject = &g.*.finobj;
    _ = &p;
    var lastnext: [*c][*c]GCObject = findlast(&g.*.tobefnz);
    _ = &lastnext;
    while ((blk: {
        const tmp = p.*;
        curr = tmp;
        ...
        _ = @as(c_int, 0);
        if (!(((@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) or (all != 0))) {
            p = &curr.*.next;
        } else {
            if (curr == g.*.finobjsur) {
...
pub fn checkpointer(arg_p: [*c][*c]GCObject, arg_o: [*c]GCObject) callconv(.c) void {
    var p = arg_p;
    _ = &p;
    var o = arg_o;
    _ = &o;
...
pub fn correctpointers(arg_g: [*c]global_State, arg_o: [*c]GCObject) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var o = arg_o;
    _ = &o;
...
pub fn setpause(arg_g: [*c]global_State) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var threshold: l_mem = undefined;
    _ = &threshold;
    var debt: l_mem = undefined;
    _ = &debt;
...
pub fn sweep2old(arg_L: [*c]lua_State, arg_p: [*c][*c]GCObject) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var p = arg_p;
    _ = &p;
    ...
    while ((blk: {
        ...
        if ((@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
            _ = @as(c_int, 0);
            p.* = curr.*.next;
            freeobj(L, curr);
        } else {
            _ = blk: {
                const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & ~@as(c_int, 7)) | @as(c_int, 4)))));
                curr.*.marked = tmp;
                break :blk tmp;
            };
            if (@as(c_int, @bitCast(@as(c_uint, curr.*.tt))) == (@as(c_int, 8) | (@as(c_int, 0) << @intCast(4)))) {
                var th: [*c]lua_State = blk: {
                    _ = @as(c_int, 0);
                    break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(curr))).*.th;
                };
                _ = &th;
                linkgclist_(blk: {
                    _ = @as(c_int, 0);
            ...
            } else if ((@as(c_int, @bitCast(@as(c_uint, curr.*.tt))) == (@as(c_int, 9) | (@as(c_int, 0) << @intCast(4)))) and ((blk: {
                _ = @as(c_int, 0);
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(curr))).*.upv;
            }).*.v.p != (&(blk: {
                _ = @as(c_int, 0);
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(curr))).*.upv;
            }).*.u.value))) {
                _ = blk: {
                    const ref = &curr.*.marked;
                    ref.* &= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(~((@as(c_int, 1) << @intCast(@as(c_int, 5))) | ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))))))))))))));
                    break :blk ref.*;
                };
            } else {
                _ = blk: {
...
pub fn sweepgen(arg_L: [*c]lua_State, arg_g: [*c]global_State, arg_p: [*c][*c]GCObject, arg_limit: [*c]GCObject, arg_pfirstold1: [*c][*c]GCObject) callconv(.c) [*c][*c]GCObject {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    ...
    var limit = arg_limit;
    _ = &limit;
    var pfirstold1 = arg_pfirstold1;
    _ = &pfirstold1;
    const nextage = struct {
        const static: [7]lu_byte = [7]lu_byte{
            1,
            3,
            3,
            4,
    ...
    while ((blk: {
        ...
        if ((@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0) {
            ...
            if ((@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & @as(c_int, 7)) == @as(c_int, 0)) {
                var marked: c_int = @as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & ~(((@as(c_int, 1) << @intCast(@as(c_int, 5))) | ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) | @as(c_int, 7));
                _ = &marked;
                curr.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((marked | @as(c_int, 1)) | white))));
            } else {
                _ = blk: {
                    const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & ~@as(c_int, 7)) | @as(c_int, @bitCast(@as(c_uint, nextage.static[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & @as(c_int, 7)))])))))));
                    curr.*.marked = tmp;
                    break :blk tmp;
                };
                if (((@as(c_int, @bitCast(@as(c_uint, curr.*.marked))) & @as(c_int, 7)) == @as(c_int, 3)) and (pfirstold1.* == @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
                    pfirstold1.* = curr;
                }
            }
            p = &curr.*.next;
...
pub fn whitelist(arg_g: [*c]global_State, arg_p: [*c]GCObject) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var p = arg_p;
    _ = &p;
    var white: c_int = @as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, g.*.currentwhite))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))))))));
    _ = &white;
    while (p != @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) : (p = p.*.next) {
        p.*.marked = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, p.*.marked))) & ~(((@as(c_int, 1) << @intCast(@as(c_int, 5))) | ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) | @as(c_int, 7))) | white))));
    }
}
// correctgraylist — ported from lgc.c (translate-c failed on goto)
// Inline helpers for bit manipulation (setbits/nw2black/changeage are @compileError)
const BLACKBIT_MASK: lu_byte = (1 << 5); // BLACKBIT = 5
const WHITEBITS_MASK: lu_byte = (1 << 3) | (1 << 4); // WHITE0BIT=3, WHITE1BIT=4

pub fn correctgraylist(arg_p: [*c][*c]GCObject) callconv(.c) [*c][*c]GCObject {
    var p = arg_p;
    while (true) {
        const curr: [*c]GCObject = p.*;
        if (curr == null) break;
        const next_ptr: [*c][*c]GCObject = getgclist(curr);
        if ((curr.*.marked & WHITEBITS_MASK) != 0) {
            // iswhite: remove all white objects
            p.* = next_ptr.*;
            continue;
        } else if ((curr.*.marked & AGEBITS) == G_TOUCHED1) {
            // touched in this cycle — make black, advance to TOUCHED2, keep
            // nw2black inlined: marked |= BLACKBIT_MASK
            curr.*.marked |= BLACKBIT_MASK;
            // changeage(curr, G_TOUCHED1, G_TOUCHED2): marked ^= (G_TOUCHED1 ^ G_TOUCHED2)
            curr.*.marked ^= @as(lu_byte, @intCast(G_TOUCHED1 ^ G_TOUCHED2));
            // remain: advance p
            p = next_ptr;
            continue;
        } else if (curr.*.tt == @as(lu_byte, @intCast(LUA_VTHREAD))) {
            // keep non-white threads on the list
            p = next_ptr;
            continue;
        } else {
            // everything else is removed
            if ((curr.*.marked & AGEBITS) == G_TOUCHED2) {
                // changeage(curr, G_TOUCHED2, G_OLD): marked ^= (G_TOUCHED2 ^ G_OLD)
                curr.*.marked ^= @as(lu_byte, @intCast(G_TOUCHED2 ^ G_OLD));
            }
            // nw2black inlined: marked |= BLACKBIT_MASK
            curr.*.marked |= BLACKBIT_MASK;
            // remove
...
pub fn correctgraylists(arg_g: [*c]global_State) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var list: [*c][*c]GCObject = correctgraylist(&g.*.grayagain);
    _ = &list;
    list.* = g.*.weak;
    g.*.weak = null;
...
pub fn markold(arg_g: [*c]global_State, arg_from: [*c]GCObject, arg_to: [*c]GCObject) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    var from = arg_from;
    _ = &from;
    var to = arg_to;
    _ = &to;
    var p: [*c]GCObject = undefined;
    _ = &p;
    {
        p = from;
        while (p != to) : (p = p.*.next) {
            if ((@as(c_int, @bitCast(@as(c_uint, p.*.marked))) & @as(c_int, 7)) == @as(c_int, 3)) {
                _ = @as(c_int, 0);
                _ = blk: {
                    _ = @as(c_int, 0);
                    break :blk blk_1: {
                        const ref = &p.*.marked;
                        ref.* ^= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 3) ^ @as(c_int, 4)))));
                        break :blk_1 ref.*;
                    };
                };
                if ((@as(c_int, @bitCast(@as(c_uint, p.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) {
...
pub fn finishgencycle(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
...
pub fn youngcollection(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    var psurvival: [*c][*c]GCObject = undefined;
    _ = &psurvival;
    var dummy: [*c]GCObject = undefined;
    _ = &dummy;
    _ = @as(c_int, 0);
    if (g.*.firstold1 != null) {
    ...
    _ = sweepgen(L, g, psurvival, g.*.old1, &g.*.firstold1);
    g.*.reallyold = g.*.old1;
    g.*.old1 = psurvival.*;
    g.*.survival = g.*.allgc;
    dummy = null;
    psurvival = sweepgen(L, g, &g.*.finobj, g.*.finobjsur, &dummy);
    _ = sweepgen(L, g, psurvival, g.*.finobjold1, &dummy);
    g.*.finobjrold = g.*.finobjold1;
    g.*.finobjold1 = psurvival.*;
    g.*.finobjsur = g.*.finobj;
    _ = sweepgen(L, g, &g.*.tobefnz, null, &dummy);
    finishgencycle(L, g);
}
pub fn atomic2gen(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    ...
    g.*.gckind = 1;
    g.*.lastatomic = 0;
    g.*.GCestimate = @as(lu_mem, @bitCast(g.*.totalbytes + g.*.GCdebt));
    finishgencycle(L, g);
}
...
pub fn entergen(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) lu_mem {
    ...
    var g = arg_g;
    _ = &g;
    var numobjs: lu_mem = undefined;
    _ = &numobjs;
    luaC_runtilstate(L, @as(c_int, 1) << @intCast(@as(c_int, 8)));
    luaC_runtilstate(L, @as(c_int, 1) << @intCast(@as(c_int, 0)));
    numobjs = atomic(L);
    atomic2gen(L, g);
    setminordebt(g);
    return numobjs;
}
pub fn enterinc(arg_g: [*c]global_State) callconv(.c) void {
    var g = arg_g;
    _ = &g;
    whitelist(g, g.*.allgc);
    g.*.reallyold = blk: {
...
pub fn fullgen(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) lu_mem {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
...
pub fn stepgenfull(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    var newatomic: lu_mem = undefined;
    _ = &newatomic;
    var lastatomic: lu_mem = g.*.lastatomic;
    _ = &lastatomic;
    if (@as(c_int, @bitCast(@as(c_uint, g.*.gckind))) == @as(c_int, 1)) {
        enterinc(g);
    }
    luaC_runtilstate(L, @as(c_int, 1) << @intCast(@as(c_int, 0)));
    newatomic = atomic(L);
    if (newatomic < (lastatomic +% (lastatomic >> @intCast(3)))) {
        atomic2gen(L, g);
        setminordebt(g);
    } else {
        g.*.GCestimate = @as(lu_mem, @bitCast(g.*.totalbytes + g.*.GCdebt));
...
pub fn genstep(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
...
pub fn deletelist(arg_L: [*c]lua_State, arg_p: [*c]GCObject, arg_limit: [*c]GCObject) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var p = arg_p;
    _ = &p;
    ...
    _ = &limit;
    while (p != limit) {
        var next: [*c]GCObject = p.*.next;
        _ = &next;
        freeobj(L, p);
        p = next;
    }
}
pub fn sweepstep(arg_L: [*c]lua_State, arg_g: [*c]global_State, arg_nextstate: c_int, arg_nextlist: [*c][*c]GCObject) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    var nextstate = arg_nextstate;
    _ = &nextstate;
    var nextlist = arg_nextlist;
    _ = &nextlist;
    if (g.*.sweepgc != null) {
        var olddebt: l_mem = g.*.GCdebt;
        _ = &olddebt;
        ...
        _ = &count;
        g.*.sweepgc = sweeplist(L, g.*.sweepgc, @as(c_int, 100), &count);
        g.*.GCestimate +%= @as(lu_mem, @bitCast(g.*.GCdebt - olddebt));
        return count;
    } else {
        g.*.gcstate = @as(lu_byte, @bitCast(@as(i8, @truncate(nextstate))));
        g.*.sweepgc = nextlist;
        return 0;
    }
    return 0;
}
pub fn singlestep(arg_L: [*c]lua_State) callconv(.c) lu_mem {
    var L = arg_L;
    _ = &L;
    var g: [*c]global_State = L.*.l_G;
    _ = &g;
    var work: lu_mem = undefined;
    _ = &work;
    _ = @as(c_int, 0);
    g.*.gcstopem = 1;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate)))) {
            @as(c_int, 8) => {
                {
                    restartcollection(g);
                    g.*.gcstate = 0;
            ...
            @as(c_int, 0) => {
                {
                    if (g.*.gray == @as([*c]GCObject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        g.*.gcstate = 1;
                        work = 0;
                    } else {
...
pub fn incstep(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    ...
    while (true) {
        var work: lu_mem = singlestep(L);
        _ = &work;
        debt -= @as(l_mem, @bitCast(work));
        gc_loop_count += 1;
        if (gc_loop_count > 10000) break;
        if (!((debt > -stepsize) and (@as(c_int, @bitCast(@as(c_uint, g.*.gcstate))) != @as(c_int, 8)))) break;
    }
...
pub fn fullinc(arg_L: [*c]lua_State, arg_g: [*c]global_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var g = arg_g;
    _ = &g;
    ...
    luaC_runtilstate(L, @as(c_int, 1) << @intCast(@as(c_int, 8)));
    luaC_runtilstate(L, @as(c_int, 1) << @intCast(@as(c_int, 7)));
    _ = @as(c_int, 0);
    luaC_runtilstate(L, @as(c_int, 1) << @intCast(@as(c_int, 8)));
    setpause(g);
}
...
pub const GCSWEEPMAX = @as(c_int, 100);
pub const GCFINMAX = @as(c_int, 10);
pub const GCFINALIZECOST = @as(c_int, 50);
pub const WORK2MEM = @import("std").zig.c_translation.sizeof(TValue);
pub const PAUSEADJ = @as(c_int, 100);
pub const maskcolors = bitmask(BLACKBIT) | WHITEBITS;
pub const maskgcbits = maskcolors | AGEBITS;
pub const makewhite = @compileError("unable to translate C expr: expected ')' instead got '='");
// /src/cosmopolitan/third_party/lua/lgc.c:88:9
pub inline fn set2gray(x: anytype) @TypeOf(resetbits(x.*.marked, maskcolors)) {
    _ = &x;
    return resetbits(x.*.marked, maskcolors);
}
pub const set2black = @compileError("unable to translate C expr: expected ')' instead got '='");
// /src/cosmopolitan/third_party/lua/lgc.c:96:9
pub inline fn valiswhite(x: anytype) @TypeOf((iscollectable(x) != 0) and (iswhite(gcvalue(x)) != 0)) {
    _ = &x;
    return (iscollectable(x) != 0) and (iswhite(gcvalue(x)) != 0);
}
pub inline fn keyiswhite(n: anytype) @TypeOf((keyiscollectable(n) != 0) and (iswhite(gckey(n)) != 0)) {
    _ = &n;
    return (keyiscollectable(n) != 0) and (iswhite(gckey(n)) != 0);
}
pub inline fn gcvalueN(o: anytype) @TypeOf(if (iscollectable(o) != 0) gcvalue(o) else NULL) {
    _ = &o;
    return if (iscollectable(o) != 0) gcvalue(o) else NULL;
}
pub const markvalue = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/third_party/lua/lgc.c:111:9
pub const markkey = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/third_party/lua/lgc.c:114:9
pub const markobject = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/third_party/lua/lgc.c:116:9
pub const markobjectN = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/third_party/lua/lgc.c:122:9
pub inline fn gnodelast(h: anytype) @TypeOf(gnode(h, cast_sizet(sizenode(h)))) {
    _ = &h;
    return gnode(h, cast_sizet(sizenode(h)));
}
pub inline fn linkgclist(o: anytype, p: anytype) @TypeOf(linkgclist_(obj2gco(o), &o.*.gclist, &p)) {
    _ = &o;
    _ = &p;
    return linkgclist_(obj2gco(o), &o.*.gclist, &p);
}
pub inline fn linkobjgclist(o: anytype, p: anytype) @TypeOf(linkgclist_(obj2gco(o), getgclist(o), &p)) {
    _ = &o;
    _ = &p;
    return linkgclist_(obj2gco(o), getgclist(o), &p);
}
