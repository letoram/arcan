...
const union_unnamed_3 = extern union {
    ...
    unnamed_2: struct_unnamed_13,
    unnamed_3: struct_unnamed_14,
    __ignoreme: [112]u8,
};
...
pub const struct_sigaction = extern struct {
    unnamed_0: union_unnamed_15 = std.mem.zeroes(union_unnamed_15),
...
pub extern fn inet_ntop(c_int, ?*const anyopaque, [*c]u8, u32) [*c]const u8;
pub extern fn inet_pton(c_int, [*c]const u8, ?*anyopaque) c_int;
pub extern fn inet_addr([*c]const u8) u32;
pub extern fn GetHostIps() [*c]u32;
...
pub extern fn sendfile(c_int, c_int, [*c]i64, usize) isize;
pub extern fn getsockopt(c_int, c_int, c_int, ?*anyopaque, [*c]u32) c_int;
pub extern fn setsockopt(c_int, c_int, c_int, ?*const anyopaque, u32) c_int;
...
pub const struct_timespec = extern struct {
    ...
    tv_nsec: i64 = std.mem.zeroes(i64),
};
pub extern fn clock_getres(c_int, [*c]struct_timespec) c_int;
pub extern fn clock_gettime(c_int, [*c]struct_timespec) c_int;
pub extern fn clock_settime(c_int, [*c]const struct_timespec) c_int;
pub extern fn clock_nanosleep(c_int, c_int, [*c]const struct_timespec, [*c]struct_timespec) c_int;
...
pub extern fn timespec_getres([*c]struct_timespec, c_int) c_int;
pub extern fn timespec_get([*c]struct_timespec, c_int) c_int;
pub const struct_pollfd = extern struct {
    fd: i32 = std.mem.zeroes(i32),
    events: i16 = std.mem.zeroes(i16),
    revents: i16 = std.mem.zeroes(i16),
};
pub extern fn poll([*c]struct_pollfd, u64, i32) c_int;
pub extern fn ppoll([*c]struct_pollfd, u64, [*c]const struct_timespec, [*c]const sigset_t) c_int;
pub extern const POLLERR: i16;
pub extern const POLLHUP: i16;
pub extern const POLLIN: i16;
pub extern const POLLNVAL: i16;
pub extern const POLLOUT: i16;
pub extern const POLLPRI: i16;
pub extern const POLLRDBAND: i16;
pub extern const POLLRDHUP: i16;
pub extern const POLLRDNORM: i16;
pub extern const POLLWRBAND: i16;
pub extern const POLLWRNORM: i16;
...
pub const struct_UrlParam_16 = extern struct {
...
pub const struct_UrlParams = extern struct {
    n: usize = std.mem.zeroes(usize),
    p: [*c]struct_UrlParam_16 = std.mem.zeroes([*c]struct_UrlParam_16),
};
...
pub const struct_luaL_Buffer = extern struct {
    ...
    init: union_unnamed_17 = std.mem.zeroes(union_unnamed_17),
};
...
pub extern fn lua_freerepl() void;
pub extern fn lua_repl_wock() void;
pub extern fn lua_repl_lock() void;
pub extern fn lua_repl_unlock() void;
pub extern fn lua_loadline(?*lua_State) c_int;
pub extern fn lua_l_print(?*lua_State) void;
pub extern fn lua_initrepl(?*lua_State) void;
pub extern fn lua_sigint(?*lua_State, c_int) void;
pub extern fn lua_report(?*lua_State, c_int) c_int;
pub extern fn lua_runchunk(?*lua_State, c_int, c_int) c_int;
pub extern fn lua_l_message([*c]const u8, [*c]const u8) void;
pub extern fn lua_readline_hint([*c]const u8, [*c][*c]const u8, [*c][*c]const u8) [*c]u8;
pub extern fn lua_readline_completions([*c]const u8, [*c]linenoiseCompletions) void;
...
pub const struct_UnixErrno = extern struct {
    errno_: c_int = std.mem.zeroes(c_int),
    winerr: c_int = std.mem.zeroes(c_int),
    call: [*c]const u8 = std.mem.zeroes([*c]const u8),
};
pub extern fn LuaUnix(?*lua_State) c_int;
pub extern fn LuaUnixSysretErrno(?*lua_State, [*c]const u8, c_int) c_int;
// /src/cosmopolitan/libc/cosmo.h:12:28: warning: unsupported type: 'Atomic'
pub const cosmo_futex_t = @compileError("unable to resolve typedef child type");
// /src/cosmopolitan/libc/cosmo.h:12:28

// /src/cosmopolitan/libc/cosmo.h:13:33: warning: unsupported type: 'Atomic'
pub const cosmo_once_t = @compileError("unable to resolve typedef child type");
// /src/cosmopolitan/libc/cosmo.h:13:33
pub extern fn cosmo_once([*c]cosmo_once_t, ?*const fn () callconv(.c) void) errno_t;
pub extern fn cosmo_cpu_count() c_int;
pub extern fn cosmo_warmup_directory([*c]const u8, c_int) void;
pub extern fn systemvpe([*c]const u8, [*c]const [*c]u8, [*c]const [*c]u8) c_int;
pub extern fn GetProgramExecutableName() [*c]u8;
pub extern fn unleaf() void;
pub extern fn IsLinuxModern() bool32;
pub extern fn AssertNoLocksAreHeld() void;
pub extern fn CheckForMemoryLeaks() void;
pub extern fn cosmo_entropy([*c]const u8, usize) f64;
pub extern fn cosmo_demangle([*c]u8, [*c]const u8, usize) c_int;
pub extern fn cosmo_is_mangled([*c]const u8) c_int;
pub extern fn cosmo_args([*c]const u8, [*c][*c][*c]u8) c_int;
pub extern fn LoadZipArgs([*c]c_int, [*c][*c][*c]u8) c_int;
pub extern fn cosmo_futex_wake([*c]cosmo_futex_t, c_int, u8) c_int;
pub extern fn cosmo_futex_wait([*c]cosmo_futex_t, c_int, u8, c_int, [*c]const struct_timespec) c_int;
pub extern fn cosmo_permalloc(usize) ?*anyopaque;
pub extern fn cosmo_stack_alloc([*c]usize, [*c]usize, [*c]?*anyopaque) errno_t;
pub extern fn cosmo_stack_free(?*anyopaque, usize, usize) errno_t;
pub extern fn cosmo_stack_clear() void;
pub extern fn cosmo_stack_setmaxstacks(c_int) void;
pub extern fn cosmo_stack_getmaxstacks() c_int;
pub extern fn __deadlock_check(?*anyopaque, c_int) c_int;
pub extern fn __deadlock_tracked(?*anyopaque) c_int;
pub extern fn __deadlock_record(?*anyopaque, c_int) void;
pub extern fn __deadlock_track(?*anyopaque, c_int) void;
pub extern fn __deadlock_untrack(?*anyopaque) void;
pub extern fn cosmo_leak_track(?*anyopaque) ?*anyopaque;
pub extern fn cosmo_leak_untrack(?*anyopaque) ?*anyopaque;
pub extern fn cosmo_leak_finalize() void;
pub extern fn cosmo_leak_print(?*const fn (?*anyopaque) callconv(.c) c_int) c_int;
pub extern var __dlmalloc: ?*const fn (usize) callconv(.c) ?*anyopaque;
pub extern var __dlfree: ?*const fn (?*anyopaque) callconv(.c) void;
pub extern var __dlcalloc: ?*const fn (usize, usize) callconv(.c) ?*anyopaque;
pub extern var __dlrealloc: ?*const fn (?*anyopaque, usize) callconv(.c) ?*anyopaque;
pub extern var __dlrealloc_in_place: ?*const fn (?*anyopaque, usize) callconv(.c) ?*anyopaque;
pub extern var __dlmemalign: ?*const fn (usize, usize) callconv(.c) ?*anyopaque;
pub extern var __dlmalloc_inspect_all: ?*const fn (?*const fn (?*anyopaque, ?*anyopaque, usize, ?*anyopaque) callconv(.c) void, ?*anyopaque) callconv(.c) void;
pub extern var __dlmallinfo: ?*const fn () callconv(.c) struct_mallinfo;
pub extern var __dlmalloc_trim: ?*const fn (usize) callconv(.c) c_int;
pub extern var __dlmalloc_usable_size: ?*const fn (?*anyopaque) callconv(.c) usize;
pub extern var cosmo_shard: ?*const fn () callconv(.c) c_ulong;
comptime {
    // asm (".section .yoink\n\tb\t\"lua_notice\"\n\t.previous");
}
pub fn lua_stdin_is_tty() callconv(.c) bool {
    return isatty(@as(c_int, 0)) != 0;
}
pub fn print_usage(arg_badoption: [*c]const u8) callconv(.c) void {
    var badoption = arg_badoption;
    _ = &badoption;
    _ = blk: {
        _ = fprintf(stderr, "%s: ", lua_progname);
        break :blk fflush(stderr);
    };
    if ((@as(c_int, @bitCast(@as(c_uint, badoption[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, 'e')) or (@as(c_int, @bitCast(@as(c_uint, badoption[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, 'l'))) {
        _ = blk: {
            _ = fprintf(stderr, "'%s' needs argument\n", badoption);
            break :blk fflush(stderr);
        };
    } else {
        _ = blk: {
            _ = fprintf(stderr, "unrecognized option '%s'\n", badoption);
            break :blk fflush(stderr);
        };
    }
    _ = blk: {
        _ = fprintf(stderr, "usage: %s [options] [script [args]]\nAvailable options are:\n  -e stat  execute string 'stat'\n  -i       enter interactive mode after executing 'script'\n  -l mod    require library 'mod' into global 'mod'\n  -l g=mod  require library 'mod' into global 'g'\n  -v       show version information\n  -E       ignore environment variables\n  -W       turn warnings on\n  --       stop handling options\n  -        stop handling options and execute stdin\n", lua_progname);
        break :blk fflush(stderr);
    };
}
pub fn print_version() callconv(.c) void {
    _ = fwrite(@as(?*const anyopaque, @ptrCast("Lua 5.4.6  Copyright (C) 1994-2023 Lua.org, PUC-Rio")), @sizeOf(u8), strlen("Lua 5.4.6  Copyright (C) 1994-2023 Lua.org, PUC-Rio"), stdout);
    _ = blk: {
        _ = fwrite(@as(?*const anyopaque, @ptrCast("\n")), @sizeOf(u8), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), stdout);
        break :blk fflush(stdout);
    };
}
pub fn createargtable(arg_L: ?*lua_State, arg_argv: [*c][*c]u8, arg_argc: c_int, arg_script: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var argv = arg_argv;
    _ = &argv;
    var argc = arg_argc;
    _ = &argc;
    var script = arg_script;
    _ = &script;
    var i: c_int = undefined;
    _ = &i;
    var narg: c_int = undefined;
    _ = &narg;
    narg = argc - (script + @as(c_int, 1));
    lua_createtable(L, narg, script + @as(c_int, 1));
    {
        i = 0;
        while (i < argc) : (i += 1) {
            _ = lua_pushstring(L, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
            lua_rawseti(L, -@as(c_int, 2), @as(lua_Integer, @bitCast(@as(c_longlong, i - script))));
        }
    }
    lua_setglobal(L, "arg");
}
pub fn dochunk(arg_L: ?*lua_State, arg_status: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var status = arg_status;
    _ = &status;
    if (status == @as(c_int, 0)) {
        status = lua_runchunk(L, @as(c_int, 0), @as(c_int, 0));
    }
    return lua_report(L, status);
}
pub fn dofile(arg_L: ?*lua_State, arg_name: [*c]const u8) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var name = arg_name;
    _ = &name;
...
pub fn dostring(arg_L: ?*lua_State, arg_s: [*c]const u8, arg_name: [*c]const u8) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var s = arg_s;
    _ = &s;
...
pub fn dolibrary(arg_L: ?*lua_State, arg_globname: [*c]u8) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var globname = arg_globname;
    _ = &globname;
    var status: c_int = undefined;
    _ = &status;
    var modname: [*c]u8 = strchr(globname, @as(c_int, '='));
    _ = &modname;
    if (modname == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        modname = globname;
    } else {
        modname.* = '\x00';
        modname += 1;
    }
    _ = lua_getglobal(L, "require");
    _ = lua_pushstring(L, modname);
    status = lua_runchunk(L, @as(c_int, 1), @as(c_int, 1));
    if (status == @as(c_int, 0)) {
        lua_setglobal(L, globname);
    }
    return lua_report(L, status);
}
pub fn pushargs(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var i: c_int = undefined;
    _ = &i;
    ...
    _ = &n;
    if (lua_getglobal(L, "arg") != @as(c_int, 5)) {
        _ = luaL_error(L, "'arg' is not a table");
    }
    n = @as(c_int, @bitCast(@as(c_int, @truncate(luaL_len(L, -@as(c_int, 1))))));
    luaL_checkstack(L, n + @as(c_int, 3), "too many arguments to script");
    {
        i = 1;
        while (i <= n) : (i += 1) {
            _ = lua_rawgeti(L, -i, @as(lua_Integer, @bitCast(@as(c_longlong, i))));
        }
    }
    _ = blk: {
        lua_rotate(L, -i, -@as(c_int, 1));
        break :blk lua_settop(L, -@as(c_int, 1) - @as(c_int, 1));
    };
    return n;
}
pub fn handle_script(arg_L: ?*lua_State, arg_argv: [*c][*c]u8) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var argv = arg_argv;
    _ = &argv;
    var status: c_int = undefined;
    _ = &status;
    var fname: [*c]const u8 = argv[@as(c_uint, @intCast(@as(c_int, 0)))];
    _ = &fname;
    if ((strcmp(fname, "-") == @as(c_int, 0)) and (strcmp((blk: {
    ...
    if (status == @as(c_int, 0)) {
        var n: c_int = pushargs(L);
        _ = &n;
        status = lua_runchunk(L, n, -@as(c_int, 1));
    }
    return lua_report(L, status);
}
pub fn collectargs(arg_argv: [*c][*c]u8, arg_first: [*c]c_int) callconv(.c) c_int {
    var argv = arg_argv;
    _ = &argv;
    var first = arg_first;
    _ = &first;
    ...
    var i: c_int = undefined;
    _ = &i;
    if (argv[@as(c_uint, @intCast(@as(c_int, 0)))] != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (argv[@as(c_uint, @intCast(@as(c_int, 0)))][@as(c_uint, @intCast(@as(c_int, 0)))] != 0) {
            lua_progname = argv[@as(c_uint, @intCast(@as(c_int, 0)))];
        }
    } else {
        first.* = -@as(c_int, 1);
        return 0;
    }
    {
        ...
        while ((blk: {
            const tmp = i;
            if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) : (i += 1) {
            first.* = i;
            if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*[@as(c_uint, @intCast(@as(c_int, 0)))]))) != @as(c_int, '-')) return args;
            while (true) {
                switch (@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*[@as(c_uint, @intCast(@as(c_int, 1)))])))) {
                    @as(c_int, 45) => {
                        if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                            const tmp = i;
                            if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*[@as(c_uint, @intCast(@as(c_int, 2)))]))) != @as(c_int, '\x00')) return 1;
                        first.* = i + @as(c_int, 1);
                        return args;
                    },
                    @as(c_int, 0) => return args,
                    @as(c_int, 69) => {
                        if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                            const tmp = i;
                            if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    ...
                    @as(c_int, 101) => {
                        ...
                        if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                            const tmp = i;
                            if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*[@as(c_uint, @intCast(@as(c_int, 2)))]))) == @as(c_int, '\x00')) {
                            i += 1;
                            if (((blk: {
                                const tmp = i;
                                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).* == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, (blk: {
                                const tmp = i;
                                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '-'))) return 1;
                        }
                        break;
                    },
                    @as(c_int, 108) => {
...
pub fn runargs(arg_L: ?*lua_State, arg_argv: [*c][*c]u8, arg_n: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var argv = arg_argv;
    _ = &argv;
    ...
    _ = &i;
    {
        i = 1;
        while (i < n) : (i += 1) {
            var option: c_int = @as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk argv + @as(usize, @intCast(tmp)) else break :blk argv - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*[@as(c_uint, @intCast(@as(c_int, 1)))])));
            _ = &option;
                    ...
                    @as(c_int, 101), @as(c_int, 108) => {
                        {
                            ...
                            _ = &extra;
                            if (@as(c_int, @bitCast(@as(c_uint, extra.*))) == @as(c_int, '\x00')) {
                                extra = (blk: {
                                    const tmp = blk_1: {
                                        const ref = &i;
                                        ref.* += 1;
                            ...
                            _ = @as(c_int, 0);
                            status = if (option == @as(c_int, 'e')) dostring(L, extra, "=(command line)") else dolibrary(L, extra);
                            if (status != @as(c_int, 0)) return 0;
                            break;
                        }
                    },
                    @as(c_int, 87) => {
                        lua_warning(L, "@on", @as(c_int, 0));
                        break;
                    },
                    else => {},
                }
...
pub fn handle_luainit(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var name: [*c]const u8 = "=LUA_INIT_5_4";
    _ = &name;
    var init: [*c]const u8 = getenv(name + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))));
    _ = &init;
    if (init == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        name = "=LUA_INIT";
        init = getenv(name + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))));
    }
    if (init == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 0 else if (@as(c_int, @bitCast(@as(c_uint, init[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '@')) return dofile(L, init + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))) else return dostring(L, init, name);
    return 0;
}
// /src/cosmopolitan/third_party/lua/lua.main.c:320:2: warning: TODO implement translation of stmt class LabelStmtClass

// /src/cosmopolitan/third_party/lua/lua.main.c:312:13: warning: unable to translate function, demoted to extern
pub extern fn doREPL(arg_L: ?*lua_State) callconv(.c) void;
pub fn pmain(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    ...
    _ = &argv;
    var script: c_int = undefined;
    _ = &script;
    var args: c_int = collectargs(argv, &script);
    _ = &args;
    var optlim: c_int = if (script > @as(c_int, 0)) script else argc;
    _ = &optlim;
    ...
    if ((args & @as(c_int, 4)) != 0) {
        print_version();
    }
    if ((args & @as(c_int, 16)) != 0) {
        lua_pushboolean(L, @as(c_int, 1));
        lua_setfield(L, -@as(c_int, 1000000) - @as(c_int, 1000), "LUA_NOENV");
    }
    luaL_openlibs(L);
    luaL_requiref(L, "unix", &LuaUnix, @as(c_int, 1));
    lua_settop(L, -@as(c_int, 1) - @as(c_int, 1));
    createargtable(L, argv, argc, script);
    _ = lua_gc(L, @as(c_int, 1));
    _ = lua_gc(L, @as(c_int, 10), @as(c_int, 0), @as(c_int, 0));
    if (!((args & @as(c_int, 16)) != 0)) {
        if (handle_luainit(L) != @as(c_int, 0)) return 0;
    }
    if (!(runargs(L, argv, optlim) != 0)) return 0;
    if (script > @as(c_int, 0)) {
        if (handle_script(L, argv + @as(usize, @bitCast(@as(isize, @intCast(script))))) != @as(c_int, 0)) return 0;
    }
    if ((args & @as(c_int, 2)) != 0) {
        doREPL(L);
    } else if ((script < @as(c_int, 1)) and !((args & (@as(c_int, 8) | @as(c_int, 4))) != 0)) {
        if (lua_stdin_is_tty()) {
            print_version();
            doREPL(L);
        } else {
...
pub export fn main(arg_argc: c_int, arg_argv: [*c][*c]u8) c_int {
    ...
    _ = &result;
    _ = LoadZipArgs(&argc, &argv);
    if (false) {
        _ = @as(c_int, 0);
    }
    L = luaL_newstate();
    if (L == @as(?*lua_State, @ptrCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))) {
        lua_l_message(argv[@as(c_uint, @intCast(@as(c_int, 0)))], "cannot create state: not enough memory");
        return 1;
    }
    _ = lua_gc(L, @as(c_int, 0));
    ...
    status = lua_pcallk(L, @as(c_int, 2), @as(c_int, 1), @as(c_int, 0), @as(lua_KContext, @bitCast(@as(c_long, @as(c_int, 0)))), null);
    result = lua_toboolean(L, -@as(c_int, 1));
    _ = lua_report(L, status);
    lua_close(L);
    if (false) {
        CheckForMemoryLeaks();
    }
    return if ((result != 0) and (status == @as(c_int, 0))) @as(c_int, 0) else @as(c_int, 1);
}
...
pub const COSMOPOLITAN_LIBC_SOCK_SOCK_H_ = "";
pub const INET_ADDRSTRLEN = @as(c_int, 22);
pub const IFHWADDRLEN = @as(c_int, 6);
pub const COSMOPOLITAN_LIBC_SOCK_STRUCT_POLLFD_H_ = "";
pub const COSMOPOLITAN_LIBC_CALLS_STRUCT_TIMESPEC_H_ = "";
pub const COSMOPOLITAN_LIBC_SYSV_CONSTS_POLL_H_ = "";
pub const INFTIM = -@as(c_int, 1);
...
pub const COSMOPOLITAN_THIRD_PARTY_LUA_LUNIX_H_ = "";
pub const COSMOPOLITAN_LIBC_COSMO_H_ = "";
pub const _COSMO_ATOMIC = @compileError("unable to translate C expr: unexpected token '_Atomic'");
// /src/cosmopolitan/libc/cosmo.h:7:9
pub const COSMO_SHARDS = @as(c_int, 32);
pub const LUA_PROGNAME = "lua";
pub const LUA_INIT_VAR = "LUA_INIT";
pub const LUA_INITVARVERSION = LUA_INIT_VAR ++ LUA_VERSUFFIX;
pub const has_error = @as(c_int, 1);
pub const has_i = @as(c_int, 2);
pub const has_v = @as(c_int, 4);
pub const has_e = @as(c_int, 8);
pub const has_E = @as(c_int, 16);
...
pub const UnixErrno = struct_UnixErrno;
