...
pub extern const IOV_MAX: c_int;
pub extern const NGROUPS_MAX: c_int;
pub extern const SOMAXCONN: c_int;
pub extern const _ARG_MAX: c_int;
pub extern const _NAME_MAX: c_int;
pub extern const _NSIG: c_int;
pub extern const _PATH_MAX: c_int;
pub extern const LINK_MAX: c_int;
pub extern const MAX_CANON: c_int;
pub extern const MAX_INPUT: c_int;
pub const pthread_t = usize;
pub const pthread_id_np_t = c_int;
pub const pthread_rwlockattr_t = u8;
pub const pthread_barrierattr_t = u8;
pub const pthread_key_t = c_uint;
pub const pthread_key_dtor = ?*const fn (?*anyopaque) callconv(.c) void;
pub const struct__pthread_cleanup_buffer = extern struct {
    __routine: ?*const fn (?*anyopaque) callconv(.c) void = std.mem.zeroes(?*const fn (?*anyopaque) callconv(.c) void),
    __arg: ?*anyopaque = std.mem.zeroes(?*anyopaque),
    __prev: [*c]struct__pthread_cleanup_buffer = std.mem.zeroes([*c]struct__pthread_cleanup_buffer),
};
// /src/cosmopolitan/libc/thread/thread.h:71:29: warning: unsupported type: 'Atomic'

// /src/cosmopolitan/libc/thread/thread.h:70:16: warning: struct demoted to opaque type - unable to translate type of field _lock
pub const struct_pthread_once_s = opaque {};
pub const pthread_once_t = struct_pthread_once_s;
// /src/cosmopolitan/libc/thread/thread.h:75:24: warning: unsupported type: 'Atomic'

// /src/cosmopolitan/libc/thread/thread.h:74:16: warning: struct demoted to opaque type - unable to translate type of field _lock
pub const struct_pthread_spinlock_s = opaque {};
pub const pthread_spinlock_t = struct_pthread_spinlock_s;
// /src/cosmopolitan/libc/thread/thread.h:80:29: warning: unsupported type: 'Atomic'

// /src/cosmopolitan/libc/thread/thread.h:78:16: warning: struct demoted to opaque type - unable to translate type of field _word
pub const struct_pthread_mutex_s = opaque {};
pub const pthread_mutex_t = struct_pthread_mutex_s;
pub const struct_pthread_mutexattr_s = extern struct {
    _word: c_uint = std.mem.zeroes(c_uint),
};
pub const pthread_mutexattr_t = struct_pthread_mutexattr_s;
pub const struct_pthread_condattr_s = extern struct {
    _pshared: u8 = std.mem.zeroes(u8),
    _clock: u8 = std.mem.zeroes(u8),
};
pub const pthread_condattr_t = struct_pthread_condattr_s;
// /src/cosmopolitan/libc/thread/thread.h:102:25: warning: unsupported type: 'Atomic'

// /src/cosmopolitan/libc/thread/thread.h:98:16: warning: struct demoted to opaque type - unable to translate type of field _waited
pub const struct_pthread_cond_s = opaque {};
pub const pthread_cond_t = struct_pthread_cond_s;
// /src/cosmopolitan/libc/thread/thread.h:115:33: warning: unsupported type: 'Atomic'

// /src/cosmopolitan/libc/thread/thread.h:111:5: warning: struct demoted to opaque type - unable to translate type of field _word
...
// /src/cosmopolitan/libc/thread/thread.h:122:29: warning: unsupported type: 'Atomic'

// /src/cosmopolitan/libc/thread/thread.h:121:16: warning: struct demoted to opaque type - unable to translate type of field _entered
pub const struct_pthread_barrier_s = opaque {};
pub const pthread_barrier_t = struct_pthread_barrier_s;
pub const struct_pthread_attr_s = extern struct {
    __detachstate: u8 = std.mem.zeroes(u8),
    __inheritsched: u8 = std.mem.zeroes(u8),
    __havesigmask: u8 = std.mem.zeroes(u8),
    __schedparam: c_int = std.mem.zeroes(c_int),
    __schedpolicy: c_int = std.mem.zeroes(c_int),
    __contentionscope: c_int = std.mem.zeroes(c_int),
    __sigaltstacksize: c_int = std.mem.zeroes(c_int),
    __sigmask: u64 = std.mem.zeroes(u64),
    __guardsize: usize = std.mem.zeroes(usize),
    __stacksize: usize = std.mem.zeroes(usize),
    __stackaddr: ?*anyopaque = std.mem.zeroes(?*anyopaque),
    __sigaltstackaddr: ?*anyopaque = std.mem.zeroes(?*anyopaque),
};
...
pub extern fn pthread_attr_getsigaltstack_np([*c]const pthread_attr_t, [*c]?*anyopaque, [*c]usize) c_int;
pub extern fn pthread_attr_getsigaltstacksize_np([*c]const pthread_attr_t, [*c]usize) c_int;
...
pub extern fn pthread_attr_setsigaltstack_np([*c]pthread_attr_t, ?*anyopaque, usize) c_int;
pub extern fn pthread_attr_setsigaltstacksize_np([*c]pthread_attr_t, usize) c_int;
...
pub extern fn pthread_barrier_destroy(?*pthread_barrier_t) c_int;
pub extern fn pthread_barrier_init(?*pthread_barrier_t, [*c]const pthread_barrierattr_t, c_uint) c_int;
pub extern fn pthread_barrier_wait(?*pthread_barrier_t) c_int;
pub extern fn pthread_barrierattr_destroy([*c]pthread_barrierattr_t) c_int;
pub extern fn pthread_barrierattr_getpshared([*c]const pthread_barrierattr_t, [*c]c_int) c_int;
...
pub extern fn pthread_cond_broadcast(?*pthread_cond_t) c_int;
pub extern fn pthread_cond_destroy(?*pthread_cond_t) c_int;
pub extern fn pthread_cond_init(?*pthread_cond_t, [*c]const pthread_condattr_t) c_int;
pub extern fn pthread_cond_signal(?*pthread_cond_t) c_int;
pub extern fn pthread_cond_wait(?*pthread_cond_t, ?*pthread_mutex_t) c_int;
pub extern fn pthread_condattr_destroy([*c]pthread_condattr_t) c_int;
pub extern fn pthread_condattr_getclock([*c]const pthread_condattr_t, [*c]c_int) c_int;
pub extern fn pthread_condattr_getpshared([*c]const pthread_condattr_t, [*c]c_int) c_int;
pub extern fn pthread_condattr_init([*c]pthread_condattr_t) c_int;
pub extern fn pthread_condattr_setclock([*c]pthread_condattr_t, c_int) c_int;
...
pub extern fn pthread_decimate_np() c_int;
pub extern fn pthread_delay_np(?*const anyopaque, c_int) c_int;
pub extern fn pthread_detach(pthread_t) c_int;
pub extern fn pthread_equal(pthread_t, pthread_t) c_int;
pub extern fn pthread_getattr_np(pthread_t, [*c]pthread_attr_t) c_int;
pub extern fn pthread_getname_np(pthread_t, [*c]u8, usize) c_int;
pub extern fn pthread_getunique_np(pthread_t, [*c]pthread_id_np_t) c_int;
pub extern fn pthread_join(pthread_t, [*c]?*anyopaque) c_int;
pub extern fn pthread_key_create([*c]pthread_key_t, pthread_key_dtor) c_int;
pub extern fn pthread_key_delete(pthread_key_t) c_int;
pub extern fn pthread_kill(pthread_t, c_int) c_int;
pub extern fn pthread_mutex_consistent(?*pthread_mutex_t) c_int;
pub extern fn pthread_mutex_destroy(?*pthread_mutex_t) c_int;
pub extern fn pthread_mutex_held_np(?*pthread_mutex_t, [*c]c_int) c_int;
pub extern fn pthread_mutex_init(?*pthread_mutex_t, [*c]const pthread_mutexattr_t) c_int;
pub extern fn pthread_mutex_lock(?*pthread_mutex_t) c_int;
pub extern fn pthread_mutex_trylock(?*pthread_mutex_t) c_int;
pub extern fn pthread_mutex_unlock(?*pthread_mutex_t) c_int;
pub extern fn pthread_mutex_wipe_np(?*pthread_mutex_t) c_int;
pub extern fn pthread_mutexattr_destroy([*c]pthread_mutexattr_t) c_int;
pub extern fn pthread_mutexattr_getpshared([*c]const pthread_mutexattr_t, [*c]c_int) c_int;
pub extern fn pthread_mutexattr_gettype([*c]const pthread_mutexattr_t, [*c]c_int) c_int;
...
pub extern fn pthread_once(?*pthread_once_t, ?*const fn () callconv(.c) void) c_int;
pub extern fn pthread_orphan_np() c_int;
pub extern fn pthread_rwlock_destroy(?*pthread_rwlock_t) c_int;
pub extern fn pthread_rwlock_init(?*pthread_rwlock_t, [*c]const pthread_rwlockattr_t) c_int;
pub extern fn pthread_rwlock_rdlock(?*pthread_rwlock_t) c_int;
pub extern fn pthread_rwlock_tryrdlock(?*pthread_rwlock_t) c_int;
pub extern fn pthread_rwlock_trywrlock(?*pthread_rwlock_t) c_int;
pub extern fn pthread_rwlock_unlock(?*pthread_rwlock_t) c_int;
pub extern fn pthread_rwlock_wrlock(?*pthread_rwlock_t) c_int;
...
pub extern fn pthread_setname_np(pthread_t, [*c]const u8) c_int;
...
pub extern fn pthread_spin_destroy(?*pthread_spinlock_t) c_int;
pub extern fn pthread_spin_init(?*pthread_spinlock_t, c_int) c_int;
pub extern fn pthread_spin_lock(?*pthread_spinlock_t) c_int;
pub extern fn pthread_spin_trylock(?*pthread_spinlock_t) c_int;
pub extern fn pthread_spin_unlock(?*pthread_spinlock_t) c_int;
pub extern fn pthread_testcancel_np() c_int;
pub extern fn pthread_tryjoin_np(pthread_t, [*c]?*anyopaque) c_int;
pub extern fn pthread_yield() c_int;
pub extern fn pthread_yield_np() c_int;
pub extern fn pthread_getthreadid_np() pthread_id_np_t;
pub extern fn pthread_self() pthread_t;
pub extern fn pthread_getspecific(pthread_key_t) ?*anyopaque;
pub extern fn __pthread_cleanup_pop([*c]struct__pthread_cleanup_buffer, c_int) void;
pub extern fn __pthread_cleanup_push([*c]struct__pthread_cleanup_buffer, ?*const fn (?*anyopaque) callconv(.c) void, ?*anyopaque) void;
pub extern fn __pthread_cleanup_unwind([*c]struct__pthread_cleanup_buffer) void;
pub extern fn pthread_exit(?*anyopaque) noreturn;
pub extern fn pthread_pause_np() void;
...
pub const struct_NodeKey_5 = extern struct {
    value_: Value = std.mem.zeroes(Value),
    tt_: lu_byte = std.mem.zeroes(lu_byte),
...
const union_unnamed_9 = extern union {
    ...
    nyield: c_int,
    nres: c_int,
    transferinfo: struct_unnamed_10,
};
pub const struct_CallInfo = extern struct {
    ...
    u: union_unnamed_6 = std.mem.zeroes(union_unnamed_6),
    u2: union_unnamed_9 = std.mem.zeroes(union_unnamed_9),
...
pub const struct_UpVal = extern struct {
    ...
    tt: lu_byte = std.mem.zeroes(lu_byte),
    marked: lu_byte = std.mem.zeroes(lu_byte),
    v: union_unnamed_11 = std.mem.zeroes(union_unnamed_11),
    u: union_unnamed_12 = std.mem.zeroes(union_unnamed_12),
};
...
pub const struct_Udata0 = extern struct {
    ...
    len: usize = std.mem.zeroes(usize),
    metatable: [*c]struct_Table = std.mem.zeroes([*c]struct_Table),
    bindata: union_unnamed_15 = std.mem.zeroes(union_unnamed_15),
};
...
pub const struct_luaL_Buffer = extern struct {
    ...
    n: usize = std.mem.zeroes(usize),
    L: [*c]lua_State = std.mem.zeroes([*c]lua_State),
    init: union_unnamed_16 = std.mem.zeroes(union_unnamed_16),
};
...
pub extern fn luaL_checkversion_(L: [*c]lua_State, ver: lua_Number, sz: usize) void;
pub extern fn luaL_getmetafield(L: [*c]lua_State, obj: c_int, e: [*c]const u8) c_int;
pub extern fn luaL_callmeta(L: [*c]lua_State, obj: c_int, e: [*c]const u8) c_int;
pub extern fn luaL_tolstring(L: [*c]lua_State, idx: c_int, len: [*c]usize) [*c]const u8;
pub extern fn luaL_argerror(L: [*c]lua_State, arg: c_int, extramsg: [*c]const u8) c_int;
pub extern fn luaL_typeerror(L: [*c]lua_State, arg: c_int, tname: [*c]const u8) c_int;
pub extern fn luaL_checklstring(L: [*c]lua_State, arg: c_int, l: [*c]usize) [*c]const u8;
pub extern fn luaL_optlstring(L: [*c]lua_State, arg: c_int, def: [*c]const u8, l: [*c]usize) [*c]const u8;
pub extern fn luaL_checknumber(L: [*c]lua_State, arg: c_int) lua_Number;
pub extern fn luaL_optnumber(L: [*c]lua_State, arg: c_int, def: lua_Number) lua_Number;
pub extern fn luaL_checkinteger(L: [*c]lua_State, arg: c_int) lua_Integer;
pub extern fn luaL_optinteger(L: [*c]lua_State, arg: c_int, def: lua_Integer) lua_Integer;
pub extern fn luaL_checkstack(L: [*c]lua_State, sz: c_int, msg: [*c]const u8) void;
pub extern fn luaL_checktype(L: [*c]lua_State, arg: c_int, t: c_int) void;
pub extern fn luaL_checkany(L: [*c]lua_State, arg: c_int) void;
pub extern fn luaL_newmetatable(L: [*c]lua_State, tname: [*c]const u8) c_int;
pub extern fn luaL_setmetatable(L: [*c]lua_State, tname: [*c]const u8) void;
pub extern fn luaL_testudata(L: [*c]lua_State, ud: c_int, tname: [*c]const u8) ?*anyopaque;
pub extern fn luaL_checkudata(L: [*c]lua_State, ud: c_int, tname: [*c]const u8) ?*anyopaque;
pub extern fn luaL_where(L: [*c]lua_State, lvl: c_int) void;
pub extern fn luaL_error(L: [*c]lua_State, fmt: [*c]const u8, ...) c_int;
pub extern fn luaL_checkoption(L: [*c]lua_State, arg: c_int, def: [*c]const u8, lst: [*c]const [*c]const u8) c_int;
pub extern fn luaL_fileresult(L: [*c]lua_State, stat: c_int, fname: [*c]const u8) c_int;
pub extern fn luaL_execresult(L: [*c]lua_State, stat: c_int) c_int;
pub extern fn luaL_ref(L: [*c]lua_State, t: c_int) c_int;
pub extern fn luaL_unref(L: [*c]lua_State, t: c_int, ref: c_int) void;
pub extern fn luaL_loadfilex(L: [*c]lua_State, filename: [*c]const u8, mode: [*c]const u8) c_int;
pub extern fn luaL_loadbufferx(L: [*c]lua_State, buff: [*c]const u8, sz: usize, name: [*c]const u8, mode: [*c]const u8) c_int;
pub extern fn luaL_loadstring(L: [*c]lua_State, s: [*c]const u8) c_int;
pub extern fn luaL_newstate() [*c]lua_State;
pub extern fn luaL_len(L: [*c]lua_State, idx: c_int) lua_Integer;
pub extern fn luaL_addgsub(b: [*c]luaL_Buffer, s: [*c]const u8, p: [*c]const u8, r: [*c]const u8) void;
pub extern fn luaL_gsub(L: [*c]lua_State, s: [*c]const u8, p: [*c]const u8, r: [*c]const u8) [*c]const u8;
pub extern fn luaL_setfuncs(L: [*c]lua_State, l: [*c]const luaL_Reg, nup: c_int) void;
pub extern fn luaL_getsubtable(L: [*c]lua_State, idx: c_int, fname: [*c]const u8) c_int;
pub extern fn luaL_traceback(L: [*c]lua_State, L1: [*c]lua_State, msg: [*c]const u8, level: c_int) void;
pub extern fn luaL_traceback2(L: [*c]lua_State, L1: [*c]lua_State, msg: [*c]const u8, level: c_int) void;
pub extern fn luaL_requiref(L: [*c]lua_State, modname: [*c]const u8, openf: lua_CFunction, glb: c_int) void;
pub extern fn luaL_buffinit(L: [*c]lua_State, B: [*c]luaL_Buffer) void;
...
pub extern fn luaL_buffinitsize(L: [*c]lua_State, B: [*c]luaL_Buffer, sz: usize) [*c]u8;
...
pub const struct_Dyndata = extern struct {
    actvar: struct_unnamed_17 = std.mem.zeroes(struct_unnamed_17),
...
const union_unnamed_19 = extern union {
    ...
    strval: [*c]TString,
    info: c_int,
    ind: struct_unnamed_20,
    @"var": struct_unnamed_21,
};
pub const struct_expdesc = extern struct {
    k: expkind = std.mem.zeroes(expkind),
    u: union_unnamed_19 = std.mem.zeroes(union_unnamed_19),
...
pub const opnames: [84][*c]const u8 = [84][*c]const u8{
    "MOVE",
    "LOADI",
    "LOADF",
    "LOADK",
...
pub extern fn luaopen_base(L: [*c]lua_State) c_int;
pub extern fn luaopen_coroutine(L: [*c]lua_State) c_int;
...
pub extern fn luaopen_utf8(L: [*c]lua_State) c_int;
...
pub extern fn luaL_openlibs(L: [*c]lua_State) void;
...
pub const _LIMITS_H = "";
pub const COSMOPOLITAN_LIBC_SYSV_CONSTS__POSIX_H_ = "";
pub const _POSIX_AIO_LISTIO_MAX = @as(c_int, 2);
pub const _POSIX_CLOCKRES_MIN = std.zig.c_translation.promoteIntLiteral(c_int, 20000000, .decimal);
...
pub const COSMOPOLITAN_LIBC_SYSV_CONSTS_IOV_H_ = "";
pub const COSMOPOLITAN_LIBC_SYSV_CONSTS_LIMITS_H_ = "";
pub const PIPE_BUF = @as(c_int, 512);
pub const COSMOPOLITAN_LIBC_SYSV_CONSTS_XOPEN_H_ = "";
pub const _XOPEN_IOV_MAX = @as(c_int, 16);
pub const _XOPEN_ENH_I18N = @as(c_int, 1);
pub const _XOPEN_UNIX = @as(c_int, 1);
pub const _XOPEN_NAME_MAX = @as(c_int, 63);
pub const _XOPEN_PATH_MAX = @as(c_int, 1024);
pub const COSMOPOLITAN_LIBC_THREAD_THREAD_H_ = "";
pub const PTHREAD_KEYS_MAX = @as(c_int, 128);
pub const PTHREAD_STACK_MIN = std.zig.c_translation.promoteIntLiteral(c_int, 32768, .decimal);
pub const PTHREAD_USE_NSYNC = @as(c_int, 1);
...
pub const PTHREAD_MUTEX_NORMAL = @as(c_int, 1);
pub const PTHREAD_MUTEX_RECURSIVE = @as(c_int, 2);
pub const PTHREAD_MUTEX_ERRORCHECK = @as(c_int, 3);
pub const PTHREAD_MUTEX_STALLED = @as(c_int, 0);
pub const PTHREAD_MUTEX_ROBUST = @as(c_int, 2048);
pub const PTHREAD_PROCESS_PRIVATE = @as(c_int, 0);
pub const PTHREAD_PROCESS_SHARED = @as(c_int, 4);
...
pub const PTHREAD_CANCELED = std.zig.c_translation.cast(?*anyopaque, -@as(c_int, 1));
...
// /src/cosmopolitan/libc/thread/thread.h:45:9
pub const PTHREAD_COND_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/libc/thread/thread.h:46:9
pub const PTHREAD_RWLOCK_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/libc/thread/thread.h:47:9
pub const PTHREAD_MUTEX_INITIALIZER = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/libc/thread/thread.h:49:9
pub const PTHREAD_NORMAL_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/libc/thread/thread.h:50:9
pub const PTHREAD_SHARED_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/libc/thread/thread.h:51:9
pub const PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/libc/thread/thread.h:52:9
pub const PTHREAD_ERRORCHECK_MUTEX_INITIALIZER_NP = @compileError("unable to translate C expr: unexpected token '{'");
// /src/cosmopolitan/libc/thread/thread.h:53:9
pub const _PTHREAD_ATOMIC = @compileError("unable to translate C expr: unexpected token '_Atomic'");
// /src/cosmopolitan/libc/thread/thread.h:56:9
pub const _PTHREAD_CLEANUP = @compileError("unable to translate macro: undefined identifier `__cleanup__`");
// /src/cosmopolitan/libc/thread/thread.h:254:9
pub const pthread_cleanup_push = @compileError("unable to translate macro: undefined identifier `_buffer`");
// /src/cosmopolitan/libc/thread/thread.h:268:9
pub const pthread_cleanup_pop = @compileError("unable to translate macro: undefined identifier `_buffer`");
// /src/cosmopolitan/libc/thread/thread.h:274:9
pub const _SETJMP_H = "";
pub const _STDIO_H = "";
pub const COSMOPOLITAN_LIBC_CALLS_WEIRDTYPES_H_ = "";
pub const TIME_T_MAX = __INT64_MAX__;
pub const TIME_T_MIN = -TIME_T_MAX - @as(c_int, 1);
...
pub const COSMOPOLITAN_THIRD_PARTY_MUSL_TEMPNAM_H_ = "";
...
pub const pthread_once_s = struct_pthread_once_s;
pub const pthread_spinlock_s = struct_pthread_spinlock_s;
