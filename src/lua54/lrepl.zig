...
pub const linenoiseHintsCallback = fn ([*c]const u8, [*c][*c]const u8, [*c][*c]const u8) callconv(.c) [*c]u8;
pub const linenoiseFreeHintsCallback = fn (?*anyopaque) callconv(.c) void;
pub const linenoiseXlatCallback = fn (wint_t) callconv(.c) wint_t;
...
pub extern fn linenoiseSetXlatCallback(?*const linenoiseXlatCallback) void;
pub extern fn linenoise([*c]const u8) [*c]u8;
pub extern fn linenoiseWithHistory([*c]const u8, [*c]const u8) [*c]u8;
pub extern fn linenoiseHistoryAdd([*c]const u8) c_int;
pub extern fn linenoiseHistorySave([*c]const u8) c_int;
pub extern fn linenoiseHistoryLoad([*c]const u8) c_int;
pub extern fn linenoiseFreeCompletions([*c]linenoiseCompletions) void;
pub extern fn linenoiseHistoryFree() void;
pub extern fn linenoiseClearScreen(c_int) void;
pub extern fn linenoiseMaskModeEnable() void;
pub extern fn linenoiseMaskModeDisable() void;
pub extern fn linenoiseEnableRawMode(c_int) c_int;
pub extern fn linenoiseDisableRawMode() void;
pub extern fn linenoiseFree(?*anyopaque) void;
pub extern fn linenoiseIsTerminal() c_int;
pub extern fn linenoiseIsTeletype() c_int;
pub extern fn linenoiseGetHistoryPath([*c]const u8) [*c]u8;
pub extern fn linenoiseBegin([*c]const u8, c_int, c_int) ?*struct_linenoiseState;
pub extern fn linenoiseEdit(?*struct_linenoiseState, [*c]const u8, [*c][*c]u8, bool) isize;
pub extern fn linenoiseGetInterrupt() c_int;
pub extern fn linenoiseEnd(?*struct_linenoiseState) void;
pub extern fn linenoiseGetLine(?*FILE) [*c]u8;
pub extern fn linenoiseGetTerminalSize(struct_winsize, c_int, c_int) struct_winsize;
pub extern fn linenoiseRefreshLine(?*struct_linenoiseState) void;
pub extern fn linenoiseRaw([*c]const u8, c_int, c_int) [*c]u8;
...
pub extern var lua_repl_blocking: bool;
pub extern var lua_repl_isterminal: bool;
pub extern var lua_progname: [*c]const u8;
pub extern var lua_repl_linenoise: ?*struct_linenoiseState;
pub extern var lua_repl_completions_callback: ?*const linenoiseCompletionCallback;
pub export fn lua_freerepl() void {
    lua_repl_lock();
    __ttyconf.replmode = 0;
    linenoiseEnd(lua_repl_linenoise);
    free(@as(?*anyopaque, @ptrCast(g_historypath)));
    lua_repl_unlock();
}
pub extern fn lua_repl_wock() void;
pub extern fn lua_repl_lock() void;
pub extern fn lua_repl_unlock() void;
pub export fn lua_loadline(arg_L: ?*lua_State) c_int {
    var L = arg_L;
    _ = &L;
    ...
    _ = &status;
    lua_settop(L, @as(c_int, 0));
    lua_repl_lock();
    if ((blk: {
        const tmp = pushline(L, @as(c_int, 1));
        rc = tmp;
        break :blk tmp;
    }) != @as(isize, @bitCast(@as(isize, @as(c_int, 1))))) {
        lua_repl_unlock();
        return @as(c_int, @bitCast(@as(c_int, @truncate(rc - @as(isize, @bitCast(@as(isize, @as(c_int, 1))))))));
    }
    if ((blk: {
        const tmp = addreturn(L);
        status = tmp;
        break :blk tmp;
    }) != @as(c_int, 0)) {
        status = multiline(L);
    ...
    _ = blk: {
        lua_rotate(L, @as(c_int, 1), -@as(c_int, 1));
...
pub export fn lua_l_print(arg_L: ?*lua_State) void {
    var L = arg_L;
    _ = &L;
    var n: c_int = lua_gettop(L);
    _ = &n;
    if (n > @as(c_int, 0)) {
        luaL_checkstack(L, @as(c_int, 20), "too many results to print");
        _ = lua_getglobal(L, "print");
        lua_rotate(L, @as(c_int, 1), @as(c_int, 1));
        if (lua_pcallk(L, n, @as(c_int, 0), @as(c_int, 0), @as(lua_KContext, @bitCast(@as(isize, @as(c_int, 0)))), null) != @as(c_int, 0)) {
            {
                var fmtbuf: [512]u8 = undefined;
                const err_str = lua_tolstring(L, -@as(c_int, 1), null);
                const result = std.fmt.bufPrintZ(&fmtbuf, "error calling 'print' ({s})", .{
                    if (err_str) |s| std.mem.span(s) else "?",
                }) catch "error calling 'print' (?)";
                lua_l_message(lua_progname, lua_pushstring(L, result));
            }
        }
    }
}
pub export fn lua_initrepl(arg_L: ?*lua_State) void {
    var L = arg_L;
    _ = &L;
    ...
    lua_repl_lock();
    if (blk: {
        const tmp = linenoiseIsTerminal() != 0;
        lua_repl_isterminal = tmp;
        break :blk tmp;
    }) {
        linenoiseSetCompletionCallback(@ptrCast(&lua_readline_completions));
        linenoiseSetHintsCallback(&lua_readline_hint);
        linenoiseSetFreeHintsCallback(&free);
        prompt = get_prompt(L, @as(c_int, 1));
        if ((blk: {
            const tmp = linenoiseGetHistoryPath(lua_progname);
            g_historypath = tmp;
            break :blk tmp;
        }) != null) {
            if (linenoiseHistoryLoad(g_historypath) == -@as(c_int, 1)) {
                _ = fprintf(stderr, "%r%s: failed to load history: %m\n", g_historypath);
                free(@as(?*anyopaque, @ptrCast(g_historypath)));
                g_historypath = null;
            }
        }
        lua_repl_linenoise = linenoiseBegin(prompt, @as(c_int, 0), @as(c_int, 1));
        lua_settop(L, -@as(c_int, 1) - @as(c_int, 1));
        __ttyconf.replmode = 1;
        if (isatty(@as(c_int, 2)) != 0) {
            __ttyconf.replstderr = 1;
        }
    }
    lua_repl_unlock();
}
pub export fn lua_sigint(arg_L: ?*lua_State, arg_sig: c_int) void {
    var L = arg_L;
    _ = &L;
    var sig = arg_sig;
    _ = &sig;
    var flag: c_int = (((@as(c_int, 1) << @intCast(0)) | (@as(c_int, 1) << @intCast(1))) | (@as(c_int, 1) << @intCast(2))) | (@as(c_int, 1) << @intCast(3));
    _ = &flag;
    lua_sethook(L, &lstop, flag, @as(c_int, 1));
}
pub export fn lua_report(arg_L: ?*lua_State, arg_status: c_int) c_int {
    var L = arg_L;
    _ = &L;
...
const struct_unnamed_8 = extern struct {
    si_pid: i32 = std.mem.zeroes(i32),
    si_uid: u32 = std.mem.zeroes(u32),
};
const struct_unnamed_9 = extern struct {
    si_timerid: i32 = std.mem.zeroes(i32),
    si_overrun: i32 = std.mem.zeroes(i32),
};
...
const struct_unnamed_11 = extern struct {
    si_status: i32 = std.mem.zeroes(i32),
    si_utime: i64 = std.mem.zeroes(i64),
    si_stime: i64 = std.mem.zeroes(i64),
};
...
const struct_unnamed_6 = extern struct {
    ...
    unnamed_1: union_unnamed_10 = std.mem.zeroes(union_unnamed_10),
};
const struct_unnamed_14 = extern struct {
    si_lower: ?*anyopaque = std.mem.zeroes(?*anyopaque),
    si_upper: ?*anyopaque = std.mem.zeroes(?*anyopaque),
};
...
const struct_unnamed_12 = extern struct {
    si_addr: ?*anyopaque = std.mem.zeroes(?*anyopaque),
    si_addr_lsb: i16 = std.mem.zeroes(i16),
    unnamed_0: union_unnamed_13 = std.mem.zeroes(union_unnamed_13),
};
const struct_unnamed_15 = extern struct {
    si_band: i64 = std.mem.zeroes(i64),
    si_fd: i32 = std.mem.zeroes(i32),
};
const struct_unnamed_16 = extern struct {
    si_call_addr: ?*anyopaque = std.mem.zeroes(?*anyopaque),
    si_syscall: i32 = std.mem.zeroes(i32),
    si_arch: u32 = std.mem.zeroes(u32),
};
const union_unnamed_5 = extern union {
    unnamed_0: struct_unnamed_6,
    unnamed_1: struct_unnamed_12,
    unnamed_2: struct_unnamed_15,
    unnamed_3: struct_unnamed_16,
    __ignoreme: [112]u8,
};
pub const struct_siginfo = extern struct {
    si_signo: i32 = std.mem.zeroes(i32),
    si_errno: i32 = std.mem.zeroes(i32),
    si_code: i32 = std.mem.zeroes(i32),
    unnamed_0: union_unnamed_5 = std.mem.zeroes(union_unnamed_5),
};
pub const siginfo_t = struct_siginfo;
pub const sigaction_f = ?*const fn (c_int, [*c]siginfo_t, ?*anyopaque) callconv(.c) void;
const union_unnamed_4 = extern union {
    sa_handler: sighandler_t,
    sa_sigaction: sigaction_f,
};
pub const sigset_t = u64;
pub const struct_sigaction = extern struct {
    unnamed_0: union_unnamed_4 = std.mem.zeroes(union_unnamed_4),
    sa_flags: u64 = std.mem.zeroes(u64),
    sa_restorer: ?*const fn () callconv(.c) void = std.mem.zeroes(?*const fn () callconv(.c) void),
    sa_mask: sigset_t = std.mem.zeroes(sigset_t),
};
pub export fn lua_runchunk(arg_L: ?*lua_State, arg_narg: c_int, arg_nres: c_int) c_int {
    var L = arg_L;
    _ = &L;
    var narg = arg_narg;
    _ = &narg;
    ...
    _ = &sa;
    var saold: struct_sigaction = undefined;
    _ = &saold;
    var status: c_int = undefined;
    _ = &status;
    var base: c_int = lua_gettop(L) - narg;
    _ = &base;
    lua_pushcclosure(L, &msghandler, @as(c_int, 0));
    lua_rotate(L, base, @as(c_int, 1));
    globalL = L;
    sa.sa_flags = @as(u64, @bitCast(@as(usize, SA_RESETHAND)));
    sa.unnamed_0.sa_handler = &laction;
    _ = sigemptyset(&sa.sa_mask);
    _ = sigaction(@as(c_int, 2), &sa, &saold);
    status = lua_pcallk(L, narg, nres, base, @as(lua_KContext, @bitCast(@as(isize, @as(c_int, 0)))), null);
    _ = sigaction(@as(c_int, 2), &saold, null);
    _ = blk: {
        lua_rotate(L, base, -@as(c_int, 1));
        break :blk lua_settop(L, -@as(c_int, 1) - @as(c_int, 1));
    };
...
pub export fn lua_l_message(arg_pname: [*c]const u8, arg_msg: [*c]const u8) void {
    var pname = arg_pname;
    _ = &pname;
    var msg = arg_msg;
    _ = &msg;
...
pub export fn lua_readline_hint(arg_p: [*c]const u8, arg_ansi1: [*c][*c]const u8, arg_ansi2: [*c][*c]const u8) [*c]u8 {
    var p = arg_p;
    _ = &p;
    var ansi1 = arg_ansi1;
    _ = &ansi1;
    var ansi2 = arg_ansi2;
    _ = &ansi2;
    var h: [*c]u8 = undefined;
    _ = &h;
    var c: linenoiseCompletions = linenoiseCompletions{
        .len = @as(usize, @bitCast(@as(isize, @as(c_int, 0)))),
        .cvec = null,
    };
    _ = &c;
    lua_readline_completions(p, &c);
    h = if (c.len == @as(usize, @bitCast(@as(isize, @as(c_int, 1))))) strdup(c.cvec[@as(c_uint, @intCast(@as(c_int, 0)))] + strlen(p)) else null;
    linenoiseFreeCompletions(&c);
    return h;
}
pub fn lua_readline_completions(arg_p: [*c]const u8, arg_c: [*c]linenoiseCompletions) void {
    var p = arg_p;
    _ = &p;
    var c = arg_c;
    _ = &c;
    ...
    _ = &found;
    var L: ?*lua_State = undefined;
    _ = &L;
    var a: [*c]const u8 = undefined;
    _ = &a;
    ...
    _ = &s;
    var component: [*c]u8 = undefined;
    _ = &component;
    L = globalL;
    _ = lua_rawgeti(L, -@as(c_int, 1000000) - @as(c_int, 1000), @as(lua_Integer, @bitCast(@as(c_longlong, @as(c_int, 2)))));
    a = p;
    b = strpbrk(a, ".:");
    while (b != null) {
        found = @as(c_int, 0) != 0;
        if (lua_type(L, -@as(c_int, 1)) == @as(c_int, 5)) {
            component = strndup(a, @as(usize, @bitCast(@divExact(@as(isize, @bitCast(@intFromPtr(b) -% @intFromPtr(a))), @sizeOf(u8)))));
            lua_pushnil(L);
            while (lua_next(L, -@as(c_int, 2)) != 0) {
                if (lua_type(L, -@as(c_int, 2)) == @as(c_int, 4)) {
                    name = lua_tolstring(L, -@as(c_int, 2), null);
            ...
            free(@as(?*anyopaque, @ptrCast(component)));
        }
        if (!found) {
            lua_settop(L, -@as(c_int, 1) - @as(c_int, 1));
            return;
    ...
    if (lua_type(L, -@as(c_int, 1)) == @as(c_int, 5)) {
        ...
        while (lua_next(L, -@as(c_int, 2)) != 0) {
            if (lua_type(L, -@as(c_int, 2)) == @as(c_int, 4)) {
                name = lua_tolstring(L, -@as(c_int, 2), &n);
                if (false and ((blk: {
                    const tmp = @as([*c]u8, @ptrCast(@alignCast(malloc((@as(usize, @bitCast(@divExact(@as(isize, @bitCast(@intFromPtr(a) -% @intFromPtr(p))), @sizeOf(u8)))) +% n) +% @as(usize, @bitCast(@as(isize, @as(c_int, 1))))))));
                    s = tmp;
                    break :blk tmp;
                }) != null)) {
                    _ = memcpy(@as(?*anyopaque, @ptrCast(s)), @as(?*const anyopaque, @ptrCast(p)), @as(usize, @bitCast(@divExact(@as(isize, @bitCast(@intFromPtr(a) -% @intFromPtr(p))), @sizeOf(u8)))));
                    _ = memcpy(@as(?*anyopaque, @ptrCast(s + @as(usize, @bitCast(@as(isize, @intCast(@divExact(@as(isize, @bitCast(@intFromPtr(a) -% @intFromPtr(p))), @sizeOf(u8)))))))), @as(?*const anyopaque, @ptrCast(name)), n +% @as(usize, @bitCast(@as(isize, @as(c_int, 1)))));
    ...
    {
        i = 0;
        while (@as(usize, @bitCast(@as(isize, i))) < ((@sizeOf([8][*c]const u8) / @sizeOf([*c]const u8)) / @as(usize, @bitCast(@as(usize, @as(c_uint, @intFromBool(!((@sizeOf([8][*c]const u8) % @sizeOf([*c]const u8)) != 0)))))))) : (i += 1) {
            if (false) {
                if ((blk: {
                    const tmp = strdup(kKeywordHints[@as(c_uint, @intCast(i))]);
                    s = tmp;
                    break :blk tmp;
                }) != null) {
                    lua_readline_addcompletion(c, s);
    ...
    if (lua_repl_completions_callback != null) {
        lua_repl_completions_callback.?(p, c);
    }
}
pub extern fn sigqueue(c_int, c_int, union_sigval) c_int;
...
pub extern fn sigandset([*c]sigset_t, [*c]const sigset_t, [*c]const sigset_t) c_int;
pub extern fn sigorset([*c]sigset_t, [*c]const sigset_t, [*c]const sigset_t) c_int;
pub extern fn sigisemptyset([*c]const sigset_t) c_int;
pub extern fn sigismember([*c]const sigset_t, c_int) c_int;
pub extern fn sigcountset([*c]const sigset_t) c_int;
...
pub extern fn signal(c_int, sighandler_t) sighandler_t;
...
const struct_unnamed_18 = extern struct {
    vline: u8 = std.mem.zeroes(u8),
    vintr: u8 = std.mem.zeroes(u8),
    vquit: u8 = std.mem.zeroes(u8),
    verase: u8 = std.mem.zeroes(u8),
    vkill: u8 = std.mem.zeroes(u8),
    veof: u8 = std.mem.zeroes(u8),
    vtime: u8 = std.mem.zeroes(u8),
    vmin: u8 = std.mem.zeroes(u8),
    vswtc: u8 = std.mem.zeroes(u8),
    vstart: u8 = std.mem.zeroes(u8),
    vstop: u8 = std.mem.zeroes(u8),
    vsusp: u8 = std.mem.zeroes(u8),
    veol: u8 = std.mem.zeroes(u8),
    vreprint: u8 = std.mem.zeroes(u8),
    vdiscard: u8 = std.mem.zeroes(u8),
    vwerase: u8 = std.mem.zeroes(u8),
    vlnext: u8 = std.mem.zeroes(u8),
    veol2: u8 = std.mem.zeroes(u8),
};
const union_unnamed_17 = extern union {
    c_cc: [20]u8,
    unnamed_0: struct_unnamed_18,
};
pub const struct_TtyConf = extern struct {
    magic: c_uint = std.mem.zeroes(c_uint),
    mousebs: u8 = std.mem.zeroes(u8),
    replmode: u8 = std.mem.zeroes(u8),
    replstderr: u8 = std.mem.zeroes(u8),
    unnamed_0: union_unnamed_17 = std.mem.zeroes(union_unnamed_17),
};
pub extern var __ttyconf: struct_TtyConf;
pub extern fn __check_fail([*c]const u8, [*c]const u8, u64, [*c]const u8, u64, [*c]const u8, [*c]const u8, c_int, [*c]const u8, ...) noreturn;
pub extern fn __check_fail_eq(u64, u64, [*c]const u8, c_int, [*c]const u8, [*c]const u8, ...) noreturn;
pub extern fn __check_fail_ne(u64, u64, [*c]const u8, c_int, [*c]const u8, [*c]const u8, ...) noreturn;
pub extern fn __check_fail_le(u64, u64, [*c]const u8, c_int, [*c]const u8, [*c]const u8, ...) noreturn;
pub extern fn __check_fail_lt(u64, u64, [*c]const u8, c_int, [*c]const u8, [*c]const u8, ...) noreturn;
pub extern fn __check_fail_ge(u64, u64, [*c]const u8, c_int, [*c]const u8, [*c]const u8, ...) noreturn;
pub extern fn __check_fail_gt(u64, u64, [*c]const u8, c_int, [*c]const u8, [*c]const u8, ...) noreturn;
pub extern fn __check_fail_aligned(c_uint, u64, [*c]const u8, c_int, [*c]const u8, ...) noreturn;
pub extern const SA_NOCLDSTOP: c_uint;
pub extern const SA_NOCLDWAIT: c_uint;
pub extern const SA_NODEFER: c_uint;
pub extern const SA_ONSTACK: c_uint;
pub extern const SA_RESETHAND: c_uint;
pub extern const SA_RESTART: c_uint;
pub extern const SA_SIGINFO: c_uint;
pub extern const SIG_BLOCK: c_int;
pub extern const SIG_SETMASK: c_int;
pub extern const SIG_UNBLOCK: c_int;
...
pub const struct_pthread_rwlock_s = extern struct {
    unnamed_0: union_unnamed_19 = std.mem.zeroes(union_unnamed_19),
};
...
pub const struct_UrlParam_21 = extern struct {
...
pub const struct_UrlParams = extern struct {
    n: usize = std.mem.zeroes(usize),
    p: [*c]struct_UrlParam_21 = std.mem.zeroes([*c]struct_UrlParam_21),
};
...
pub const kKeywordHints: [8][*c]const u8 = [8][*c]const u8{
    "else",
    "elseif",
    "function",
    "function",
...
pub var globalL: ?*lua_State = std.mem.zeroes(?*lua_State);
pub var g_historypath: [*c]u8 = std.mem.zeroes([*c]u8);
pub fn lua_readline_addcompletion(arg_c: [*c]linenoiseCompletions, arg_s: [*c]u8) callconv(.c) void {
    var c = arg_c;
    _ = &c;
    var s = arg_s;
    _ = &s;
    ...
    _ = &p;
    if ((blk: {
        const tmp = @as([*c][*c]u8, @ptrCast(@alignCast(realloc(@as(?*anyopaque, @ptrCast(c.*.cvec)), (c.*.len +% @as(usize, @bitCast(@as(isize, @as(c_int, 1))))) *% @sizeOf([*c]u8)))));
        p = tmp;
        break :blk tmp;
    }) != null) {
        c.*.cvec = p;
...
pub fn lua_freeline(arg_L: ?*lua_State, arg_b: [*c]u8) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var b = arg_b;
    _ = &b;
    free(@as(?*anyopaque, @ptrCast(b)));
}
pub fn get_prompt(arg_L: ?*lua_State, arg_firstline: c_int) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var firstline = arg_firstline;
    _ = &firstline;
    if (lua_getglobal(L, if (firstline != 0) "_PROMPT" else "_PROMPT2") == @as(c_int, 0)) return if (firstline != 0) ">: " else ">>: " else {
        var p: [*c]const u8 = luaL_tolstring(L, -@as(c_int, 1), null);
        _ = &p;
        _ = blk: {
            lua_rotate(L, -@as(c_int, 2), -@as(c_int, 1));
            break :blk lua_settop(L, -@as(c_int, 1) - @as(c_int, 1));
...
pub fn incomplete(arg_L: ?*lua_State, arg_status: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var status = arg_status;
    _ = &status;
    if (status == @as(c_int, 3)) {
        var lmsg: usize = undefined;
        _ = &lmsg;
        var msg: [*c]const u8 = lua_tolstring(L, -@as(c_int, 1), &lmsg);
        _ = &msg;
        if ((lmsg >= ((@sizeOf([6]u8) / @sizeOf(u8)) -% @as(usize, @bitCast(@as(isize, @as(c_int, 1)))))) and (strcmp((msg + lmsg) - ((@sizeOf([6]u8) / @sizeOf(u8)) -% @as(usize, @bitCast(@as(isize, @as(c_int, 1))))), "<eof>") == @as(c_int, 0))) {
            lua_settop(L, -@as(c_int, 1) - @as(c_int, 1));
            return 1;
        }
    }
...
// /src/cosmopolitan/third_party/lua/lrepl.c:230:16: warning: unable to translate function, demoted to extern
pub extern fn pushline(arg_L: ?*lua_State, arg_firstline: c_int) callconv(.c) isize;
pub fn addreturn(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var line: [*c]const u8 = lua_tolstring(L, -@as(c_int, 1), null);
    _ = &line;
    var retline: [*c]const u8 = blk: {
        var fmtbuf: [4096]u8 = undefined;
        const line_s: [*:0]const u8 = @ptrCast(line);
        const result = std.fmt.bufPrintZ(&fmtbuf, "return {s};", .{
            std.mem.span(line_s),
        }) catch "return ;";
        break :blk lua_pushstring(L, result);
    };
    _ = &retline;
    var status: c_int = luaL_loadbufferx(L, retline, strlen(retline), "=stdin", null);
    _ = &status;
    if (status == @as(c_int, 0)) {
        _ = blk: {
            lua_rotate(L, -@as(c_int, 2), -@as(c_int, 1));
...
pub fn lstop(arg_L: ?*lua_State, arg_ar: [*c]lua_Debug) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var ar = arg_ar;
    _ = &ar;
    _ = &ar;
    lua_sethook(L, null, @as(c_int, 0), @as(c_int, 0));
    _ = luaL_error(L, "interrupted!");
}
pub fn multiline(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    while (true) {
        var len: usize = undefined;
        _ = &len;
        var line: [*c]const u8 = lua_tolstring(L, @as(c_int, 1), &len);
        _ = &line;
        var status: c_int = luaL_loadbufferx(L, line, len, "=stdin", null);
        _ = &status;
        if (!(incomplete(L, status) != 0) or (pushline(L, @as(c_int, 0)) != @as(isize, @bitCast(@as(isize, @as(c_int, 1)))))) return status;
        _ = lua_pushstring(L, "\n");
        lua_rotate(L, -@as(c_int, 2), @as(c_int, 1));
...
pub fn laction(arg_i: c_int) callconv(.c) void {
    var i = arg_i;
    _ = &i;
    lua_sigint(globalL, i);
    var flag: c_int = (((@as(c_int, 1) << @intCast(0)) | (@as(c_int, 1) << @intCast(1))) | (@as(c_int, 1) << @intCast(2))) | (@as(c_int, 1) << @intCast(3));
    _ = &flag;
    lua_sethook(globalL, &lstop, flag, @as(c_int, 1));
}
pub fn msghandler(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var msg: [*c]const u8 = lua_tolstring(L, @as(c_int, 1), null);
    _ = &msg;
    if (msg == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if ((luaL_callmeta(L, @as(c_int, 1), "__tostring") != 0) and (lua_type(L, -@as(c_int, 1)) == @as(c_int, 4))) return 1 else {
            {
                var fmtbuf: [512]u8 = undefined;
                const result = std.fmt.bufPrintZ(&fmtbuf, "(error object is a {s} value)", .{
                    std.mem.span(@as([*:0]const u8, @ptrCast(lua_typename(L, lua_type(L, @as(c_int, 1)))))),
                }) catch "(error object is a ? value)";
                msg = lua_pushstring(L, result);
            }
        }
    }
    luaL_traceback(L, L, msg, @as(c_int, 1));
    return 1;
}
...
pub const lua_c = "";
pub const COSMOPOLITAN_THIRD_PARTY_LUA_LREPL_H_ = "";
pub const COSMOPOLITAN_THIRD_PARTY_LINENOISE_LINENOISE_H_ = "";
...
pub const COSMOPOLITAN_LIBC_CALLS_STRUCT_SIGACTION_H_ = "";
pub const COSMOPOLITAN_LIBC_CALLS_STRUCT_SIGINFO_H_ = "";
pub const COSMOPOLITAN_LIBC_CALLS_STRUCT_SIGVAL_H_ = "";
pub const COSMOPOLITAN_LIBC_CALLS_STRUCT_SIGSET_H_ = "";
...
pub const COSMOPOLITAN_NOMULTICS_H_ = "";
pub const kTtySilence = @as(c_int, 1);
pub const kTtyEchoRaw = @as(c_int, 2);
pub const kTtyUncanon = @as(c_int, 4);
pub const kTtyNoCr2Nl = @as(c_int, 8);
pub const kTtyNoIsigs = @as(c_int, 16);
pub const kTtyXtMouse = @as(c_int, 32);
pub const kTtyNoIexten = @as(c_int, 64);
pub const kTtyNoEchoe = @as(c_int, 128);
pub const kTtyNoEchok = @as(c_int, 256);
pub const kTtyNoEchoke = @as(c_int, 512);
pub const kTtyNoFlow = @as(c_int, 1024);
pub const COSMOPOLITAN_LIBC_LOG_CHECK_H_ = "";
pub const COSMOPOLITAN_LIBC_MACROS_H_ = "";
pub const TRUE = @as(c_int, 1);
pub const FALSE = @as(c_int, 0);
pub inline fn IS2POW(X: anytype) @TypeOf(!((X & (X - @as(c_int, 1))) != 0)) {
    _ = &X;
    return !((X & (X - @as(c_int, 1))) != 0);
}
pub inline fn ROUNDUP(X: anytype, K: anytype) @TypeOf(((X + K) - @as(c_int, 1)) & -K) {
    _ = &X;
    _ = &K;
    return ((X + K) - @as(c_int, 1)) & -K;
}
pub inline fn ROUNDDOWN(X: anytype, K: anytype) @TypeOf(X & -K) {
    _ = &X;
    _ = &K;
    return X & -K;
}
...
pub inline fn MIN(X: anytype, Y: anytype) @TypeOf(if (Y > X) X else Y) {
    _ = &X;
    _ = &Y;
    return if (Y > X) X else Y;
}
pub inline fn MAX(X: anytype, Y: anytype) @TypeOf(if (Y < X) X else Y) {
    _ = &X;
    _ = &Y;
    return if (Y < X) X else Y;
}
pub inline fn PASTE(A: anytype, B: anytype) @TypeOf(__PASTE(A, B)) {
    _ = &A;
    _ = &B;
    return __PASTE(A, B);
}
pub inline fn STRINGIFY(A: anytype) @TypeOf(__STRINGIFY(A)) {
    _ = &A;
    return __STRINGIFY(A);
}
pub inline fn EQUIVALENT(X: anytype, Y: anytype) @TypeOf((__builtin_constant_p(X == Y) != 0) and (X == Y)) {
    _ = &X;
    _ = &Y;
    return (__builtin_constant_p(X == Y) != 0) and (X == Y);
}
pub inline fn TYPE_BIT(@"type": anytype) @TypeOf(@import("std").zig.c_translation.sizeof(@"type") * CHAR_BIT) {
    _ = &@"type";
    return @import("std").zig.c_translation.sizeof(@"type") * CHAR_BIT;
}
pub inline fn TYPE_SIGNED(@"type": anytype) @TypeOf((@"type" - @as(c_int, 1)) < @as(c_int, 0)) {
    _ = &@"type";
    return (@"type" - @as(c_int, 1)) < @as(c_int, 0);
}
pub const TYPE_INTEGRAL = @compileError("unable to translate C expr: expected ')' instead got 'A number'");
// /src/cosmopolitan/libc/macros.h:44:9
pub const ARRAYLEN = @compileError("unable to translate C expr: unexpected token '*'");
// /src/cosmopolitan/libc/macros.h:46:9
pub const __STRINGIFY = @compileError("unable to translate C expr: unexpected token '#'");
// /src/cosmopolitan/libc/macros.h:49:9
pub const __PASTE = @compileError("unable to translate C expr: unexpected token '##'");
// /src/cosmopolitan/libc/macros.h:50:9
pub const CHECK = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:7:9
pub const CHECK_EQ = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:8:9
pub const CHECK_NE = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:9:9
pub const CHECK_LE = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:10:9
pub const CHECK_LT = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:11:9
pub const CHECK_GE = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:12:9
pub const CHECK_GT = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:13:9
pub const CHECK_NOTNULL = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:14:9
pub const DCHECK = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:16:9
pub const DCHECK_EQ = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:17:9
pub const DCHECK_NE = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:18:9
pub const DCHECK_LE = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:19:9
pub const DCHECK_LT = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:20:9
pub const DCHECK_GE = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:21:9
pub const DCHECK_GT = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:22:9
pub const DCHECK_NOTNULL = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:23:9
pub const CHECK_ALIGNED = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:26:9
pub const DCHECK_ALIGNED = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:36:9
pub const __CHK = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:45:9
pub const __DCHK = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:62:9
pub const __DCHK_ALIGNED = @compileError("unable to translate C expr: expected ')' instead got '...'");
// /src/cosmopolitan/libc/log/check.h:76:9
pub const COSMOPOLITAN_LIBC_SYSV_CONSTS_SA_H_ = "";
pub const SA_NOMASK = SA_NODEFER;
pub const SA_ONESHOT = SA_RESETHAND;
pub const COSMOPOLITAN_LIBC_SYSV_CONSTS_SIG_H_ = "";
...
pub const PTHREAD_STACK_MIN = @import("std").zig.c_translation.promoteIntLiteral(c_int, 32768, .decimal);
...
pub const LUA_PROMPT = ">: ";
pub const LUA_PROMPT2 = ">>: ";
pub const LUA_MAXINPUT = @as(c_int, 512);
pub const EOFMARK = "<eof>";
pub const marklen = @import("std").zig.c_translation.MacroArithmetic.div(@import("std").zig.c_translation.sizeof(EOFMARK), @import("std").zig.c_translation.sizeof(u8)) - @as(c_int, 1);
...
pub const TtyConf = struct_TtyConf;
