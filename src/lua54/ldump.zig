...
pub export fn luaU_dump(arg_L: [*c]lua_State, arg_f: [*c]const Proto, arg_w: lua_Writer, arg_data: ?*anyopaque, arg_strip: c_int) c_int {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
...
pub const DumpState = extern struct {
    L: [*c]lua_State = std.mem.zeroes([*c]lua_State),
    writer: lua_Writer = std.mem.zeroes(lua_Writer),
    data: ?*anyopaque = std.mem.zeroes(?*anyopaque),
    strip: c_int = std.mem.zeroes(c_int),
    status: c_int = std.mem.zeroes(c_int),
};
pub fn dumpBlock(arg_D: [*c]DumpState, arg_b: ?*const anyopaque, arg_size: usize) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var b = arg_b;
    _ = &b;
    var size = arg_size;
    _ = &size;
    if ((D.*.status == @as(c_int, 0)) and (size > @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        _ = @as(c_int, 0);
        D.*.status = D.*.writer.?(D.*.L, b, size, D.*.data);
        _ = @as(c_int, 0);
    }
}
pub fn dumpByte(arg_D: [*c]DumpState, arg_y: c_int) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var y = arg_y;
    _ = &y;
    var x: lu_byte = @as(lu_byte, @bitCast(@as(i8, @truncate(y))));
    _ = &x;
    dumpBlock(D, @as(?*const anyopaque, @ptrCast(&x)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))) *% @sizeOf(lu_byte));
}
pub fn dumpSize(arg_D: [*c]DumpState, arg_x: usize) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var x = arg_x;
    _ = &x;
    var buff: [10]lu_byte = undefined;
    _ = &buff;
    var n: c_int = 0;
    _ = &n;
    while (true) {
        buff[(((@sizeOf(usize) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) +% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 6))))) / @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 7))))) -% @as(c_ulong, @bitCast(@as(c_long, blk: {
            const ref = &n;
            ref.* += 1;
            break :blk ref.*;
        })))] = @as(lu_byte, @bitCast(@as(u8, @truncate(x & @as(usize, @bitCast(@as(c_long, @as(c_int, 127))))))));
        x >>= @intCast(@as(c_int, 7));
        if (!(x != @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))))) break;
    }
    buff[(((@sizeOf(usize) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) +% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 6))))) / @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 7))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))] |= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 128)))));
    dumpBlock(D, @as(?*const anyopaque, @ptrCast((@as([*c]lu_byte, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))) + (((@sizeOf(usize) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) +% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 6))))) / @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 7)))))) - @as(usize, @bitCast(@as(isize, @intCast(n)))))), @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(lu_byte));
}
pub fn dumpInt(arg_D: [*c]DumpState, arg_x: c_int) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var x = arg_x;
    _ = &x;
    dumpSize(D, @as(usize, @bitCast(@as(c_long, x))));
}
pub fn dumpNumber(arg_D: [*c]DumpState, arg_x: lua_Number) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var x = arg_x;
    _ = &x;
    dumpBlock(D, @as(?*const anyopaque, @ptrCast(&x)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))) *% @sizeOf(lua_Number));
}
pub fn dumpInteger(arg_D: [*c]DumpState, arg_x: lua_Integer) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var x = arg_x;
    _ = &x;
    dumpBlock(D, @as(?*const anyopaque, @ptrCast(&x)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))) *% @sizeOf(lua_Integer));
}
pub fn dumpString(arg_D: [*c]DumpState, arg_s: [*c]const TString) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var s = arg_s;
    _ = &s;
    if (s == @as([*c]const TString, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        dumpSize(D, @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))));
    } else {
        var size: usize = if (@as(c_int, @bitCast(@as(c_uint, s.*.tt))) == (@as(c_int, 4) | (@as(c_int, 0) << @intCast(4)))) @as(usize, @bitCast(@as(c_ulong, s.*.shrlen))) else s.*.u.lnglen;
        _ = &size;
        var str: [*c]const u8 = @as([*c]const u8, @ptrCast(@alignCast(&s.*.contents[@as(usize, @intCast(0))])));
        _ = &str;
        dumpSize(D, size +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1)))));
        dumpBlock(D, @as(?*const anyopaque, @ptrCast(str)), size *% @sizeOf(u8));
    }
}
pub fn dumpCode(arg_D: [*c]DumpState, arg_f: [*c]const Proto) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var f = arg_f;
    _ = &f;
    dumpInt(D, f.*.sizecode);
    dumpBlock(D, @as(?*const anyopaque, @ptrCast(f.*.code)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizecode))) *% @sizeOf(Instruction));
}
pub fn dumpFunction(arg_D: [*c]DumpState, arg_f: [*c]const Proto, arg_psource: [*c]TString) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var f = arg_f;
    _ = &f;
    ...
    _ = &psource;
    if ((D.*.strip != 0) or (f.*.source == psource)) {
        dumpString(D, null);
    } else {
    ...
    dumpByte(D, @as(c_int, @bitCast(@as(c_uint, f.*.numparams))));
    dumpByte(D, @as(c_int, @bitCast(@as(c_uint, f.*.is_vararg))));
    dumpByte(D, @as(c_int, @bitCast(@as(c_uint, f.*.maxstacksize))));
    dumpCode(D, f);
    dumpConstants(D, f);
    dumpUpvalues(D, f);
    dumpProtos(D, f);
...
pub fn dumpConstants(arg_D: [*c]DumpState, arg_f: [*c]const Proto) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var f = arg_f;
    _ = &f;
    ...
    dumpInt(D, n);
    {
        ...
        while (i < n) : (i += 1) {
            ...
            _ = &o;
            var tt: c_int = @as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 63);
            _ = &tt;
            dumpByte(D, tt);
            while (true) {
                switch (tt) {
...
pub fn dumpProtos(arg_D: [*c]DumpState, arg_f: [*c]const Proto) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var f = arg_f;
    _ = &f;
...
pub fn dumpUpvalues(arg_D: [*c]DumpState, arg_f: [*c]const Proto) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var f = arg_f;
    _ = &f;
    var i: c_int = undefined;
    _ = &i;
    var n: c_int = f.*.sizeupvalues;
    _ = &n;
    dumpInt(D, n);
    {
        i = 0;
        while (i < n) : (i += 1) {
            dumpByte(D, @as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
...
pub fn dumpDebug(arg_D: [*c]DumpState, arg_f: [*c]const Proto) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    var f = arg_f;
    _ = &f;
    ...
    _ = &n;
    n = if (D.*.strip != 0) @as(c_int, 0) else f.*.sizelineinfo;
    dumpInt(D, n);
    dumpBlock(D, @as(?*const anyopaque, @ptrCast(f.*.lineinfo)), @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(ls_byte));
    n = if (D.*.strip != 0) @as(c_int, 0) else f.*.sizeabslineinfo;
    dumpInt(D, n);
    {
        i = 0;
        while (i < n) : (i += 1) {
    ...
    n = if (D.*.strip != 0) @as(c_int, 0) else f.*.sizelocvars;
    dumpInt(D, n);
    {
        i = 0;
        while (i < n) : (i += 1) {
    ...
    n = if (D.*.strip != 0) @as(c_int, 0) else f.*.sizeupvalues;
    dumpInt(D, n);
    {
        i = 0;
        while (i < n) : (i += 1) {
...
pub fn dumpHeader(arg_D: [*c]DumpState) callconv(.c) void {
    var D = arg_D;
    _ = &D;
    dumpBlock(D, @as(?*const anyopaque, @ptrCast("\x1bLua")), @sizeOf([5]u8) -% @sizeOf(u8));
    dumpByte(D, ((@as(c_int, @bitCast(@as(c_uint, "5"[@as(c_uint, @intCast(@as(c_int, 0)))]))) - @as(c_int, '0')) * @as(c_int, 16)) + (@as(c_int, @bitCast(@as(c_uint, "4"[@as(c_uint, @intCast(@as(c_int, 0)))]))) - @as(c_int, '0')));
    dumpByte(D, @as(c_int, 0));
    dumpBlock(D, @as(?*const anyopaque, @ptrCast("\x19\x93\r\n\x1a\n")), @sizeOf([7]u8) -% @sizeOf(u8));
    dumpByte(D, @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(Instruction))))));
    dumpByte(D, @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(lua_Integer))))));
    dumpByte(D, @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(lua_Number))))));
    dumpInteger(D, @as(lua_Integer, @bitCast(@as(c_longlong, @as(c_int, 22136)))));
    dumpNumber(D, @as(lua_Number, @floatCast(370.5)));
}
...
pub const dumpVector = @compileError("unable to translate C expr: unexpected token '('");
// /src/cosmopolitan/third_party/lua/ldump.c:52:9
pub inline fn dumpLiteral(D: anytype, s: anytype) @TypeOf(dumpBlock(D, s, @import("std").zig.c_translation.sizeof(s) - @import("std").zig.c_translation.sizeof(u8))) {
    _ = &D;
    _ = &s;
    return dumpBlock(D, s, @import("std").zig.c_translation.sizeof(s) - @import("std").zig.c_translation.sizeof(u8));
}
pub inline fn dumpVar(D: anytype, x: anytype) @TypeOf(dumpVector(D, &x, @as(c_int, 1))) {
    _ = &D;
    _ = &x;
    return dumpVector(D, &x, @as(c_int, 1));
}
pub const DIBS = @import("std").zig.c_translation.MacroArithmetic.div((@import("std").zig.c_translation.sizeof(usize) * CHAR_BIT) + @as(c_int, 6), @as(c_int, 7));
