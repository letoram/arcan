...
pub export fn luaU_undump(arg_L: [*c]lua_State, arg_Z: [*c]ZIO, arg_name: [*c]const u8) [*c]LClosure {
    var L = arg_L;
    _ = &L;
    var Z = arg_Z;
    _ = &Z;
    var name = arg_name;
    _ = &name;
    var S: LoadState = undefined;
    _ = &S;
    var cl: [*c]LClosure = undefined;
    _ = &cl;
    if ((@as(c_int, @bitCast(@as(c_uint, name.*))) == @as(c_int, '@')) or (@as(c_int, @bitCast(@as(c_uint, name.*))) == @as(c_int, '='))) {
        S.name = name + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    } else if (@as(c_int, @bitCast(@as(c_uint, name.*))) == @as(c_int, @bitCast(@as(c_uint, "\x1bLua"[@as(c_uint, @intCast(@as(c_int, 0)))])))) {
    ...
    S.Z = Z;
    checkHeader(&S);
    cl = luaF_newLclosure(L, @as(c_int, @bitCast(@as(c_uint, loadByte(&S)))));
    {
        var io: [*c]TValue = &L.*.top.p.*.val;
        _ = &io;
        var x_: [*c]LClosure = cl;
        _ = &x_;
        io.*.value_.gc = blk: {
            _ = @as(c_int, 0);
        ...
        _ = blk: {
            const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, 6) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))));
            io.*.tt_ = tmp;
            break :blk tmp;
        };
        _ = blk: {
    ...
    _ = if (((@as(c_int, @bitCast(@as(c_uint, cl.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, cl.*.p.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(L, blk: {
        _ = @as(c_int, 0);
        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(cl))).*.gc;
    }, blk: {
        _ = @as(c_int, 0);
...
pub const LoadState = extern struct {
    L: [*c]lua_State = std.mem.zeroes([*c]lua_State),
    Z: [*c]ZIO = std.mem.zeroes([*c]ZIO),
    name: [*c]const u8 = std.mem.zeroes([*c]const u8),
};
pub fn @"error"(arg_S: [*c]LoadState, arg_why: [*c]const u8) callconv(.c) noreturn {
    var S = arg_S;
    _ = &S;
    var why = arg_why;
    _ = &why;
    {
        ...
        const result = std.fmt.bufPrintZ(&fmtbuf, "{s}: bad binary format ({s})", .{
            std.mem.span(@as([*:0]const u8, @ptrCast(S.*.name))),
            std.mem.span(@as([*:0]const u8, @ptrCast(why))),
        }) catch "?: bad binary format (?)";
        _ = lua_pushstring(S.*.L, result);
    }
    luaD_throw(S.*.L, @as(c_int, 3));
}
pub fn loadBlock(arg_S: [*c]LoadState, arg_b: ?*anyopaque, arg_size: usize) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var b = arg_b;
    _ = &b;
    var size = arg_size;
    _ = &size;
    if (luaZ_read(S.*.Z, b, size) != @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) {
        @"error"(S, "truncated chunk");
    }
}
pub fn loadByte(arg_S: [*c]LoadState) callconv(.c) lu_byte {
    var S = arg_S;
    _ = &S;
    var b: c_int = if ((blk: {
        const ref = &S.*.Z.*.n;
    ...
    return @as(lu_byte, @bitCast(@as(i8, @truncate(b))));
}
pub fn loadUnsigned(arg_S: [*c]LoadState, arg_limit: usize) callconv(.c) usize {
    var S = arg_S;
    _ = &S;
    var limit = arg_limit;
    _ = &limit;
    ...
    _ = &b;
    limit >>= @intCast(@as(c_int, 7));
    while (true) {
        b = @as(c_int, @bitCast(@as(c_uint, loadByte(S))));
        if (x >= limit) {
            @"error"(S, "integer overflow");
        }
        x = (x << @intCast(7)) | @as(usize, @bitCast(@as(c_long, b & @as(c_int, 127))));
        if (!((b & @as(c_int, 128)) == @as(c_int, 0))) break;
    }
    return x;
}
pub fn loadSize(arg_S: [*c]LoadState) callconv(.c) usize {
    var S = arg_S;
    _ = &S;
    return loadUnsigned(S, ~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))));
}
pub fn loadInt(arg_S: [*c]LoadState) callconv(.c) c_int {
    var S = arg_S;
    _ = &S;
    return @as(c_int, @bitCast(@as(c_uint, @truncate(loadUnsigned(S, @as(usize, @bitCast(@as(c_long, @as(c_int, 2147483647)))))))));
}
pub fn loadNumber(arg_S: [*c]LoadState) callconv(.c) lua_Number {
    var S = arg_S;
    _ = &S;
    var x: lua_Number = undefined;
    _ = &x;
    loadBlock(S, @as(?*anyopaque, @ptrCast(&x)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))) *% @sizeOf(lua_Number));
    return x;
}
pub fn loadInteger(arg_S: [*c]LoadState) callconv(.c) lua_Integer {
    var S = arg_S;
    _ = &S;
    var x: lua_Integer = undefined;
    _ = &x;
    loadBlock(S, @as(?*anyopaque, @ptrCast(&x)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))) *% @sizeOf(lua_Integer));
    return x;
}
pub fn loadStringN(arg_S: [*c]LoadState, arg_p: [*c]Proto) callconv(.c) [*c]TString {
    var S = arg_S;
    _ = &S;
    var p = arg_p;
    _ = &p;
    var L: [*c]lua_State = S.*.L;
    _ = &L;
    var ts: [*c]TString = undefined;
    _ = &ts;
    var size: usize = loadSize(S);
    _ = &size;
    if (size == @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) return null else if ((blk: {
        const ref = &size;
        ref.* -%= 1;
        break :blk ref.*;
    }) <= @as(usize, @bitCast(@as(c_long, @as(c_int, 40))))) {
        var buff: [40]u8 = undefined;
        _ = &buff;
        loadBlock(S, @as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))))), size *% @sizeOf(u8));
        ts = luaS_newlstr(L, @as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))), size);
    } else {
        ...
        luaD_inctop(L);
        loadBlock(S, @as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&ts.*.contents[@as(usize, @intCast(0))]))))), size *% @sizeOf(u8));
        L.*.top.p -= 1;
    }
    _ = if (((@as(c_int, @bitCast(@as(c_uint, p.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, ts.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(L, blk: {
        _ = @as(c_int, 0);
        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(p))).*.gc;
    }, blk: {
        _ = @as(c_int, 0);
...
pub fn loadString(arg_S: [*c]LoadState, arg_p: [*c]Proto) callconv(.c) [*c]TString {
    var S = arg_S;
    _ = &S;
    var p = arg_p;
    _ = &p;
    var st: [*c]TString = loadStringN(S, p);
    _ = &st;
    if (st == @as([*c]TString, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        @"error"(S, "bad format for constant string");
    }
    return st;
}
pub fn loadCode(arg_S: [*c]LoadState, arg_f: [*c]Proto) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var f = arg_f;
    _ = &f;
    var n: c_int = loadInt(S);
    _ = &n;
    f.*.code = blk: {
        _ = if ((@sizeOf(c_int) >= @sizeOf(usize)) and ((@as(usize, @bitCast(@as(c_long, n))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) > (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(Instruction)))) luaM_toobig(S.*.L) else @as(c_int, 0);
        break :blk @as([*c]Instruction, @ptrCast(@alignCast(luaM_malloc_(S.*.L, @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(Instruction), @as(c_int, 0)))));
    };
    f.*.sizecode = n;
    loadBlock(S, @as(?*anyopaque, @ptrCast(f.*.code)), @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(Instruction));
}
pub fn loadFunction(arg_S: [*c]LoadState, arg_f: [*c]Proto, arg_psource: [*c]TString) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var f = arg_f;
    _ = &f;
    var psource = arg_psource;
    _ = &psource;
    f.*.source = loadStringN(S, f);
    if (f.*.source == @as([*c]TString, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        f.*.source = psource;
    }
...
pub fn loadConstants(arg_S: [*c]LoadState, arg_f: [*c]Proto) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var f = arg_f;
    _ = &f;
    ...
    _ = &n;
    f.*.k = blk: {
        _ = if ((@sizeOf(c_int) >= @sizeOf(usize)) and ((@as(usize, @bitCast(@as(c_long, n))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) > (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(TValue)))) luaM_toobig(S.*.L) else @as(c_int, 0);
        break :blk @as([*c]TValue, @ptrCast(@alignCast(luaM_malloc_(S.*.L, @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(TValue), @as(c_int, 0)))));
    };
    f.*.sizek = n;
    {
        i = 0;
    ...
    }
    {
        ...
        while (i < n) : (i += 1) {
            ...
            _ = &o;
            var t: c_int = @as(c_int, @bitCast(@as(c_uint, loadByte(S))));
            _ = &t;
            while (true) {
                switch (t) {
                    @as(c_int, 0) => {
                    ...
                    @as(c_int, 4), @as(c_int, 20) => {
                        {
                            var io: [*c]TValue = o;
                            _ = &io;
                            var x_: [*c]TString = loadString(S, f);
                            _ = &x_;
                            io.*.value_.gc = blk: {
                                _ = @as(c_int, 0);
                                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
                            ...
                            _ = blk: {
                                ...
                                break :blk if (!((@as(c_int, @bitCast(@as(c_uint, io.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) or (((@as(c_int, @bitCast(@as(c_uint, io.*.tt_))) & @as(c_int, 63)) == @as(c_int, @bitCast(@as(c_uint, (blk_1: {
                                    _ = @as(c_int, 0);
                                    break :blk_1 io.*.value_.gc;
                                }).*.tt)))) and ((S.*.L == @as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, (blk_1: {
                                    _ = @as(c_int, 0);
                                    break :blk_1 io.*.value_.gc;
                                }).*.marked))) & (@as(c_int, @bitCast(@as(c_uint, S.*.L.*.l_G.*.currentwhite))) ^ ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))) != 0)))) @as(c_int, 0) else @as(c_int, 0);
                            };
                        }
                        break;
                    },
...
pub fn loadProtos(arg_S: [*c]LoadState, arg_f: [*c]Proto) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var f = arg_f;
    _ = &f;
    ...
    _ = &n;
    f.*.p = blk: {
        _ = if ((@sizeOf(c_int) >= @sizeOf(usize)) and ((@as(usize, @bitCast(@as(c_long, n))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) > (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf([*c]Proto)))) luaM_toobig(S.*.L) else @as(c_int, 0);
        break :blk @as([*c][*c]Proto, @ptrCast(@alignCast(luaM_malloc_(S.*.L, @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf([*c]Proto), @as(c_int, 0)))));
    };
    f.*.sizep = n;
    {
        i = 0;
    ...
    }
    {
        ...
        while (i < n) : (i += 1) {
            ...
            _ = if (((@as(c_int, @bitCast(@as(c_uint, f.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk f.*.p + @as(usize, @intCast(tmp)) else break :blk f.*.p - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(S.*.L, blk: {
                _ = @as(c_int, 0);
...
pub fn loadUpvalues(arg_S: [*c]LoadState, arg_f: [*c]Proto) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var f = arg_f;
    _ = &f;
    ...
    n = loadInt(S);
    f.*.upvalues = blk: {
        _ = if ((@sizeOf(c_int) >= @sizeOf(usize)) and ((@as(usize, @bitCast(@as(c_long, n))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) > (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(Upvaldesc)))) luaM_toobig(S.*.L) else @as(c_int, 0);
        break :blk @as([*c]Upvaldesc, @ptrCast(@alignCast(luaM_malloc_(S.*.L, @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(Upvaldesc), @as(c_int, 0)))));
    };
    f.*.sizeupvalues = n;
    {
        i = 0;
...
pub fn loadDebug(arg_S: [*c]LoadState, arg_f: [*c]Proto) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var f = arg_f;
    _ = &f;
    ...
    n = loadInt(S);
    f.*.lineinfo = blk: {
        _ = if ((@sizeOf(c_int) >= @sizeOf(usize)) and ((@as(usize, @bitCast(@as(c_long, n))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) > (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(ls_byte)))) luaM_toobig(S.*.L) else @as(c_int, 0);
        break :blk @as([*c]ls_byte, @ptrCast(@alignCast(luaM_malloc_(S.*.L, @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(ls_byte), @as(c_int, 0)))));
    };
    f.*.sizelineinfo = n;
    loadBlock(S, @as(?*anyopaque, @ptrCast(f.*.lineinfo)), @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(ls_byte));
    n = loadInt(S);
    f.*.abslineinfo = blk: {
        _ = if ((@sizeOf(c_int) >= @sizeOf(usize)) and ((@as(usize, @bitCast(@as(c_long, n))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) > (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(AbsLineInfo)))) luaM_toobig(S.*.L) else @as(c_int, 0);
        break :blk @as([*c]AbsLineInfo, @ptrCast(@alignCast(luaM_malloc_(S.*.L, @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(AbsLineInfo), @as(c_int, 0)))));
    };
    f.*.sizeabslineinfo = n;
    {
        i = 0;
    ...
    n = loadInt(S);
    f.*.locvars = blk: {
        _ = if ((@sizeOf(c_int) >= @sizeOf(usize)) and ((@as(usize, @bitCast(@as(c_long, n))) +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) > (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(LocVar)))) luaM_toobig(S.*.L) else @as(c_int, 0);
        break :blk @as([*c]LocVar, @ptrCast(@alignCast(luaM_malloc_(S.*.L, @as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(LocVar), @as(c_int, 0)))));
    };
    f.*.sizelocvars = n;
    {
        i = 0;
    ...
    }
    {
        ...
        while (i < n) : (i += 1) {
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk f.*.upvalues + @as(usize, @intCast(tmp)) else break :blk f.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.name = loadStringN(S, f);
        }
    }
}
pub fn checkliteral(arg_S: [*c]LoadState, arg_s: [*c]const u8, arg_msg: [*c]const u8) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var s = arg_s;
    _ = &s;
    ...
    _ = &len;
    loadBlock(S, @as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))))), len *% @sizeOf(u8));
    if (memcmp(@as(?*const anyopaque, @ptrCast(s)), @as(?*const anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))))), len) != @as(c_int, 0)) {
        @"error"(S, msg);
    }
}
pub fn fchecksize(arg_S: [*c]LoadState, arg_size: usize, arg_tname: [*c]const u8) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    var size = arg_size;
    _ = &size;
    var tname = arg_tname;
    _ = &tname;
    if (@as(usize, @bitCast(@as(c_ulong, loadByte(S)))) != size) {
        {
            var fmtbuf: [512]u8 = undefined;
            const result = std.fmt.bufPrintZ(&fmtbuf, "{s} size mismatch", .{
                std.mem.span(@as([*:0]const u8, @ptrCast(tname))),
            }) catch "? size mismatch";
            @"error"(S, lua_pushstring(S.*.L, result));
        }
    }
}
pub fn checkHeader(arg_S: [*c]LoadState) callconv(.c) void {
    var S = arg_S;
    _ = &S;
    checkliteral(S, &"\x1bLua"[@as(c_uint, @intCast(@as(c_int, 1)))], "not a binary chunk");
    if (@as(c_int, @bitCast(@as(c_uint, loadByte(S)))) != (((@as(c_int, @bitCast(@as(c_uint, "5"[@as(c_uint, @intCast(@as(c_int, 0)))]))) - @as(c_int, '0')) * @as(c_int, 16)) + (@as(c_int, @bitCast(@as(c_uint, "4"[@as(c_uint, @intCast(@as(c_int, 0)))]))) - @as(c_int, '0')))) {
        @"error"(S, "version mismatch");
    }
    if (@as(c_int, @bitCast(@as(c_uint, loadByte(S)))) != @as(c_int, 0)) {
    ...
    if (loadInteger(S) != @as(lua_Integer, @bitCast(@as(c_longlong, @as(c_int, 22136))))) {
        @"error"(S, "integer format mismatch");
    }
    if (loadNumber(S) != @as(lua_Number, @floatCast(370.5))) {
...
pub const luai_verifycode = @compileError("unable to translate C expr: unexpected token ''");
// /src/cosmopolitan/third_party/lua/lundump.c:46:9
pub const loadVector = @compileError("unable to translate C expr: unexpected token '('");
// /src/cosmopolitan/third_party/lua/lundump.c:67:9
pub inline fn loadVar(S: anytype, x: anytype) @TypeOf(loadVector(S, &x, @as(c_int, 1))) {
    _ = &S;
    _ = &x;
    return loadVector(S, &x, @as(c_int, 1));
}
pub const checksize = @compileError("unable to translate C expr: unexpected token '#'");
// /src/cosmopolitan/third_party/lua/lundump.c:307:9
