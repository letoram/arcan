...
pub export fn luaopen_io(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    _ = blk: {
        _ = blk_1: {
...
pub fn l_checkmode(arg_mode: [*c]const u8) callconv(.c) c_int {
    var mode = arg_mode;
    _ = &mode;
    return @intFromBool((((@as(c_int, @bitCast(@as(c_uint, mode.*))) != @as(c_int, '\x00')) and (strchr("rwa", @as(c_int, @bitCast(@as(c_uint, (blk: {
        const ref = &mode;
        const tmp = ref.*;
        ref.* += 1;
        break :blk tmp;
    }).*)))) != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and ((@as(c_int, @bitCast(@as(c_uint, mode.*))) != @as(c_int, '+')) or ((blk: {
        _ = blk_1: {
            const ref = &mode;
            ref.* += 1;
            break :blk_1 ref.*;
    ...
    }) != 0))) and (strspn(mode, "b") == strlen(mode)));
}
pub const LStream = luaL_Stream;
pub fn io_type(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = undefined;
    _ = &p;
    luaL_checkany(L, @as(c_int, 1));
    p = @as([*c]LStream, @ptrCast(@alignCast(luaL_testudata(L, @as(c_int, 1), "FILE*"))));
    if (p == @as([*c]LStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        lua_pushnil(L);
    } else if (p.*.closef == @as(lua_CFunction, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        _ = lua_pushstring(L, "closed file");
    } else {
        _ = lua_pushstring(L, "file");
    }
    return 1;
}
pub fn f_tostring(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(luaL_checkudata(L, @as(c_int, 1), "FILE*"))));
    _ = &p;
    if (p.*.closef == @as(lua_CFunction, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        _ = lua_pushstring(L, "file (closed)");
    } else {
        {
            var fmtbuf: [64]u8 = undefined;
            const result = std.fmt.bufPrintZ(&fmtbuf, "file (0x{x})", .{
                @intFromPtr(p.*.f),
            }) catch "file (0x0)";
...
pub fn tofile(arg_L: ?*lua_State) callconv(.c) ?*FILE {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(luaL_checkudata(L, @as(c_int, 1), "FILE*"))));
    _ = &p;
...
pub fn newprefile(arg_L: ?*lua_State) callconv(.c) [*c]LStream {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(lua_newuserdatauv(L, @sizeOf(LStream), @as(c_int, 0)))));
    _ = &p;
    p.*.closef = null;
    luaL_setmetatable(L, "FILE*");
    return p;
}
pub fn aux_close(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(luaL_checkudata(L, @as(c_int, 1), "FILE*"))));
    _ = &p;
    var cf: lua_CFunction = p.*.closef;
    _ = &cf;
    p.*.closef = null;
    return cf.?(L);
}
pub fn f_close(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    _ = tofile(L);
    return aux_close(L);
}
pub fn io_close(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    if (lua_type(L, @as(c_int, 1)) == -@as(c_int, 1)) {
        _ = lua_getfield(L, -@as(c_int, 1000000) - @as(c_int, 1000), "_IO_output");
    }
    return f_close(L);
}
pub fn f_gc(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(luaL_checkudata(L, @as(c_int, 1), "FILE*"))));
    _ = &p;
    if (!(p.*.closef == @as(lua_CFunction, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (p.*.f != @as(?*FILE, @ptrCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        _ = aux_close(L);
    }
    return 0;
}
pub fn io_fclose(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(luaL_checkudata(L, @as(c_int, 1), "FILE*"))));
    _ = &p;
    var res: c_int = fclose(p.*.f);
    _ = &res;
    return luaL_fileresult(L, @intFromBool(res == @as(c_int, 0)), null);
}
pub fn newfile(arg_L: ?*lua_State) callconv(.c) [*c]LStream {
    var L = arg_L;
    _ = &L;
...
// /src/cosmopolitan/third_party/lua/liolib.c:276:13: warning: unable to translate function, demoted to extern
pub extern fn opencheck(arg_L: ?*lua_State, arg_fname: [*c]const u8, arg_mode: [*c]const u8) callconv(.c) void;
pub fn io_open(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var filename: [*c]const u8 = luaL_checklstring(L, @as(c_int, 1), null);
    _ = &filename;
    var mode: [*c]const u8 = luaL_optlstring(L, @as(c_int, 2), "r", null);
    _ = &mode;
    var p: [*c]LStream = newfile(L);
    _ = &p;
...
// /src/cosmopolitan/third_party/lua/liolib.c:298:12: warning: unable to translate function, demoted to extern
pub extern fn io_pclose(arg_L: ?*lua_State) callconv(.c) c_int;
pub fn io_popen(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var filename: [*c]const u8 = luaL_checklstring(L, @as(c_int, 1), null);
    _ = &filename;
...
pub fn io_tmpfile(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = newfile(L);
    _ = &p;
    p.*.f = tmpfile();
    return if (p.*.f == @as(?*FILE, @ptrCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))) luaL_fileresult(L, @as(c_int, 0), null) else @as(c_int, 1);
}
pub fn getiofile(arg_L: ?*lua_State, arg_findex: [*c]const u8) callconv(.c) ?*FILE {
    var L = arg_L;
    _ = &L;
...
pub fn g_iofile(arg_L: ?*lua_State, arg_f: [*c]const u8, arg_mode: [*c]const u8) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    if (!(lua_type(L, @as(c_int, 1)) <= @as(c_int, 0))) {
        var filename: [*c]const u8 = lua_tolstring(L, @as(c_int, 1), null);
        _ = &filename;
        if (filename != null) {
        ...
        lua_setfield(L, -@as(c_int, 1000000) - @as(c_int, 1000), f);
    }
    _ = lua_getfield(L, -@as(c_int, 1000000) - @as(c_int, 1000), f);
    return 1;
}
pub fn io_input(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return g_iofile(L, "_IO_input", "r");
}
pub fn io_output(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return g_iofile(L, "_IO_output", "w");
}
pub fn io_readline(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(lua_touserdata(L, (-@as(c_int, 1000000) - @as(c_int, 1000)) - @as(c_int, 1)))));
    _ = &p;
    var i: c_int = undefined;
    _ = &i;
    var n: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(lua_tointegerx(L, (-@as(c_int, 1000000) - @as(c_int, 1000)) - @as(c_int, 2), null)))));
    _ = &n;
    if (p.*.closef == @as(lua_CFunction, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return luaL_error(L, "file is already closed");
    lua_settop(L, @as(c_int, 1));
    luaL_checkstack(L, n, "too many arguments");
    {
        i = 1;
        while (i <= n) : (i += 1) {
            lua_pushvalue(L, (-@as(c_int, 1000000) - @as(c_int, 1000)) - (@as(c_int, 3) + i));
        }
    }
    n = g_read(L, p.*.f, @as(c_int, 2));
    _ = @as(c_int, 0);
    if (lua_toboolean(L, -n) != 0) return n else {
        if (n > @as(c_int, 1)) {
            return luaL_error(L, "%s", lua_tolstring(L, -n + @as(c_int, 1), null));
        }
        if (lua_toboolean(L, (-@as(c_int, 1000000) - @as(c_int, 1000)) - @as(c_int, 3)) != 0) {
            lua_settop(L, @as(c_int, 0));
            lua_pushvalue(L, (-@as(c_int, 1000000) - @as(c_int, 1000)) - @as(c_int, 1));
            _ = aux_close(L);
        }
        return 0;
    }
...
pub fn aux_lines(arg_L: ?*lua_State, arg_toclose: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var toclose = arg_toclose;
    _ = &toclose;
    ...
    lua_rotate(L, @as(c_int, 2), @as(c_int, 3));
    lua_pushcclosure(L, &io_readline, @as(c_int, 3) + n);
}
pub fn f_lines(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    _ = tofile(L);
    aux_lines(L, @as(c_int, 0));
    return 1;
}
pub fn io_lines(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var toclose: c_int = undefined;
    _ = &toclose;
    if (lua_type(L, @as(c_int, 1)) == -@as(c_int, 1)) {
        lua_pushnil(L);
    }
    if (lua_type(L, @as(c_int, 1)) == @as(c_int, 0)) {
        _ = lua_getfield(L, -@as(c_int, 1000000) - @as(c_int, 1000), "_IO_input");
        _ = blk: {
            lua_copy(L, -@as(c_int, 1), @as(c_int, 1));
...
pub const RN = extern struct {
    f: ?*FILE = std.mem.zeroes(?*FILE),
    c: c_int = std.mem.zeroes(c_int),
    n: c_int = std.mem.zeroes(c_int),
    buff: [201]u8 = std.mem.zeroes([201]u8),
};
pub fn nextc(arg_rn: [*c]RN) callconv(.c) c_int {
    ...
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(rn.*.n >= @as(c_int, 200)) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
        ...
        rn.*.buff[@as(c_uint, @intCast(blk: {
            const ref = &rn.*.n;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }))] = @as(u8, @bitCast(@as(i8, @truncate(rn.*.c))));
        rn.*.c = getc_unlocked(rn.*.f);
        return 1;
    }
    return 0;
}
pub fn test2(arg_rn: [*c]RN, arg_set: [*c]const u8) callconv(.c) c_int {
    var rn = arg_rn;
    _ = &rn;
    var set = arg_set;
    _ = &set;
    if ((rn.*.c == @as(c_int, @bitCast(@as(c_uint, set[@as(c_uint, @intCast(@as(c_int, 0)))])))) or (rn.*.c == @as(c_int, @bitCast(@as(c_uint, set[@as(c_uint, @intCast(@as(c_int, 1)))]))))) return nextc(rn) else return 0;
    return 0;
}
pub fn readdigits(arg_rn: [*c]RN, arg_hex: c_int) callconv(.c) c_int {
    var rn = arg_rn;
    _ = &rn;
    var hex = arg_hex;
    _ = &hex;
    var count: c_int = 0;
    _ = &count;
    while (((if (hex != 0) isxdigit(rn.*.c) else isdigit(rn.*.c)) != 0) and (nextc(rn) != 0)) {
        count += 1;
    }
    return count;
}
pub fn read_number(arg_L: ?*lua_State, arg_f: ?*FILE) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    var hex: c_int = 0;
    _ = &hex;
    var decp: [2]u8 = undefined;
    _ = &decp;
    rn.f = f;
    rn.n = 0;
    decp[@as(c_uint, @intCast(@as(c_int, 0)))] = localeconv().*.decimal_point[@as(c_uint, @intCast(@as(c_int, 0)))];
    decp[@as(c_uint, @intCast(@as(c_int, 1)))] = '.';
    flockfile(rn.f);
    while (true) {
        rn.c = getc_unlocked(rn.f);
        if (!(isspace(rn.c) != 0)) break;
    }
    _ = test2(&rn, "-+");
    if (test2(&rn, "00") != 0) {
        if (test2(&rn, "xX") != 0) {
    ...
    if (test2(&rn, @as([*c]u8, @ptrCast(@alignCast(&decp[@as(usize, @intCast(0))])))) != 0) {
        count += readdigits(&rn, hex);
    }
    if ((count > @as(c_int, 0)) and (test2(&rn, if (hex != 0) "pP" else "eE") != 0)) {
        _ = test2(&rn, "-+");
        _ = readdigits(&rn, @as(c_int, 0));
    }
    _ = ungetc(rn.c, rn.f);
    funlockfile(rn.f);
...
pub fn test_eof(arg_L: ?*lua_State, arg_f: ?*FILE) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    _ = ungetc(c, f);
    _ = lua_pushstring(L, "");
    return @intFromBool(c != -@as(c_int, 1));
}
pub fn read_line(arg_L: ?*lua_State, arg_f: ?*FILE, arg_chop: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    luaL_pushresult(&b);
    return @intFromBool((c == @as(c_int, '\n')) or (lua_rawlen(L, -@as(c_int, 1)) > @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 0))))));
}
pub fn read_all(arg_L: ?*lua_State, arg_f: ?*FILE) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    var nr: usize = undefined;
    _ = &nr;
    var b: luaL_Buffer = undefined;
    _ = &b;
    luaL_buffinit(L, &b);
...
pub fn read_chars(arg_L: ?*lua_State, arg_f: ?*FILE, arg_n: usize) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    nr = fread(@as(?*anyopaque, @ptrCast(p)), @sizeOf(u8), n, f);
    _ = blk: {
        const ref = &(&b).*.n;
        ref.* +%= nr;
        break :blk ref.*;
...
pub fn g_read(arg_L: ?*lua_State, arg_f: ?*FILE, arg_first: c_int) callconv(.c) c_int {
    ...
    var first = arg_first;
    _ = &first;
    var nargs: c_int = lua_gettop(L) - @as(c_int, 1);
    _ = &nargs;
    ...
    clearerr(f);
    if (nargs == @as(c_int, 0)) {
        success = read_line(L, f, @as(c_int, 1));
        n = first + @as(c_int, 1);
    } else {
        luaL_checkstack(L, nargs + @as(c_int, 20), "too many arguments");
        success = 1;
        {
            n = first;
            while (((blk: {
                ...
                if (lua_type(L, n) == @as(c_int, 3)) {
                    ...
                    while (true) {
                        switch (@as(c_int, @bitCast(@as(c_uint, p.*)))) {
                            ...
                            @as(c_int, 76) => {
                                success = read_line(L, f, @as(c_int, 0));
                                break;
                            },
                            @as(c_int, 97) => {
                                read_all(L, f);
                            ...
                            else => return luaL_argerror(L, n, "invalid format"),
                        }
                        break;
                    }
                }
    ...
    if (ferror(f) != 0) return luaL_fileresult(L, @as(c_int, 0), null);
    if (!(success != 0)) {
...
pub fn io_read(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return g_read(L, getiofile(L, "_IO_input"), @as(c_int, 1));
}
pub fn f_read(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return g_read(L, tofile(L), @as(c_int, 2));
}
pub fn g_write(arg_L: ?*lua_State, arg_f: ?*FILE, arg_arg: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    var arg = arg_arg;
    _ = &arg;
    var nargs: c_int = lua_gettop(L) - arg;
    _ = &nargs;
    var status: c_int = 1;
    _ = &status;
    while ((blk: {
        ...
        if (lua_type(L, arg) == @as(c_int, 3)) {
            var len: c_int = if (lua_isinteger(L, arg) != 0) fprintf(f, "%lld", @as(c_longlong, @bitCast(lua_tointegerx(L, arg, null)))) else fprintf(f, "%.14g", @as(f64, @floatCast(lua_tonumberx(L, arg, null))));
            _ = &len;
            status = @intFromBool((status != 0) and (len > @as(c_int, 0)));
        } else {
            var l: usize = undefined;
            _ = &l;
            var s: [*c]const u8 = luaL_checklstring(L, arg, &l);
            _ = &s;
...
pub fn io_write(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return g_write(L, getiofile(L, "_IO_output"), @as(c_int, 1));
}
pub fn f_write(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var f: ?*FILE = tofile(L);
    _ = &f;
    lua_pushvalue(L, @as(c_int, 1));
    return g_write(L, f, @as(c_int, 2));
}
pub fn f_seek(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    const mode = struct {
        const static: [3]c_int = [3]c_int{
            0,
            1,
            2,
        };
    ...
    _ = &mode;
    const modenames = struct {
        const static: [4][*c]const u8 = [4][*c]const u8{
            "set",
            "cur",
            "end",
            null,
    ...
    var f: ?*FILE = tofile(L);
    _ = &f;
    var op: c_int = luaL_checkoption(L, @as(c_int, 2), "cur", @as([*c]const [*c]const u8, @ptrCast(@alignCast(&modenames.static[@as(usize, @intCast(0))]))));
    _ = &op;
...
pub fn f_setvbuf(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    const mode = struct {
        const static: [3]c_int = [3]c_int{
...
pub fn io_flush(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return luaL_fileresult(L, @intFromBool(fflush(getiofile(L, "_IO_output")) == @as(c_int, 0)), null);
}
pub fn f_flush(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return luaL_fileresult(L, @intFromBool(fflush(tofile(L)) == @as(c_int, 0)), null);
}
pub const iolib: [12]luaL_Reg = [12]luaL_Reg{
    luaL_Reg{
        .name = "close",
        .func = &io_close,
    },
...
pub const meth: [8]luaL_Reg = [8]luaL_Reg{
    luaL_Reg{
        .name = "read",
        .func = &f_read,
    },
...
pub const metameth: [5]luaL_Reg = [5]luaL_Reg{
    luaL_Reg{
        .name = "__index",
        .func = null,
    },
...
pub fn createmeta(arg_L: ?*lua_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
...
pub fn io_noclose(arg_L: ?*lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p: [*c]LStream = @as([*c]LStream, @ptrCast(@alignCast(luaL_checkudata(L, @as(c_int, 1), "FILE*"))));
    _ = &p;
    p.*.closef = &io_noclose;
    lua_pushnil(L);
    _ = lua_pushstring(L, "cannot close standard file");
    return 2;
}
pub fn createstdfile(arg_L: ?*lua_State, arg_f: ?*FILE, arg_k: [*c]const u8, arg_fname: [*c]const u8) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    p.*.f = f;
    p.*.closef = &io_noclose;
    if (k != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        lua_pushvalue(L, -@as(c_int, 1));
        lua_setfield(L, -@as(c_int, 1000000) - @as(c_int, 1000), k);
    }
    lua_setfield(L, -@as(c_int, 2), fname);
}
...
pub const L_MODEEXT = "b";
pub inline fn l_popen(L: anytype, c: anytype, m: anytype) @TypeOf(popen(c, m)) {
    _ = &L;
    _ = &c;
    _ = &m;
    return blk_1: {
        _ = fflush(NULL);
        break :blk_1 popen(c, m);
    };
}
pub inline fn l_pclose(L: anytype, file: anytype) @TypeOf(pclose(file)) {
    _ = &L;
    _ = &file;
    return pclose(file);
}
pub inline fn l_checkmodep(m: anytype) @TypeOf(((m[@as(usize, @intCast(@as(c_int, 0)))] == 'r') or (m[@as(usize, @intCast(@as(c_int, 0)))] == 'w')) and (m[@as(usize, @intCast(@as(c_int, 1)))] == '\x00')) {
    _ = &m;
    return ((m[@as(usize, @intCast(@as(c_int, 0)))] == 'r') or (m[@as(usize, @intCast(@as(c_int, 0)))] == 'w')) and (m[@as(usize, @intCast(@as(c_int, 1)))] == '\x00');
}
pub inline fn l_getc(f: anytype) @TypeOf(getc_unlocked(f)) {
    _ = &f;
    return getc_unlocked(f);
}
pub inline fn l_lockfile(f: anytype) @TypeOf(flockfile(f)) {
    _ = &f;
    return flockfile(f);
}
pub inline fn l_unlockfile(f: anytype) @TypeOf(funlockfile(f)) {
    _ = &f;
    return funlockfile(f);
}
pub inline fn l_fseek(f: anytype, o: anytype, w: anytype) @TypeOf(fseeko(f, o, w)) {
    _ = &f;
    _ = &o;
    _ = &w;
    return fseeko(f, o, w);
}
pub inline fn l_ftell(f: anytype) @TypeOf(ftello(f)) {
    _ = &f;
    return ftello(f);
}
pub const l_seeknum = off_t;
pub const IO_PREFIX = "_IO_";
pub const IOPREF_LEN = @import("std").zig.c_translation.MacroArithmetic.div(@import("std").zig.c_translation.sizeof(IO_PREFIX), @import("std").zig.c_translation.sizeof(u8)) - @as(c_int, 1);
pub const IO_INPUT = IO_PREFIX ++ "input";
pub const IO_OUTPUT = IO_PREFIX ++ "output";
pub inline fn tolstream(L: anytype) [*c]LStream {
    _ = &L;
    return @import("std").zig.c_translation.cast([*c]LStream, luaL_checkudata(L, @as(c_int, 1), LUA_FILEHANDLE));
}
pub inline fn isclosed(p: anytype) @TypeOf(p.*.closef == NULL) {
    _ = &p;
    return p.*.closef == NULL;
}
pub const MAXARGLINE = @as(c_int, 250);
