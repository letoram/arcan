...
const mem = std.mem;
const cb = std.zig.c_builtins;

pub const __builtin_bswap16 = cb.__builtin_bswap16;
pub const __builtin_bswap32 = cb.__builtin_bswap32;
pub const __builtin_bswap64 = cb.__builtin_bswap64;
pub const __builtin_signbit = cb.__builtin_signbit;
pub const __builtin_signbitf = cb.__builtin_signbitf;
pub const __builtin_popcount = cb.__builtin_popcount;
pub const __builtin_ctz = cb.__builtin_ctz;
pub const __builtin_clz = cb.__builtin_clz;
pub const __builtin_sqrt = cb.__builtin_sqrt;
pub const __builtin_sqrtf = cb.__builtin_sqrtf;
pub const __builtin_sin = cb.__builtin_sin;
pub const __builtin_sinf = cb.__builtin_sinf;
pub const __builtin_cos = cb.__builtin_cos;
pub const __builtin_cosf = cb.__builtin_cosf;
pub const __builtin_exp = cb.__builtin_exp;
pub const __builtin_expf = cb.__builtin_expf;
pub const __builtin_exp2 = cb.__builtin_exp2;
pub const __builtin_exp2f = cb.__builtin_exp2f;
pub const __builtin_log = cb.__builtin_log;
pub const __builtin_logf = cb.__builtin_logf;
pub const __builtin_log2 = cb.__builtin_log2;
pub const __builtin_log2f = cb.__builtin_log2f;
pub const __builtin_log10 = cb.__builtin_log10;
pub const __builtin_log10f = cb.__builtin_log10f;
pub const __builtin_abs = cb.__builtin_abs;
pub const __builtin_labs = cb.__builtin_labs;
pub const __builtin_llabs = cb.__builtin_llabs;
pub const __builtin_fabs = cb.__builtin_fabs;
pub const __builtin_fabsf = cb.__builtin_fabsf;
pub const __builtin_floor = cb.__builtin_floor;
pub const __builtin_floorf = cb.__builtin_floorf;
pub const __builtin_ceil = cb.__builtin_ceil;
pub const __builtin_ceilf = cb.__builtin_ceilf;
pub const __builtin_trunc = cb.__builtin_trunc;
pub const __builtin_truncf = cb.__builtin_truncf;
pub const __builtin_round = cb.__builtin_round;
pub const __builtin_roundf = cb.__builtin_roundf;
pub const __builtin_strlen = cb.__builtin_strlen;
pub const __builtin_strcmp = cb.__builtin_strcmp;
pub const __builtin_object_size = cb.__builtin_object_size;
pub const __builtin___memset_chk = cb.__builtin___memset_chk;
pub const __builtin_memset = cb.__builtin_memset;
pub const __builtin___memcpy_chk = cb.__builtin___memcpy_chk;
pub const __builtin_memcpy = cb.__builtin_memcpy;
pub const __builtin_expect = cb.__builtin_expect;
pub const __builtin_nanf = cb.__builtin_nanf;
pub const __builtin_huge_valf = cb.__builtin_huge_valf;
pub const __builtin_inff = cb.__builtin_inff;
pub const __builtin_isnan = cb.__builtin_isnan;
pub const __builtin_isinf = cb.__builtin_isinf;
pub const __builtin_isinf_sign = cb.__builtin_isinf_sign;
pub const __has_builtin = cb.__has_builtin;
pub const __builtin_assume = cb.__builtin_assume;
pub const __builtin_unreachable = cb.__builtin_unreachable;
pub const __builtin_constant_p = cb.__builtin_constant_p;
pub const __builtin_mul_overflow = cb.__builtin_mul_overflow;
...
pub const struct_TString = extern struct {
    next: [*c]struct_GCObject = mem.zeroes([*c]struct_GCObject),
    tt: lu_byte = mem.zeroes(lu_byte),
    marked: lu_byte = mem.zeroes(lu_byte),
    extra: lu_byte = mem.zeroes(lu_byte),
    shrlen: lu_byte = mem.zeroes(lu_byte),
    hash: c_uint = mem.zeroes(c_uint),
    u: union_unnamed_5 = mem.zeroes(union_unnamed_5),
    contents: [1]u8 = std.mem.zeroes([1]u8),
};
pub const TString = struct_TString;
pub const struct_stringtable = extern struct {
    hash: [*c][*c]TString = mem.zeroes([*c][*c]TString),
    nuse: c_int = mem.zeroes(c_int),
...
pub const struct_TValue = extern struct {
    value_: Value = mem.zeroes(Value),
    tt_: lu_byte = mem.zeroes(lu_byte),
};
...
pub const struct_NodeKey_6 = extern struct {
    value_: Value = mem.zeroes(Value),
    tt_: lu_byte = mem.zeroes(lu_byte),
    key_tt: lu_byte = mem.zeroes(lu_byte),
    next: c_int = mem.zeroes(c_int),
    key_val: Value = mem.zeroes(Value),
};
...
pub const struct_Table = extern struct {
    ...
    tt: lu_byte = mem.zeroes(lu_byte),
    marked: lu_byte = mem.zeroes(lu_byte),
    flags: lu_byte = mem.zeroes(lu_byte),
    lsizenode: lu_byte = mem.zeroes(lu_byte),
    alimit: c_uint = mem.zeroes(c_uint),
    array: [*c]TValue = mem.zeroes([*c]TValue),
    node: [*c]Node = mem.zeroes([*c]Node),
    lastfree: [*c]Node = mem.zeroes([*c]Node),
    metatable: [*c]struct_Table = mem.zeroes([*c]struct_Table),
    gclist: [*c]GCObject = mem.zeroes([*c]GCObject),
};
...
pub const struct_global_State = extern struct {
    frealloc: lua_Alloc = mem.zeroes(lua_Alloc),
    ud: ?*anyopaque = mem.zeroes(?*anyopaque),
    totalbytes: l_mem = mem.zeroes(l_mem),
    GCdebt: l_mem = mem.zeroes(l_mem),
    GCestimate: lu_mem = mem.zeroes(lu_mem),
    lastatomic: lu_mem = mem.zeroes(lu_mem),
    strt: stringtable = mem.zeroes(stringtable),
    l_registry: TValue = mem.zeroes(TValue),
    nilvalue: TValue = mem.zeroes(TValue),
    seed: c_uint = mem.zeroes(c_uint),
    currentwhite: lu_byte = mem.zeroes(lu_byte),
    gcstate: lu_byte = mem.zeroes(lu_byte),
    gckind: lu_byte = mem.zeroes(lu_byte),
    gcstopem: lu_byte = mem.zeroes(lu_byte),
    genminormul: lu_byte = mem.zeroes(lu_byte),
    genmajormul: lu_byte = mem.zeroes(lu_byte),
    gcstp: lu_byte = mem.zeroes(lu_byte),
    gcemergency: lu_byte = mem.zeroes(lu_byte),
    gcpause: lu_byte = mem.zeroes(lu_byte),
    gcstepmul: lu_byte = mem.zeroes(lu_byte),
    gcstepsize: lu_byte = mem.zeroes(lu_byte),
    allgc: [*c]GCObject = mem.zeroes([*c]GCObject),
    sweepgc: [*c][*c]GCObject = mem.zeroes([*c][*c]GCObject),
    finobj: [*c]GCObject = mem.zeroes([*c]GCObject),
    gray: [*c]GCObject = mem.zeroes([*c]GCObject),
    grayagain: [*c]GCObject = mem.zeroes([*c]GCObject),
    weak: [*c]GCObject = mem.zeroes([*c]GCObject),
    ephemeron: [*c]GCObject = mem.zeroes([*c]GCObject),
    allweak: [*c]GCObject = mem.zeroes([*c]GCObject),
    tobefnz: [*c]GCObject = mem.zeroes([*c]GCObject),
    fixedgc: [*c]GCObject = mem.zeroes([*c]GCObject),
    survival: [*c]GCObject = mem.zeroes([*c]GCObject),
    old1: [*c]GCObject = mem.zeroes([*c]GCObject),
    reallyold: [*c]GCObject = mem.zeroes([*c]GCObject),
    firstold1: [*c]GCObject = mem.zeroes([*c]GCObject),
    finobjsur: [*c]GCObject = mem.zeroes([*c]GCObject),
    finobjold1: [*c]GCObject = mem.zeroes([*c]GCObject),
    finobjrold: [*c]GCObject = mem.zeroes([*c]GCObject),
    twups: [*c]struct_lua_State = mem.zeroes([*c]struct_lua_State),
    panic: lua_CFunction = mem.zeroes(lua_CFunction),
    mainthread: [*c]struct_lua_State = mem.zeroes([*c]struct_lua_State),
    memerrmsg: [*c]TString = mem.zeroes([*c]TString),
    tmname: [25][*c]TString = mem.zeroes([25][*c]TString),
    mt: [9][*c]struct_Table = mem.zeroes([9][*c]struct_Table),
    strcache: [53][2][*c]TString = mem.zeroes([53][2][*c]TString),
    warnf: lua_WarnFunction = mem.zeroes(lua_WarnFunction),
    ud_warn: ?*anyopaque = mem.zeroes(?*anyopaque),
};
...
const struct_unnamed_9 = extern struct {
    next: [*c]struct_UpVal = mem.zeroes([*c]struct_UpVal),
    previous: [*c][*c]struct_UpVal = mem.zeroes([*c][*c]struct_UpVal),
};
...
pub const struct_UpVal = extern struct {
    ...
    tt: lu_byte = mem.zeroes(lu_byte),
    marked: lu_byte = mem.zeroes(lu_byte),
    v: union_unnamed_7 = mem.zeroes(union_unnamed_7),
    u: union_unnamed_8 = mem.zeroes(union_unnamed_8),
};
pub const UpVal = struct_UpVal;
pub const struct_lua_longjmp = opaque {};
pub const struct_lua_Debug = extern struct {
    event: c_int = mem.zeroes(c_int),
    name: [*c]const u8 = mem.zeroes([*c]const u8),
    namewhat: [*c]const u8 = mem.zeroes([*c]const u8),
    what: [*c]const u8 = mem.zeroes([*c]const u8),
    source: [*c]const u8 = mem.zeroes([*c]const u8),
    srclen: usize = mem.zeroes(usize),
    currentline: c_int = mem.zeroes(c_int),
    linedefined: c_int = mem.zeroes(c_int),
    lastlinedefined: c_int = mem.zeroes(c_int),
    nups: u8 = mem.zeroes(u8),
    nparams: u8 = mem.zeroes(u8),
    isvararg: u8 = mem.zeroes(u8),
    istailcall: u8 = mem.zeroes(u8),
    ftransfer: c_ushort = mem.zeroes(c_ushort),
    ntransfer: c_ushort = mem.zeroes(c_ushort),
    short_src: [60]u8 = mem.zeroes([60]u8),
    i_ci: [*c]struct_CallInfo = mem.zeroes([*c]struct_CallInfo),
};
...
pub const struct_lua_State = extern struct {
    ...
    tt: lu_byte = mem.zeroes(lu_byte),
    marked: lu_byte = mem.zeroes(lu_byte),
    status: lu_byte = mem.zeroes(lu_byte),
    allowhook: lu_byte = mem.zeroes(lu_byte),
    nci: c_ushort = mem.zeroes(c_ushort),
    top: StkIdRel = mem.zeroes(StkIdRel),
    l_G: [*c]global_State = mem.zeroes([*c]global_State),
    ci: [*c]CallInfo = mem.zeroes([*c]CallInfo),
    stack_last: StkIdRel = mem.zeroes(StkIdRel),
    stack: StkIdRel = mem.zeroes(StkIdRel),
    openupval: [*c]UpVal = mem.zeroes([*c]UpVal),
    tbclist: StkIdRel = mem.zeroes(StkIdRel),
    gclist: [*c]GCObject = mem.zeroes([*c]GCObject),
    twups: [*c]struct_lua_State = mem.zeroes([*c]struct_lua_State),
    errorJmp: ?*struct_lua_longjmp = mem.zeroes(?*struct_lua_longjmp),
    base_ci: CallInfo = mem.zeroes(CallInfo),
    hook: lua_Hook = mem.zeroes(lua_Hook),
    errfunc: ptrdiff_t = mem.zeroes(ptrdiff_t),
    nCcalls: l_uint32 = mem.zeroes(l_uint32),
    oldpc: c_int = mem.zeroes(c_int),
    basehookcount: c_int = mem.zeroes(c_int),
    hookcount: c_int = mem.zeroes(c_int),
    hookmask: sig_atomic_t = mem.zeroes(sig_atomic_t),
};
...
const struct_unnamed_4 = extern struct {
    k: lua_KFunction = mem.zeroes(lua_KFunction),
    old_errfunc: ptrdiff_t = mem.zeroes(ptrdiff_t),
    ctx: lua_KContext = mem.zeroes(lua_KContext),
};
...
pub const struct_CallInfo = extern struct {
    func: StkIdRel = mem.zeroes(StkIdRel),
    top: StkIdRel = mem.zeroes(StkIdRel),
    previous: [*c]struct_CallInfo = mem.zeroes([*c]struct_CallInfo),
    next: [*c]struct_CallInfo = mem.zeroes([*c]struct_CallInfo),
    u: union_unnamed_2 = mem.zeroes(union_unnamed_2),
    u2: union_unnamed_10 = mem.zeroes(union_unnamed_10),
    nresults: c_short = mem.zeroes(c_short),
    callstatus: c_ushort = mem.zeroes(c_ushort),
};
...
pub const struct_lconv = extern struct {
    decimal_point: [*c]u8 = mem.zeroes([*c]u8),
    thousands_sep: [*c]u8 = mem.zeroes([*c]u8),
    grouping: [*c]u8 = mem.zeroes([*c]u8),
    int_curr_symbol: [*c]u8 = mem.zeroes([*c]u8),
    currency_symbol: [*c]u8 = mem.zeroes([*c]u8),
    mon_decimal_point: [*c]u8 = mem.zeroes([*c]u8),
    mon_thousands_sep: [*c]u8 = mem.zeroes([*c]u8),
    mon_grouping: [*c]u8 = mem.zeroes([*c]u8),
    positive_sign: [*c]u8 = mem.zeroes([*c]u8),
    negative_sign: [*c]u8 = mem.zeroes([*c]u8),
    int_frac_digits: u8 = mem.zeroes(u8),
    frac_digits: u8 = mem.zeroes(u8),
    p_cs_precedes: u8 = mem.zeroes(u8),
    p_sep_by_space: u8 = mem.zeroes(u8),
    n_cs_precedes: u8 = mem.zeroes(u8),
    n_sep_by_space: u8 = mem.zeroes(u8),
    p_sign_posn: u8 = mem.zeroes(u8),
    n_sign_posn: u8 = mem.zeroes(u8),
    int_p_cs_precedes: u8 = mem.zeroes(u8),
    int_n_cs_precedes: u8 = mem.zeroes(u8),
    int_p_sep_by_space: u8 = mem.zeroes(u8),
    int_n_sep_by_space: u8 = mem.zeroes(u8),
    int_p_sign_posn: u8 = mem.zeroes(u8),
    int_n_sign_posn: u8 = mem.zeroes(u8),
};
...
const struct_unnamed_12 = extern struct {
    value_: Value = mem.zeroes(Value),
    tt_: lu_byte = mem.zeroes(lu_byte),
    delta: c_ushort = mem.zeroes(c_ushort),
};
...
pub const struct_Udata = extern struct {
    ...
    tt: lu_byte = mem.zeroes(lu_byte),
    marked: lu_byte = mem.zeroes(lu_byte),
    nuvalue: c_ushort = mem.zeroes(c_ushort),
    len: usize = mem.zeroes(usize),
    metatable: [*c]struct_Table = mem.zeroes([*c]struct_Table),
    gclist: [*c]GCObject = mem.zeroes([*c]GCObject),
    uv: [1]UValue = mem.zeroes([1]UValue),
};
...
pub const struct_Udata0 = extern struct {
    ...
    len: usize = mem.zeroes(usize),
    metatable: [*c]struct_Table = mem.zeroes([*c]struct_Table),
    bindata: union_unnamed_13 = mem.zeroes(union_unnamed_13),
};
pub const Udata0 = struct_Udata0;
pub const struct_Upvaldesc = extern struct {
    name: [*c]TString = mem.zeroes([*c]TString),
    instack: lu_byte = mem.zeroes(lu_byte),
    idx: lu_byte = mem.zeroes(lu_byte),
    kind: lu_byte = mem.zeroes(lu_byte),
};
pub const Upvaldesc = struct_Upvaldesc;
pub const struct_LocVar = extern struct {
    varname: [*c]TString = mem.zeroes([*c]TString),
    startpc: c_int = mem.zeroes(c_int),
    endpc: c_int = mem.zeroes(c_int),
};
pub const LocVar = struct_LocVar;
pub const struct_AbsLineInfo = extern struct {
    pc: c_int = mem.zeroes(c_int),
    line: c_int = mem.zeroes(c_int),
};
...
pub const struct_Proto = extern struct {
    ...
    tt: lu_byte = mem.zeroes(lu_byte),
    marked: lu_byte = mem.zeroes(lu_byte),
    numparams: lu_byte = mem.zeroes(lu_byte),
    is_vararg: lu_byte = mem.zeroes(lu_byte),
    maxstacksize: lu_byte = mem.zeroes(lu_byte),
    sizeupvalues: c_int = mem.zeroes(c_int),
    sizek: c_int = mem.zeroes(c_int),
    sizecode: c_int = mem.zeroes(c_int),
    sizelineinfo: c_int = mem.zeroes(c_int),
    sizep: c_int = mem.zeroes(c_int),
    sizelocvars: c_int = mem.zeroes(c_int),
    sizeabslineinfo: c_int = mem.zeroes(c_int),
    linedefined: c_int = mem.zeroes(c_int),
    lastlinedefined: c_int = mem.zeroes(c_int),
    k: [*c]TValue = mem.zeroes([*c]TValue),
    code: [*c]Instruction = mem.zeroes([*c]Instruction),
    p: [*c][*c]struct_Proto = mem.zeroes([*c][*c]struct_Proto),
    upvalues: [*c]Upvaldesc = mem.zeroes([*c]Upvaldesc),
    lineinfo: [*c]ls_byte = mem.zeroes([*c]ls_byte),
    abslineinfo: [*c]AbsLineInfo = mem.zeroes([*c]AbsLineInfo),
    locvars: [*c]LocVar = mem.zeroes([*c]LocVar),
    source: [*c]TString = mem.zeroes([*c]TString),
    gclist: [*c]GCObject = mem.zeroes([*c]GCObject),
};
...
pub const struct_CClosure = extern struct {
    ...
    tt: lu_byte = mem.zeroes(lu_byte),
    marked: lu_byte = mem.zeroes(lu_byte),
    nupvalues: lu_byte = mem.zeroes(lu_byte),
    gclist: [*c]GCObject = mem.zeroes([*c]GCObject),
    f: lua_CFunction = mem.zeroes(lua_CFunction),
    upvalue: [1]TValue = mem.zeroes([1]TValue),
};
...
pub const struct_LClosure = extern struct {
    ...
    nupvalues: lu_byte = mem.zeroes(lu_byte),
    gclist: [*c]GCObject = mem.zeroes([*c]GCObject),
    p: [*c]struct_Proto = mem.zeroes([*c]struct_Proto),
    upvals: [1][*c]UpVal = mem.zeroes([1][*c]UpVal),
};
...
pub const struct_Zio = extern struct {
    n: usize = mem.zeroes(usize),
    p: [*c]const u8 = mem.zeroes([*c]const u8),
    reader: lua_Reader = mem.zeroes(lua_Reader),
    data: ?*anyopaque = mem.zeroes(?*anyopaque),
    L: [*c]lua_State = mem.zeroes([*c]lua_State),
};
pub const ZIO = struct_Zio;
pub const struct_Mbuffer = extern struct {
    buffer: [*c]u8 = mem.zeroes([*c]u8),
    n: usize = mem.zeroes(usize),
    buffsize: usize = mem.zeroes(usize),
};
...
pub export fn luaH_getint(arg_t: [*c]Table, arg_key: lua_Integer) [*c]const TValue {
    var t = arg_t;
    _ = &t;
    var key = arg_key;
    _ = &key;
    if ((@as(lua_Unsigned, @bitCast(key)) -% @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, 1))))) < @as(lua_Unsigned, @bitCast(@as(c_ulonglong, t.*.alimit)))) return &(blk: {
        const tmp = key - @as(lua_Integer, @bitCast(@as(c_longlong, @as(c_int, 1))));
        if (tmp >= 0) break :blk t.*.array + @as(usize, @intCast(tmp)) else break :blk t.*.array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* else if (!(!((@as(c_int, @bitCast(@as(c_uint, t.*.flags))) & (@as(c_int, 1) << @intCast(7))) != 0) or ((t.*.alimit & (t.*.alimit -% @as(c_uint, @bitCast(@as(c_int, 1))))) == @as(c_uint, @bitCast(@as(c_int, 0))))) and ((@as(lua_Unsigned, @bitCast(key)) == @as(lua_Unsigned, @bitCast(@as(c_ulonglong, t.*.alimit +% @as(c_uint, @bitCast(@as(c_int, 1))))))) or ((@as(lua_Unsigned, @bitCast(key)) -% @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, 1))))) < @as(lua_Unsigned, @bitCast(@as(c_ulonglong, luaH_realasize(t))))))) {
        t.*.alimit = @as(c_uint, @bitCast(@as(c_int, @truncate(key))));
        return &(blk: {
            const tmp = key - @as(lua_Integer, @bitCast(@as(c_longlong, @as(c_int, 1))));
            if (tmp >= 0) break :blk t.*.array + @as(usize, @intCast(tmp)) else break :blk t.*.array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*;
    } else {
        var n: [*c]Node = hashint(t, key);
        _ = &n;
        while (true) {
            if ((@as(c_int, @bitCast(@as(c_uint, n.*.u.key_tt))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) and (n.*.u.key_val.i == key)) return &n.*.i_val else {
                var nx: c_int = n.*.u.next;
                _ = &nx;
                if (nx == @as(c_int, 0)) break;
                n += @as(usize, @bitCast(@as(isize, @intCast(nx))));
            }
        }
        return &absentkey;
    }
...
pub export fn luaH_setint(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_key: lua_Integer, arg_value: [*c]TValue) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    var value = arg_value;
    _ = &value;
    var p: [*c]const TValue = luaH_getint(t, key);
    _ = &p;
    if (@as(c_int, @bitCast(@as(c_uint, p.*.tt_))) == (@as(c_int, 0) | (@as(c_int, 2) << @intCast(4)))) {
        ...
        var io1: [*c]TValue = @as([*c]TValue, @ptrCast(@constCast(@volatileCast(p))));
        _ = &io1;
        var io2: [*c]const TValue = value;
        _ = &io2;
...
pub export fn luaH_getshortstr(arg_t: [*c]Table, arg_key: [*c]TString) [*c]const TValue {
    var t = arg_t;
    _ = &t;
    var key = arg_key;
    _ = &key;
    var n: [*c]Node = &(blk: {
        const tmp = blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 @as(c_int, @bitCast(key.*.hash & @as(c_uint, @bitCast((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)))));
        };
        if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*;
    _ = &n;
    _ = @as(c_int, 0);
    while (true) {
        if ((@as(c_int, @bitCast(@as(c_uint, n.*.u.key_tt))) == ((@as(c_int, 4) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) and ((blk: {
            _ = @as(c_int, 0);
            break :blk (blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(n.*.u.key_val.gc))).*.ts;
            }) == key;
        }))) return &n.*.i_val else {
            var nx: c_int = n.*.u.next;
            _ = &nx;
            if (nx == @as(c_int, 0)) return &absentkey;
            n += @as(usize, @bitCast(@as(isize, @intCast(nx))));
        }
    }
    return null;
}
pub export fn luaH_getstr(arg_t: [*c]Table, arg_key: [*c]TString) [*c]const TValue {
    var t = arg_t;
    _ = &t;
    var key = arg_key;
    _ = &key;
    if (@as(c_int, @bitCast(@as(c_uint, key.*.tt))) == (@as(c_int, 4) | (@as(c_int, 0) << @intCast(4)))) return luaH_getshortstr(t, key) else {
        var ko: TValue = undefined;
        _ = &ko;
        {
            var io: [*c]TValue = &ko;
            _ = &io;
            var x_: [*c]TString = key;
            _ = &x_;
            io.*.value_.gc = blk: {
                _ = @as(c_int, 0);
            ...
            _ = blk: {
                _ = @as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))));
                ...
                }).*.tt)))) and ((@as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))) == @as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 io.*.value_.gc;
                }).*.marked))) & (@as(c_int, @bitCast(@as(c_uint, @as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))).*.l_G.*.currentwhite))) ^ ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))) != 0)))) @as(c_int, 0) else @as(c_int, 0);
            };
        }
        return getgeneric(t, &ko, @as(c_int, 0));
    }
    return null;
}
pub export fn luaH_get(arg_t: [*c]Table, arg_key: [*c]const TValue) [*c]const TValue {
    var t = arg_t;
    _ = &t;
    var key = arg_key;
    _ = &key;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, key.*.tt_))) & @as(c_int, 63)) {
            @as(c_int, 4) => return luaH_getshortstr(t, blk: {
                _ = @as(c_int, 0);
                break :blk blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(key.*.value_.gc))).*.ts;
                };
            }),
            @as(c_int, 3) => return luaH_getint(t, blk: {
                _ = @as(c_int, 0);
                break :blk key.*.value_.i;
            }),
            @as(c_int, 0) => return &absentkey,
            @as(c_int, 19) => {
                {
                    var k: lua_Integer = undefined;
                    _ = &k;
                    if (luaV_flttointeger(blk: {
                        _ = @as(c_int, 0);
                        break :blk key.*.value_.n;
                    }, &k, @as(c_uint, @bitCast(F2Ieq))) != 0) return luaH_getint(t, k);
                }
                return getgeneric(t, key, @as(c_int, 0));
            },
            else => return getgeneric(t, key, @as(c_int, 0)),
        }
        break;
    }
    return null;
}
pub export fn luaH_newkey(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_key: [*c]const TValue, arg_value: [*c]TValue) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    var value = arg_value;
    _ = &value;
    var mp: [*c]Node = undefined;
    _ = &mp;
    var aux: TValue = undefined;
    _ = &aux;
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool((@as(c_int, @bitCast(@as(c_uint, key.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
        luaG_runerror(L, "table index is nil");
    } else if (@as(c_int, @bitCast(@as(c_uint, key.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 1) << @intCast(4)))) {
        var f: lua_Number = blk: {
            _ = @as(c_int, 0);
            break :blk key.*.value_.n;
        };
        _ = &f;
        var k: lua_Integer = undefined;
        _ = &k;
        if (luaV_flttointeger(f, &k, @as(c_uint, @bitCast(F2Ieq))) != 0) {
            {
                var io: [*c]TValue = &aux;
                _ = &io;
                io.*.value_.i = k;
            ...
            key = &aux;
        } else if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(!(f == f)) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
            luaG_runerror(L, "table index is NaN");
        }
    }
    if ((@as(c_int, @bitCast(@as(c_uint, value.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) return;
    mp = mainpositionTV(t, key);
    if (!((@as(c_int, @bitCast(@as(c_uint, (&mp.*.i_val).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) or (t.*.lastfree == @as([*c]Node, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        var othern: [*c]Node = undefined;
        _ = &othern;
        var f: [*c]Node = getfreepos(t);
        _ = &f;
        if (f == @as([*c]Node, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            rehash(L, t, key);
        ...
        if (othern != mp) {
            while ((othern + @as(usize, @bitCast(@as(isize, @intCast(othern.*.u.next))))) != mp) {
                othern += @as(usize, @bitCast(@as(isize, @intCast(othern.*.u.next))));
            }
            othern.*.u.next = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(f) -% @intFromPtr(othern))), @sizeOf(Node))))));
            f.* = mp.*;
            if (mp.*.u.next != @as(c_int, 0)) {
                f.*.u.next += @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(mp) -% @intFromPtr(f))), @sizeOf(Node))))));
                mp.*.u.next = 0;
            }
            _ = blk: {
                const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0) | (@as(c_int, 1) << @intCast(4))))));
                (&mp.*.i_val).*.tt_ = tmp;
                break :blk tmp;
            };
        } else {
            if (mp.*.u.next != @as(c_int, 0)) {
                f.*.u.next = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(mp + @as(usize, @bitCast(@as(isize, @intCast(mp.*.u.next))))) -% @intFromPtr(f))), @sizeOf(Node))))));
            } else {
                _ = @as(c_int, 0);
            }
            mp.*.u.next = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(f) -% @intFromPtr(mp))), @sizeOf(Node))))));
            mp = f;
        }
    }
    {
        var n_: [*c]Node = mp;
        _ = &n_;
        var io_: [*c]const TValue = key;
        _ = &io_;
        n_.*.u.key_val = io_.*.value_;
        n_.*.u.key_tt = io_.*.tt_;
        _ = blk: {
            _ = &L;
            break :blk if (!((@as(c_int, @bitCast(@as(c_uint, io_.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) or (((@as(c_int, @bitCast(@as(c_uint, io_.*.tt_))) & @as(c_int, 63)) == @as(c_int, @bitCast(@as(c_uint, (blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 io_.*.value_.gc;
            }).*.tt)))) and ((L == @as([*c]lua_State, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, (blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 io_.*.value_.gc;
            }).*.marked))) & (@as(c_int, @bitCast(@as(c_uint, L.*.l_G.*.currentwhite))) ^ ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4)))))) != 0)))) @as(c_int, 0) else @as(c_int, 0);
    ...
    _ = if ((@as(c_int, @bitCast(@as(c_uint, key.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) if (((@as(c_int, @bitCast(@as(c_uint, (blk: {
        _ = @as(c_int, 0);
...
pub export fn luaH_set(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_key: [*c]const TValue, arg_value: [*c]TValue) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    var value = arg_value;
    _ = &value;
    var slot: [*c]const TValue = luaH_get(t, key);
    _ = &slot;
    luaH_finishset(L, t, key, slot, value);
}
pub export fn luaH_finishset(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_key: [*c]const TValue, arg_slot: [*c]const TValue, arg_value: [*c]TValue) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    var value = arg_value;
    _ = &value;
    if (@as(c_int, @bitCast(@as(c_uint, slot.*.tt_))) == (@as(c_int, 0) | (@as(c_int, 2) << @intCast(4)))) {
...
pub export fn luaH_new(arg_L: [*c]lua_State) [*c]Table {
    var L = arg_L;
    _ = &L;
    var o: [*c]GCObject = luaC_newobj(L, @as(c_int, 5) | (@as(c_int, 0) << @intCast(4)), @sizeOf(Table));
    _ = &o;
    var t: [*c]Table = blk: {
        _ = @as(c_int, 0);
    ...
    _ = &t;
    t.*.metatable = null;
    t.*.flags = @as(lu_byte, @bitCast(@as(u8, @truncate(~(~@as(c_uint, 0) << @intCast(TM_EQ + @as(c_int, 1)))))));
    t.*.array = null;
    t.*.alimit = 0;
    setnodevector(L, t, @as(c_uint, @bitCast(@as(c_int, 0))));
    return t;
}
pub export fn luaH_resize(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_newasize: c_uint, arg_nhsize: c_uint) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    var newasize = arg_newasize;
    _ = &newasize;
    var nhsize = arg_nhsize;
    _ = &nhsize;
    var i: c_uint = undefined;
    _ = &i;
    var newt: Table = undefined;
    _ = &newt;
    var oldasize: c_uint = setlimittosize(t);
    _ = &oldasize;
    var newarray: [*c]TValue = undefined;
    _ = &newarray;
    ...
    if (newasize < oldasize) {
        ...
        exchangehashpart(t, &newt);
        {
            ...
            while (i < oldasize) : (i +%= 1) {
                if (!((@as(c_int, @bitCast(@as(c_uint, (&t.*.array[i]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
                    luaH_setint(L, t, @as(lua_Integer, @bitCast(@as(c_ulonglong, i +% @as(c_uint, @bitCast(@as(c_int, 1)))))), &t.*.array[i]);
                }
            }
        }
        t.*.alimit = oldasize;
    ...
    newarray = @as([*c]TValue, @ptrCast(@alignCast(luaM_realloc_(L, @as(?*anyopaque, @ptrCast(t.*.array)), @as(usize, @bitCast(@as(c_ulong, oldasize))) *% @sizeOf(TValue), @as(usize, @bitCast(@as(c_ulong, newasize))) *% @sizeOf(TValue)))));
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool((newarray == @as([*c]TValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (newasize > @as(c_uint, @bitCast(@as(c_int, 0))))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
        freehash(L, &newt);
...
pub export fn luaH_resizearray(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_nasize: c_uint) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    var nasize = arg_nasize;
    _ = &nasize;
    var nsize: c_int = if (t.*.lastfree == @as([*c]Node, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, 0) else @as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))));
    _ = &nsize;
    luaH_resize(L, t, nasize, @as(c_uint, @bitCast(nsize)));
}
pub export fn luaH_free(arg_L: [*c]lua_State, arg_t: [*c]Table) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    freehash(L, t);
    luaM_free_(L, @as(?*anyopaque, @ptrCast(t.*.array)), @as(c_ulong, @bitCast(@as(c_ulong, luaH_realasize(t)))) *% @sizeOf(TValue));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(t)), @sizeOf(Table));
}
pub export fn luaH_next(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_key: StkId) c_int {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    var key = arg_key;
    _ = &key;
    var asize: c_uint = luaH_realasize(t);
    _ = &asize;
    var i: c_uint = findindex(L, t, &key.*.val, asize);
    _ = &i;
    while (i < asize) : (i +%= 1) {
        if (!((@as(c_int, @bitCast(@as(c_uint, (&t.*.array[i]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
            {
                var io: [*c]TValue = &key.*.val;
                _ = &io;
                io.*.value_.i = @as(lua_Integer, @bitCast(@as(c_ulonglong, i +% @as(c_uint, @bitCast(@as(c_int, 1))))));
                _ = blk: {
                    const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 3) | (@as(c_int, 0) << @intCast(4))))));
                    io.*.tt_ = tmp;
                    break :blk tmp;
            ...
            {
                var io1: [*c]TValue = &(key + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
                _ = &io1;
                var io2: [*c]const TValue = &t.*.array[i];
                _ = &io2;
                io1.*.value_ = io2.*.value_;
                _ = blk: {
                    const tmp = io2.*.tt_;
    ...
    {
        i -%= asize;
        while (@as(c_int, @bitCast(i)) < (@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode)))))) : (i +%= 1) {
            if (!((@as(c_int, @bitCast(@as(c_uint, (&(&t.*.node[i]).*.i_val).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
                var n: [*c]Node = &t.*.node[i];
                _ = &n;
                {
                    var io_: [*c]TValue = &key.*.val;
                    _ = &io_;
                    var n_: [*c]const Node = n;
                    _ = &n_;
                ...
                }
                {
                    var io1: [*c]TValue = &(key + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
                    _ = &io1;
                    var io2: [*c]const TValue = &n.*.i_val;
                    _ = &io2;
                    io1.*.value_ = io2.*.value_;
                    _ = blk: {
                        const tmp = io2.*.tt_;
...
pub export fn luaH_getn(arg_t: [*c]Table) lua_Unsigned {
    var t = arg_t;
    _ = &t;
    var limit: c_uint = t.*.alimit;
    _ = &limit;
    if ((limit > @as(c_uint, @bitCast(@as(c_int, 0)))) and ((@as(c_int, @bitCast(@as(c_uint, (&t.*.array[limit -% @as(c_uint, @bitCast(@as(c_int, 1)))]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
        if ((limit >= @as(c_uint, @bitCast(@as(c_int, 2)))) and !((@as(c_int, @bitCast(@as(c_uint, (&t.*.array[limit -% @as(c_uint, @bitCast(@as(c_int, 2)))]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
            if ((ispow2realasize(t) != 0) and !(((limit -% @as(c_uint, @bitCast(@as(c_int, 1)))) & ((limit -% @as(c_uint, @bitCast(@as(c_int, 1)))) -% @as(c_uint, @bitCast(@as(c_int, 1))))) == @as(c_uint, @bitCast(@as(c_int, 0))))) {
                t.*.alimit = limit -% @as(c_uint, @bitCast(@as(c_int, 1)));
                _ = blk: {
                    const ref = &t.*.flags;
                    ref.* |= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 1) << @intCast(7)))));
                    break :blk ref.*;
                };
            }
            return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, limit -% @as(c_uint, @bitCast(@as(c_int, 1))))));
        } else {
            var boundary: c_uint = binsearch(t.*.array, @as(c_uint, @bitCast(@as(c_int, 0))), limit);
            _ = &boundary;
            if ((ispow2realasize(t) != 0) and (boundary > (luaH_realasize(t) / @as(c_uint, @bitCast(@as(c_int, 2)))))) {
                t.*.alimit = boundary;
                _ = blk: {
                    const ref = &t.*.flags;
                    ref.* |= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 1) << @intCast(7)))));
            ...
            return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, boundary)));
        }
    }
    if (!(!((@as(c_int, @bitCast(@as(c_uint, t.*.flags))) & (@as(c_int, 1) << @intCast(7))) != 0) or ((t.*.alimit & (t.*.alimit -% @as(c_uint, @bitCast(@as(c_int, 1))))) == @as(c_uint, @bitCast(@as(c_int, 0)))))) {
        if ((@as(c_int, @bitCast(@as(c_uint, (&t.*.array[limit]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, limit)));
        limit = luaH_realasize(t);
        if ((@as(c_int, @bitCast(@as(c_uint, (&t.*.array[limit -% @as(c_uint, @bitCast(@as(c_int, 1)))]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
            var boundary: c_uint = binsearch(t.*.array, t.*.alimit, limit);
            _ = &boundary;
            t.*.alimit = boundary;
            return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, boundary)));
        }
    ...
    _ = @as(c_int, 0);
    if ((t.*.lastfree == @as([*c]Node, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((@as(c_int, @bitCast(@as(c_uint, luaH_getint(t, @as(lua_Integer, @bitCast(@as(c_ulonglong, limit +% @as(c_uint, @bitCast(@as(c_int, 1))))))).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, limit))) else return hash_search(t, @as(lua_Unsigned, @bitCast(@as(c_ulonglong, limit))));
    return mem.zeroes(lua_Unsigned);
}
pub export fn luaH_realasize(arg_t: [*c]const Table) callconv(.c) c_uint {
    var t = arg_t;
    _ = &t;
    if (!((@as(c_int, @bitCast(@as(c_uint, t.*.flags))) & (@as(c_int, 1) << @intCast(7))) != 0) or ((t.*.alimit & (t.*.alimit -% @as(c_uint, @bitCast(@as(c_int, 1))))) == @as(c_uint, @bitCast(@as(c_int, 0))))) return t.*.alimit else {
        var size: c_uint = t.*.alimit;
        _ = &size;
        size |= size >> @intCast(1);
        size |= size >> @intCast(2);
        size |= size >> @intCast(4);
        size |= size >> @intCast(8);
        size |= size >> @intCast(16);
        size +%= 1;
        _ = @as(c_int, 0);
        return size;
    }
...
pub const dummynode_: Node = Node{
    .u = struct_NodeKey_6{
        .value_ = Value{
            .gc = null,
        },
        .tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0) | (@as(c_int, 1) << @intCast(4)))))),
        .key_tt = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0) | (@as(c_int, 0) << @intCast(4)))))),
        .next = @as(c_int, 0),
        .key_val = Value{
            .gc = null,
        },
...
pub const absentkey: TValue = TValue{
    .value_ = Value{
        .gc = null,
    },
    .tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0) | (@as(c_int, 2) << @intCast(4)))))),
};
pub fn hashint(arg_t: [*c]const Table, arg_i: lua_Integer) callconv(.c) [*c]Node {
    var t = arg_t;
    _ = &t;
    var i = arg_i;
    _ = &i;
    var ui: lua_Unsigned = @as(lua_Unsigned, @bitCast(i));
    _ = &ui;
    if (ui <= @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, @bitCast(@as(c_int, 2147483647))))))) return &(blk: {
        const tmp = @import("std").zig.c_translation.signedRemainder(@as(c_int, @bitCast(@as(c_uint, @truncate(ui)))), ((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)) | @as(c_int, 1));
        if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* else return &t.*.node[@as(usize, @intCast(ui % @as(lua_Unsigned, @bitCast(@as(c_longlong, ((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)) | @as(c_int, 1))))))];
    return null;
}
pub fn l_hashfloat(arg_n: lua_Number) callconv(.c) c_int {
    var n = arg_n;
    _ = &n;
    var i: c_int = undefined;
    _ = &i;
    var ni: lua_Integer = undefined;
    _ = &ni;
    n = frexp(n, &i) * -@as(lua_Number, @floatFromInt(-@as(c_int, 2147483647) - @as(c_int, 1)));
    if (!(((n >= @as(f64, @floatFromInt(-@as(c_longlong, 9223372036854775807) - @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 1))))))) and (n < -@as(f64, @floatFromInt(-@as(c_longlong, 9223372036854775807) - @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 1)))))))) and ((blk: {
        (&ni).* = @as(c_longlong, @intFromFloat(n));
        break :blk @as(c_int, 1);
    }) != 0))) {
        _ = @as(c_int, 0);
        return 0;
    } else {
        var u: c_uint = @as(c_uint, @bitCast(i)) +% @as(c_uint, @bitCast(@as(c_int, @truncate(ni))));
        _ = &u;
        return @as(c_int, @bitCast(if (u <= @as(c_uint, @bitCast(@as(c_int, 2147483647)))) u else ~u));
    }
    return 0;
}
pub fn mainpositionTV(arg_t: [*c]const Table, arg_key: [*c]const TValue) callconv(.c) [*c]Node {
    var t = arg_t;
    _ = &t;
    var key = arg_key;
    _ = &key;
            ...
            @as(c_int, 19) => {
                {
                    ...
                    _ = &n;
                    return &(blk: {
                        const tmp = @import("std").zig.c_translation.signedRemainder(l_hashfloat(n), ((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)) | @as(c_int, 1));
                        if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                }
            },
            @as(c_int, 4) => {
                {
                    ...
                    return &(blk: {
                        const tmp = blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 @as(c_int, @bitCast(ts.*.hash & @as(c_uint, @bitCast((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)))));
                        };
                        if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                }
            ...
            @as(c_int, 20) => {
                {
                    ...
                    return &(blk: {
                        const tmp = blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 @as(c_int, @bitCast(luaS_hashlongstr(ts) & @as(c_uint, @bitCast((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)))));
                        };
                        if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                }
            },
            @as(c_int, 1) => return &(blk: {
                const tmp = blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 @as(c_int, 0) & ((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1));
                };
                if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*,
            @as(c_int, 17) => return &(blk: {
                const tmp = blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 @as(c_int, 1) & ((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1));
                };
                if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*,
            @as(c_int, 2) => {
                {
                    var p: ?*anyopaque = blk: {
                        _ = @as(c_int, 0);
                        break :blk key.*.value_.p;
                    };
                    _ = &p;
                    return &t.*.node[@as(c_uint, @bitCast(@as(c_uint, @truncate(@as(usize, @intCast(@intFromPtr(p))) & @as(usize, @bitCast(@as(c_ulong, @as(c_uint, 4294967295)))))))) % @as(c_uint, @bitCast(((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)) | @as(c_int, 1)))];
                }
            },
            @as(c_int, 22) => {
                {
                    var f: lua_CFunction = blk: {
                        _ = @as(c_int, 0);
                        break :blk key.*.value_.f;
                    };
                    _ = &f;
                    return &t.*.node[@as(c_uint, @bitCast(@as(c_uint, @truncate(@as(usize, @intCast(@intFromPtr(f))) & @as(usize, @bitCast(@as(c_ulong, @as(c_uint, 4294967295)))))))) % @as(c_uint, @bitCast(((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)) | @as(c_int, 1)))];
                }
            },
            else => {
                {
                    var o: [*c]GCObject = blk: {
                        _ = @as(c_int, 0);
                        break :blk key.*.value_.gc;
                    };
                    _ = &o;
                    return &t.*.node[@as(c_uint, @bitCast(@as(c_uint, @truncate(@as(usize, @intCast(@intFromPtr(o))) & @as(usize, @bitCast(@as(c_ulong, @as(c_uint, 4294967295)))))))) % @as(c_uint, @bitCast(((@as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))) - @as(c_int, 1)) | @as(c_int, 1)))];
                }
            },
        }
        break;
...
pub fn mainpositionfromnode(arg_t: [*c]const Table, arg_nd: [*c]Node) callconv(.c) [*c]Node {
    var t = arg_t;
    _ = &t;
    var nd = arg_nd;
    _ = &nd;
    var key: TValue = undefined;
    _ = &key;
    {
        var io_: [*c]TValue = &key;
        _ = &io_;
        var n_: [*c]const Node = nd;
        _ = &n_;
        io_.*.value_ = n_.*.u.key_val;
        io_.*.tt_ = n_.*.u.key_tt;
        _ = blk: {
...
pub fn equalkey(arg_k1: [*c]const TValue, arg_n2: [*c]const Node, arg_deadok: c_int) callconv(.c) c_int {
    var k1 = arg_k1;
    _ = &k1;
    var n2 = arg_n2;
    _ = &n2;
    var deadok = arg_deadok;
    _ = &deadok;
    if ((@as(c_int, @bitCast(@as(c_uint, k1.*.tt_))) != @as(c_int, @bitCast(@as(c_uint, n2.*.u.key_tt)))) and !(((deadok != 0) and (@as(c_int, @bitCast(@as(c_uint, n2.*.u.key_tt))) == (@as(c_int, 9) + @as(c_int, 2)))) and ((@as(c_int, @bitCast(@as(c_uint, k1.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0))) return 0;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, n2.*.u.key_tt)))) {
            @as(c_int, 0), @as(c_int, 1), @as(c_int, 17) => return 1,
            @as(c_int, 3) => return @intFromBool((blk: {
                _ = @as(c_int, 0);
                break :blk k1.*.value_.i;
            }) == n2.*.u.key_val.i),
            @as(c_int, 19) => return @intFromBool((blk: {
                _ = @as(c_int, 0);
                break :blk k1.*.value_.n;
            }) == n2.*.u.key_val.n),
            @as(c_int, 2) => return @intFromBool((blk: {
                _ = @as(c_int, 0);
                break :blk k1.*.value_.p;
            }) == n2.*.u.key_val.p),
            @as(c_int, 22) => return @intFromBool((blk: {
                _ = @as(c_int, 0);
                break :blk k1.*.value_.f;
            }) == n2.*.u.key_val.f),
            @as(c_int, 84) => return luaS_eqlngstr(blk: {
                _ = @as(c_int, 0);
                break :blk blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(k1.*.value_.gc))).*.ts;
                };
            }, blk: {
                _ = @as(c_int, 0);
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(n2.*.u.key_val.gc))).*.ts;
            }),
            else => return @intFromBool((blk: {
                _ = @as(c_int, 0);
                break :blk k1.*.value_.gc;
            }) == n2.*.u.key_val.gc),
        }
        break;
    }
...
pub fn ispow2realasize(arg_t: [*c]const Table) callconv(.c) c_int {
    var t = arg_t;
    _ = &t;
    return @intFromBool(!!((@as(c_int, @bitCast(@as(c_uint, t.*.flags))) & (@as(c_int, 1) << @intCast(7))) != 0) or ((t.*.alimit & (t.*.alimit -% @as(c_uint, @bitCast(@as(c_int, 1))))) == @as(c_uint, @bitCast(@as(c_int, 0)))));
}
pub fn setlimittosize(arg_t: [*c]Table) callconv(.c) c_uint {
    var t = arg_t;
    _ = &t;
    t.*.alimit = luaH_realasize(t);
    _ = blk: {
        const ref = &t.*.flags;
        ref.* &= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(~(@as(c_int, 1) << @intCast(7)))))))))))));
        break :blk ref.*;
    };
    return t.*.alimit;
}
pub fn getgeneric(arg_t: [*c]Table, arg_key: [*c]const TValue, arg_deadok: c_int) callconv(.c) [*c]const TValue {
    var t = arg_t;
    _ = &t;
    var key = arg_key;
    _ = &key;
    var deadok = arg_deadok;
    _ = &deadok;
    var n: [*c]Node = mainpositionTV(t, key);
    _ = &n;
    while (true) {
        if (equalkey(key, n, deadok) != 0) return &n.*.i_val else {
            var nx: c_int = n.*.u.next;
            _ = &nx;
            if (nx == @as(c_int, 0)) return &absentkey;
            n += @as(usize, @bitCast(@as(isize, @intCast(nx))));
...
pub fn arrayindex(arg_k: lua_Integer) callconv(.c) c_uint {
    var k = arg_k;
    _ = &k;
    if ((@as(lua_Unsigned, @bitCast(k)) -% @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, 1))))) < @as(lua_Unsigned, @bitCast(@as(c_ulonglong, if (@as(usize, @bitCast(@as(c_ulong, @as(c_uint, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, @truncate((@sizeOf(c_int) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))))))))) <= (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(TValue))) @as(c_uint, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, @truncate((@sizeOf(c_int) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))))))) else @as(c_uint, @bitCast(@as(c_uint, @truncate(~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(TValue))))))))) return @as(c_uint, @bitCast(@as(c_int, @truncate(k)))) else return 0;
    return 0;
}
pub fn findindex(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_key: [*c]TValue, arg_asize: c_uint) callconv(.c) c_uint {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    var i: c_uint = undefined;
    _ = &i;
    if ((@as(c_int, @bitCast(@as(c_uint, key.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) return 0;
    i = if (@as(c_int, @bitCast(@as(c_uint, key.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) arrayindex(blk: {
        _ = @as(c_int, 0);
        break :blk key.*.value_.i;
    }) else @as(c_uint, @bitCast(@as(c_int, 0)));
    if ((i -% @as(c_uint, 1)) < asize) return i else {
        var n: [*c]const TValue = getgeneric(t, key, @as(c_int, 1));
        _ = &n;
        if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(@as(c_int, @bitCast(@as(c_uint, n.*.tt_))) == (@as(c_int, 0) | (@as(c_int, 2) << @intCast(4)))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
            luaG_runerror(L, "invalid key to 'next'");
        }
        i = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(@as([*c]Node, @ptrCast(@constCast(@volatileCast(n))))) -% @intFromPtr(&t.*.node[@as(c_uint, @intCast(@as(c_int, 0)))]))), @sizeOf(Node))))))));
        return (i +% @as(c_uint, @bitCast(@as(c_int, 1)))) +% asize;
    }
    return 0;
}
pub fn freehash(arg_L: [*c]lua_State, arg_t: [*c]Table) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    if (!(t.*.lastfree == @as([*c]Node, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        luaM_free_(L, @as(?*anyopaque, @ptrCast(t.*.node)), @as(usize, @bitCast(@as(c_long, @as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))))))) *% @sizeOf(Node));
    }
}
pub fn computesizes(arg_nums: [*c]c_uint, arg_pna: [*c]c_uint) callconv(.c) c_uint {
    var nums = arg_nums;
    _ = &nums;
    var pna = arg_pna;
    _ = &pna;
    var i: c_int = undefined;
    _ = &i;
    var twotoi: c_uint = undefined;
    _ = &twotoi;
    var a: c_uint = 0;
    _ = &a;
    var na: c_uint = 0;
    _ = &na;
    var optimal: c_uint = 0;
    _ = &optimal;
    {
        _ = blk: {
            i = 0;
        ...
        while ((twotoi > @as(c_uint, @bitCast(@as(c_int, 0)))) and (pna.* > (twotoi / @as(c_uint, @bitCast(@as(c_int, 2)))))) : (_ = blk: {
            i += 1;
            break :blk blk_1: {
                const ref = &twotoi;
                ref.* *%= @as(c_uint, @bitCast(@as(c_int, 2)));
                break :blk_1 ref.*;
            };
        }) {
            a +%= (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk nums + @as(usize, @intCast(tmp)) else break :blk nums - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            if (a > (twotoi / @as(c_uint, @bitCast(@as(c_int, 2))))) {
                optimal = twotoi;
                na = a;
            }
        }
...
pub fn countint(arg_key: lua_Integer, arg_nums: [*c]c_uint) callconv(.c) c_int {
    var key = arg_key;
    _ = &key;
    var nums = arg_nums;
    _ = &nums;
    var k: c_uint = arrayindex(key);
    _ = &k;
    if (k != @as(c_uint, @bitCast(@as(c_int, 0)))) {
        (blk: {
            const tmp = luaO_ceillog2(k);
            if (tmp >= 0) break :blk nums + @as(usize, @intCast(tmp)) else break :blk nums - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* +%= 1;
        return 1;
    } else return 0;
...
pub fn numusearray(arg_t: [*c]const Table, arg_nums: [*c]c_uint) callconv(.c) c_uint {
    var t = arg_t;
    _ = &t;
    var nums = arg_nums;
    _ = &nums;
    var lg: c_int = undefined;
    _ = &lg;
    var ttlg: c_uint = undefined;
    _ = &ttlg;
    var ause: c_uint = 0;
    _ = &ause;
    var i: c_uint = 1;
    _ = &i;
    var asize: c_uint = blk: {
        _ = @as(c_int, 0);
        break :blk t.*.alimit;
    };
    _ = &asize;
    {
        ...
        while (lg <= @as(c_int, @bitCast(@as(c_uint, @truncate((@sizeOf(c_int) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))))))) : (_ = blk: {
            lg += 1;
            break :blk blk_1: {
                const ref = &ttlg;
                ref.* *%= @as(c_uint, @bitCast(@as(c_int, 2)));
            ...
            while (i <= lim) : (i +%= 1) {
                if (!((@as(c_int, @bitCast(@as(c_uint, (&t.*.array[i -% @as(c_uint, @bitCast(@as(c_int, 1)))]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
                    lc +%= 1;
                }
            }
            (blk: {
...
pub fn numusehash(arg_t: [*c]const Table, arg_nums: [*c]c_uint, arg_pna: [*c]c_uint) callconv(.c) c_int {
    var t = arg_t;
    _ = &t;
    var nums = arg_nums;
    _ = &nums;
    var pna = arg_pna;
    _ = &pna;
    var totaluse: c_int = 0;
    _ = &totaluse;
    var ause: c_int = 0;
    _ = &ause;
    var i: c_int = @as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, t.*.lsizenode))));
    _ = &i;
    while ((blk: {
        const ref = &i;
        const tmp = ref.*;
        ...
        _ = &n;
        if (!((@as(c_int, @bitCast(@as(c_uint, (&n.*.i_val).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
            if (@as(c_int, @bitCast(@as(c_uint, n.*.u.key_tt))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) {
                ause += countint(n.*.u.key_val.i, nums);
            }
            totaluse += 1;
        }
    }
    pna.* +%= @as(c_uint, @bitCast(ause));
    return totaluse;
}
pub fn setnodevector(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_size: c_uint) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    var size = arg_size;
    _ = &size;
    if (size == @as(c_uint, @bitCast(@as(c_int, 0)))) {
        t.*.node = @as([*c]Node, @ptrCast(@constCast(@volatileCast(&dummynode_))));
        t.*.lsizenode = 0;
        t.*.lastfree = null;
    } else {
        var i: c_int = undefined;
        _ = &i;
        var lsize: c_int = luaO_ceillog2(size);
        _ = &lsize;
        if ((lsize > (@as(c_int, @bitCast(@as(c_uint, @truncate((@sizeOf(c_int) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))))) - @as(c_int, 1))) or ((@as(c_uint, 1) << @intCast(lsize)) > (if (@as(usize, @bitCast(@as(c_ulong, @as(c_uint, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, @truncate((@sizeOf(c_int) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))))) - @as(c_int, 1))))) <= (~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(Node))) @as(c_uint, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, @truncate((@sizeOf(c_int) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))))) - @as(c_int, 1)) else @as(c_uint, @bitCast(@as(c_uint, @truncate(~@as(usize, @bitCast(@as(c_long, @as(c_int, 0)))) / @sizeOf(Node)))))))) {
            luaG_runerror(L, "table overflow");
        }
        size = @as(c_uint, @bitCast(@as(c_int, 1) << @intCast(lsize)));
        t.*.node = @as([*c]Node, @ptrCast(@alignCast(luaM_malloc_(L, @as(c_ulong, @bitCast(@as(c_ulong, size))) *% @sizeOf(Node), @as(c_int, 0)))));
        {
            i = 0;
            while (i < @as(c_int, @bitCast(size))) : (i += 1) {
                var n: [*c]Node = &(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk t.*.node + @as(usize, @intCast(tmp)) else break :blk t.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*;
                ...
                n.*.u.next = 0;
                _ = blk: {
                    const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0)))));
                    n.*.u.key_tt = tmp;
                    break :blk tmp;
                };
                _ = blk: {
        ...
        t.*.lsizenode = @as(lu_byte, @bitCast(@as(i8, @truncate(lsize))));
        t.*.lastfree = &t.*.node[size];
    }
}
pub fn reinsert(arg_L: [*c]lua_State, arg_ot: [*c]Table, arg_t: [*c]Table) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var ot = arg_ot;
    _ = &ot;
    ...
    _ = &j;
    var size: c_int = @as(c_int, 1) << @intCast(@as(c_int, @bitCast(@as(c_uint, ot.*.lsizenode))));
    _ = &size;
    {
        j = 0;
        while (j < size) : (j += 1) {
            var old: [*c]Node = &(blk: {
                const tmp = j;
                if (tmp >= 0) break :blk ot.*.node + @as(usize, @intCast(tmp)) else break :blk ot.*.node - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            _ = &old;
            if (!((@as(c_int, @bitCast(@as(c_uint, (&old.*.i_val).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) {
                var k: TValue = undefined;
                _ = &k;
                {
                    var io_: [*c]TValue = &k;
                    _ = &io_;
                    var n_: [*c]const Node = old;
                    _ = &n_;
                    io_.*.value_ = n_.*.u.key_val;
                    io_.*.tt_ = n_.*.u.key_tt;
                    _ = blk: {
...
pub fn exchangehashpart(arg_t1: [*c]Table, arg_t2: [*c]Table) callconv(.c) void {
    var t1 = arg_t1;
    _ = &t1;
    var t2 = arg_t2;
    _ = &t2;
    var lsizenode: lu_byte = t1.*.lsizenode;
    _ = &lsizenode;
    var node: [*c]Node = t1.*.node;
    _ = &node;
    var lastfree: [*c]Node = t1.*.lastfree;
    _ = &lastfree;
...
pub fn rehash(arg_L: [*c]lua_State, arg_t: [*c]Table, arg_ek: [*c]const TValue) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    var ek = arg_ek;
    _ = &ek;
    var asize: c_uint = undefined;
    _ = &asize;
    var na: c_uint = undefined;
    _ = &na;
    var nums: [32]c_uint = undefined;
    _ = &nums;
    var i: c_int = undefined;
    _ = &i;
    var totaluse: c_int = undefined;
    _ = &totaluse;
    {
        i = 0;
        while (i <= @as(c_int, @bitCast(@as(c_uint, @truncate((@sizeOf(c_int) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))))))) : (i += 1) {
            nums[@as(c_uint, @intCast(i))] = 0;
        }
    }
    _ = setlimittosize(t);
    na = numusearray(t, @as([*c]c_uint, @ptrCast(@alignCast(&nums[@as(usize, @intCast(0))]))));
    totaluse = @as(c_int, @bitCast(na));
    totaluse += numusehash(t, @as([*c]c_uint, @ptrCast(@alignCast(&nums[@as(usize, @intCast(0))]))), &na);
    if (@as(c_int, @bitCast(@as(c_uint, ek.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) {
        na +%= @as(c_uint, @bitCast(countint(blk: {
            _ = @as(c_int, 0);
            break :blk ek.*.value_.i;
        }, @as([*c]c_uint, @ptrCast(@alignCast(&nums[@as(usize, @intCast(0))]))))));
    }
    totaluse += 1;
    asize = computesizes(@as([*c]c_uint, @ptrCast(@alignCast(&nums[@as(usize, @intCast(0))]))), &na);
    luaH_resize(L, t, asize, @as(c_uint, @bitCast(totaluse)) -% na);
}
pub fn getfreepos(arg_t: [*c]Table) callconv(.c) [*c]Node {
    var t = arg_t;
    _ = &t;
    if (!(t.*.lastfree == @as([*c]Node, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        while (t.*.lastfree > t.*.node) {
            t.*.lastfree -= 1;
            if (@as(c_int, @bitCast(@as(c_uint, t.*.lastfree.*.u.key_tt))) == @as(c_int, 0)) return t.*.lastfree;
        }
    }
    return null;
}
pub fn hash_search(arg_t: [*c]Table, arg_j: lua_Unsigned) callconv(.c) lua_Unsigned {
    var t = arg_t;
    _ = &t;
    var j = arg_j;
    _ = &j;
    var i: lua_Unsigned = undefined;
    _ = &i;
    if (j == @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 0))))) {
        j +%= 1;
    }
    while (true) {
        i = j;
        if (j <= (@as(lua_Unsigned, @bitCast(@as(c_longlong, 9223372036854775807))) / @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 2)))))) {
            j *%= @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 2))));
        } else {
            j = @as(lua_Unsigned, @bitCast(@as(c_longlong, 9223372036854775807)));
            if ((@as(c_int, @bitCast(@as(c_uint, luaH_getint(t, @as(lua_Integer, @bitCast(j))).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) break else return j;
        }
        if (!!((@as(c_int, @bitCast(@as(c_uint, luaH_getint(t, @as(lua_Integer, @bitCast(j))).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) break;
    }
    while ((j -% i) > @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, 1))))) {
        var m: lua_Unsigned = (i +% j) / @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 2))));
        _ = &m;
        if ((@as(c_int, @bitCast(@as(c_uint, luaH_getint(t, @as(lua_Integer, @bitCast(m))).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
            j = m;
        } else {
            i = m;
        }
...
pub fn binsearch(arg_array: [*c]const TValue, arg_i: c_uint, arg_j: c_uint) callconv(.c) c_uint {
    var array = arg_array;
    _ = &array;
    var i = arg_i;
    _ = &i;
    var j = arg_j;
    _ = &j;
    while ((j -% i) > @as(c_uint, 1)) {
        var m: c_uint = (i +% j) / @as(c_uint, @bitCast(@as(c_int, 2)));
        _ = &m;
        if ((@as(c_int, @bitCast(@as(c_uint, (&array[m -% @as(c_uint, @bitCast(@as(c_int, 1)))]).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
            j = m;
        } else {
            i = m;
        }
...
pub const MAXABITS = cast_int((@import("std").zig.c_translation.sizeof(c_int) * CHAR_BIT) - @as(c_int, 1));
pub const MAXASIZE = luaM_limitN(@as(c_uint, 1) << MAXABITS, TValue);
pub const MAXHBITS = MAXABITS - @as(c_int, 1);
pub const MAXHSIZE = luaM_limitN(@as(c_uint, 1) << MAXHBITS, Node);
pub inline fn hashpow2(t: anytype, n: anytype) @TypeOf(gnode(t, lmod(n, sizenode(t)))) {
    _ = &t;
    _ = &n;
    return gnode(t, lmod(n, sizenode(t)));
}
pub inline fn hashmod(t: anytype, n: anytype) @TypeOf(gnode(t, @import("std").zig.c_translation.MacroArithmetic.rem(n, (sizenode(t) - @as(c_int, 1)) | @as(c_int, 1)))) {
    _ = &t;
    _ = &n;
    return gnode(t, @import("std").zig.c_translation.MacroArithmetic.rem(n, (sizenode(t) - @as(c_int, 1)) | @as(c_int, 1)));
}
pub inline fn hashstr(t: anytype, str: anytype) @TypeOf(hashpow2(t, str.*.hash)) {
    _ = &t;
    _ = &str;
    return hashpow2(t, str.*.hash);
}
pub inline fn hashboolean(t: anytype, p: anytype) @TypeOf(hashpow2(t, p)) {
    _ = &t;
    _ = &p;
    return hashpow2(t, p);
}
pub inline fn hashpointer(t: anytype, p: anytype) @TypeOf(hashmod(t, point2uint(p))) {
    _ = &t;
    _ = &p;
    return hashmod(t, point2uint(p));
}
pub const dummynode = &dummynode_;
pub inline fn limitequalsasize(t: anytype) @TypeOf((isrealasize(t) != 0) or (ispow2(t.*.alimit) != 0)) {
    _ = &t;
    return (isrealasize(t) != 0) or (ispow2(t.*.alimit) != 0);
}
pub inline fn limitasasize(t: anytype) @TypeOf(check_exp(isrealasize(t), t.*.alimit)) {
    _ = &t;
    return check_exp(isrealasize(t), t.*.alimit);
}
