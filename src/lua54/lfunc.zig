...
pub export fn luaF_newproto(arg_L: [*c]lua_State) [*c]Proto {
    var L = arg_L;
    _ = &L;
    var o: [*c]GCObject = luaC_newobj(L, (@as(c_int, 9) + @as(c_int, 1)) | (@as(c_int, 0) << @intCast(4)), @sizeOf(Proto));
    _ = &o;
    var f: [*c]Proto = blk: {
        _ = @as(c_int, 0);
...
pub export fn luaF_newCclosure(arg_L: [*c]lua_State, arg_nupvals: c_int) [*c]CClosure {
    var L = arg_L;
    _ = &L;
    var nupvals = arg_nupvals;
    _ = &nupvals;
    var o: [*c]GCObject = luaC_newobj(L, @as(c_int, 6) | (@as(c_int, 2) << @intCast(4)), @as(usize, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, @truncate(@offsetOf(struct_CClosure, "upvalue"))))) + (@as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(TValue))))) * nupvals)))));
    _ = &o;
    var c: [*c]CClosure = blk: {
        _ = @as(c_int, 0);
        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(o))).*.cl.c;
    };
    _ = &c;
    c.*.nupvalues = @as(lu_byte, @bitCast(@as(i8, @truncate(nupvals))));
    return c;
}
pub export fn luaF_newLclosure(arg_L: [*c]lua_State, arg_nupvals: c_int) [*c]LClosure {
    var L = arg_L;
    _ = &L;
    var nupvals = arg_nupvals;
    _ = &nupvals;
    var o: [*c]GCObject = luaC_newobj(L, @as(c_int, 6) | (@as(c_int, 0) << @intCast(4)), @as(usize, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, @truncate(@offsetOf(struct_LClosure, "upvals"))))) + (@as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([*c]TValue))))) * nupvals)))));
    _ = &o;
    ...
    while ((blk: {
        ...
        @as([*][*c]UpVal, @ptrCast(&c.*.upvals))[@as(c_uint, @intCast(nupvals))] = null;
    }
    return c;
}
pub export fn luaF_initupvals(arg_L: [*c]lua_State, arg_cl: [*c]LClosure) void {
    var L = arg_L;
    _ = &L;
    var cl = arg_cl;
    _ = &cl;
    ...
    _ = &i;
    {
        ...
        while (i < @as(c_int, @bitCast(@as(c_uint, cl.*.nupvalues)))) : (i += 1) {
            var o: [*c]GCObject = luaC_newobj(L, @as(c_int, 9) | (@as(c_int, 0) << @intCast(4)), @sizeOf(UpVal));
            _ = &o;
            var uv: [*c]UpVal = blk: {
                _ = @as(c_int, 0);
            ...
            @as([*][*c]UpVal, @ptrCast(&cl.*.upvals))[@as(c_uint, @intCast(i))] = uv;
            _ = if (((@as(c_int, @bitCast(@as(c_uint, cl.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, uv.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(L, blk: {
                _ = @as(c_int, 0);
...
pub export fn luaF_findupval(arg_L: [*c]lua_State, arg_level: StkId) [*c]UpVal {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
    var pp: [*c][*c]UpVal = &L.*.openupval;
    _ = &pp;
    var p: [*c]UpVal = undefined;
    _ = &p;
    _ = @as(c_int, 0);
    ...
    while (((blk: {
        ...
        p = tmp;
        break :blk tmp;
    }) != @as([*c]UpVal, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and ((blk: {
        _ = @as(c_int, 0);
        break :blk @as(StkId, @ptrCast(@alignCast(p.*.v.p)));
    }) >= level)) {
        loop_count += 1;
        if (loop_count > 1000) return @ptrFromInt(0); // infinite loop guard
        _ = @as(c_int, 0);
        if ((blk: {
            _ = @as(c_int, 0);
            break :blk @as(StkId, @ptrCast(@alignCast(p.*.v.p)));
...
pub export fn luaF_newtbcupval(arg_L: [*c]lua_State, arg_level: StkId) void {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
    _ = @as(c_int, 0);
    if ((@as(c_int, @bitCast(@as(c_uint, (&level.*.val).*.tt_))) == (@as(c_int, 1) | (@as(c_int, 0) << @intCast(4)))) or ((@as(c_int, @bitCast(@as(c_uint, (&level.*.val).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))) return;
    checkclosemth(L, level);
    while (@as(c_ulong, @bitCast(@as(c_ulong, @as(c_uint, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(level) -% @intFromPtr(L.*.tbclist.p))), @sizeOf(StackValue))))))))) > ((@as(c_ulong, 256) << @intCast((@sizeOf(c_ushort) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))) {
        L.*.tbclist.p += (@as(c_ulong, 256) << @intCast((@sizeOf(c_ushort) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))));
        L.*.tbclist.p.*.tbclist.delta = 0;
    }
    level.*.tbclist.delta = @as(c_ushort, @bitCast(@as(c_short, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(level) -% @intFromPtr(L.*.tbclist.p))), @sizeOf(StackValue))))));
    L.*.tbclist.p = level;
}
pub export fn luaF_closeupval(arg_L: [*c]lua_State, arg_level: StkId) void {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
    ...
    _ = &uv;
    var upl: StkId = undefined;
    _ = &upl;
    while (((blk: {
        const tmp = L.*.openupval;
        uv = tmp;
        break :blk tmp;
    }) != @as([*c]UpVal, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and ((blk: {
        const tmp = blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 @as(StkId, @ptrCast(@alignCast(uv.*.v.p)));
        };
        upl = tmp;
        break :blk tmp;
    }) >= level)) {
        var slot: [*c]TValue = &uv.*.u.value;
        _ = &slot;
        _ = @as(c_int, 0);
        luaF_unlinkupval(uv);
        {
            var io1: [*c]TValue = slot;
            _ = &io1;
            var io2: [*c]const TValue = uv.*.v.p;
            _ = &io2;
        ...
        if (!((@as(c_int, @bitCast(@as(c_uint, uv.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) {
            ...
            _ = if ((@as(c_int, @bitCast(@as(c_uint, slot.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) if (((@as(c_int, @bitCast(@as(c_uint, uv.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                _ = @as(c_int, 0);
                break :blk slot.*.value_.gc;
                ...
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 slot.*.value_.gc;
                }))).*.gc;
            }) else @as(c_int, 0) else @as(c_int, 0);
        }
    }
}
pub export fn luaF_close(arg_L: [*c]lua_State, arg_level: StkId, arg_status: c_int, arg_yy: c_int) StkId {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
    ...
    var yy = arg_yy;
    _ = &yy;
    var levelrel: ptrdiff_t = @divExact(@as(c_long, @bitCast(@intFromPtr(@as([*c]u8, @ptrCast(@alignCast(level)))) -% @intFromPtr(@as([*c]u8, @ptrCast(@alignCast(L.*.stack.p)))))), @sizeOf(u8));
    _ = &levelrel;
    luaF_closeupval(L, level);
    while (L.*.tbclist.p >= level) {
        var tbc: StkId = L.*.tbclist.p;
        _ = &tbc;
        poptbclist(L);
        prepcallclosemth(L, tbc, status, yy);
        level = @as(StkId, @ptrFromInt(@intFromPtr(L.*.stack.p) + @as(usize, @bitCast(@as(isize, @intCast(levelrel))))));
    }
    return level;
}
pub export fn luaF_unlinkupval(arg_uv: [*c]UpVal) void {
    var uv = arg_uv;
    _ = &uv;
    _ = @as(c_int, 0);
...
pub export fn luaF_freeproto(arg_L: [*c]lua_State, arg_f: [*c]Proto) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f.*.code)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizecode))) *% @sizeOf(Instruction));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f.*.p)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizep))) *% @sizeOf([*c]struct_Proto));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f.*.k)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizek))) *% @sizeOf(TValue));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f.*.lineinfo)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizelineinfo))) *% @sizeOf(ls_byte));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f.*.abslineinfo)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizeabslineinfo))) *% @sizeOf(AbsLineInfo));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f.*.locvars)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizelocvars))) *% @sizeOf(LocVar));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f.*.upvalues)), @as(c_ulong, @bitCast(@as(c_long, f.*.sizeupvalues))) *% @sizeOf(Upvaldesc));
    luaM_free_(L, @as(?*anyopaque, @ptrCast(f)), @sizeOf(Proto));
}
pub export fn luaF_getlocalname(arg_f: [*c]const Proto, arg_local_number: c_int, arg_pc: c_int) [*c]const u8 {
    var f = arg_f;
    _ = &f;
    var local_number = arg_local_number;
    _ = &local_number;
    var pc = arg_pc;
    _ = &pc;
    var i: c_int = undefined;
    _ = &i;
    {
        ...
        while ((i < f.*.sizelocvars) and ((blk: {
            ...
            if (pc < (blk: {
                ...
                local_number -= 1;
                if (local_number == @as(c_int, 0)) return @as([*c]u8, @ptrCast(@alignCast(&(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk f.*.locvars + @as(usize, @intCast(tmp)) else break :blk f.*.locvars - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*.varname.*.contents[@as(usize, @intCast(0))])));
            }
        }
    }
    return null;
...
pub fn newupval(arg_L: [*c]lua_State, arg_level: StkId, arg_prev: [*c][*c]UpVal) callconv(.c) [*c]UpVal {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
...
pub fn callclosemethod(arg_L: [*c]lua_State, arg_obj: [*c]TValue, arg_err: [*c]TValue, arg_yy: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var obj = arg_obj;
    _ = &obj;
    ...
    _ = &top;
    var tm: [*c]const TValue = luaT_gettmbyobj(L, obj, @as(c_uint, @bitCast(TM_CLOSE)));
    _ = &tm;
    {
        var io1: [*c]TValue = &top.*.val;
        _ = &io1;
    ...
    {
        var io1: [*c]TValue = &(top + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
        _ = &io1;
        var io2: [*c]const TValue = obj;
        _ = &io2;
        io1.*.value_ = io2.*.value_;
        _ = blk: {
            const tmp = io2.*.tt_;
    ...
    L.*.top.p = top + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))));
    if (yy != 0) {
        luaD_call(L, top, @as(c_int, 0));
    } else {
        luaD_callnoyield(L, top, @as(c_int, 0));
    }
}
pub fn checkclosemth(arg_L: [*c]lua_State, arg_level: StkId) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
    var tm: [*c]const TValue = luaT_gettmbyobj(L, &level.*.val, @as(c_uint, @bitCast(TM_CLOSE)));
    _ = &tm;
    if ((@as(c_int, @bitCast(@as(c_uint, tm.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
        var idx: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(level) -% @intFromPtr(L.*.ci.*.func.p))), @sizeOf(StackValue))))));
        _ = &idx;
        var vname: [*c]const u8 = luaG_findlocal(L, L.*.ci, idx, null);
        _ = &vname;
        if (vname == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            vname = "?";
        }
        luaG_runerror(L, "variable '%s' got a non-closable value", vname);
    }
}
pub fn prepcallclosemth(arg_L: [*c]lua_State, arg_level: StkId, arg_status: c_int, arg_yy: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
    ...
    if (status == -@as(c_int, 1)) {
        ...
        errobj = &(level + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
        luaD_seterrorobj(L, status, level + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))));
    }
    callclosemethod(L, uv, errobj, yy);
}
pub fn poptbclist(arg_L: [*c]lua_State) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var tbc: StkId = L.*.tbclist.p;
    _ = &tbc;
    _ = @as(c_int, 0);
    tbc -= @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, @bitCast(@as(c_uint, tbc.*.tbclist.delta)))))));
    while ((tbc > L.*.stack.p) and (@as(c_int, @bitCast(@as(c_uint, tbc.*.tbclist.delta))) == @as(c_int, 0))) {
        tbc -= (@as(c_ulong, 256) << @intCast((@sizeOf(c_ushort) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))))) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))));
    }
    L.*.tbclist.p = tbc;
}
...
pub const MAXDELTA = @compileError("unable to translate macro: undefined identifier `L`");
// /src/cosmopolitan/third_party/lua/lfunc.c:178:9
