...
pub export fn lua_getstack(arg_L: [*c]lua_State, arg_level: c_int, arg_ar: [*c]lua_Debug) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var level = arg_level;
    _ = &level;
    ...
    _ = &ci;
    if (level < @as(c_int, 0)) return 0;
    _ = @as(c_int, 0);
    {
        ci = L.*.ci;
        while ((level > @as(c_int, 0)) and (ci != (&L.*.base_ci))) : (ci = ci.*.previous) {
            level -= 1;
        }
    }
    if ((level == @as(c_int, 0)) and (ci != (&L.*.base_ci))) {
        status = 1;
        ar.*.i_ci = ci;
    } else {
        status = 0;
...
pub export fn lua_getinfo(arg_L: [*c]lua_State, arg_what: [*c]const u8, arg_ar: [*c]lua_Debug) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var what = arg_what;
    _ = &what;
    ...
    var status: c_int = undefined;
    _ = &status;
    var cl: [*c]Closure = undefined;
    _ = &cl;
    var ci: [*c]CallInfo = undefined;
    _ = &ci;
    var func: [*c]TValue = undefined;
    _ = &func;
    _ = @as(c_int, 0);
    if (@as(c_int, @bitCast(@as(c_uint, what.*))) == @as(c_int, '>')) {
        ci = null;
        func = &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
        _ = blk: {
            _ = &L;
    ...
    cl = if ((@as(c_int, @bitCast(@as(c_uint, func.*.tt_))) == ((@as(c_int, 6) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) or (@as(c_int, @bitCast(@as(c_uint, func.*.tt_))) == ((@as(c_int, 6) | (@as(c_int, 2) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))) blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(func.*.value_.gc))).*.cl;
        };
    } else null;
    status = auxgetinfo(L, what, ar, cl, ci);
    if (strchr(what, @as(c_int, 'f')) != null) {
        {
            var io1: [*c]TValue = &L.*.top.p.*.val;
            _ = &io1;
            var io2: [*c]const TValue = func;
            _ = &io2;
    ...
    if (strchr(what, @as(c_int, 'L')) != null) {
...
pub export fn lua_getlocal(arg_L: [*c]lua_State, arg_ar: [*c]const lua_Debug, arg_n: c_int) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var ar = arg_ar;
    _ = &ar;
    ...
    _ = &name;
    _ = @as(c_int, 0);
    if (ar == @as([*c]const lua_Debug, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (!(@as(c_int, @bitCast(@as(c_uint, (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.tt_))) == ((@as(c_int, 6) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))) {
            name = null;
        } else {
            name = luaF_getlocalname((blk: {
                _ = @as(c_int, 0);
                break :blk blk_1: {
                    _ = @as(c_int, 0);
        ...
        if (name != null) {
            {
                var io1: [*c]TValue = &L.*.top.p.*.val;
                _ = &io1;
                var io2: [*c]const TValue = &pos.*.val;
                _ = &io2;
                io1.*.value_ = io2.*.value_;
                _ = blk: {
                    const tmp = io2.*.tt_;
...
pub export fn lua_setlocal(arg_L: [*c]lua_State, arg_ar: [*c]const lua_Debug, arg_n: c_int) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var ar = arg_ar;
    _ = &ar;
...
pub export fn lua_sethook(arg_L: [*c]lua_State, arg_func: lua_Hook, arg_mask: c_int, arg_count: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var func = arg_func;
    _ = &func;
    ...
    var count = arg_count;
    _ = &count;
    if ((func == @as(lua_Hook, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (mask == @as(c_int, 0))) {
        mask = 0;
        func = null;
    }
    L.*.hook = func;
    ...
    L.*.hookmask = @as(sig_atomic_t, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(i8, @truncate(mask)))))));
    if (mask != 0) {
        settraps(L.*.ci);
    }
}
pub export fn lua_gethook(arg_L: [*c]lua_State) callconv(.c) lua_Hook {
    var L = arg_L;
    _ = &L;
    return L.*.hook;
}
pub export fn lua_gethookmask(arg_L: [*c]lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return L.*.hookmask;
}
pub export fn lua_gethookcount(arg_L: [*c]lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
...
pub const struct_Token = extern struct {
    token: c_int = std.mem.zeroes(c_int),
    seminfo: SemInfo = std.mem.zeroes(SemInfo),
};
pub const Token = struct_Token;
pub const struct_BlockCnt = opaque {};
pub const struct_FuncState = extern struct {
    f: [*c]Proto = std.mem.zeroes([*c]Proto),
    prev: [*c]struct_FuncState = std.mem.zeroes([*c]struct_FuncState),
    ls: [*c]struct_LexState = std.mem.zeroes([*c]struct_LexState),
    bl: ?*struct_BlockCnt = std.mem.zeroes(?*struct_BlockCnt),
    pc: c_int = std.mem.zeroes(c_int),
    lasttarget: c_int = std.mem.zeroes(c_int),
    previousline: c_int = std.mem.zeroes(c_int),
    nk: c_int = std.mem.zeroes(c_int),
    np: c_int = std.mem.zeroes(c_int),
    nabslineinfo: c_int = std.mem.zeroes(c_int),
    firstlocal: c_int = std.mem.zeroes(c_int),
    firstlabel: c_int = std.mem.zeroes(c_int),
    ndebugvars: c_short = std.mem.zeroes(c_short),
    nactvar: lu_byte = std.mem.zeroes(lu_byte),
    nups: lu_byte = std.mem.zeroes(lu_byte),
    freereg: lu_byte = std.mem.zeroes(lu_byte),
    iwthabs: lu_byte = std.mem.zeroes(lu_byte),
    needclose: lu_byte = std.mem.zeroes(lu_byte),
};
const struct_unnamed_15 = extern struct {
    value_: Value = std.mem.zeroes(Value),
    tt_: lu_byte = std.mem.zeroes(lu_byte),
    kind: lu_byte = std.mem.zeroes(lu_byte),
    ridx: lu_byte = std.mem.zeroes(lu_byte),
    pidx: c_short = std.mem.zeroes(c_short),
    name: [*c]TString = std.mem.zeroes([*c]TString),
};
...
const struct_unnamed_14 = extern struct {
    arr: [*c]Vardesc = std.mem.zeroes([*c]Vardesc),
...
pub const struct_Labeldesc = extern struct {
    ...
    line: c_int = std.mem.zeroes(c_int),
    nactvar: lu_byte = std.mem.zeroes(lu_byte),
    close: lu_byte = std.mem.zeroes(lu_byte),
};
pub const Labeldesc = struct_Labeldesc;
pub const struct_Labellist = extern struct {
    arr: [*c]Labeldesc = std.mem.zeroes([*c]Labeldesc),
    n: c_int = std.mem.zeroes(c_int),
    size: c_int = std.mem.zeroes(c_int),
};
pub const Labellist = struct_Labellist;
pub const struct_Dyndata = extern struct {
    actvar: struct_unnamed_14 = std.mem.zeroes(struct_unnamed_14),
    gt: Labellist = std.mem.zeroes(Labellist),
    label: Labellist = std.mem.zeroes(Labellist),
};
pub const struct_LexState = extern struct {
    current: c_int = std.mem.zeroes(c_int),
    linenumber: c_int = std.mem.zeroes(c_int),
    lastline: c_int = std.mem.zeroes(c_int),
    t: Token = std.mem.zeroes(Token),
    lookahead: Token = std.mem.zeroes(Token),
    fs: [*c]struct_FuncState = std.mem.zeroes([*c]struct_FuncState),
    L: [*c]struct_lua_State = std.mem.zeroes([*c]struct_lua_State),
    z: [*c]ZIO = std.mem.zeroes([*c]ZIO),
    buff: [*c]Mbuffer = std.mem.zeroes([*c]Mbuffer),
    h: [*c]Table = std.mem.zeroes([*c]Table),
    dyd: [*c]struct_Dyndata = std.mem.zeroes([*c]struct_Dyndata),
    source: [*c]TString = std.mem.zeroes([*c]TString),
    envn: [*c]TString = std.mem.zeroes([*c]TString),
};
...
const struct_unnamed_17 = extern struct {
    idx: c_short = std.mem.zeroes(c_short),
    t: lu_byte = std.mem.zeroes(lu_byte),
};
const struct_unnamed_18 = extern struct {
    ridx: lu_byte = std.mem.zeroes(lu_byte),
    vidx: c_ushort = std.mem.zeroes(c_ushort),
};
...
pub const struct_expdesc = extern struct {
    k: expkind = std.mem.zeroes(expkind),
    u: union_unnamed_16 = std.mem.zeroes(union_unnamed_16),
    t: c_int = std.mem.zeroes(c_int),
    f: c_int = std.mem.zeroes(c_int),
};
...
pub export fn luaG_getfuncline(arg_f: [*c]const Proto, arg_pc: c_int) c_int {
    var f = arg_f;
    _ = &f;
    var pc = arg_pc;
    _ = &pc;
    if (f.*.lineinfo == @as([*c]ls_byte, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return -@as(c_int, 1) else {
        var basepc: c_int = undefined;
        _ = &basepc;
        var baseline: c_int = getbaseline(f, pc, &basepc);
        _ = &baseline;
        // Defensive: clamp pc to lineinfo array bounds. A corrupt CallInfo
        // (savedpc / code mismatch) can yield pc values far outside [0,
        // sizelineinfo), which would walk basepc off the lineinfo array
        // and SEGV on `f.lineinfo[basepc]` deref. Bounding the loop here
        // produces a slightly-wrong line number for the broken frame but
        // keeps the traceback alive so the original Lua error message
        // (the actual bug) reaches alt_call's error logger.
        const size_li: c_int = f.*.sizelineinfo;
        var bounded_pc: c_int = pc;
        if (bounded_pc > size_li) bounded_pc = size_li;
        if (bounded_pc < -1) bounded_pc = -1;
        while ((blk: {
            const ref = &basepc;
            const tmp = ref.*;
            ref.* += 1;
            ...
            if (basepc < 0 or basepc >= size_li) break;
            baseline += @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = basepc;
...
pub export fn luaG_findlocal(arg_L: [*c]lua_State, arg_ci: [*c]CallInfo, arg_n: c_int, arg_pos: [*c]StkId) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var ci = arg_ci;
    _ = &ci;
    ...
    if (!((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(1))) != 0)) {
        if (n < @as(c_int, 0)) return findvararg(ci, n, pos) else {
            name = luaF_getlocalname((blk: {
                _ = @as(c_int, 0);
                break :blk blk_1: {
                    _ = @as(c_int, 0);
    ...
    if (pos != null) {
        pos.* = base + @as(usize, @bitCast(@as(isize, @intCast(n - @as(c_int, 1)))));
    }
    return name;
}
pub export fn luaG_typeerror(arg_L: [*c]lua_State, arg_o: [*c]const TValue, arg_op: [*c]const u8) noreturn {
    var L = arg_L;
    _ = &L;
    var o = arg_o;
    _ = &o;
...
pub export fn luaG_callerror(arg_L: [*c]lua_State, arg_o: [*c]const TValue) noreturn {
    var L = arg_L;
    _ = &L;
    var o = arg_o;
    _ = &o;
    ...
    var name: [*c]const u8 = null;
    _ = &name;
    var kind: [*c]const u8 = funcnamefromcall(L, ci, &name);
    _ = &kind;
    var extra: [*c]const u8 = if (kind != null) formatvarinfo(L, kind, name) else varinfo(L, o);
    _ = &extra;
    typeerror(L, o, "call", extra);
}
pub export fn luaG_forerror(arg_L: [*c]lua_State, arg_o: [*c]const TValue, arg_what: [*c]const u8) noreturn {
    var L = arg_L;
    _ = &L;
    var o = arg_o;
    _ = &o;
...
pub export fn luaG_concaterror(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue) noreturn {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
    var p2 = arg_p2;
    _ = &p2;
    if (((@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) & @as(c_int, 15)) == @as(c_int, 4)) or ((@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) & @as(c_int, 15)) == @as(c_int, 3))) {
        p1 = p2;
    }
    luaG_typeerror(L, p1, "concatenate");
}
pub export fn luaG_opinterror(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_msg: [*c]const u8) noreturn {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
    ...
    var msg = arg_msg;
    _ = &msg;
    if (!((@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) & @as(c_int, 15)) == @as(c_int, 3))) {
        p2 = p1;
    }
    luaG_typeerror(L, p2, msg);
}
pub export fn luaG_tointerror(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue) noreturn {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
    var p2 = arg_p2;
    _ = &p2;
    var temp: lua_Integer = undefined;
    _ = &temp;
    if (!(luaV_tointegerns(p1, &temp, @as(c_uint, @bitCast(F2Ieq))) != 0)) {
        p2 = p1;
    }
    luaG_runerror(L, "number%s has no integer representation", varinfo(L, p2));
}
pub export fn luaG_ordererror(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue) noreturn {
    const L = arg_L;
    const p1 = arg_p1;
    const p2 = arg_p2;
    const t1: [*c]const u8 = luaT_objtypename(L, p1);
    const t2: [*c]const u8 = luaT_objtypename(L, p2);
    // luaG_runerror's variadic format is stubbed (no @cVaStart on aarch64),
    // so format inline via bufPrintZ — same pattern as `typeerror` below.
    ...
    {
        var ci: [*c]CallInfo = L.*.ci;
        while (ci != null) : (ci = ci.*.previous) {
            if ((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(1))) == 0) {
                const cl = &@as([*c]union_GCUnion, @ptrCast(@alignCast((&ci.*.func.p.*.val).*.value_.gc))).*.cl.l;
                const proto = cl.*.p;
                const src_ts = proto.*.source;
                if (src_ts != null) {
                    ...
                    const eff_len = @min(src_buf.len - 1, src_len - start);
                    @memcpy(src_buf[0..eff_len], src_chars[start .. start + eff_len]);
                    src_buf[eff_len] = 0;
                }
                line_no = getcurrentline(ci);
                break;
            }
        }
    }
    var buf: [512]u8 = undefined;
    const same = strcmp(t1, t2) == 0;
    const t1s = std.mem.span(@as([*:0]const u8, @ptrCast(t1)));
    const t2s = std.mem.span(@as([*:0]const u8, @ptrCast(t2)));
    const srcs = std.mem.span(@as([*:0]const u8, @ptrCast(&src_buf)));
    const formatted = if (line_no > 0) (if (same)
        std.fmt.bufPrintZ(&buf, "{s}:{d}: attempt to compare two {s} values", .{ srcs, line_no, t1s }) catch "compare error"
    else
        std.fmt.bufPrintZ(&buf, "{s}:{d}: attempt to compare {s} with {s}", .{ srcs, line_no, t1s, t2s }) catch "compare error")
    else (if (same)
        std.fmt.bufPrintZ(&buf, "attempt to compare two {s} values", .{t1s}) catch "compare error"
    else
        std.fmt.bufPrintZ(&buf, "attempt to compare {s} with {s}", .{ t1s, t2s }) catch "compare error");
    _ = lua_pushstring(L, formatted);
    luaG_errormsg(L);
    unreachable;
}
// luaG_runerror: simplified implementation — Zig 0.15 disables @cVaStart on aarch64,
// so we cannot format the variadic message. We just throw LUA_ERRRUN directly.
// luaG_runerror: simplified for Zig 0.15 (no @cVaStart on aarch64). We
// can't format the variadic args, but we MUST still go through
// luaG_errormsg so the registered errfunc (e.g. durden_fatal) runs and
// the message lands on the stack where lua_pcall expects it. Originally
// this stub bypassed luaG_errormsg and went straight to luaD_throw,
// which left whatever was last pushed (a stale metatable name like
// "nonblockIOs", or a `(global 'X')` varinfo fragment from a previous
// error) as the surface error. Pushing the unformatted template string
// at least lets the surrounding error handler attach a traceback. Hot
// callers (typeerror/luaG_concaterror) format inline before getting
// here, so this fallback is only hit by the long tail of luaG_runerror
// callsites that haven't been migrated.
pub export fn luaG_runerror(L: [*c]lua_State, fmt: [*c]const u8, ...) callconv(.c) noreturn {
    _ = lua_pushstring(L, fmt);
    luaG_errormsg(L);
    unreachable;
}
pub export fn luaG_addinfo(arg_L: [*c]lua_State, arg_msg: [*c]const u8, arg_src: [*c]TString, arg_line: c_int) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var msg = arg_msg;
    _ = &msg;
    ...
    }
    {
        ...
        const result = std.fmt.bufPrintZ(&fmtbuf, "{s}:{d}: {s}", .{
            std.mem.span(@as([*:0]const u8, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))])))))),
            line,
...
pub export fn luaG_errormsg(arg_L: [*c]lua_State) noreturn {
    ...
    if (L.*.errfunc != @as(ptrdiff_t, @bitCast(@as(c_long, @as(c_int, 0))))) {
        ...
        {
            var io1: [*c]TValue = &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
            _ = &io1;
            var io2: [*c]const TValue = &errfunc.*.val;
            _ = &io2;
            io1.*.value_ = io2.*.value_;
            _ = blk: {
                const tmp = io2.*.tt_;
        ...
        L.*.top.p += 1;
        luaD_callnoyield(L, L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))), @as(c_int, 1));
    }
    luaD_throw(L, @as(c_int, 2));
}
pub export fn luaG_traceexec(arg_L: [*c]lua_State, arg_pc: [*c]const Instruction) c_int {
    var L = arg_L;
    _ = &L;
    var pc = arg_pc;
    _ = &pc;
    var ci: [*c]CallInfo = L.*.ci;
    _ = &ci;
    var mask: lu_byte = @as(lu_byte, @bitCast(@as(i8, @truncate(L.*.hookmask))));
    _ = &mask;
    var p: [*c]const Proto = (blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&ci.*.func.p.*.val).*.value_.gc))).*.cl.l;
    ...
    _ = &p;
    var counthook: c_int = undefined;
    _ = &counthook;
    if (!((@as(c_int, @bitCast(@as(c_uint, mask))) & ((@as(c_int, 1) << @intCast(2)) | (@as(c_int, 1) << @intCast(3)))) != 0)) {
        ci.*.u.l.trap = 0;
        return 0;
    }
    pc += 1;
    ci.*.u.l.savedpc = pc;
    counthook = @intFromBool(((blk: {
        const ref = &L.*.hookcount;
        ref.* -= 1;
        break :blk ref.*;
    }) == @as(c_int, 0)) and ((@as(c_int, @bitCast(@as(c_uint, mask))) & (@as(c_int, 1) << @intCast(3))) != 0));
    if (counthook != 0) {
        _ = blk: {
            const tmp = L.*.basehookcount;
            L.*.hookcount = tmp;
    ...
    } else if (!((@as(c_int, @bitCast(@as(c_uint, mask))) & (@as(c_int, 1) << @intCast(2))) != 0)) return 1;
    if ((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(6))) != 0) {
        ci.*.callstatus &= @as(c_ushort, @bitCast(@as(c_short, @truncate(~(@as(c_int, 1) << @intCast(6))))));
        return 1;
    }
    if (!(((@as(c_int, @bitCast(@as(c_uint, luaP_opmodes[@as(c_uint, @bitCast(((ci.*.u.l.savedpc - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).* >> @intCast(0)) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 7))) << @intCast(@as(c_int, 0)))))]))) & (@as(c_int, 1) << @intCast(5))) != 0) and ((blk: {
        _ = @as(c_int, 0);
        break :blk @as(c_int, @bitCast(((ci.*.u.l.savedpc - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).* >> @intCast(((@as(c_int, 0) + @as(c_int, 7)) + @as(c_int, 8)) + @as(c_int, 1))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0)))));
    }) == @as(c_int, 0)))) {
        L.*.top.p = ci.*.top.p;
    }
    if (counthook != 0) {
        luaD_hook(L, @as(c_int, 3), -@as(c_int, 1), @as(c_int, 0), @as(c_int, 0));
    }
    if ((@as(c_int, @bitCast(@as(c_uint, mask))) & (@as(c_int, 1) << @intCast(2))) != 0) {
        ...
        if ((npci <= oldpc) or (changedline(p, oldpc, npci) != 0)) {
            ...
            _ = &newline;
            luaD_hook(L, @as(c_int, 2), newline, @as(c_int, 0), @as(c_int, 0));
        }
        L.*.oldpc = npci;
    }
    if (@as(c_int, @bitCast(@as(c_uint, L.*.status))) == @as(c_int, 1)) {
        if (counthook != 0) {
            L.*.hookcount = 1;
        }
        ci.*.u.l.savedpc -= 1;
        ci.*.callstatus |= @as(c_ushort, @bitCast(@as(c_short, @truncate(@as(c_int, 1) << @intCast(6)))));
        luaD_throw(L, @as(c_int, 1));
    }
    return 1;
}
...
pub fn funcnamefromcall(arg_L: [*c]lua_State, arg_ci: [*c]CallInfo, arg_name: [*c][*c]const u8) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var ci = arg_ci;
    _ = &ci;
    var name = arg_name;
    _ = &name;
    if ((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(3))) != 0) {
        name.* = "?";
        return "hook";
    } else if ((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(7))) != 0) {
        name.* = "__gc";
        return "metamethod";
    } else if (!((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(1))) != 0)) return funcnamefromcode(L, (blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&ci.*.func.p.*.val).*.value_.gc))).*.cl.l;
        };
    }).*.p, currentpc(ci), name) else return null;
    return null;
}
pub fn currentpc(arg_ci: [*c]CallInfo) callconv(.c) c_int {
    var ci = arg_ci;
    _ = &ci;
    _ = @as(c_int, 0);
...
pub fn getbaseline(arg_f: [*c]const Proto, arg_pc: c_int, arg_basepc: [*c]c_int) callconv(.c) c_int {
    var f = arg_f;
    _ = &f;
    var pc = arg_pc;
    _ = &pc;
    var basepc = arg_basepc;
    _ = &basepc;
    if ((f.*.sizeabslineinfo == @as(c_int, 0)) or (pc < f.*.abslineinfo[@as(c_uint, @intCast(@as(c_int, 0)))].pc)) {
        basepc.* = -@as(c_int, 1);
        return f.*.linedefined;
    } else {
        var i: c_int = @as(c_int, @bitCast((@as(c_uint, @bitCast(pc)) / @as(c_uint, @bitCast(@as(c_int, 128)))) -% @as(c_uint, @bitCast(@as(c_int, 1)))));
        _ = &i;
        _ = @as(c_int, 0);
        while (((i + @as(c_int, 1)) < f.*.sizeabslineinfo) and (pc >= (blk: {
...
pub fn getcurrentline(arg_ci: [*c]CallInfo) callconv(.c) c_int {
    var ci = arg_ci;
    _ = &ci;
    return luaG_getfuncline((blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&ci.*.func.p.*.val).*.value_.gc))).*.cl.l;
...
pub fn settraps(arg_ci: [*c]CallInfo) callconv(.c) void {
    var ci = arg_ci;
    _ = &ci;
    while (ci != @as([*c]CallInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) : (ci = ci.*.previous) if (!((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(1))) != 0)) {
        ci.*.u.l.trap = 1;
    };
}
pub fn upvalname(arg_p: [*c]const Proto, arg_uv: c_int) callconv(.c) [*c]const u8 {
    var p = arg_p;
    _ = &p;
    var uv = arg_uv;
    _ = &uv;
    var s: [*c]TString = blk: {
        ...
        break :blk (blk_1: {
            const tmp = uv;
            if (tmp >= 0) break :blk_1 p.*.upvalues + @as(usize, @intCast(tmp)) else break :blk_1 p.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*.name;
    };
    _ = &s;
    if (s == @as([*c]TString, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return "?" else return @as([*c]u8, @ptrCast(@alignCast(&s.*.contents[@as(usize, @intCast(0))])));
    return null;
}
pub fn findvararg(arg_ci: [*c]CallInfo, arg_n: c_int, arg_pos: [*c]StkId) callconv(.c) [*c]const u8 {
    var ci = arg_ci;
    _ = &ci;
    var n = arg_n;
    _ = &n;
    ...
    if ((blk: {
        ...
        var nextra: c_int = ci.*.u.l.nextraargs;
        _ = &nextra;
        if (n >= -nextra) {
            pos.* = (ci.*.func.p - @as(usize, @bitCast(@as(isize, @intCast(nextra))))) - @as(usize, @bitCast(@as(isize, @intCast(n + @as(c_int, 1)))));
            return "(vararg)";
        }
    }
    return null;
}
pub fn funcinfo(arg_ar: [*c]lua_Debug, arg_cl: [*c]Closure) callconv(.c) void {
    var ar = arg_ar;
    _ = &ar;
    var cl = arg_cl;
    _ = &cl;
    if ((cl == @as([*c]Closure, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cl.*.c.tt))) == (@as(c_int, 6) | (@as(c_int, 2) << @intCast(4))))) {
        ...
        ar.*.what = if (ar.*.linedefined == @as(c_int, 0)) "main" else "Lua";
    }
    luaO_chunkid(@as([*c]u8, @ptrCast(@alignCast(&ar.*.short_src[@as(usize, @intCast(0))]))), ar.*.source, ar.*.srclen);
}
pub fn nextline(arg_p: [*c]const Proto, arg_currentline: c_int, arg_pc: c_int) callconv(.c) c_int {
    var p = arg_p;
    _ = &p;
    var currentline = arg_currentline;
    _ = &currentline;
    var pc = arg_pc;
    _ = &pc;
    if (@as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = pc;
        if (tmp >= 0) break :blk p.*.lineinfo + @as(usize, @intCast(tmp)) else break :blk p.*.lineinfo - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) != -@as(c_int, 128)) return currentline + @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = pc;
        if (tmp >= 0) break :blk p.*.lineinfo + @as(usize, @intCast(tmp)) else break :blk p.*.lineinfo - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) else return luaG_getfuncline(p, pc);
    return 0;
}
pub fn collectvalidlines(arg_L: [*c]lua_State, arg_f: [*c]Closure) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    if ((f == @as([*c]Closure, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, f.*.c.tt))) == (@as(c_int, 6) | (@as(c_int, 2) << @intCast(4))))) {
        _ = blk: {
        ...
        _ = &v;
        var p: [*c]const Proto = f.*.l.p;
        _ = &p;
        var currentline: c_int = p.*.linedefined;
        _ = &currentline;
        var t: [*c]Table = luaH_new(L);
        _ = &t;
        {
        ...
        if (!(p.*.is_vararg != 0)) {
            ...
            _ = @as(c_int, 0);
            currentline = nextline(p, currentline, @as(c_int, 0));
            i = 1;
        }
        while (i < p.*.sizelineinfo) : (i += 1) {
            currentline = nextline(p, currentline, i);
            luaH_setint(L, t, @as(lua_Integer, @bitCast(@as(c_longlong, currentline))), &v);
        }
    }
}
pub fn getfuncname(arg_L: [*c]lua_State, arg_ci: [*c]CallInfo, arg_name: [*c][*c]const u8) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var ci = arg_ci;
    _ = &ci;
    var name = arg_name;
    _ = &name;
    if ((ci != @as([*c]CallInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and !((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(5))) != 0)) return funcnamefromcall(L, ci.*.previous, name) else return null;
    return null;
}
pub fn auxgetinfo(arg_L: [*c]lua_State, arg_what: [*c]const u8, arg_ar: [*c]lua_Debug, arg_f: [*c]Closure, arg_ci: [*c]CallInfo) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var what = arg_what;
    _ = &what;
    ...
    while (what.* != 0) : (what += 1) {
        while (true) {
            switch (@as(c_int, @bitCast(@as(c_uint, what.*)))) {
                @as(c_int, 83) => {
                    {
                        funcinfo(ar, f);
                        break;
                ...
                @as(c_int, 108) => {
                    {
                        ar.*.currentline = if ((ci != null) and !((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(1))) != 0)) getcurrentline(ci) else -@as(c_int, 1);
                        break;
                    }
                },
                @as(c_int, 117) => {
                    {
                        ar.*.nups = @as(u8, @bitCast(@as(i8, @truncate(if (f == @as([*c]Closure, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, 0) else @as(c_int, @bitCast(@as(c_uint, f.*.c.nupvalues)))))));
                        if ((f == @as([*c]Closure, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, f.*.c.tt))) == (@as(c_int, 6) | (@as(c_int, 2) << @intCast(4))))) {
                            ar.*.isvararg = 1;
                            ar.*.nparams = 0;
                        } else {
                            ar.*.isvararg = @as(u8, @bitCast(f.*.l.p.*.is_vararg));
                ...
                @as(c_int, 116) => {
                    {
                        ar.*.istailcall = @as(u8, @bitCast(@as(i8, @truncate(if (ci != null) @as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(5)) else @as(c_int, 0)))));
                        break;
                    }
                },
                @as(c_int, 110) => {
                    {
                        ...
                        if (ar.*.namewhat == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            ar.*.namewhat = "";
                            ar.*.name = null;
                        }
                        break;
                ...
                @as(c_int, 114) => {
                    {
                        if ((ci == @as([*c]CallInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(8))) != 0)) {
                            ar.*.ftransfer = blk: {
                                const tmp = @as(c_ushort, @bitCast(@as(c_short, @truncate(@as(c_int, 0)))));
                                ar.*.ntransfer = tmp;
                                break :blk tmp;
                            };
                        } else {
                ...
                @as(c_int, 76), @as(c_int, 102) => break,
                else => {
                    status = 0;
                },
            }
...
pub fn getobjname(arg_p: [*c]const Proto, arg_lastpc: c_int, arg_reg: c_int, arg_name: [*c][*c]const u8) callconv(.c) [*c]const u8 {
    var p = arg_p;
    _ = &p;
    var lastpc = arg_lastpc;
    _ = &lastpc;
    var reg = arg_reg;
    _ = &reg;
    var name = arg_name;
    ...
    _ = &pc;
    name.* = luaF_getlocalname(p, reg + @as(c_int, 1), lastpc);
    if (name.* != null) return "local";
    pc = findsetreg(p, lastpc, reg);
    if (pc != -@as(c_int, 1)) {
        var i: Instruction = (blk: {
            const tmp = pc;
            if (tmp >= 0) break :blk p.*.code + @as(usize, @intCast(tmp)) else break :blk p.*.code - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*;
        _ = &i;
        var op: OpCode = @as(c_uint, @bitCast((i >> @intCast(0)) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 7))) << @intCast(@as(c_int, 0)))));
        _ = &op;
        while (true) {
            switch (op) {
                @as(c_uint, @bitCast(@as(c_int, 0))) => {
                    {
                        ...
                        _ = &b;
                        if (b < @as(c_int, @bitCast((i >> @intCast(@as(c_int, 0) + @as(c_int, 7))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0)))))) return getobjname(p, pc, b, name);
                        break;
                    }
                },
                @as(c_uint, @bitCast(@as(c_int, 11))) => {
                    {
                        var k: c_int = blk: {
                            _ = @as(c_int, 0);
                            break :blk @as(c_int, @bitCast((i >> @intCast((((@as(c_int, 0) + @as(c_int, 7)) + @as(c_int, 8)) + @as(c_int, 1)) + @as(c_int, 8))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0)))));
                        };
                        _ = &k;
                        kname(p, k, name);
                        return gxf(p, pc, i, @as(c_int, 1));
                    }
                },
                ...
                @as(c_uint, @bitCast(@as(c_int, 3))), @as(c_uint, @bitCast(@as(c_int, 4))) => {
                    {
                        var b: c_int = if (op == @as(c_uint, @bitCast(OP_LOADK))) blk: {
                            _ = @as(c_int, 0);
                            break :blk @as(c_int, @bitCast((i >> @intCast((@as(c_int, 0) + @as(c_int, 7)) + @as(c_int, 8))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast((@as(c_int, 8) + @as(c_int, 8)) + @as(c_int, 1))) << @intCast(@as(c_int, 0)))));
                        } else blk: {
                            _ = @as(c_int, 0);
                            break :blk @as(c_int, @bitCast(((blk_1: {
                                const tmp = pc + @as(c_int, 1);
                                if (tmp >= 0) break :blk_1 p.*.code + @as(usize, @intCast(tmp)) else break :blk_1 p.*.code - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).* >> @intCast(@as(c_int, 0) + @as(c_int, 7))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(((@as(c_int, 8) + @as(c_int, 8)) + @as(c_int, 1)) + @as(c_int, 8))) << @intCast(@as(c_int, 0)))));
                        };
                        _ = &b;
                        if ((@as(c_int, @bitCast(@as(c_uint, (&(blk: {
                            const tmp = b;
                            if (tmp >= 0) break :blk p.*.k + @as(usize, @intCast(tmp)) else break :blk p.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*).*.tt_))) & @as(c_int, 15)) == @as(c_int, 4)) {
                            name.* = @as([*c]u8, @ptrCast(@alignCast(&(blk: {
                                _ = @as(c_int, 0);
                                break :blk blk_1: {
                                    _ = @as(c_int, 0);
                                    break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&(blk_2: {
                                        const tmp = b;
                                        if (tmp >= 0) break :blk_2 p.*.k + @as(usize, @intCast(tmp)) else break :blk_2 p.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                    }).*).*.value_.gc))).*.ts;
                                };
...
pub fn kname(arg_p: [*c]const Proto, arg_c: c_int, arg_name: [*c][*c]const u8) callconv(.c) void {
    var p = arg_p;
    _ = &p;
    var c = arg_c;
    _ = &c;
    var name = arg_name;
    _ = &name;
    var kvalue: [*c]TValue = &(blk: {
        const tmp = c;
        if (tmp >= 0) break :blk p.*.k + @as(usize, @intCast(tmp)) else break :blk p.*.k - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*;
    _ = &kvalue;
    name.* = if ((@as(c_int, @bitCast(@as(c_uint, kvalue.*.tt_))) & @as(c_int, 15)) == @as(c_int, 4)) @as([*c]u8, @ptrCast(@alignCast(&(blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(kvalue.*.value_.gc))).*.ts;
        };
    }).*.contents[@as(usize, @intCast(0))]))) else "?";
}
pub fn rname(arg_p: [*c]const Proto, arg_pc: c_int, arg_c: c_int, arg_name: [*c][*c]const u8) callconv(.c) void {
    var p = arg_p;
    _ = &p;
    var pc = arg_pc;
    _ = &pc;
    ...
    var name = arg_name;
    _ = &name;
    var what: [*c]const u8 = getobjname(p, pc, c, name);
    _ = &what;
    if (!((what != null) and (@as(c_int, @bitCast(@as(c_uint, what.*))) == @as(c_int, 'c')))) {
        name.* = "?";
    }
}
pub fn rkname(arg_p: [*c]const Proto, arg_pc: c_int, arg_i: Instruction, arg_name: [*c][*c]const u8) callconv(.c) void {
    var p = arg_p;
    _ = &p;
    var pc = arg_pc;
    _ = &pc;
...
pub fn filterpc(arg_pc: c_int, arg_jmptarget: c_int) callconv(.c) c_int {
    var pc = arg_pc;
    _ = &pc;
    var jmptarget = arg_jmptarget;
    _ = &jmptarget;
    if (pc < jmptarget) return -@as(c_int, 1) else return pc;
    return 0;
}
pub fn findsetreg(arg_p: [*c]const Proto, arg_lastpc: c_int, arg_reg: c_int) callconv(.c) c_int {
    var p = arg_p;
    _ = &p;
    var lastpc = arg_lastpc;
    _ = &lastpc;
    ...
    var pc: c_int = undefined;
    _ = &pc;
    var setreg: c_int = -@as(c_int, 1);
    _ = &setreg;
    var jmptarget: c_int = 0;
    _ = &jmptarget;
    if ((@as(c_int, @bitCast(@as(c_uint, luaP_opmodes[@as(c_uint, @bitCast(((blk: {
        const tmp = lastpc;
        if (tmp >= 0) break :blk p.*.code + @as(usize, @intCast(tmp)) else break :blk p.*.code - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* >> @intCast(0)) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 7))) << @intCast(@as(c_int, 0)))))]))) & (@as(c_int, 1) << @intCast(7))) != 0) {
        lastpc -= 1;
    }
    {
        pc = 0;
        while (pc < lastpc) : (pc += 1) {
            ...
            var op: OpCode = @as(c_uint, @bitCast((i >> @intCast(0)) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 7))) << @intCast(@as(c_int, 0)))));
            _ = &op;
            var a: c_int = @as(c_int, @bitCast((i >> @intCast(@as(c_int, 0) + @as(c_int, 7))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0)))));
            _ = &a;
            var change: c_int = undefined;
            _ = &change;
            while (true) {
                switch (op) {
                    @as(c_uint, @bitCast(@as(c_int, 8))) => {
                        {
                            ...
                            _ = &b;
                            change = @intFromBool((a <= reg) and (reg <= (a + b)));
                            break;
                        }
                    },
                    @as(c_uint, @bitCast(@as(c_int, 76))) => {
                        {
                            change = @intFromBool(reg >= (a + @as(c_int, 2)));
                            break;
                        }
                    },
                    @as(c_uint, @bitCast(@as(c_int, 68))), @as(c_uint, @bitCast(@as(c_int, 69))) => {
                        {
                            change = @intFromBool(reg >= a);
                            break;
                        }
                    },
                    @as(c_uint, @bitCast(@as(c_int, 56))) => {
                        {
                            var b: c_int = blk: {
                                _ = @as(c_int, 0);
                                break :blk @as(c_int, @bitCast((i >> @intCast(@as(c_int, 0) + @as(c_int, 7))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(((@as(c_int, 8) + @as(c_int, 8)) + @as(c_int, 1)) + @as(c_int, 8))) << @intCast(@as(c_int, 0))))) - (((@as(c_int, 1) << @intCast(((@as(c_int, 8) + @as(c_int, 8)) + @as(c_int, 1)) + @as(c_int, 8))) - @as(c_int, 1)) >> @intCast(1));
                            };
                            _ = &b;
                            var dest: c_int = (pc + @as(c_int, 1)) + b;
                            _ = &dest;
                            if ((dest <= lastpc) and (dest > jmptarget)) {
                                jmptarget = dest;
                            }
                            change = 0;
                            break;
                        ...
                        change = @intFromBool(((@as(c_int, @bitCast(@as(c_uint, luaP_opmodes[op]))) & (@as(c_int, 1) << @intCast(3))) != 0) and (reg == a));
                        break;
                    },
                }
                break;
...
pub fn gxf(arg_p: [*c]const Proto, arg_pc: c_int, arg_i: Instruction, arg_isup: c_int) callconv(.c) [*c]const u8 {
    var p = arg_p;
    _ = &p;
    var pc = arg_pc;
    _ = &pc;
    ...
    if (isup != 0) {
        ...
        _ = getobjname(p, pc, t, &name);
    }
    return if ((name != null) and (strcmp(name, "_ENV") == @as(c_int, 0))) "global" else "field";
}
pub fn funcnamefromcode(arg_L: [*c]lua_State, arg_p: [*c]const Proto, arg_pc: c_int, arg_name: [*c][*c]const u8) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var p = arg_p;
    _ = &p;
    ...
    var name = arg_name;
    _ = &name;
    var tm: TMS = @as(c_uint, @bitCast(@as(c_int, 0)));
    _ = &tm;
    var i: Instruction = (blk: {
        const tmp = pc;
        if (tmp >= 0) break :blk p.*.code + @as(usize, @intCast(tmp)) else break :blk p.*.code - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    ...
    _ = &i;
    while (true) {
        switch (@as(c_uint, @bitCast((i >> @intCast(0)) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 7))) << @intCast(@as(c_int, 0)))))) {
            @as(c_uint, @bitCast(@as(c_int, 68))), @as(c_uint, @bitCast(@as(c_int, 69))) => return getobjname(p, pc, @as(c_int, @bitCast((i >> @intCast(@as(c_int, 0) + @as(c_int, 7))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0))))), name),
            @as(c_uint, @bitCast(@as(c_int, 76))) => {
                {
                    name.* = "for iterator";
                    return "for iterator";
            ...
            @as(c_uint, @bitCast(@as(c_int, 20))), @as(c_uint, @bitCast(@as(c_int, 11))), @as(c_uint, @bitCast(@as(c_int, 12))), @as(c_uint, @bitCast(@as(c_int, 13))), @as(c_uint, @bitCast(@as(c_int, 14))) => {
                tm = @as(c_uint, @bitCast(TM_INDEX));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 15))), @as(c_uint, @bitCast(@as(c_int, 16))), @as(c_uint, @bitCast(@as(c_int, 17))), @as(c_uint, @bitCast(@as(c_int, 18))) => {
                tm = @as(c_uint, @bitCast(TM_NEWINDEX));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 46))), @as(c_uint, @bitCast(@as(c_int, 47))), @as(c_uint, @bitCast(@as(c_int, 48))) => {
                {
                    tm = @as(c_uint, @bitCast(blk: {
                        _ = @as(c_int, 0);
                        break :blk @as(c_int, @bitCast((i >> @intCast((((@as(c_int, 0) + @as(c_int, 7)) + @as(c_int, 8)) + @as(c_int, 1)) + @as(c_int, 8))) & (~(~@as(Instruction, @bitCast(@as(c_int, 0))) << @intCast(@as(c_int, 8))) << @intCast(@as(c_int, 0)))));
                    }));
                    break;
            ...
            @as(c_uint, @bitCast(@as(c_int, 49))) => {
                tm = @as(c_uint, @bitCast(TM_UNM));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 50))) => {
                tm = @as(c_uint, @bitCast(TM_BNOT));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 52))) => {
                tm = @as(c_uint, @bitCast(TM_LEN));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 53))) => {
                tm = @as(c_uint, @bitCast(TM_CONCAT));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 57))) => {
                tm = @as(c_uint, @bitCast(TM_EQ));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 58))), @as(c_uint, @bitCast(@as(c_int, 62))), @as(c_uint, @bitCast(@as(c_int, 64))) => {
                tm = @as(c_uint, @bitCast(TM_LT));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 59))), @as(c_uint, @bitCast(@as(c_int, 63))), @as(c_uint, @bitCast(@as(c_int, 65))) => {
                tm = @as(c_uint, @bitCast(TM_LE));
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 54))), @as(c_uint, @bitCast(@as(c_int, 70))) => {
                tm = @as(c_uint, @bitCast(TM_CLOSE));
                break;
            },
            else => return null,
        }
    ...
    name.* = @as([*c]u8, @ptrCast(@alignCast(&L.*.l_G.*.tmname[tm].*.contents[@as(usize, @intCast(0))]))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))));
    return "metamethod";
}
pub fn instack(arg_ci: [*c]CallInfo, arg_o: [*c]const TValue) callconv(.c) c_int {
    var ci = arg_ci;
    _ = &ci;
    var o = arg_o;
    _ = &o;
    ...
    {
        pos = 0;
        while ((base + @as(usize, @bitCast(@as(isize, @intCast(pos))))) < ci.*.top.p) : (pos += 1) {
            if (o == @as([*c]const TValue, @ptrCast(@alignCast(&(base + @as(usize, @bitCast(@as(isize, @intCast(pos))))).*.val)))) return pos;
        }
    }
    return -@as(c_int, 1);
}
pub fn getupvalname(arg_ci: [*c]CallInfo, arg_o: [*c]const TValue, arg_name: [*c][*c]const u8) callconv(.c) [*c]const u8 {
    var ci = arg_ci;
    _ = &ci;
    var o = arg_o;
    _ = &o;
    ...
    {
        i = 0;
        while (i < @as(c_int, @bitCast(@as(c_uint, c.*.nupvalues)))) : (i += 1) {
            if (@as([*][*c]UpVal, @ptrCast(&c.*.upvals))[@as(usize, @intCast(i))].*.v.p == @as([*c]TValue, @ptrCast(@constCast(@volatileCast(o))))) {
...
pub fn formatvarinfo(arg_L: [*c]lua_State, arg_kind: [*c]const u8, arg_name: [*c]const u8) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var kind = arg_kind;
    _ = &kind;
    var name = arg_name;
    _ = &name;
    if (kind == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return "" else {
        var fmtbuf: [512]u8 = undefined;
        const result = std.fmt.bufPrintZ(&fmtbuf, " ({s} '{s}')", .{
...
pub fn varinfo(arg_L: [*c]lua_State, arg_o: [*c]const TValue) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var o = arg_o;
    _ = &o;
    ...
    var name: [*c]const u8 = null;
    _ = &name;
    var kind: [*c]const u8 = null;
    _ = &kind;
    if (!((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(1))) != 0)) {
        kind = getupvalname(ci, o, &name);
        if (!(kind != null)) {
            var reg: c_int = instack(ci, o);
            _ = &reg;
            if (reg >= @as(c_int, 0)) {
                kind = getobjname((blk: {
                    _ = @as(c_int, 0);
                ...
                }).*.p, currentpc(ci), reg, &name);
            }
        }
    }
    return formatvarinfo(L, kind, name);
}
pub fn typeerror(arg_L: [*c]lua_State, arg_o: [*c]const TValue, arg_op: [*c]const u8, arg_extra: [*c]const u8) callconv(.c) noreturn {
    const L = arg_L;
    const o = arg_o;
    const op = arg_op;
    const extra = arg_extra;
    const t: [*c]const u8 = luaT_objtypename(L, o);
    // Walk CallInfo chain to find the nearest Lua frame and pull
    // source:line directly. Avoids depending on lua_getstack/lua_getinfo
    // which may be stubbed in this port.
    var src_buf: [256]u8 = undefined;
    src_buf[0] = '?';
    src_buf[1] = 0;
    var line_no: c_int = -1;
    {
        var ci: [*c]CallInfo = L.*.ci;
        while (ci != null) : (ci = ci.*.previous) {
            // CIST_C bit (1<<1): is C frame. Walk past C frames to find Lua frame.
            if ((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & (@as(c_int, 1) << @intCast(1))) == 0) {
                const cl = &@as([*c]union_GCUnion, @ptrCast(@alignCast((&ci.*.func.p.*.val).*.value_.gc))).*.cl.l;
                const proto = cl.*.p;
                const src_ts = proto.*.source;
    ...
    var buf: [512]u8 = undefined;
    const formatted = if (line_no > 0)
        std.fmt.bufPrintZ(&buf, "{s}:{d}: attempt to {s} a {s} value{s}", .{
            std.mem.span(@as([*:0]const u8, @ptrCast(&src_buf))),
            line_no,
            std.mem.span(@as([*:0]const u8, @ptrCast(op))),
            std.mem.span(@as([*:0]const u8, @ptrCast(t))),
            std.mem.span(@as([*:0]const u8, @ptrCast(extra))),
        }) catch "attempt-to (format failed)"
    else
        std.fmt.bufPrintZ(&buf, "attempt to {s} a {s} value{s}", .{
            std.mem.span(@as([*:0]const u8, @ptrCast(op))),
            std.mem.span(@as([*:0]const u8, @ptrCast(t))),
            std.mem.span(@as([*:0]const u8, @ptrCast(extra))),
        }) catch "attempt-to (format failed)";
...
pub fn changedline(arg_p: [*c]const Proto, arg_oldpc: c_int, arg_newpc: c_int) callconv(.c) c_int {
    var p = arg_p;
    _ = &p;
    var oldpc = arg_oldpc;
    _ = &oldpc;
    var newpc = arg_newpc;
    _ = &newpc;
    if (p.*.lineinfo == @as([*c]ls_byte, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 0;
    if ((newpc - oldpc) < @divTrunc(@as(c_int, 128), @as(c_int, 2))) {
        var delta: c_int = 0;
        _ = &delta;
        var pc: c_int = oldpc;
        _ = &pc;
        while (true) {
            var lineinfo: c_int = @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = blk_1: {
                    const ref = &pc;
                    ref.* += 1;
                    break :blk_1 ref.*;
            ...
            _ = &lineinfo;
            if (lineinfo == -@as(c_int, 128)) break;
            delta += lineinfo;
            if (pc == newpc) return @intFromBool(delta != @as(c_int, 0));
        }
    }
    return @intFromBool(luaG_getfuncline(p, oldpc) != luaG_getfuncline(p, newpc));
}
...
pub const MAX_SIZE = if (std.zig.c_translation.sizeof(usize) < std.zig.c_translation.sizeof(lua_Integer)) MAX_SIZET else std.zig.c_translation.cast(usize, LUA_MAXINTEGER);
pub const MAX_LUMEM = std.zig.c_translation.cast(lu_mem, ~std.zig.c_translation.cast(lu_mem, @as(c_int, 0)));
pub const MAX_LMEM = std.zig.c_translation.cast(l_mem, MAX_LUMEM >> @as(c_int, 1));
pub const MAX_INT = INT_MAX;
pub inline fn log2maxs(t: anytype) @TypeOf((std.zig.c_translation.sizeof(t) * @as(c_int, 8)) - @as(c_int, 2)) {
    _ = &t;
    return (std.zig.c_translation.sizeof(t) * @as(c_int, 8)) - @as(c_int, 2);
}
pub inline fn ispow2(x: anytype) @TypeOf((x & (x - @as(c_int, 1))) == @as(c_int, 0)) {
    _ = &x;
    return (x & (x - @as(c_int, 1))) == @as(c_int, 0);
}
pub inline fn LL(x: anytype) @TypeOf(std.zig.c_translation.MacroArithmetic.div(std.zig.c_translation.sizeof(x), std.zig.c_translation.sizeof(u8)) - @as(c_int, 1)) {
    _ = &x;
    return std.zig.c_translation.MacroArithmetic.div(std.zig.c_translation.sizeof(x), std.zig.c_translation.sizeof(u8)) - @as(c_int, 1);
}
pub const L_P2I = usize;
pub inline fn point2uint(p: anytype) c_uint {
    _ = &p;
    return std.zig.c_translation.cast(c_uint, L_P2I(p) & UINT_MAX);
}
...
pub inline fn lua_longassert(c: anytype) @TypeOf(if (c != 0) std.zig.c_translation.cast(anyopaque, @as(c_int, 0)) else lua_assert(@as(c_int, 0))) {
    _ = &c;
    return if (c != 0) std.zig.c_translation.cast(anyopaque, @as(c_int, 0)) else lua_assert(@as(c_int, 0));
}
...
pub const UNUSED = std.zig.c_translation.Macros.DISCARD;
pub const cast = std.zig.c_translation.Macros.CAST_OR_CALL;
...
pub inline fn l_castS2U(i: anytype) lua_Unsigned {
    _ = &i;
    return std.zig.c_translation.cast(lua_Unsigned, i);
}
pub inline fn l_castU2S(i: anytype) lua_Integer {
    _ = &i;
    return std.zig.c_translation.cast(lua_Integer, i);
}
...
pub inline fn luai_userstateopen(L: anytype) anyopaque {
    _ = &L;
    return std.zig.c_translation.cast(anyopaque, L);
}
...
pub inline fn luai_numdiv(L: anytype, a: anytype, b: anytype) @TypeOf(std.zig.c_translation.MacroArithmetic.div(a, b)) {
    _ = &L;
    _ = &a;
    _ = &b;
    return std.zig.c_translation.MacroArithmetic.div(a, b);
}
...
pub inline fn luaM_testsize(n: anytype, e: anytype) @TypeOf((std.zig.c_translation.sizeof(n) >= std.zig.c_translation.sizeof(usize)) and ((cast_sizet(n) + @as(c_int, 1)) > std.zig.c_translation.MacroArithmetic.div(MAX_SIZET, e))) {
    _ = &n;
    _ = &e;
    return (std.zig.c_translation.sizeof(n) >= std.zig.c_translation.sizeof(usize)) and ((cast_sizet(n) + @as(c_int, 1)) > std.zig.c_translation.MacroArithmetic.div(MAX_SIZET, e));
}
...
pub inline fn luaM_limitN(n: anytype, t: anytype) @TypeOf(if (cast_sizet(n) <= std.zig.c_translation.MacroArithmetic.div(MAX_SIZET, std.zig.c_translation.sizeof(t))) n else cast_uint(std.zig.c_translation.MacroArithmetic.div(MAX_SIZET, std.zig.c_translation.sizeof(t)))) {
    _ = &n;
    _ = &t;
    return if (cast_sizet(n) <= std.zig.c_translation.MacroArithmetic.div(MAX_SIZET, std.zig.c_translation.sizeof(t))) n else cast_uint(std.zig.c_translation.MacroArithmetic.div(MAX_SIZET, std.zig.c_translation.sizeof(t)));
}
pub inline fn luaM_reallocvchar(L: anytype, b: anytype, on: anytype, n: anytype) @TypeOf(cast_charp(luaM_saferealloc_(L, b, on * std.zig.c_translation.sizeof(u8), n * std.zig.c_translation.sizeof(u8)))) {
    _ = &L;
    _ = &b;
    _ = &on;
    _ = &n;
    return cast_charp(luaM_saferealloc_(L, b, on * std.zig.c_translation.sizeof(u8), n * std.zig.c_translation.sizeof(u8)));
}
...
pub inline fn luaM_newvectorchecked(L: anytype, n: anytype, t: anytype) @TypeOf(luaM_newvector(L, n, t)) {
    ...
    _ = &t;
    return blk_1: {
        _ = luaM_checksize(L, n, std.zig.c_translation.sizeof(t));
...
pub inline fn yieldable(L: anytype) @TypeOf((L.*.nCcalls & std.zig.c_translation.promoteIntLiteral(c_int, 0xffff0000, .hex)) == @as(c_int, 0)) {
    _ = &L;
    return (L.*.nCcalls & std.zig.c_translation.promoteIntLiteral(c_int, 0xffff0000, .hex)) == @as(c_int, 0);
}
pub inline fn getCcalls(L: anytype) @TypeOf(L.*.nCcalls & std.zig.c_translation.promoteIntLiteral(c_int, 0xffff, .hex)) {
    _ = &L;
    return L.*.nCcalls & std.zig.c_translation.promoteIntLiteral(c_int, 0xffff, .hex);
}
...
pub const nyci = std.zig.c_translation.promoteIntLiteral(c_int, 0x10000, .hex) | @as(c_int, 1);
...
pub inline fn MASK1(n: anytype, p: anytype) @TypeOf(~(~std.zig.c_translation.cast(Instruction, @as(c_int, 0)) << n) << p) {
    _ = &n;
    _ = &p;
    return ~(~std.zig.c_translation.cast(Instruction, @as(c_int, 0)) << n) << p;
}
...
pub const NUM_OPCODES = std.zig.c_translation.cast(c_int, OP_EXTRAARG) + @as(c_int, 1);
...
pub inline fn luaD_checkstack(L: anytype, n: anytype) @TypeOf(luaD_checkstackaux(L, n, std.zig.c_translation.cast(anyopaque, @as(c_int, 0)), std.zig.c_translation.cast(anyopaque, @as(c_int, 0)))) {
    _ = &L;
    _ = &n;
    return luaD_checkstackaux(L, n, std.zig.c_translation.cast(anyopaque, @as(c_int, 0)), std.zig.c_translation.cast(anyopaque, @as(c_int, 0)));
}
...
pub inline fn checkstackGC(L: anytype, fsize: anytype) @TypeOf(luaD_checkstackaux(L, fsize, luaC_checkGC(L), std.zig.c_translation.cast(anyopaque, @as(c_int, 0)))) {
    _ = &L;
    _ = &fsize;
    return luaD_checkstackaux(L, fsize, luaC_checkGC(L), std.zig.c_translation.cast(anyopaque, @as(c_int, 0)));
}
pub const lfunc_h = "";
...
pub inline fn luaC_checkGC(L: anytype) @TypeOf(luaC_condGC(L, std.zig.c_translation.cast(anyopaque, @as(c_int, 0)), std.zig.c_translation.cast(anyopaque, @as(c_int, 0)))) {
    _ = &L;
    return luaC_condGC(L, std.zig.c_translation.cast(anyopaque, @as(c_int, 0)), std.zig.c_translation.cast(anyopaque, @as(c_int, 0)));
}
...
pub inline fn luaS_newliteral(L: anytype, s: anytype) @TypeOf(luaS_newlstr(L, "" ++ s, std.zig.c_translation.MacroArithmetic.div(std.zig.c_translation.sizeof(s), std.zig.c_translation.sizeof(u8)) - @as(c_int, 1))) {
    _ = &L;
    _ = &s;
    return luaS_newlstr(L, "" ++ s, std.zig.c_translation.MacroArithmetic.div(std.zig.c_translation.sizeof(s), std.zig.c_translation.sizeof(u8)) - @as(c_int, 1));
}
...
pub inline fn noLuaClosure(f: anytype) @TypeOf((f == NULL) or (f.*.c.tt == LUA_VCCL)) {
    _ = &f;
    return (f == NULL) or (f.*.c.tt == LUA_VCCL);
}
