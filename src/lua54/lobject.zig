...
pub export fn luaO_utf8esc(arg_buff: [*c]u8, arg_x: c_ulong) c_int {
    var buff = arg_buff;
    _ = &buff;
    var x = arg_x;
    _ = &x;
    ...
    if (x < @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 128))))) {
        ...
        while (true) {
            (blk: {
                ...
                if (tmp >= 0) break :blk buff + @as(usize, @intCast(tmp)) else break :blk buff - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as(u8, @bitCast(@as(u8, @truncate(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 128)))) | (x & @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 63)))))))));
            x >>= @intCast(@as(c_int, 6));
            mfb >>= @intCast(@as(c_int, 1));
            if (!(x > @as(c_ulong, @bitCast(@as(c_ulong, mfb))))) break;
        }
        (blk: {
            const tmp = @as(c_int, 8) - n;
            if (tmp >= 0) break :blk buff + @as(usize, @intCast(tmp)) else break :blk buff - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* = @as(u8, @bitCast(@as(u8, @truncate(@as(c_ulong, @bitCast(@as(c_ulong, ~mfb << @intCast(1)))) | x))));
    }
    return n;
}
pub export fn luaO_rawarith(arg_L: [*c]lua_State, arg_op: c_int, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_res: [*c]TValue) c_int {
    var L = arg_L;
    _ = &L;
    var op = arg_op;
    _ = &op;
            ...
            @as(c_int, 7), @as(c_int, 8), @as(c_int, 9), @as(c_int, 10), @as(c_int, 11), @as(c_int, 13) => {
                {
                    ...
                    _ = &@"i2";
                    if (((if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 1))))) != 0) blk: {
                        (&@"i1").* = blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 p1.*.value_.i;
                        };
                        break :blk @as(c_int, 1);
                    } else luaV_tointegerns(p1, &@"i1", @as(c_uint, @bitCast(F2Ieq)))) != 0) and ((if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(@as(c_int, @bitCast(@as(c_uint, p2.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 1))))) != 0) blk: {
                        (&@"i2").* = blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 p2.*.value_.i;
                        };
                        break :blk @as(c_int, 1);
                    } else luaV_tointegerns(p2, &@"i2", @as(c_uint, @bitCast(F2Ieq)))) != 0)) {
                        {
                            var io: [*c]TValue = res;
                            _ = &io;
                ...
                }
                {
                    ...
                    _ = &n2;
                    if (((if (@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 1) << @intCast(4)))) blk: {
                        n1 = blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 p1.*.value_.n;
                        };
                        break :blk @as(c_int, 1);
                    } else if (@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) blk: {
                        n1 = @as(lua_Number, @floatFromInt(blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 p1.*.value_.i;
                        }));
                        break :blk @as(c_int, 1);
                    } else @as(c_int, 0)) != 0) and ((if (@as(c_int, @bitCast(@as(c_uint, p2.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 1) << @intCast(4)))) blk: {
                        n2 = blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 p2.*.value_.n;
                        };
                        break :blk @as(c_int, 1);
                    } else if (@as(c_int, @bitCast(@as(c_uint, p2.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) blk: {
                        n2 = @as(lua_Number, @floatFromInt(blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 p2.*.value_.i;
                        }));
                        break :blk @as(c_int, 1);
                ...
                }
                {
                    ...
                    var n2: lua_Number = undefined;
                    _ = &n2;
                    if ((@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) and (@as(c_int, @bitCast(@as(c_uint, p2.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4))))) {
                        {
                            var io: [*c]TValue = res;
                            _ = &io;
                            io.*.value_.i = intarith(L, op, blk: {
                                _ = @as(c_int, 0);
                                break :blk p1.*.value_.i;
                            }, blk: {
                                _ = @as(c_int, 0);
                                break :blk p2.*.value_.i;
                            });
                            _ = blk: {
                                const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 3) | (@as(c_int, 0) << @intCast(4))))));
                                io.*.tt_ = tmp;
                        ...
                        return 1;
                    } else if (((if (@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 1) << @intCast(4)))) blk: {
                        n1 = blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 p1.*.value_.n;
                        };
...
pub export fn luaO_arith(arg_L: [*c]lua_State, arg_op: c_int, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_res: StkId) void {
    var L = arg_L;
    _ = &L;
    var op = arg_op;
    _ = &op;
    ...
    var res = arg_res;
    _ = &res;
    if (!(luaO_rawarith(L, op, p1, p2, &res.*.val) != 0)) {
        luaT_trybinTM(L, p1, p2, res, @as(c_uint, @bitCast((op - @as(c_int, 0)) + TM_ADD)));
    }
}
pub export fn luaO_str2num(arg_s: [*c]const u8, arg_o: [*c]TValue) usize {
    var s = arg_s;
    _ = &s;
    var o = arg_o;
    _ = &o;
    ...
    return @as(usize, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(e) -% @intFromPtr(s))), @sizeOf(u8)) + @as(c_long, @bitCast(@as(c_long, @as(c_int, 1))))));
}
pub export fn luaO_hexavalue(arg_c: c_int) c_int {
    var c = arg_c;
    _ = &c;
    if ((blk: {
        var c_: u8 = @as(u8, @bitCast(@as(i8, @truncate(c))));
        _ = &c_;
        break :blk (@as(c_int, '0') <= @as(c_int, @bitCast(@as(c_uint, c_)))) and (@as(c_int, @bitCast(@as(c_uint, c_))) <= @as(c_int, '9'));
    })) return c - @as(c_int, '0') else return ((blk: {
        _ = @as(c_int, 0);
        break :blk c | (@as(c_int, 'A') ^ @as(c_int, 'a'));
...
pub export fn luaO_tostring(arg_L: [*c]lua_State, arg_obj: [*c]TValue) void {
    var L = arg_L;
    _ = &L;
    var obj = arg_obj;
    _ = &obj;
    var buff: [44]u8 = undefined;
    _ = &buff;
    var len: c_int = tostringbuff(obj, @as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))));
    _ = &len;
    {
        var io: [*c]TValue = obj;
        _ = &io;
        var x_: [*c]TString = luaS_newlstr(L, @as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))), @as(usize, @bitCast(@as(c_long, len))));
        _ = &x_;
        io.*.value_.gc = blk: {
            _ = @as(c_int, 0);
...
pub const struct_BuffFS = extern struct {
    L: [*c]lua_State = std.mem.zeroes([*c]lua_State),
    pushed: c_int = std.mem.zeroes(c_int),
    blen: c_int = std.mem.zeroes(c_int),
    space: [199]u8 = std.mem.zeroes([199]u8),
};
pub const BuffFS = struct_BuffFS;
// aarch64 va_list layout (AAPCS64)
const VaList = extern struct {
    __stack: ?*anyopaque,
    __gr_top: ?*anyopaque,
    __vr_top: ?*anyopaque,
    __gr_offs: c_int,
...
fn vaArgPtr(ap: *VaList) ?*anyopaque {
    const gr_top = @intFromPtr(ap.__gr_top orelse return null);
    if (ap.__gr_offs < 0) {
        const val_ptr: *const ?*anyopaque = @ptrFromInt(gr_top +% @as(usize, @bitCast(@as(isize, ap.__gr_offs))));
        ap.__gr_offs += 8;
        return val_ptr.*;
    }
    // Fallback to stack
    const stk = @intFromPtr(ap.__stack orelse return null);
    const val_ptr: *const ?*anyopaque = @ptrFromInt(stk);
    ap.__stack = @ptrFromInt(stk + 8);
    return val_ptr.*;
}

fn vaArgInt(ap: *VaList) c_int {
    const gr_top = @intFromPtr(ap.__gr_top orelse return 0);
    if (ap.__gr_offs < 0) {
        const val_ptr: *const c_int = @ptrFromInt(gr_top +% @as(usize, @bitCast(@as(isize, ap.__gr_offs))));
        ap.__gr_offs += 8;
        return val_ptr.*;
    }
    const stk = @intFromPtr(ap.__stack orelse return 0);
    const val_ptr: *const c_int = @ptrFromInt(stk);
    ap.__stack = @ptrFromInt(stk + 8);
    return val_ptr.*;
}

fn vaArgLongLong(ap: *VaList) c_longlong {
    const gr_top = @intFromPtr(ap.__gr_top orelse return 0);
    if (ap.__gr_offs < 0) {
        const val_ptr: *const c_longlong = @ptrFromInt(gr_top +% @as(usize, @bitCast(@as(isize, ap.__gr_offs))));
        ap.__gr_offs += 8;
        return val_ptr.*;
    }
    const stk = @intFromPtr(ap.__stack orelse return 0);
    const val_ptr: *const c_longlong = @ptrFromInt(stk);
    ap.__stack = @ptrFromInt(stk + 8);
    return val_ptr.*;
}

/// luaO_pushvfstring — format string with va_list args, push result onto Lua stack.
/// Implements %s, %d, %I, %p, %c, %% (enough for luaL_traceback and luaG_runerror).
pub export fn luaO_pushvfstring(arg_L: [*c]lua_State, arg_fmt: [*c]const u8, arg_argp: ?*anyopaque) callconv(.c) [*c]const u8 {
    const L = arg_L;
    const fmt = arg_fmt;
    const ap: *VaList = @ptrCast(@alignCast(arg_argp orelse return lua_pushstring(L, fmt)));

    // Build result in a fixed buffer, then push as Lua string
    var buf: [1024]u8 = undefined;
    var out: usize = 0;
    var i: usize = 0;

    while (fmt[i] != 0 and out + 1 < buf.len) {
        if (fmt[i] != '%') {
            buf[out] = fmt[i];
            out += 1;
            i += 1;
        ...
        switch (fmt[i]) {
            's' => {
                i += 1;
                const raw_ptr = vaArgPtr(ap);
                const s: [*c]const u8 = if (raw_ptr) |p| @ptrCast(p) else "(null)";
                var j: usize = 0;
                if (s != null) {
                    while (s[j] != 0 and out + 1 < buf.len) : (j += 1) {
                        buf[out] = s[j];
                        out += 1;
                    }
                }
            ...
            'I' => {
                ...
                i += 1;
                var val: i64 = vaArgLongLong(ap);
                if (val < 0) { buf[out] = '-'; out += 1; val = -val; }
                var digits: [20]u8 = undefined;
                var dlen: usize = 0;
                if (val == 0) { digits[0] = '0'; dlen = 1; } else {
                    var v: u64 = @intCast(val);
                    while (v > 0) : (dlen += 1) { digits[dlen] = @intCast(v % 10 + '0'); v /= 10; }
                }
                var d: usize = dlen;
                while (d > 0 and out + 1 < buf.len) { d -= 1; buf[out] = digits[d]; out += 1; }
            },
            'p' => {
                i += 1;
                const ptr = @intFromPtr(vaArgPtr(ap));
                // Hex format
                const hex = "0123456789abcdef";
                buf[out] = '0'; out += 1;
                if (out < buf.len) { buf[out] = 'x'; out += 1; }
                var shift: u6 = 60;
                var started = false;
                while (out + 1 < buf.len) {
                    const nibble: u4 = @truncate(ptr >> shift);
            ...
            'c' => {
                i += 1;
                buf[out] = @intCast(@as(u32, @bitCast(vaArgInt(ap))) & 0xFF);
                out += 1;
            },
            '%' => {
                i += 1;
            ...
            'f' => {
                // Skip float arg, print placeholder
                i += 1;
                _ = vaArgLongLong(ap); // consume 8 bytes (double)
                const placeholder = "<float>";
                for (placeholder) |ch| {
                    if (out + 1 < buf.len) { buf[out] = ch; out += 1; }
                }
            },
            'U' => {
                i += 1;
                _ = vaArgLongLong(ap); // consume
                const placeholder = "<U+?>";
                for (placeholder) |ch| {
                    if (out + 1 < buf.len) { buf[out] = ch; out += 1; }
                }
                ...
                buf[out] = '%';
                out += 1;
                if (out + 1 < buf.len) { buf[out] = fmt[i]; out += 1; }
                i += 1;
            },
        }
    }
    buf[out] = 0;
    return lua_pushlstring(L, &buf, out);
}

/// luaO_pushfstring — variadic stub.
/// @cVaStart disabled in Zig 0.15. Naked trampoline corrupts caller state.
/// Pushes format string literally. Callers that need real formatting should
/// call luaO_pushvfstring with a proper va_list pointer.
pub export fn luaO_pushfstring(L: [*c]lua_State, fmt: [*c]const u8, ...) callconv(.c) [*c]const u8 {
    return lua_pushstring(L, fmt);
}
pub export fn luaO_chunkid(arg_out: [*c]u8, arg_source: [*c]const u8, arg_srclen: usize) void {
    var out = arg_out;
    _ = &out;
    ...
    _ = &srclen;
    var bufflen: usize = 60;
    _ = &bufflen;
    if (@as(c_int, @bitCast(@as(c_uint, source.*))) == @as(c_int, '=')) {
        if (srclen <= bufflen) {
            _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast(source + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))))), srclen *% @sizeOf(u8));
        } else {
            _ = blk: {
                _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast(source + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))))), (bufflen -% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))) *% @sizeOf(u8));
                break :blk blk_1: {
                    const ref = &out;
                    ref.* += bufflen -% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))));
                    break :blk_1 ref.*;
                };
            };
            out.* = '\x00';
        }
    } else if (@as(c_int, @bitCast(@as(c_uint, source.*))) == @as(c_int, '@')) {
        if (srclen <= bufflen) {
            _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast(source + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))))), srclen *% @sizeOf(u8));
        } else {
            _ = blk: {
                _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast("...")), ((@sizeOf([4]u8) / @sizeOf(u8)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) *% @sizeOf(u8));
                break :blk blk_1: {
                    const ref = &out;
                    ref.* += (@sizeOf([4]u8) / @sizeOf(u8)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))));
                    break :blk_1 ref.*;
                };
            };
            bufflen -%= @as(usize, @bitCast((@sizeOf([4]u8) / @sizeOf(u8)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))));
            _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast(((source + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))) + srclen) - bufflen)), bufflen *% @sizeOf(u8));
        }
    } else {
        var nl: [*c]const u8 = strchr(source, @as(c_int, '\n'));
        _ = &nl;
        _ = blk: {
            _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast("[string \"")), ((@sizeOf([10]u8) / @sizeOf(u8)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) *% @sizeOf(u8));
            break :blk blk_1: {
                const ref = &out;
                ref.* += (@sizeOf([10]u8) / @sizeOf(u8)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))));
                break :blk_1 ref.*;
            };
        };
        bufflen -%= @as(usize, @bitCast(((@sizeOf([15]u8) / @sizeOf(u8)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) +% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))));
        if ((srclen < bufflen) and (nl == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            _ = blk: {
                _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast(source)), srclen *% @sizeOf(u8));
                break :blk blk_1: {
                    const ref = &out;
                    ref.* += srclen;
                    break :blk_1 ref.*;
            ...
            if (nl != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                srclen = @as(usize, @bitCast(@divExact(@as(c_long, @bitCast(@intFromPtr(nl) -% @intFromPtr(source))), @sizeOf(u8))));
            }
            if (srclen > bufflen) {
                srclen = bufflen;
            }
        ...
        _ = memcpy(@as(?*anyopaque, @ptrCast(out)), @as(?*const anyopaque, @ptrCast("\"]")), (((@sizeOf([3]u8) / @sizeOf(u8)) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) +% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) *% @sizeOf(u8));
    }
}
...
pub fn intarith(arg_L: [*c]lua_State, arg_op: c_int, arg_v1: lua_Integer, arg_v2: lua_Integer) callconv(.c) lua_Integer {
    var L = arg_L;
    _ = &L;
    var op = arg_op;
    _ = &op;
    ...
    while (true) {
        switch (op) {
            @as(c_int, 0) => return @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(v1)) +% @as(lua_Unsigned, @bitCast(v2)))),
            @as(c_int, 1) => return @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(v1)) -% @as(lua_Unsigned, @bitCast(v2)))),
            @as(c_int, 2) => return @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(v1)) *% @as(lua_Unsigned, @bitCast(v2)))),
            @as(c_int, 3) => return luaV_mod(L, v1, v2),
            @as(c_int, 6) => return luaV_idiv(L, v1, v2),
            @as(c_int, 7) => return @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(v1)) & @as(lua_Unsigned, @bitCast(v2)))),
            @as(c_int, 8) => return @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(v1)) | @as(lua_Unsigned, @bitCast(v2)))),
            @as(c_int, 9) => return @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(v1)) ^ @as(lua_Unsigned, @bitCast(v2)))),
            @as(c_int, 10) => return luaV_shiftl(v1, v2),
            @as(c_int, 11) => return luaV_shiftl(v1, @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 0)))) -% @as(lua_Unsigned, @bitCast(v2))))),
            @as(c_int, 12) => return @as(lua_Integer, @bitCast(@as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 0)))) -% @as(lua_Unsigned, @bitCast(v1)))),
            @as(c_int, 13) => return @as(lua_Integer, @bitCast(~@as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 0)))) ^ @as(lua_Unsigned, @bitCast(v1)))),
            else => {
                _ = @as(c_int, 0);
                return 0;
            },
...
pub fn numarith(arg_L: [*c]lua_State, arg_op: c_int, arg_v1: lua_Number, arg_v2: lua_Number) callconv(.c) lua_Number {
    var L = arg_L;
    _ = &L;
    var op = arg_op;
    _ = &op;
    ...
    while (true) {
        switch (op) {
            @as(c_int, 0) => return v1 + v2,
            @as(c_int, 1) => return v1 - v2,
            @as(c_int, 2) => return v1 * v2,
            @as(c_int, 5) => return v1 / v2,
            @as(c_int, 4) => return blk: {
                _ = &L;
                break :blk if (v2 == @as(lua_Number, @floatFromInt(@as(c_int, 2)))) v1 * v1 else pow(v1, v2);
            },
            @as(c_int, 6) => return blk: {
                _ = &L;
                break :blk floor(v1 / v2);
            },
            @as(c_int, 12) => return -v1,
            @as(c_int, 3) => return luaV_modf(L, v1, v2),
            else => {
                _ = @as(c_int, 0);
                return 0;
            },
...
pub fn isneg(arg_s: [*c][*c]const u8) callconv(.c) c_int {
    var s = arg_s;
    _ = &s;
    if (@as(c_int, @bitCast(@as(c_uint, s.*.*))) == @as(c_int, '-')) {
        s.* += 1;
        return 1;
    } else if (@as(c_int, @bitCast(@as(c_uint, s.*.*))) == @as(c_int, '+')) {
        s.* += 1;
    }
    return 0;
}
pub fn l_str2dloc(arg_s: [*c]const u8, arg_result: [*c]lua_Number, arg_mode: c_int) callconv(.c) [*c]const u8 {
    var s = arg_s;
    _ = &s;
    ...
    _ = &endptr;
    result.* = if (mode == @as(c_int, 'x')) strtod(s, &endptr) else strtod(s, &endptr);
    if (endptr == @as([*c]u8, @ptrCast(@constCast(@volatileCast(s))))) return null;
    while ((blk: {
        var c_: u8 = @as(u8, @bitCast(endptr.*));
        _ = &c_;
        break :blk (((((@as(c_int, @bitCast(@as(c_uint, c_))) == @as(c_int, ' ')) or (@as(c_int, @bitCast(@as(c_uint, c_))) == @as(c_int, '\t'))) or (@as(c_int, @bitCast(@as(c_uint, c_))) == @as(c_int, '\r'))) or (@as(c_int, @bitCast(@as(c_uint, c_))) == @as(c_int, '\n'))) or (@as(c_int, @bitCast(@as(c_uint, c_))) == @as(c_int, '\x0c'))) or (@as(c_int, @bitCast(@as(c_uint, c_))) == @as(c_int, '\x0b'));
    })) {
        endptr += 1;
    }
    return if (@as(c_int, @bitCast(@as(c_uint, endptr.*))) == @as(c_int, '\x00')) endptr else null;
}
pub fn l_str2d(arg_s: [*c]const u8, arg_result: [*c]lua_Number) callconv(.c) [*c]const u8 {
    var s = arg_s;
    _ = &s;
    var result = arg_result;
    _ = &result;
    var endptr: [*c]const u8 = undefined;
    _ = &endptr;
    var pmode: [*c]const u8 = strpbrk(s, ".xXnN");
    _ = &pmode;
    var mode: c_int = if (pmode != null) blk: {
        _ = @as(c_int, 0);
        break :blk @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(pmode.*))))) | (@as(c_int, 'A') ^ @as(c_int, 'a'));
    } else @as(c_int, 0);
    _ = &mode;
    if (mode == @as(c_int, 'n')) return null;
    endptr = l_str2dloc(s, result, mode);
    if (endptr == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        var buff: [201]u8 = undefined;
        _ = &buff;
        var pdot: [*c]const u8 = strchr(s, @as(c_int, '.'));
        _ = &pdot;
        if ((pdot == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (strlen(s) > @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 200)))))) return null;
        _ = strcpy(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))), s);
        buff[@as(c_ulong, @intCast(@divExact(@as(c_long, @bitCast(@intFromPtr(pdot) -% @intFromPtr(s))), @sizeOf(u8))))] = localeconv().*.decimal_point[@as(c_uint, @intCast(@as(c_int, 0)))];
        endptr = l_str2dloc(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))]))), result, mode);
        if (endptr != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            endptr = s + @as(usize, @bitCast(@as(isize, @intCast(@divExact(@as(c_long, @bitCast(@intFromPtr(endptr) -% @intFromPtr(@as([*c]u8, @ptrCast(@alignCast(&buff[@as(usize, @intCast(0))])))))), @sizeOf(u8))))));
        }
    }
    return endptr;
}
pub fn l_str2int(arg_s: [*c]const u8, arg_result: [*c]lua_Integer) callconv(.c) [*c]const u8 {
    var s = arg_s;
    _ = &s;
    var result = arg_result;
    _ = &result;
    var a: lua_Unsigned = 0;
    _ = &a;
    var empty: c_int = 1;
    _ = &empty;
    ...
    neg = isneg(&s);
    if ((@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '0')) and ((@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, 'x')) or (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, 'X')))) {
        ...
        while ((blk: {
            ...
            a = (a *% @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 16))))) +% @as(lua_Unsigned, @bitCast(@as(c_longlong, luaO_hexavalue(@as(c_int, @bitCast(@as(c_uint, s.*)))))));
            empty = 0;
        }
    }
    if ((@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '0')) and ((@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, 'b')) or (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, 'B')))) {
        s += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))));
        while ((blk: {
            var c_: u8 = @as(u8, @bitCast(s.*));
            _ = &c_;
            break :blk (@as(c_int, '0') <= @as(c_int, @bitCast(@as(c_uint, c_)))) and (@as(c_int, @bitCast(@as(c_uint, c_))) <= @as(c_int, '1'));
        })) : (s += 1) {
            a = (a *% @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 2))))) +% @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, @bitCast(@as(c_uint, s.*))) - @as(c_int, '0'))));
            empty = 0;
        }
    } else if (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '0')) {
        while ((blk: {
            var c_: u8 = @as(u8, @bitCast(s.*));
            _ = &c_;
            break :blk (@as(c_int, '0') <= @as(c_int, @bitCast(@as(c_uint, c_)))) and (@as(c_int, @bitCast(@as(c_uint, c_))) <= @as(c_int, '9'));
        })) : (s += 1) {
            var d: c_int = @as(c_int, @bitCast(@as(c_uint, s.*))) - @as(c_int, '0');
            _ = &d;
            if ((a >= @as(lua_Unsigned, @bitCast(@divTrunc(@as(c_longlong, 9223372036854775807), @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 8)))))))) and ((a > @as(lua_Unsigned, @bitCast(@divTrunc(@as(c_longlong, 9223372036854775807), @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 8)))))))) or (d > (@as(c_int, @bitCast(@as(c_int, @truncate(@import("std").zig.c_translation.signedRemainder(@as(c_longlong, 9223372036854775807), @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 8))))))))) + neg)))) return null;
            a = (a *% @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 8))))) +% @as(lua_Unsigned, @bitCast(@as(c_longlong, d)));
            empty = 0;
        }
    } else {
        while ((blk: {
            ...
            var d: c_int = @as(c_int, @bitCast(@as(c_uint, s.*))) - @as(c_int, '0');
            _ = &d;
            if ((a >= @as(lua_Unsigned, @bitCast(@divTrunc(@as(c_longlong, 9223372036854775807), @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 10)))))))) and ((a > @as(lua_Unsigned, @bitCast(@divTrunc(@as(c_longlong, 9223372036854775807), @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 10)))))))) or (d > (@as(c_int, @bitCast(@as(c_int, @truncate(@import("std").zig.c_translation.signedRemainder(@as(c_longlong, 9223372036854775807), @as(c_longlong, @bitCast(@as(c_longlong, @as(c_int, 10))))))))) + neg)))) return null;
            a = (a *% @as(lua_Unsigned, @bitCast(@as(c_longlong, @as(c_int, 10))))) +% @as(lua_Unsigned, @bitCast(@as(c_longlong, d)));
            empty = 0;
        }
    }
    while ((blk: {
    ...
    if ((empty != 0) or (@as(c_int, @bitCast(@as(c_uint, s.*))) != @as(c_int, '\x00'))) return null else {
        result.* = @as(lua_Integer, @bitCast(if (neg != 0) @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, 0)))) -% a else a));
        return s;
    }
    return null;
}
pub fn tostringbuff(arg_obj: [*c]TValue, arg_buff: [*c]u8) callconv(.c) c_int {
    var obj = arg_obj;
    _ = &obj;
    var buff = arg_buff;
    _ = &buff;
    ...
    if (@as(c_int, @bitCast(@as(c_uint, obj.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) {
        len = snprintf(buff, @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 44)))), "%lld", @as(c_longlong, @bitCast(blk: {
            _ = @as(c_int, 0);
            break :blk obj.*.value_.i;
        })));
    } else {
        len = snprintf(buff, @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 44)))), "%.14g", @as(f64, @floatCast(blk: {
            _ = @as(c_int, 0);
            break :blk obj.*.value_.n;
        })));
        if (@as(c_int, @bitCast(@as(c_uint, buff[strspn(buff, "-0123456789")]))) == @as(c_int, '\x00')) {
            (blk: {
                const tmp = blk_1: {
                    const ref = &len;
                    const tmp_2 = ref.*;
                ...
                if (tmp >= 0) break :blk buff + @as(usize, @intCast(tmp)) else break :blk buff - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = localeconv().*.decimal_point[@as(c_uint, @intCast(@as(c_int, 0)))];
            (blk: {
                const tmp = blk_1: {
                    const ref = &len;
                    const tmp_2 = ref.*;
...
pub fn pushstr(arg_buff: [*c]BuffFS, arg_str: [*c]const u8, arg_lstr: usize) callconv(.c) void {
    var buff = arg_buff;
    _ = &buff;
    var str = arg_str;
    _ = &str;
    var lstr = arg_lstr;
    _ = &lstr;
    var L: [*c]lua_State = buff.*.L;
    _ = &L;
    {
        var io: [*c]TValue = &L.*.top.p.*.val;
        _ = &io;
        var x_: [*c]TString = luaS_newlstr(L, str, lstr);
        _ = &x_;
        io.*.value_.gc = blk: {
            _ = @as(c_int, 0);
            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
    ...
    if (!(buff.*.pushed != 0)) {
        ...
        luaV_concat(L, @as(c_int, 2));
    }
}
pub fn clearbuff(arg_buff: [*c]BuffFS) callconv(.c) void {
    var buff = arg_buff;
    _ = &buff;
    pushstr(buff, @as([*c]u8, @ptrCast(@alignCast(&buff.*.space[@as(usize, @intCast(0))]))), @as(usize, @bitCast(@as(c_long, buff.*.blen))));
    buff.*.blen = 0;
}
pub fn getbuff(arg_buff: [*c]BuffFS, arg_sz: c_int) callconv(.c) [*c]u8 {
    var buff = arg_buff;
    _ = &buff;
    var sz = arg_sz;
    _ = &sz;
    _ = @as(c_int, 0);
    _ = @as(c_int, 0);
    if (sz > (((@as(c_int, 60) + @as(c_int, 44)) + @as(c_int, 95)) - buff.*.blen)) {
        clearbuff(buff);
    }
    return @as([*c]u8, @ptrCast(@alignCast(&buff.*.space[@as(usize, @intCast(0))]))) + @as(usize, @bitCast(@as(isize, @intCast(buff.*.blen))));
}
pub fn addstr2buff(arg_buff: [*c]BuffFS, arg_str: [*c]const u8, arg_slen: usize) callconv(.c) void {
    var buff = arg_buff;
    _ = &buff;
    var str = arg_str;
    _ = &str;
    var slen = arg_slen;
    _ = &slen;
    if (slen <= @as(usize, @bitCast(@as(c_long, (@as(c_int, 60) + @as(c_int, 44)) + @as(c_int, 95))))) {
        var bf: [*c]u8 = getbuff(buff, @as(c_int, @bitCast(@as(c_uint, @truncate(slen)))));
        _ = &bf;
        _ = memcpy(@as(?*anyopaque, @ptrCast(bf)), @as(?*const anyopaque, @ptrCast(str)), slen);
        _ = blk: {
            const ref = &buff.*.blen;
            ref.* += @as(c_int, @bitCast(@as(c_uint, @truncate(slen))));
            break :blk ref.*;
        };
    } else {
        clearbuff(buff);
...
pub fn addnum2buff(arg_buff: [*c]BuffFS, arg_num: [*c]TValue) callconv(.c) void {
    var buff = arg_buff;
    _ = &buff;
    var num = arg_num;
    _ = &num;
    var numbuff: [*c]u8 = getbuff(buff, @as(c_int, 44));
    _ = &numbuff;
    var len: c_int = tostringbuff(num, numbuff);
    _ = &len;
    _ = blk: {
        const ref = &buff.*.blen;
        ref.* += len;
...
pub const luaV_fastgeti = @compileError("unable to translate macro: undefined identifier `luaH_getint`");
...
pub const L_MAXLENNUM = @as(c_int, 200);
pub const MAXBY10 = cast(lua_Unsigned, @import("std").zig.c_translation.MacroArithmetic.div(LUA_MAXINTEGER, @as(c_int, 10)));
pub const MAXBY8 = cast(lua_Unsigned, @import("std").zig.c_translation.MacroArithmetic.div(LUA_MAXINTEGER, @as(c_int, 8)));
pub const MAXLASTD = cast_int(@import("std").zig.c_translation.MacroArithmetic.rem(LUA_MAXINTEGER, @as(c_int, 10)));
pub const MAXLASTD8 = cast_int(@import("std").zig.c_translation.MacroArithmetic.rem(LUA_MAXINTEGER, @as(c_int, 8)));
pub const MAXNUMBER2STR = @as(c_int, 44);
pub const BUFVFS = (LUA_IDSIZE + MAXNUMBER2STR) + @as(c_int, 95);
pub const addsize = @compileError("unable to translate C expr: expected ')' instead got '+='");
// /src/cosmopolitan/third_party/lua/lobject.c:463:9
pub const RETS = "...";
pub const PRE = "[string \"";
pub const POS = "\"]";
pub const addstr = @compileError("unable to translate C expr: expected ')' instead got '+='");
// /src/cosmopolitan/third_party/lua/lobject.c:582:9
