...
pub extern const kEscapeAuthority: [256]u8;
pub extern const kEscapeIp: [256]u8;
pub extern const kEscapePath: [256]u8;
pub extern const kEscapeSegment: [256]u8;
pub extern const kEscapeParam: [256]u8;
pub extern const kEscapeFragment: [256]u8;
pub extern fn EscapeHtml([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapeUrl([*c]const u8, usize, [*c]usize, [*c]const u8) [*c]u8;
pub extern fn EscapeUser([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapePass([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapeIp([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapeHost([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapePath([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapeParam([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapeFragment([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapeSegment([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EscapeJsStringLiteral([*c][*c]u8, [*c]usize, [*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn HasControlCodes([*c]const u8, usize, c_int) isize;
pub extern fn Underlong([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn DecodeLatin1([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EncodeLatin1([*c]const u8, usize, [*c]usize, c_int) [*c]u8;
pub extern fn EncodeHttpHeaderValue([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn VisualizeControlCodes([*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn IndentLines([*c]const u8, usize, [*c]usize, usize) [*c]u8;
pub extern fn EncodeBase32(?*const anyopaque, usize, [*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn DecodeBase32([*c]const u8, usize, [*c]const u8, usize, [*c]usize) [*c]u8;
pub extern fn EncodeBase64(?*const anyopaque, usize, [*c]usize) [*c]u8;
pub extern fn DecodeBase64([*c]const u8, usize, [*c]usize) [*c]u8;
...
pub export fn LuaEncodeJsonData(L: ?*lua_State, buf: [*c][*c]u8, idx: c_int, conf: struct_EncoderConfig) c_int {
    var z: struct_Serializer = .{
    ...
    if (lua_checkstack(L, (@as(c_int, conf.maxdepth) * 3) + 20) != 0) {
        const rc = Serialize(L, buf, idx, &z, 0);
        free(@as(?*anyopaque, @ptrCast(z.visited.p)));
        free(@as(?*anyopaque, @ptrCast(z.strbuf)));
        if (rc == -1) {
            lua_pushnil(L);
...
pub fn Serialize(L: ?*lua_State, buf: [*c][*c]u8, idx: c_int, z: [*c]struct_Serializer, depth: c_int) callconv(.c) c_int {
    if (depth < @as(c_int, z.*.conf.maxdepth)) {
        return switch (lua_type(L, idx)) {
            0 => SerializeNull(L, buf),
            1 => SerializeBoolean(L, buf, idx),
            4 => SerializeString(L, buf, idx, z),
            3 => SerializeNumber(L, buf, idx),
            5 => SerializeTable(L, buf, idx, z, depth),
            else => {
...
// Demoted to extern (translate-c could not handle goto statements in original C)
pub extern fn SerializeNull(?*lua_State, [*c][*c]u8) callconv(.c) c_int;
pub extern fn SerializeBoolean(?*lua_State, [*c][*c]u8, c_int) callconv(.c) c_int;
pub extern fn SerializeNumber(?*lua_State, [*c][*c]u8, c_int) callconv(.c) c_int;
pub extern fn SerializeString(?*lua_State, [*c][*c]u8, c_int, [*c]struct_Serializer) callconv(.c) c_int;
pub extern fn SerializeArray(?*lua_State, [*c][*c]u8, [*c]struct_Serializer, c_int, usize) callconv(.c) c_int;
pub extern fn SerializeObject(?*lua_State, [*c][*c]u8, [*c]struct_Serializer, c_int, bool) callconv(.c) c_int;
pub extern fn SerializeSorted(?*lua_State, [*c][*c]u8, [*c]struct_Serializer, c_int, bool) callconv(.c) c_int;
pub extern fn SerializeTable(?*lua_State, [*c][*c]u8, c_int, [*c]struct_Serializer, c_int) callconv(.c) c_int;
...
pub const COSMOPOLITAN_NET_HTTP_ESCAPE_H_ = "";
pub const kControlWs = @as(c_int, 1);
pub const kControlC0 = @as(c_int, 2);
pub const kControlC1 = @as(c_int, 4);
