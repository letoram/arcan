...
const builtin = std.zig.c_builtins;

pub const __builtin_bswap16 = builtin.__builtin_bswap16;
pub const __builtin_bswap32 = builtin.__builtin_bswap32;
pub const __builtin_bswap64 = builtin.__builtin_bswap64;
pub const __builtin_signbit = builtin.__builtin_signbit;
pub const __builtin_signbitf = builtin.__builtin_signbitf;
pub const __builtin_popcount = builtin.__builtin_popcount;
pub const __builtin_ctz = builtin.__builtin_ctz;
pub const __builtin_clz = builtin.__builtin_clz;
pub const __builtin_sqrt = builtin.__builtin_sqrt;
pub const __builtin_sqrtf = builtin.__builtin_sqrtf;
pub const __builtin_sin = builtin.__builtin_sin;
pub const __builtin_sinf = builtin.__builtin_sinf;
pub const __builtin_cos = builtin.__builtin_cos;
pub const __builtin_cosf = builtin.__builtin_cosf;
pub const __builtin_exp = builtin.__builtin_exp;
pub const __builtin_expf = builtin.__builtin_expf;
pub const __builtin_exp2 = builtin.__builtin_exp2;
pub const __builtin_exp2f = builtin.__builtin_exp2f;
pub const __builtin_log = builtin.__builtin_log;
pub const __builtin_logf = builtin.__builtin_logf;
pub const __builtin_log2 = builtin.__builtin_log2;
pub const __builtin_log2f = builtin.__builtin_log2f;
pub const __builtin_log10 = builtin.__builtin_log10;
pub const __builtin_log10f = builtin.__builtin_log10f;
pub const __builtin_abs = builtin.__builtin_abs;
pub const __builtin_labs = builtin.__builtin_labs;
pub const __builtin_llabs = builtin.__builtin_llabs;
pub const __builtin_fabs = builtin.__builtin_fabs;
pub const __builtin_fabsf = builtin.__builtin_fabsf;
pub const __builtin_floor = builtin.__builtin_floor;
pub const __builtin_floorf = builtin.__builtin_floorf;
pub const __builtin_ceil = builtin.__builtin_ceil;
pub const __builtin_ceilf = builtin.__builtin_ceilf;
pub const __builtin_trunc = builtin.__builtin_trunc;
pub const __builtin_truncf = builtin.__builtin_truncf;
pub const __builtin_round = builtin.__builtin_round;
pub const __builtin_roundf = builtin.__builtin_roundf;
pub const __builtin_strlen = builtin.__builtin_strlen;
pub const __builtin_strcmp = builtin.__builtin_strcmp;
pub const __builtin_object_size = builtin.__builtin_object_size;
pub const __builtin___memset_chk = builtin.__builtin___memset_chk;
pub const __builtin_memset = builtin.__builtin_memset;
pub const __builtin___memcpy_chk = builtin.__builtin___memcpy_chk;
pub const __builtin_memcpy = builtin.__builtin_memcpy;
pub const __builtin_expect = builtin.__builtin_expect;
pub const __builtin_nanf = builtin.__builtin_nanf;
pub const __builtin_huge_valf = builtin.__builtin_huge_valf;
pub const __builtin_inff = builtin.__builtin_inff;
pub const __builtin_isnan = builtin.__builtin_isnan;
pub const __builtin_isinf = builtin.__builtin_isinf;
pub const __builtin_isinf_sign = builtin.__builtin_isinf_sign;
pub const __has_builtin = builtin.__has_builtin;
pub const __builtin_assume = builtin.__builtin_assume;
pub const __builtin_unreachable = builtin.__builtin_unreachable;
pub const __builtin_constant_p = builtin.__builtin_constant_p;
pub const __builtin_mul_overflow = builtin.__builtin_mul_overflow;
...
pub const struct_TString = extern struct {
    ...
    tt: lu_byte = std.mem.zeroes(lu_byte),
    marked: lu_byte = std.mem.zeroes(lu_byte),
    extra: lu_byte = std.mem.zeroes(lu_byte),
    shrlen: lu_byte = std.mem.zeroes(lu_byte),
    hash: c_uint = std.mem.zeroes(c_uint),
...
pub const struct_stringtable = extern struct {
    hash: [*c][*c]TString = std.mem.zeroes([*c][*c]TString),
    nuse: c_int = std.mem.zeroes(c_int),
...
pub const struct_NodeKey_3 = extern struct {
    value_: Value = std.mem.zeroes(Value),
    tt_: lu_byte = std.mem.zeroes(lu_byte),
    key_tt: lu_byte = std.mem.zeroes(lu_byte),
    next: c_int = std.mem.zeroes(c_int),
...
pub const struct_Table = extern struct {
    ...
    tt: lu_byte = std.mem.zeroes(lu_byte),
    marked: lu_byte = std.mem.zeroes(lu_byte),
    flags: lu_byte = std.mem.zeroes(lu_byte),
    lsizenode: lu_byte = std.mem.zeroes(lu_byte),
    alimit: c_uint = std.mem.zeroes(c_uint),
    array: [*c]TValue = std.mem.zeroes([*c]TValue),
    node: [*c]Node = std.mem.zeroes([*c]Node),
    lastfree: [*c]Node = std.mem.zeroes([*c]Node),
...
pub const struct_global_State = extern struct {
    frealloc: lua_Alloc = std.mem.zeroes(lua_Alloc),
    ud: ?*anyopaque = std.mem.zeroes(?*anyopaque),
    totalbytes: l_mem = std.mem.zeroes(l_mem),
    GCdebt: l_mem = std.mem.zeroes(l_mem),
    GCestimate: lu_mem = std.mem.zeroes(lu_mem),
    lastatomic: lu_mem = std.mem.zeroes(lu_mem),
    strt: stringtable = std.mem.zeroes(stringtable),
    l_registry: TValue = std.mem.zeroes(TValue),
    nilvalue: TValue = std.mem.zeroes(TValue),
    seed: c_uint = std.mem.zeroes(c_uint),
    currentwhite: lu_byte = std.mem.zeroes(lu_byte),
    gcstate: lu_byte = std.mem.zeroes(lu_byte),
    gckind: lu_byte = std.mem.zeroes(lu_byte),
    gcstopem: lu_byte = std.mem.zeroes(lu_byte),
    genminormul: lu_byte = std.mem.zeroes(lu_byte),
    genmajormul: lu_byte = std.mem.zeroes(lu_byte),
    gcstp: lu_byte = std.mem.zeroes(lu_byte),
    gcemergency: lu_byte = std.mem.zeroes(lu_byte),
    gcpause: lu_byte = std.mem.zeroes(lu_byte),
    gcstepmul: lu_byte = std.mem.zeroes(lu_byte),
    gcstepsize: lu_byte = std.mem.zeroes(lu_byte),
    allgc: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    sweepgc: [*c][*c]GCObject = std.mem.zeroes([*c][*c]GCObject),
    finobj: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    gray: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    grayagain: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    weak: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    ephemeron: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    allweak: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    tobefnz: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    fixedgc: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    survival: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    old1: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    reallyold: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    firstold1: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    finobjsur: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    finobjold1: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    finobjrold: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    twups: [*c]struct_lua_State = std.mem.zeroes([*c]struct_lua_State),
    panic: lua_CFunction = std.mem.zeroes(lua_CFunction),
    mainthread: [*c]struct_lua_State = std.mem.zeroes([*c]struct_lua_State),
    memerrmsg: [*c]TString = std.mem.zeroes([*c]TString),
    ...
    warnf: lua_WarnFunction = std.mem.zeroes(lua_WarnFunction),
    ud_warn: ?*anyopaque = std.mem.zeroes(?*anyopaque),
};
pub const global_State = struct_global_State;
pub const l_uint32 = c_uint;
pub const Instruction = l_uint32;
const struct_unnamed_5 = extern struct {
    savedpc: [*c]const Instruction = std.mem.zeroes([*c]const Instruction),
    trap: sig_atomic_t = std.mem.zeroes(sig_atomic_t),
    nextraargs: c_int = std.mem.zeroes(c_int),
};
pub const lua_KContext = isize;
pub const lua_KFunction = ?*const fn ([*c]lua_State, c_int, lua_KContext) callconv(.c) c_int;
const struct_unnamed_6 = extern struct {
    k: lua_KFunction = std.mem.zeroes(lua_KFunction),
    old_errfunc: ptrdiff_t = std.mem.zeroes(ptrdiff_t),
    ctx: lua_KContext = std.mem.zeroes(lua_KContext),
};
...
pub const struct_CallInfo = extern struct {
    ...
    previous: [*c]struct_CallInfo = std.mem.zeroes([*c]struct_CallInfo),
    next: [*c]struct_CallInfo = std.mem.zeroes([*c]struct_CallInfo),
    u: union_unnamed_4 = std.mem.zeroes(union_unnamed_4),
    u2: union_unnamed_7 = std.mem.zeroes(union_unnamed_7),
    nresults: c_short = std.mem.zeroes(c_short),
    callstatus: c_ushort = std.mem.zeroes(c_ushort),
};
...
const struct_unnamed_11 = extern struct {
    next: [*c]struct_UpVal = std.mem.zeroes([*c]struct_UpVal),
    previous: [*c][*c]struct_UpVal = std.mem.zeroes([*c][*c]struct_UpVal),
};
...
pub const struct_UpVal = extern struct {
    ...
    tt: lu_byte = std.mem.zeroes(lu_byte),
    marked: lu_byte = std.mem.zeroes(lu_byte),
    v: union_unnamed_9 = std.mem.zeroes(union_unnamed_9),
    u: union_unnamed_10 = std.mem.zeroes(union_unnamed_10),
};
...
pub const struct_lua_Debug = extern struct {
    ...
    i_ci: [*c]struct_CallInfo = std.mem.zeroes([*c]struct_CallInfo),
};
...
pub const struct_lua_State = extern struct {
    ...
    tt: lu_byte = std.mem.zeroes(lu_byte),
    marked: lu_byte = std.mem.zeroes(lu_byte),
    status: lu_byte = std.mem.zeroes(lu_byte),
    allowhook: lu_byte = std.mem.zeroes(lu_byte),
    nci: c_ushort = std.mem.zeroes(c_ushort),
    top: StkIdRel = std.mem.zeroes(StkIdRel),
    l_G: [*c]global_State = std.mem.zeroes([*c]global_State),
    ci: [*c]CallInfo = std.mem.zeroes([*c]CallInfo),
    stack_last: StkIdRel = std.mem.zeroes(StkIdRel),
    stack: StkIdRel = std.mem.zeroes(StkIdRel),
    openupval: [*c]UpVal = std.mem.zeroes([*c]UpVal),
    tbclist: StkIdRel = std.mem.zeroes(StkIdRel),
    gclist: [*c]GCObject = std.mem.zeroes([*c]GCObject),
    twups: [*c]struct_lua_State = std.mem.zeroes([*c]struct_lua_State),
    errorJmp: ?*struct_lua_longjmp = std.mem.zeroes(?*struct_lua_longjmp),
    base_ci: CallInfo = std.mem.zeroes(CallInfo),
    hook: lua_Hook = std.mem.zeroes(lua_Hook),
    errfunc: ptrdiff_t = std.mem.zeroes(ptrdiff_t),
    nCcalls: l_uint32 = std.mem.zeroes(l_uint32),
    oldpc: c_int = std.mem.zeroes(c_int),
    basehookcount: c_int = std.mem.zeroes(c_int),
    hookcount: c_int = std.mem.zeroes(c_int),
    hookmask: sig_atomic_t = std.mem.zeroes(sig_atomic_t),
};
...
pub export fn lua_atpanic(L: [*c]lua_State, panicf: lua_CFunction) callconv(.c) lua_CFunction {
    const old = L.*.l_G.*.panic;
    L.*.l_G.*.panic = panicf;
    return old;
}
pub export fn lua_version(_: [*c]lua_State) callconv(.c) lua_Number {
    return 504;
}
...
pub export fn lua_absindex(L: [*c]lua_State, idx: c_int) callconv(.c) c_int {
    return if (idx > 0 or idx <= -1001000) idx else @as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(L.*.top.p) -% @intFromPtr(L.*.ci.*.func.p))), @sizeOf(StackValue)))) + idx;
}
pub export fn lua_gettop(L: [*c]lua_State) callconv(.c) c_int {
    return @as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(L.*.top.p) -% @intFromPtr(L.*.ci.*.func.p + @as(usize, @bitCast(@as(isize, 1)))))), @sizeOf(StackValue))));
}
pub export fn lua_settop(L: [*c]lua_State, idx: c_int) callconv(.c) void {
    const ci = L.*.ci;
    const func = ci.*.func.p;
    var diff: ptrdiff_t = undefined;
    if (idx >= 0) {
        diff = @divExact(@as(c_long, @bitCast(@intFromPtr((func + @as(usize, @bitCast(@as(isize, 1)))) + @as(usize, @bitCast(@as(isize, @intCast(idx))))) -% @intFromPtr(L.*.top.p))), @sizeOf(StackValue));
        while (diff > 0) : (diff -= 1) {
            const ref = &L.*.top.p;
            const tmp = ref.*;
            ref.* += 1;
        ...
        diff = @as(ptrdiff_t, @bitCast(@as(c_long, idx + 1)));
    }
    var newtop = L.*.top.p + @as(usize, @bitCast(@as(isize, @intCast(diff))));
    if (diff < 0 and L.*.tbclist.p >= newtop) {
        newtop = luaF_close(L, newtop, -1, 0);
    }
    L.*.top.p = newtop;
}
pub export fn lua_pushvalue(L: [*c]lua_State, idx: c_int) callconv(.c) void {
    {
        const io1: [*c]TValue = &L.*.top.p.*.val;
        const io2: [*c]const TValue = index2value(L, idx);
        io1.*.value_ = io2.*.value_;
        io1.*.tt_ = io2.*.tt_;
    }
    L.*.top.p += 1;
}
pub export fn lua_rotate(L: [*c]lua_State, idx: c_int, n: c_int) callconv(.c) void {
    const t = L.*.top.p - @as(usize, @bitCast(@as(isize, 1)));
    const p = index2stack(L, idx);
    const m = if (n >= 0) t - @as(usize, @bitCast(@as(isize, @intCast(n)))) else (p - @as(usize, @bitCast(@as(isize, @intCast(n))))) - @as(usize, @bitCast(@as(isize, 1)));
    reverse(L, p, m);
    reverse(L, m + @as(usize, @bitCast(@as(isize, 1))), t);
    reverse(L, p, t);
}
...
pub export fn lua_copy(L: [*c]lua_State, fromidx: c_int, toidx: c_int) callconv(.c) void {
    const fr = index2value(L, fromidx);
    const to = index2value(L, toidx);
    {
        const io1: [*c]TValue = to;
        const io2: [*c]const TValue = fr;
        io1.*.value_ = io2.*.value_;
        io1.*.tt_ = io2.*.tt_;
    }
    if (toidx < -1001000) {
        const cl = &@as([*c]union_GCUnion, @ptrCast(@alignCast((&L.*.ci.*.func.p.*.val).*.value_.gc))).*.cl.c;
        _ = if ((@as(c_int, @bitCast(@as(c_uint, fr.*.tt_))) & (1 << 6)) != 0)
            if (((@as(c_int, @bitCast(@as(c_uint, cl.*.marked))) & (1 << 5)) != 0) and
                ((@as(c_int, @bitCast(@as(c_uint, fr.*.value_.gc.*.marked))) & ((1 << 3) | (1 << 4))) != 0))
                luaC_barrier_(L, &@as([*c]union_GCUnion, @ptrCast(@alignCast(cl))).*.gc, &@as([*c]union_GCUnion, @ptrCast(@alignCast(fr.*.value_.gc))).*.gc)
            else
                0
        else
            0;
...
pub export fn lua_checkstack(L: [*c]lua_State, n: c_int) callconv(.c) c_int {
    const ci = L.*.ci;
    const res = if (@divExact(@as(c_long, @bitCast(@intFromPtr(L.*.stack_last.p) -% @intFromPtr(L.*.top.p))), @sizeOf(StackValue)) > @as(c_long, @bitCast(@as(c_long, n))))
        @as(c_int, 1)
    else
        luaD_growstack(L, n, 0);
    if (res != 0 and ci.*.top.p < L.*.top.p + @as(usize, @bitCast(@as(isize, @intCast(n))))) {
        ci.*.top.p = L.*.top.p + @as(usize, @bitCast(@as(isize, @intCast(n))));
    }
    return res;
}
pub export fn lua_xmove(from: [*c]lua_State, to: [*c]lua_State, n: c_int) callconv(.c) void {
    if (from == to) return;
    from.*.top.p -= @as(usize, @bitCast(@as(isize, @intCast(n))));
    var i: c_int = 0;
    while (i < n) : (i += 1) {
        const io1: [*c]TValue = &to.*.top.p.*.val;
        const io2: [*c]const TValue = &(from.*.top.p + @as(usize, @bitCast(@as(isize, @intCast(i))))).*.val;
        io1.*.value_ = io2.*.value_;
        io1.*.tt_ = io2.*.tt_;
        to.*.top.p += 1;
    }
}
pub export fn lua_isnumber(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var n: lua_Number = undefined;
    _ = &n;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    return if (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 1) << @intCast(4)))) blk: {
        (&n).* = blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 o.*.value_.n;
        };
        break :blk @as(c_int, 1);
    } else luaV_tonumber_(o, &n);
}
pub export fn lua_isstring(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    return @intFromBool(((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) == @as(c_int, 4)) or ((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) == @as(c_int, 3)));
}
pub export fn lua_iscfunction(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    return @intFromBool((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (@as(c_int, 6) | (@as(c_int, 1) << @intCast(4)))) or (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == ((@as(c_int, 6) | (@as(c_int, 2) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))));
}
pub export fn lua_isinteger(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    return @intFromBool(@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4))));
}
pub export fn lua_isuserdata(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    return @intFromBool((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == ((@as(c_int, 7) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) or (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (@as(c_int, 2) | (@as(c_int, 0) << @intCast(4)))));
}
pub export fn lua_type(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    return if (!((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) or (o != @as([*c]const TValue, @ptrCast(@alignCast(&L.*.l_G.*.nilvalue))))) @as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15) else -@as(c_int, 1);
}
pub export fn lua_typename(arg_L: [*c]lua_State, arg_t: c_int) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    return luaT_typenames_[@as(c_uint, @intCast(t + @as(c_int, 1)))];
}
pub export fn lua_tonumberx(arg_L: [*c]lua_State, arg_idx: c_int, arg_pisnum: [*c]c_int) callconv(.c) lua_Number {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var pisnum = arg_pisnum;
    _ = &pisnum;
    var n: lua_Number = 0;
    _ = &n;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    var isnum: c_int = if (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 1) << @intCast(4)))) blk: {
        (&n).* = blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 o.*.value_.n;
        };
...
pub export fn lua_tointegerx(arg_L: [*c]lua_State, arg_idx: c_int, arg_pisnum: [*c]c_int) callconv(.c) lua_Integer {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var pisnum = arg_pisnum;
    _ = &pisnum;
    var res: lua_Integer = 0;
    _ = &res;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    var isnum: c_int = if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (@as(c_int, 3) | (@as(c_int, 0) << @intCast(4)))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 1))))) != 0) blk: {
        (&res).* = blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 o.*.value_.i;
        };
        break :blk @as(c_int, 1);
    } else luaV_tointeger(o, &res, @as(c_uint, @bitCast(F2Ieq)));
    _ = &isnum;
    if (pisnum != null) {
        pisnum.* = isnum;
    }
...
pub export fn lua_toboolean(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var o: [*c]const TValue = index2value(L, idx);
    _ = &o;
    return @intFromBool(!((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (@as(c_int, 1) | (@as(c_int, 0) << @intCast(4)))) or ((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))));
}
pub export fn lua_tolstring(arg_L: [*c]lua_State, arg_idx: c_int, arg_len: [*c]usize) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var len = arg_len;
    _ = &len;
    var o: [*c]TValue = undefined;
    _ = &o;
    _ = @as(c_int, 0);
    o = index2value(L, idx);
    if (!((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) == @as(c_int, 4))) {
        if (!((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) == @as(c_int, 3))) {
            if (len != @as([*c]usize, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                len.* = 0;
            }
            _ = @as(c_int, 0);
            return null;
    ...
    if (len != @as([*c]usize, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        len.* = if (@as(c_int, @bitCast(@as(c_uint, (blk: {
            _ = @as(c_int, 0);
            break :blk blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.ts;
            };
    ...
    }).*.contents[@as(usize, @intCast(0))])));
}
pub export fn lua_tostring(L: [*c]lua_State, idx: c_int) callconv(.c) [*c]const u8 {
    return lua_tolstring(L, idx, null);
}
pub export fn lua_rawlen(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) lua_Unsigned {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    const o: [*c]const TValue = index2value(L, idx);
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & 63) {
            4 => return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, (&@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.ts).*.shrlen))),
            20 => return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, (&@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.ts).*.u.lnglen))),
            7 => return @as(lua_Unsigned, @bitCast(@as(c_ulonglong, (&@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.u).*.len))),
            5 => return luaH_getn(&@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.h),
            else => return 0,
        }
        break;
    }
...
pub export fn lua_tocfunction(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) lua_CFunction {
    const L = arg_L;
    const idx = arg_idx;
    const o: [*c]const TValue = index2value(L, idx);
    if (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == (6 | (1 << @intCast(4)))) return o.*.value_.f else if (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == ((6 | (2 << @intCast(4))) | (1 << @intCast(6)))) return (&@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.cl.c).*.f else return null;
    return std.mem.zeroes(lua_CFunction);
}
pub export fn lua_touserdata(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) ?*anyopaque {
    const L = arg_L;
    const idx = arg_idx;
    const o: [*c]const TValue = index2value(L, idx);
    return touserdata(o);
}
pub export fn lua_tothread(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) [*c]lua_State {
    const L = arg_L;
    const idx = arg_idx;
    const o: [*c]const TValue = index2value(L, idx);
    return if (!(@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == ((8 | (0 << @intCast(4))) | (1 << @intCast(6))))) null else &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.th;
}
pub export fn lua_topointer(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) ?*const anyopaque {
    const L = arg_L;
    const idx = arg_idx;
    const o: [*c]const TValue = index2value(L, idx);
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & 63) {
            22 => return @as(?*anyopaque, @ptrFromInt(@as(usize, @intCast(@intFromPtr(o.*.value_.f))))),
            7, 2 => return touserdata(o),
            else => {
                if ((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & (1 << @intCast(6))) != 0) return @as(?*const anyopaque, @ptrCast(o.*.value_.gc)) else return null;
            },
        }
        break;
    }
...
pub export fn lua_arith(arg_L: [*c]lua_State, arg_op: c_int) callconv(.c) void {
    const L = arg_L;
    const op = arg_op;
    if ((op != 12) and (op != 13)) {
        // api_checknelems (noop in non-debug)
    } else {
        {
            const io1: [*c]TValue = &L.*.top.p.*.val;
            ...
            io1.*.value_ = io2.*.value_;
            io1.*.tt_ = io2.*.tt_;
            // checkliveness (barrier check, noop in non-debug)
        }
        {
            L.*.top.p += 1;
        }
    }
    luaO_arith(L, op, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val, L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))));
    L.*.top.p -= 1;
}
pub export fn lua_rawequal(arg_L: [*c]lua_State, arg_index1: c_int, arg_index2: c_int) callconv(.c) c_int {
    const L = arg_L;
    const index1 = arg_index1;
    const index2 = arg_index2;
    const o1: [*c]const TValue = index2value(L, index1);
    const o2: [*c]const TValue = index2value(L, index2);
    return if ((!((@as(c_int, @bitCast(@as(c_uint, o1.*.tt_))) & 15) == 0) or (o1 != @as([*c]const TValue, @ptrCast(@alignCast(&L.*.l_G.*.nilvalue))))) and (!((@as(c_int, @bitCast(@as(c_uint, o2.*.tt_))) & 15) == 0) or (o2 != @as([*c]const TValue, @ptrCast(@alignCast(&L.*.l_G.*.nilvalue)))))) luaV_equalobj(null, o1, o2) else 0;
}
pub export fn lua_compare(arg_L: [*c]lua_State, arg_index1: c_int, arg_index2: c_int, arg_op: c_int) callconv(.c) c_int {
    const L = arg_L;
    const index1 = arg_index1;
    const index2 = arg_index2;
    const op = arg_op;
    var o1: [*c]const TValue = undefined;
    var o2: [*c]const TValue = undefined;
    var i: c_int = 0;
    o1 = index2value(L, index1);
    o2 = index2value(L, index2);
    if ((!((@as(c_int, @bitCast(@as(c_uint, o1.*.tt_))) & 15) == 0) or (o1 != @as([*c]const TValue, @ptrCast(@alignCast(&L.*.l_G.*.nilvalue))))) and (!((@as(c_int, @bitCast(@as(c_uint, o2.*.tt_))) & 15) == 0) or (o2 != @as([*c]const TValue, @ptrCast(@alignCast(&L.*.l_G.*.nilvalue)))))) {
        while (true) {
            switch (op) {
                0 => {
...
pub export fn lua_pushnil(arg_L: [*c]lua_State) callconv(.c) void {
    const L = arg_L;
    (&L.*.top.p.*.val).*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(0 | (0 << @intCast(4))))));
    L.*.top.p += 1;
}
pub export fn lua_pushnumber(arg_L: [*c]lua_State, arg_n: lua_Number) callconv(.c) void {
    const L = arg_L;
    const n = arg_n;
    {
        const io: [*c]TValue = &L.*.top.p.*.val;
        io.*.value_.n = n;
        io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(3 | (1 << @intCast(4))))));
    }
    L.*.top.p += 1;
}
pub export fn lua_pushinteger(arg_L: [*c]lua_State, arg_n: lua_Integer) callconv(.c) void {
    const L = arg_L;
    const n = arg_n;
    {
        const io: [*c]TValue = &L.*.top.p.*.val;
...
pub export fn lua_pushlstring(arg_L: [*c]lua_State, arg_s: [*c]const u8, arg_len: usize) callconv(.c) [*c]const u8 {
    const L = arg_L;
    const s = arg_s;
    const len = arg_len;
    var ts: [*c]TString = undefined;
    ts = if (len == @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) luaS_new(L, "") else luaS_newlstr(L, s, len);
    {
        const io: [*c]TValue = &L.*.top.p.*.val;
        const x_: [*c]TString = ts;
        io.*.value_.gc = &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
        io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, x_.*.tt))) | (1 << @intCast(6))))));
        // checkliveness (barrier check, noop in non-debug)
    }
    L.*.top.p += 1;
    {
    ...
    return @as([*c]u8, @ptrCast(@alignCast(&ts.*.contents[0])));
}
pub export fn lua_pushstring(arg_L: [*c]lua_State, arg_s: [*c]const u8) callconv(.c) [*c]const u8 {
    const L = arg_L;
    var s = arg_s;
    if (s == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        (&L.*.top.p.*.val).*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(0 | (0 << @intCast(4))))));
    } else {
        var ts: [*c]TString = undefined;
        ts = luaS_new(L, s);
        ...
        s = @as([*c]u8, @ptrCast(@alignCast(&ts.*.contents[0])));
    }
    L.*.top.p += 1;
    {
        if (L.*.l_G.*.GCdebt > @as(l_mem, @bitCast(@as(c_long, @as(c_int, 0))))) {
...
pub export fn lua_pushvfstring(arg_L: [*c]lua_State, arg_fmt: [*c]const u8, arg_argp: __builtin_va_list) callconv(.c) [*c]const u8 {
    const L = arg_L;
    const fmt = arg_fmt;
    const argp = arg_argp;
    var ret: [*c]const u8 = undefined;
...
// Simplified lua_pushfstring: Zig 0.15 cannot do @cVaStart on aarch64,
// so we just push the format string without interpolation.
pub export fn lua_pushfstring(L: [*c]lua_State, fmt: [*c]const u8, ...) callconv(.c) [*c]const u8 {
    return lua_pushstring(L, fmt);
}
pub export fn lua_pushcclosure(arg_L: [*c]lua_State, arg_fn: lua_CFunction, arg_n: c_int) callconv(.c) void {
    const L = arg_L;
    const @"fn" = arg_fn;
    var n = arg_n;
    if (n == 0) {
        {
            const io: [*c]TValue = &L.*.top.p.*.val;
            io.*.value_.f = @"fn";
            io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(6 | (1 << @intCast(4))))));
        }
        L.*.top.p += 1;
    } else {
        var cl: [*c]CClosure = undefined;
        cl = luaF_newCclosure(L, n);
        cl.*.f = @"fn";
        L.*.top.p -= @as(usize, @bitCast(@as(isize, @intCast(n))));
        while ((blk: {
            const ref = &n;
            const tmp = ref.*;
            ref.* -= 1;
            ...
            {
                const io1: [*c]TValue = &@as([*]TValue, @ptrCast(&cl.*.upvalue))[@as(c_uint, @intCast(n))];
                const io2: [*c]const TValue = &(L.*.top.p + @as(usize, @bitCast(@as(isize, @intCast(n))))).*.val;
                io1.*.value_ = io2.*.value_;
                io1.*.tt_ = io2.*.tt_;
                // checkliveness (barrier check, noop in non-debug)
            }
        ...
        {
            const io: [*c]TValue = &L.*.top.p.*.val;
            const x_: [*c]CClosure = cl;
            io.*.value_.gc = &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
            io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate((6 | (2 << @intCast(4))) | (1 << @intCast(6))))));
            // checkliveness (barrier check, noop in non-debug)
        }
        L.*.top.p += 1;
        {
...
pub export fn lua_pushboolean(arg_L: [*c]lua_State, arg_b: c_int) callconv(.c) void {
    const L = arg_L;
    const b = arg_b;
    if (b != 0) {
        (&L.*.top.p.*.val).*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(1 | (1 << @intCast(4))))));
    } else {
        (&L.*.top.p.*.val).*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(1 | (0 << @intCast(4))))));
    }
    L.*.top.p += 1;
}
pub export fn lua_pushlightuserdata(arg_L: [*c]lua_State, arg_p: ?*anyopaque) callconv(.c) void {
    const L = arg_L;
    const p = arg_p;
    {
        const io: [*c]TValue = &L.*.top.p.*.val;
        io.*.value_.p = p;
        io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(2 | (0 << @intCast(4))))));
    }
    L.*.top.p += 1;
}
pub export fn lua_pushthread(arg_L: [*c]lua_State) callconv(.c) c_int {
    const L = arg_L;
    {
        const io: [*c]TValue = &L.*.top.p.*.val;
        const x_: [*c]lua_State = L;
        io.*.value_.gc = &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
        io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate((8 | (0 << @intCast(4))) | (1 << @intCast(6))))));
        // checkliveness (barrier check, noop in non-debug)
    }
    L.*.top.p += 1;
    return @intFromBool(L.*.l_G.*.mainthread == L);
}
pub export fn lua_getglobal(arg_L: [*c]lua_State, arg_name: [*c]const u8) callconv(.c) c_int {
    const L = arg_L;
    const name = arg_name;
    var G_1: [*c]const TValue = undefined;
    const reg_h = &@as([*c]union_GCUnion, @ptrCast(@alignCast((&L.*.l_G.*.l_registry).*.value_.gc))).*.h;
    const tmp = 2 - 1;
    G_1 = &(if (tmp >= 0) reg_h.*.array + @as(usize, @intCast(tmp)) else reg_h.*.array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1))).*;
    return auxgetstr(L, G_1, name);
}
pub export fn lua_gettable(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    const L = arg_L;
    const idx = arg_idx;
    var slot: [*c]const TValue = undefined;
    var t: [*c]TValue = undefined;
    t = index2value(L, idx);
    if ((if (!(@as(c_int, @bitCast(@as(c_uint, t.*.tt_))) == ((5 | (0 << @intCast(4))) | (1 << @intCast(6))))) blk: {
        slot = null;
        break :blk @as(c_int, 0);
    } else blk: {
        slot = luaH_get(&@as([*c]union_GCUnion, @ptrCast(@alignCast(t.*.value_.gc))).*.h, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val);
        break :blk @as(c_int, @intFromBool(!((@as(c_int, @bitCast(@as(c_uint, slot.*.tt_))) & 15) == 0)));
    }) != 0) {
        {
            const io1: [*c]TValue = &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
            const io2: [*c]const TValue = slot;
            io1.*.value_ = io2.*.value_;
            io1.*.tt_ = io2.*.tt_;
            // checkliveness (barrier check, noop in non-debug)
        }
    } else {
        luaV_finishget(L, t, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val, L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))), slot);
    }
    return @as(c_int, @bitCast(@as(c_uint, (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.tt_))) & 15;
}
pub export fn lua_getfield(arg_L: [*c]lua_State, arg_idx: c_int, arg_k: [*c]const u8) callconv(.c) c_int {
    const L = arg_L;
    const idx = arg_idx;
    const k = arg_k;
    return auxgetstr(L, index2value(L, idx), k);
}
pub export fn lua_geti(arg_L: [*c]lua_State, arg_idx: c_int, arg_n: lua_Integer) callconv(.c) c_int {
    const L = arg_L;
    const idx = arg_idx;
    const n = arg_n;
    var t: [*c]TValue = undefined;
    ...
    if ((if (!(@as(c_int, @bitCast(@as(c_uint, t.*.tt_))) == ((5 | (0 << @intCast(4))) | (1 << @intCast(6))))) blk: {
        ...
        slot = if ((@as(lua_Unsigned, @bitCast(n)) -% @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, 1))))) < @as(lua_Unsigned, @bitCast(@as(c_ulonglong, h.*.alimit)))) @as([*c]const TValue, @ptrCast(@alignCast(&(blk_1: {
            const tmp = n - @as(lua_Integer, @bitCast(@as(c_longlong, @as(c_int, 1))));
            if (tmp >= 0) break :blk_1 h.*.array + @as(usize, @intCast(tmp)) else break :blk_1 h.*.array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*))) else luaH_getint(h, n);
        break :blk @as(c_int, @intFromBool(!((@as(c_int, @bitCast(@as(c_uint, slot.*.tt_))) & 15) == 0)));
    }) != 0) {
        {
            const io1: [*c]TValue = &L.*.top.p.*.val;
        ...
        var aux: TValue = undefined;
        {
            const io: [*c]TValue = &aux;
            io.*.value_.i = n;
            io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(3 | (0 << @intCast(4))))));
        }
...
pub export fn lua_rawget(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    const L = arg_L;
    const idx = arg_idx;
    var t: [*c]Table = undefined;
    var val: [*c]const TValue = undefined;
    t = gettable(L, idx);
    val = luaH_get(t, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val);
    L.*.top.p -= 1;
    return finishrawget(L, val);
}
pub export fn lua_rawgeti(arg_L: [*c]lua_State, arg_idx: c_int, arg_n: lua_Integer) callconv(.c) c_int {
    const L = arg_L;
    const idx = arg_idx;
    const n = arg_n;
    var t: [*c]Table = undefined;
...
pub export fn lua_rawgetp(arg_L: [*c]lua_State, arg_idx: c_int, arg_p: ?*const anyopaque) callconv(.c) c_int {
    const L = arg_L;
    const idx = arg_idx;
    const p = arg_p;
    var t: [*c]Table = undefined;
    ...
    {
        const io: [*c]TValue = &k;
        io.*.value_.p = @as(?*anyopaque, @ptrCast(@constCast(@volatileCast(p))));
        io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(2 | (0 << @intCast(4))))));
    }
    return finishrawget(L, luaH_get(t, &k));
}
pub export fn lua_createtable(arg_L: [*c]lua_State, arg_narray: c_int, arg_nrec: c_int) callconv(.c) void {
    const L = arg_L;
    const narray = arg_narray;
    const nrec = arg_nrec;
    var t: [*c]Table = undefined;
    t = luaH_new(L);
    {
        ...
        const x_: [*c]Table = t;
        io.*.value_.gc = &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
        io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate((5 | (0 << @intCast(4))) | (1 << @intCast(6))))));
        // checkliveness (barrier check, noop in non-debug)
    }
    L.*.top.p += 1;
    if ((narray > 0) or (nrec > 0)) {
        luaH_resize(L, t, @as(c_uint, @bitCast(narray)), @as(c_uint, @bitCast(nrec)));
    }
    {
        if (L.*.l_G.*.GCdebt > @as(l_mem, @bitCast(@as(c_long, @as(c_int, 0))))) {
            luaC_step(L);
...
// /src/cosmopolitan/libc/integral/c.inc:383:32: warning: failed to translate simple OffsetOfExpr

// /src/cosmopolitan/third_party/lua/lapi.c:1732:15: warning: unable to translate function, demoted to extern
// translate-c failed on OffsetOfExpr in getudatamem macro; manually implemented:
pub export fn lua_newuserdatauv(arg_L: [*c]lua_State, arg_size: usize, arg_nuvalue: c_int) callconv(.c) ?*anyopaque {
    const L = arg_L;
    const size = arg_size;
    const nuvalue = arg_nuvalue;
    const u: [*c]Udata = luaS_newudata(L, size, nuvalue);
    // setuvalue(L, s2v(L->top.p), u)
    {
        const io: [*c]TValue = &L.*.top.p.*.val;
        const x_: [*c]Udata = u;
        io.*.value_.gc = &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
        io.*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate((@as(c_int, 7) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))));
    }
    // api_incr_top
    L.*.top.p += 1;
    // luaC_checkGC
    ...
    // getudatamem(u): pointer to user data area past Udata header
    return @as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(u))) +
        (if (@as(c_int, @bitCast(@as(c_uint, u.*.nuvalue))) == @as(c_int, 0))
            @offsetOf(struct_Udata0, "bindata")
        else
            @offsetOf(struct_Udata, "uv") +% (@sizeOf(UValue) *% @as(usize, @bitCast(@as(c_long, @as(c_int, nuvalue))))))));
}
pub export fn lua_getmetatable(arg_L: [*c]lua_State, arg_objindex: c_int) callconv(.c) c_int {
    const L = arg_L;
    const objindex = arg_objindex;
    var obj: [*c]const TValue = undefined;
    var mt: [*c]Table = undefined;
    var res: c_int = 0;
    obj = index2value(L, objindex);
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, obj.*.tt_))) & 15) {
            5 => {
                mt = (&@as([*c]union_GCUnion, @ptrCast(@alignCast(obj.*.value_.gc))).*.h).*.metatable;
                break;
            },
            7 => {
                mt = (&@as([*c]union_GCUnion, @ptrCast(@alignCast(obj.*.value_.gc))).*.u).*.metatable;
                break;
            },
            else => {
                mt = L.*.l_G.*.mt[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.tt_))) & 15))];
                break;
            },
        }
        break;
    }
    if (mt != @as([*c]Table, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        {
            const io: [*c]TValue = &L.*.top.p.*.val;
            const x_: [*c]Table = mt;
            io.*.value_.gc = &@as([*c]union_GCUnion, @ptrCast(@alignCast(x_))).*.gc;
...
pub export fn lua_getiuservalue(arg_L: [*c]lua_State, arg_idx: c_int, arg_n: c_int) callconv(.c) c_int {
    const L = arg_L;
    const idx = arg_idx;
    const n = arg_n;
    var o: [*c]TValue = undefined;
    ...
    o = index2value(L, idx);
    const u = &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.u;
    if ((n <= 0) or (n > @as(c_int, @bitCast(@as(c_uint, u.*.nuvalue))))) {
        (&L.*.top.p.*.val).*.tt_ = @as(lu_byte, @bitCast(@as(i8, @truncate(0 | (0 << @intCast(4))))));
        t = -1;
    } else {
        {
            const io1: [*c]TValue = &L.*.top.p.*.val;
            const io2: [*c]const TValue = &u.*.uv[@as(c_uint, @intCast(n - 1))].uv;
            io1.*.value_ = io2.*.value_;
            io1.*.tt_ = io2.*.tt_;
            // checkliveness (barrier check, noop in non-debug)
        }
        t = @as(c_int, @bitCast(@as(c_uint, (&L.*.top.p.*.val).*.tt_))) & 15;
    }
    L.*.top.p += 1;
    return t;
}
pub export fn lua_setglobal(arg_L: [*c]lua_State, arg_name: [*c]const u8) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var name = arg_name;
    _ = &name;
    ...
    G_1 = &(blk: {
        ...
        if (tmp >= 0) break :blk (blk_1: {
            ...
            break :blk_1 blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&L.*.l_G.*.l_registry).*.value_.gc))).*.h;
            };
        }).*.array + @as(usize, @intCast(tmp)) else break :blk (blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&L.*.l_G.*.l_registry).*.value_.gc))).*.h;
            };
        }).*.array - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*;
    auxsetstr(L, G_1, name);
}
pub export fn lua_settable(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    if ((if (!(@as(c_int, @bitCast(@as(c_uint, t.*.tt_))) == ((@as(c_int, 5) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))) blk: {
        ...
        }, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val);
        ...
        {
            {
                ...
                _ = &io1;
                var io2: [*c]const TValue = &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
                _ = &io2;
                io1.*.value_ = io2.*.value_;
                _ = blk: {
                    const tmp = io2.*.tt_;
            ...
            _ = if ((@as(c_int, @bitCast(@as(c_uint, (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) if (((@as(c_int, @bitCast(@as(c_uint, (blk: {
                _ = @as(c_int, 0);
                break :blk t.*.value_.gc;
            }).*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                _ = @as(c_int, 0);
                break :blk (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.value_.gc;
        ...
        luaV_finishset(L, t, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val, slot);
    }
    L.*.top.p -= @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))));
    _ = @as(c_int, 0);
}
pub export fn lua_setfield(arg_L: [*c]lua_State, arg_idx: c_int, arg_k: [*c]const u8) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
...
pub export fn lua_seti(arg_L: [*c]lua_State, arg_idx: c_int, arg_n: lua_Integer) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    if ((if (!(@as(c_int, @bitCast(@as(c_uint, t.*.tt_))) == ((@as(c_int, 5) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))) blk: {
        ...
        slot = if ((@as(lua_Unsigned, @bitCast(n)) -% @as(lua_Unsigned, @bitCast(@as(c_ulonglong, @as(c_uint, 1))))) < @as(lua_Unsigned, @bitCast(@as(c_ulonglong, (blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast(t.*.value_.gc))).*.h;
            };
        }).*.alimit)))) @as([*c]const TValue, @ptrCast(@alignCast(&(blk_1: {
            const tmp = n - @as(lua_Integer, @bitCast(@as(c_longlong, @as(c_int, 1))));
            if (tmp >= 0) break :blk_1 (blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 blk_3: {
                    _ = @as(c_int, 0);
                    break :blk_3 &@as([*c]union_GCUnion, @ptrCast(@alignCast(t.*.value_.gc))).*.h;
                };
            }).*.array + @as(usize, @intCast(tmp)) else break :blk_1 (blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 blk_3: {
                    _ = @as(c_int, 0);
                    break :blk_3 &@as([*c]union_GCUnion, @ptrCast(@alignCast(t.*.value_.gc))).*.h;
        ...
        luaV_finishset(L, t, &aux, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val, slot);
    }
    L.*.top.p -= 1;
    _ = @as(c_int, 0);
}
pub export fn lua_rawset(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    aux_rawset(L, idx, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val, @as(c_int, 2));
}
pub export fn lua_rawseti(arg_L: [*c]lua_State, arg_idx: c_int, arg_n: lua_Integer) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    t = gettable(L, idx);
    luaH_setint(L, t, n, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val);
    _ = if ((@as(c_int, @bitCast(@as(c_uint, (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) if (((@as(c_int, @bitCast(@as(c_uint, (blk: {
        _ = @as(c_int, 0);
        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(t))).*.gc;
    }).*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        _ = @as(c_int, 0);
        break :blk (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.value_.gc;
    }).*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrierback_(L, blk: {
...
pub export fn lua_rawsetp(arg_L: [*c]lua_State, arg_idx: c_int, arg_p: ?*const anyopaque) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    _ = &k;
    {
        ...
        io.*.value_.p = @as(?*anyopaque, @ptrCast(@constCast(@volatileCast(p))));
        _ = blk: {
            const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 2) | (@as(c_int, 0) << @intCast(4))))));
            io.*.tt_ = tmp;
            break :blk tmp;
        };
    }
    aux_rawset(L, idx, &k, @as(c_int, 1));
}
pub export fn lua_setmetatable(arg_L: [*c]lua_State, arg_objindex: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var objindex = arg_objindex;
    _ = &objindex;
    var obj: [*c]TValue = undefined;
    _ = &obj;
    var mt: [*c]Table = undefined;
    _ = &mt;
    _ = @as(c_int, 0);
    ...
    obj = index2value(L, objindex);
    if ((@as(c_int, @bitCast(@as(c_uint, (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
        mt = null;
    } else {
        _ = blk: {
            _ = &L;
        ...
        mt = blk: {
            ...
            break :blk blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.value_.gc))).*.h;
            };
        };
    }
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, obj.*.tt_))) & @as(c_int, 15)) {
            @as(c_int, 5) => {
                {
                    (blk: {
                        _ = @as(c_int, 0);
                        break :blk blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(obj.*.value_.gc))).*.h;
                        };
                    }).*.metatable = mt;
                    if (mt != null) {
                        _ = if (((@as(c_int, @bitCast(@as(c_uint, (blk: {
                            _ = @as(c_int, 0);
                            break :blk obj.*.value_.gc;
                        }).*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, mt.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(L, blk: {
                            _ = @as(c_int, 0);
                            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(blk_1: {
                                _ = @as(c_int, 0);
                                break :blk_1 obj.*.value_.gc;
                            }))).*.gc;
                        }, blk: {
                            _ = @as(c_int, 0);
                            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(mt))).*.gc;
                        }) else @as(c_int, 0);
                        luaC_checkfinalizer(L, blk: {
                            _ = @as(c_int, 0);
                            break :blk obj.*.value_.gc;
                        }, mt);
                    }
            ...
            @as(c_int, 7) => {
                {
                    (blk: {
                        ...
                        break :blk blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(obj.*.value_.gc))).*.u;
                        };
                    }).*.metatable = mt;
                    if (mt != null) {
                        _ = if (((@as(c_int, @bitCast(@as(c_uint, (blk: {
                            ...
                            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(blk_1: {
                                ...
                                break :blk_1 blk_2: {
                                    _ = @as(c_int, 0);
                                    break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast(obj.*.value_.gc))).*.u;
                                };
                            }))).*.gc;
                        }, blk: {
                            _ = @as(c_int, 0);
                ...
                {
                    L.*.l_G.*.mt[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, obj.*.tt_))) & @as(c_int, 15)))] = mt;
                    break;
                }
            },
        }
...
pub export fn lua_setiuservalue(arg_L: [*c]lua_State, arg_idx: c_int, arg_n: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    if (!((@as(c_uint, @bitCast(n)) -% @as(c_uint, 1)) < @as(c_uint, @bitCast(@as(c_uint, (blk: {
        _ = @as(c_int, 0);
        break :blk blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.u;
        };
    }).*.nuvalue))))) {
        res = 0;
    } else {
        {
            ...
            }).*.uv[@as(c_uint, @intCast(n - @as(c_int, 1)))].uv;
            _ = &io1;
            var io2: [*c]const TValue = &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
            _ = &io2;
            io1.*.value_ = io2.*.value_;
...
pub export fn lua_callk(arg_L: [*c]lua_State, arg_nargs: c_int, arg_nresults: c_int, arg_ctx: lua_KContext, arg_k: lua_KFunction) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var nargs = arg_nargs;
    _ = &nargs;
    ...
    func = L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(nargs + @as(c_int, 1)))));
    if ((k != @as(lua_KFunction, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and ((L.*.nCcalls & @as(c_uint, 4294901760)) == @as(c_uint, @bitCast(@as(c_int, 0))))) {
        L.*.ci.*.u.c.k = k;
        L.*.ci.*.u.c.ctx = ctx;
    ...
    {
        if ((nresults <= -@as(c_int, 1)) and (L.*.ci.*.top.p < L.*.top.p)) {
            L.*.ci.*.top.p = L.*.top.p;
        }
    }
    _ = @as(c_int, 0);
}
pub const struct_CallS = extern struct {
    func: StkId = std.mem.zeroes(StkId),
    nresults: c_int = std.mem.zeroes(c_int),
};
pub export fn lua_pcallk(arg_L: [*c]lua_State, arg_nargs: c_int, arg_nresults: c_int, arg_errfunc: c_int, arg_ctx: lua_KContext, arg_k: lua_KFunction) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var nargs = arg_nargs;
    _ = &nargs;
    var nresults = arg_nresults;
    _ = &nresults;
    var errfunc = arg_errfunc;
    _ = &errfunc;
    var ctx = arg_ctx;
    _ = &ctx;
    var k = arg_k;
    _ = &k;
    var c: struct_CallS = undefined;
    _ = &c;
    var status: c_int = undefined;
    _ = &status;
    var func: ptrdiff_t = undefined;
    _ = &func;
    _ = @as(c_int, 0);
    _ = blk: {
        _ = &L;
    ...
    if (errfunc == @as(c_int, 0)) {
        func = 0;
    } else {
        var o: StkId = index2stack(L, errfunc);
        _ = &o;
        _ = blk: {
            _ = &L;
            break :blk @as(c_int, 0);
        };
        func = @divExact(@as(c_long, @bitCast(@intFromPtr(@as([*c]u8, @ptrCast(@alignCast(o)))) -% @intFromPtr(@as([*c]u8, @ptrCast(@alignCast(L.*.stack.p)))))), @sizeOf(u8));
    }
    c.func = L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(nargs + @as(c_int, 1)))));
    if ((k == @as(lua_KFunction, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !((L.*.nCcalls & @as(c_uint, 4294901760)) == @as(c_uint, @bitCast(@as(c_int, 0))))) {
        c.nresults = nresults;
        status = luaD_pcall(L, &f_call, @as(?*anyopaque, @ptrCast(&c)), @divExact(@as(c_long, @bitCast(@intFromPtr(@as([*c]u8, @ptrCast(@alignCast(c.func)))) -% @intFromPtr(@as([*c]u8, @ptrCast(@alignCast(L.*.stack.p)))))), @sizeOf(u8)), func);
    } else {
        var ci: [*c]CallInfo = L.*.ci;
        _ = &ci;
        ci.*.u.c.k = k;
        ci.*.u.c.ctx = ctx;
        ci.*.u2.funcidx = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(@as([*c]u8, @ptrCast(@alignCast(c.func)))) -% @intFromPtr(@as([*c]u8, @ptrCast(@alignCast(L.*.stack.p)))))), @sizeOf(u8))))));
        ci.*.u.c.old_errfunc = L.*.errfunc;
        L.*.errfunc = func;
        _ = blk: {
            const tmp = @as(c_ushort, @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_uint, ci.*.callstatus))) & ~(@as(c_int, 1) << @intCast(0))) | @as(c_int, @bitCast(@as(c_uint, L.*.allowhook)))))));
            ci.*.callstatus = tmp;
            break :blk tmp;
        };
...
pub export fn lua_pcall(L: [*c]lua_State, nargs: c_int, nresults: c_int, errfunc: c_int) callconv(.c) c_int {
...
pub export fn lua_load(arg_L: [*c]lua_State, arg_reader: lua_Reader, arg_data: ?*anyopaque, arg_chunkname: [*c]const u8, arg_mode: [*c]const u8) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    ...
    if (status == @as(c_int, 0)) {
        var f: [*c]LClosure = blk: {
            _ = @as(c_int, 0);
            break :blk blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.value_.gc))).*.cl.l;
            };
        };
        _ = &f;
        if (@as(c_int, @bitCast(@as(c_uint, f.*.nupvalues))) >= @as(c_int, 1)) {
            var gt: [*c]const TValue = &(blk: {
                const tmp = @as(c_int, 2) - @as(c_int, 1);
                if (tmp >= 0) break :blk (blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 blk_2: {
            ...
            _ = &gt;
            {
                var io1: [*c]TValue = f.*.upvals[@as(c_uint, @intCast(@as(c_int, 0)))].*.v.p;
                _ = &io1;
                var io2: [*c]const TValue = gt;
                _ = &io2;
                io1.*.value_ = io2.*.value_;
                _ = blk: {
                    const tmp = io2.*.tt_;
            ...
            _ = if ((@as(c_int, @bitCast(@as(c_uint, gt.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) if (((@as(c_int, @bitCast(@as(c_uint, f.*.upvals[@as(c_uint, @intCast(@as(c_int, 0)))].*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                _ = @as(c_int, 0);
                break :blk gt.*.value_.gc;
            }).*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(L, blk: {
                _ = @as(c_int, 0);
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(f.*.upvals[@as(c_uint, @intCast(@as(c_int, 0)))]))).*.gc;
            }, blk: {
                _ = @as(c_int, 0);
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 gt.*.value_.gc;
                }))).*.gc;
            }) else @as(c_int, 0) else @as(c_int, 0);
        }
    }
...
pub export fn lua_dump(arg_L: [*c]lua_State, arg_writer: lua_Writer, arg_data: ?*anyopaque, arg_strip: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    ...
    o = &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
    if (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == ((@as(c_int, 6) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) {
        status = luaU_dump(L, (blk: {
            _ = @as(c_int, 0);
            break :blk blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.cl.l;
            };
        }).*.p, writer, data, strip);
    } else {
        status = 1;
...
pub export fn lua_status(arg_L: [*c]lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    return @as(c_int, @bitCast(@as(c_uint, L.*.status)));
}
pub extern fn lua_isyieldable(L: [*c]lua_State) c_int;
pub export fn lua_setwarnf(arg_L: [*c]lua_State, arg_f: lua_WarnFunction, arg_ud: ?*anyopaque) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
...
pub export fn lua_warning(arg_L: [*c]lua_State, arg_msg: [*c]const u8, arg_tocont: c_int) void {
    var L = arg_L;
    _ = &L;
    var msg = arg_msg;
    _ = &msg;
...
// Simplified lua_gc: Zig 0.15 disables @cVaStart on aarch64, so we cannot
// extract variadic args. Stub the return values for query operations and
// treat mutating operations (stop/restart/collect/step/inc/gen) as no-ops.
pub export fn lua_gc(L: [*c]lua_State, what: c_int, ...) callconv(.c) c_int {
    _ = L;
    return switch (what) {
        3 => 0, // LUA_GCCOUNT — total KB (stub: 0)
        4 => 0, // LUA_GCCOUNTB — remainder bytes (stub: 0)
        9 => 1, // LUA_GCISRUNNING — report GC as running
        else => 0, // stop/restart/collect/step/inc/gen — no-op
    };
}
...
pub export fn gc_control_restart() void {
    if (gc_state_ptr) |g| {
        g.*.GCdebt = gc_saved_debt;
    }
}
var gc_state_ptr: ?*global_State = null;
// Called from luaInit to save the global_State pointer for GC control
pub export fn gc_control_init(L: [*c]lua_State) void {
    gc_state_ptr = L.*.l_G;
}
pub export fn lua_error(arg_L: [*c]lua_State) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var errobj: [*c]TValue = undefined;
    _ = &errobj;
    _ = @as(c_int, 0);
    errobj = &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
    _ = blk: {
        _ = &L;
        break :blk @as(c_int, 0);
    };
    if ((@as(c_int, @bitCast(@as(c_uint, errobj.*.tt_))) == ((@as(c_int, 4) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) and ((blk: {
        _ = @as(c_int, 0);
        break :blk (blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast(errobj.*.value_.gc))).*.ts;
            };
        }) == L.*.l_G.*.memerrmsg;
    }))) {
        luaD_throw(L, @as(c_int, 4));
    } else {
        luaG_errormsg(L);
    }
...
pub export fn lua_next(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    t = gettable(L, idx);
    more = luaH_next(L, t, L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))));
    if (more != 0) {
        {
            L.*.top.p += 1;
            _ = blk: {
        ...
        L.*.top.p -= @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    }
    _ = @as(c_int, 0);
    return more;
}
pub export fn lua_concat(arg_L: [*c]lua_State, arg_n: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var n = arg_n;
    _ = &n;
    ...
    if (n > @as(c_int, 0)) {
    ...
    } else {
        {
            ...
            _ = &io;
            var x_: [*c]TString = luaS_newlstr(L, "", @as(usize, @bitCast(@as(c_long, @as(c_int, 0)))));
            _ = &x_;
            io.*.value_.gc = blk: {
                _ = @as(c_int, 0);
...
pub export fn lua_len(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
...
pub export fn lua_stringtonumber(arg_L: [*c]lua_State, arg_s: [*c]const u8) callconv(.c) usize {
    var L = arg_L;
    _ = &L;
    var s = arg_s;
    _ = &s;
    var sz: usize = luaO_str2num(s, &L.*.top.p.*.val);
    _ = &sz;
    if (sz != @as(usize, @bitCast(@as(c_long, @as(c_int, 0))))) {
        L.*.top.p += 1;
        _ = blk: {
            _ = &L;
            break :blk @as(c_int, 0);
...
pub export fn lua_getallocf(arg_L: [*c]lua_State, arg_ud: [*c]?*anyopaque) callconv(.c) lua_Alloc {
    var L = arg_L;
    _ = &L;
    var ud = arg_ud;
    _ = &ud;
    var f: lua_Alloc = undefined;
    _ = &f;
    _ = @as(c_int, 0);
    if (ud != null) {
        ud.* = L.*.l_G.*.ud;
...
pub export fn lua_setallocf(arg_L: [*c]lua_State, arg_f: lua_Alloc, arg_ud: ?*anyopaque) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
...
pub export fn lua_toclose(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    _ = &nresults;
    var o: StkId = undefined;
    _ = &o;
    _ = @as(c_int, 0);
    o = index2stack(L, idx);
    nresults = @as(c_int, @bitCast(@as(c_int, L.*.ci.*.nresults)));
    _ = blk: {
        _ = &L;
        break :blk @as(c_int, 0);
    };
    luaF_newtbcupval(L, o);
    if (!(nresults < -@as(c_int, 1))) {
        L.*.ci.*.nresults = @as(c_short, @bitCast(@as(c_short, @truncate(-nresults - @as(c_int, 3)))));
    }
    _ = @as(c_int, 0);
    _ = @as(c_int, 0);
}
pub export fn lua_closeslot(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var level: StkId = undefined;
    _ = &level;
    _ = @as(c_int, 0);
    ...
    level = luaF_close(L, level, -@as(c_int, 1), @as(c_int, 0));
    _ = blk: {
...
pub export fn lua_getupvalue(arg_L: [*c]lua_State, arg_funcindex: c_int, arg_n: c_int) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var funcindex = arg_funcindex;
    _ = &funcindex;
    var n = arg_n;
    _ = &n;
    var name: [*c]const u8 = undefined;
    _ = &name;
    var val: [*c]TValue = null;
    _ = &val;
    _ = @as(c_int, 0);
    name = aux_upvalue(index2value(L, funcindex), n, &val, null);
    if (name != null) {
        {
            var io1: [*c]TValue = &L.*.top.p.*.val;
            _ = &io1;
...
pub export fn lua_setupvalue(arg_L: [*c]lua_State, arg_funcindex: c_int, arg_n: c_int) callconv(.c) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var funcindex = arg_funcindex;
    _ = &funcindex;
    ...
    var val: [*c]TValue = null;
    _ = &val;
    var owner: [*c]GCObject = null;
    _ = &owner;
    var fi: [*c]TValue = undefined;
    _ = &fi;
    _ = @as(c_int, 0);
    ...
    if (name != null) {
        L.*.top.p -= 1;
        {
            var io1: [*c]TValue = val;
            _ = &io1;
            var io2: [*c]const TValue = &L.*.top.p.*.val;
            _ = &io2;
            io1.*.value_ = io2.*.value_;
            _ = blk: {
                const tmp = io2.*.tt_;
        ...
        _ = if ((@as(c_int, @bitCast(@as(c_uint, val.*.tt_))) & (@as(c_int, 1) << @intCast(6))) != 0) if (((@as(c_int, @bitCast(@as(c_uint, owner.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
            _ = @as(c_int, 0);
            break :blk val.*.value_.gc;
        }).*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(L, blk: {
            _ = @as(c_int, 0);
            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(owner))).*.gc;
        }, blk: {
            _ = @as(c_int, 0);
            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 val.*.value_.gc;
            }))).*.gc;
        }) else @as(c_int, 0) else @as(c_int, 0);
    }
    _ = @as(c_int, 0);
...
pub export fn lua_upvalueid(arg_L: [*c]lua_State, arg_fidx: c_int, arg_n: c_int) callconv(.c) ?*anyopaque {
    var L = arg_L;
    _ = &L;
    var fidx = arg_fidx;
    _ = &fidx;
    var n = arg_n;
    _ = &n;
    var fi: [*c]TValue = index2value(L, fidx);
    _ = &fi;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, fi.*.tt_))) & @as(c_int, 63)) {
            @as(c_int, 6) => {
                {
                    return @as(?*anyopaque, @ptrCast(getupvalref(L, fidx, n, null).*));
                }
            },
            @as(c_int, 38) => {
                {
                    var f: [*c]CClosure = blk: {
                        _ = @as(c_int, 0);
                        break :blk blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(fi.*.value_.gc))).*.cl.c;
                        };
                    };
                    _ = &f;
                    if ((@as(c_int, 1) <= n) and (n <= @as(c_int, @bitCast(@as(c_uint, f.*.nupvalues))))) return @as(?*anyopaque, @ptrCast(&@as([*]TValue, @ptrCast(&f.*.upvalue))[@as(c_uint, @intCast(n - @as(c_int, 1)))]));
                }
                return @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
            },
            @as(c_int, 22) => return @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))),
            else => {
                {
                    _ = blk: {
                        _ = &L;
...
pub export fn lua_upvaluejoin(arg_L: [*c]lua_State, arg_fidx1: c_int, arg_n1: c_int, arg_fidx2: c_int, arg_n2: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var fidx1 = arg_fidx1;
    _ = &fidx1;
    ...
    var n2 = arg_n2;
    _ = &n2;
    var f1: [*c]LClosure = undefined;
    _ = &f1;
    var up1: [*c][*c]UpVal = getupvalref(L, fidx1, n1, &f1);
    _ = &up1;
    var up2: [*c][*c]UpVal = getupvalref(L, fidx2, n2, null);
    _ = &up2;
    _ = blk: {
        _ = &L;
        break :blk @as(c_int, 0);
    ...
    up1.* = up2.*;
    _ = if (((@as(c_int, @bitCast(@as(c_uint, f1.*.marked))) & (@as(c_int, 1) << @intCast(@as(c_int, 5)))) != 0) and ((@as(c_int, @bitCast(@as(c_uint, up1.*.*.marked))) & ((@as(c_int, 1) << @intCast(@as(c_int, 3))) | (@as(c_int, 1) << @intCast(@as(c_int, 4))))) != 0)) luaC_barrier_(L, blk: {
        _ = @as(c_int, 0);
        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(f1))).*.gc;
    }, blk: {
        _ = @as(c_int, 0);
        break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(up1.*))).*.gc;
    }) else @as(c_int, 0);
}
...
pub fn index2value(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) [*c]TValue {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    _ = &ci;
    if (idx > @as(c_int, 0)) {
        var o: StkId = ci.*.func.p + @as(usize, @bitCast(@as(isize, @intCast(idx))));
        _ = &o;
        _ = blk: {
            _ = &L;
            break :blk @as(c_int, 0);
        };
        if (o >= L.*.top.p) return &L.*.l_G.*.nilvalue else return &o.*.val;
    } else if (!(idx <= (-@as(c_int, 1000000) - @as(c_int, 1000)))) {
        _ = blk: {
            _ = &L;
            break :blk @as(c_int, 0);
        };
        return &(L.*.top.p + @as(usize, @bitCast(@as(isize, @intCast(idx))))).*.val;
    } else if (idx == (-@as(c_int, 1000000) - @as(c_int, 1000))) return &L.*.l_G.*.l_registry else {
        idx = (-@as(c_int, 1000000) - @as(c_int, 1000)) - idx;
        _ = blk: {
            _ = &L;
            break :blk @as(c_int, 0);
        };
        if (@as(c_int, @bitCast(@as(c_uint, (&ci.*.func.p.*.val).*.tt_))) == ((@as(c_int, 6) | (@as(c_int, 2) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) {
            var func: [*c]CClosure = blk: {
                _ = @as(c_int, 0);
                break :blk blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast((&ci.*.func.p.*.val).*.value_.gc))).*.cl.c;
                };
            };
            _ = &func;
            return if (idx <= @as(c_int, @bitCast(@as(c_uint, func.*.nupvalues)))) &@as([*]TValue, @ptrCast(&func.*.upvalue))[@as(c_uint, @intCast(idx - @as(c_int, 1)))] else &L.*.l_G.*.nilvalue;
        } else {
            _ = blk: {
                _ = &L;
                break :blk @as(c_int, 0);
...
pub fn index2stack(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) StkId {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    if (idx > @as(c_int, 0)) {
        ...
        return L.*.top.p + @as(usize, @bitCast(@as(isize, @intCast(idx))));
    }
    return std.mem.zeroes(StkId);
}
pub fn reverse(arg_L: [*c]lua_State, arg_from: StkId, arg_to: StkId) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var from = arg_from;
    _ = &from;
    ...
    while (from < to) : (_ = blk: {
        ...
        var temp: TValue = undefined;
        _ = &temp;
        {
            var io1: [*c]TValue = &temp;
            _ = &io1;
            var io2: [*c]const TValue = &from.*.val;
            _ = &io2;
            io1.*.value_ = io2.*.value_;
            _ = blk: {
                const tmp = io2.*.tt_;
        ...
        {
            var io1: [*c]TValue = &from.*.val;
            _ = &io1;
            var io2: [*c]const TValue = &to.*.val;
            _ = &io2;
            io1.*.value_ = io2.*.value_;
            _ = blk: {
                const tmp = io2.*.tt_;
        ...
        {
            var io1: [*c]TValue = &to.*.val;
            _ = &io1;
            var io2: [*c]const TValue = &temp;
            _ = &io2;
            io1.*.value_ = io2.*.value_;
            _ = blk: {
                const tmp = io2.*.tt_;
...
pub fn touserdata(arg_o: [*c]const TValue) callconv(.c) ?*anyopaque {
    var o = arg_o;
    _ = &o;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) {
            @as(c_int, 7) => return @as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(blk: {
                _ = @as(c_int, 0);
                break :blk blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.u;
            ...
            }).*.nuvalue))) == @as(c_int, 0)) @offsetOf(struct_Udata0, "bindata") else @offsetOf(struct_Udata, "uv") +% (@sizeOf(UValue) *% @as(c_ulong, @bitCast(@as(c_ulong, (blk: {
                _ = @as(c_int, 0);
                break :blk blk_1: {
                    _ = @as(c_int, 0);
                    break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.u;
            ...
            @as(c_int, 2) => return blk: {
                _ = @as(c_int, 0);
                break :blk o.*.value_.p;
            },
            else => return @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))),
        }
        break;
    }
    return null;
}
pub fn auxgetstr(arg_L: [*c]lua_State, arg_t: [*c]const TValue, arg_k: [*c]const u8) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    var slot: [*c]const TValue = undefined;
    _ = &slot;
    var str: [*c]TString = luaS_new(L, k);
    _ = &str;
    if ((if (!(@as(c_int, @bitCast(@as(c_uint, t.*.tt_))) == ((@as(c_int, 5) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))) blk: {
        slot = null;
        break :blk @as(c_int, 0);
    } else blk: {
        slot = luaH_getstr(blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast(t.*.value_.gc))).*.h;
    ...
    _ = @as(c_int, 0);
    return @as(c_int, @bitCast(@as(c_uint, (&(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val).*.tt_))) & @as(c_int, 15);
}
pub fn finishrawget(arg_L: [*c]lua_State, arg_val: [*c]const TValue) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var val = arg_val;
    _ = &val;
    if ((@as(c_int, @bitCast(@as(c_uint, val.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
        _ = blk: {
            const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0) | (@as(c_int, 0) << @intCast(4))))));
            (&L.*.top.p.*.val).*.tt_ = tmp;
            break :blk tmp;
...
pub fn gettable(arg_L: [*c]lua_State, arg_idx: c_int) callconv(.c) [*c]Table {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    var t: [*c]TValue = index2value(L, idx);
    _ = &t;
    _ = blk: {
        _ = &L;
        break :blk @as(c_int, 0);
...
pub fn auxsetstr(arg_L: [*c]lua_State, arg_t: [*c]const TValue, arg_k: [*c]const u8) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var t = arg_t;
    _ = &t;
    ...
    if ((if (!(@as(c_int, @bitCast(@as(c_uint, t.*.tt_))) == ((@as(c_int, 5) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6))))) blk: {
        ...
        luaV_finishset(L, t, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val, slot);
        L.*.top.p -= @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))));
    }
    _ = @as(c_int, 0);
}
pub fn aux_rawset(arg_L: [*c]lua_State, arg_idx: c_int, arg_key: [*c]TValue, arg_n: c_int) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var idx = arg_idx;
    _ = &idx;
    ...
    t = gettable(L, idx);
    luaH_set(L, t, key, &(L.*.top.p - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val);
    _ = blk: {
        const ref = &t.*.flags;
...
pub fn f_call(arg_L: [*c]lua_State, arg_ud: ?*anyopaque) callconv(.c) void {
    var L = arg_L;
    _ = &L;
    var ud = arg_ud;
    _ = &ud;
    var c: [*c]struct_CallS = @as([*c]struct_CallS, @ptrCast(@alignCast(ud)));
    _ = &c;
    luaD_callnoyield(L, c.*.func, c.*.nresults);
}
pub fn aux_upvalue(arg_fi: [*c]TValue, arg_n: c_int, arg_val: [*c][*c]TValue, arg_owner: [*c][*c]GCObject) callconv(.c) [*c]const u8 {
    var fi = arg_fi;
    _ = &fi;
    var n = arg_n;
    _ = &n;
            ...
            @as(c_int, 38) => {
                {
                    ...
                    _ = &f;
                    if (!((@as(c_uint, @bitCast(n)) -% @as(c_uint, 1)) < @as(c_uint, @bitCast(@as(c_uint, f.*.nupvalues))))) return null;
                    val.* = &@as([*]TValue, @ptrCast(&f.*.upvalue))[@as(c_uint, @intCast(n - @as(c_int, 1)))];
                    if (owner != null) {
                        owner.* = blk: {
                            _ = @as(c_int, 0);
            ...
            @as(c_int, 6) => {
                {
                    var f: [*c]LClosure = blk: {
                        ...
                        break :blk blk_1: {
                            _ = @as(c_int, 0);
                            break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(fi.*.value_.gc))).*.cl.l;
                        };
                    };
                    _ = &f;
                    var name: [*c]TString = undefined;
                    _ = &name;
                    var p: [*c]Proto = f.*.p;
                    _ = &p;
                    if (!((@as(c_uint, @bitCast(n)) -% @as(c_uint, 1)) < @as(c_uint, @bitCast(p.*.sizeupvalues)))) return null;
                    val.* = @as([*][*c]UpVal, @ptrCast(&f.*.upvals))[@as(usize, @intCast(n - @as(c_int, 1)))].*.v.p;
                    if (owner != null) {
                        owner.* = blk: {
                            _ = @as(c_int, 0);
                            break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(@as([*][*c]UpVal, @ptrCast(&f.*.upvals))[@as(usize, @intCast(n - @as(c_int, 1)))]))).*.gc;
                        };
                    }
                    name = (blk: {
                        const tmp = n - @as(c_int, 1);
                        if (tmp >= 0) break :blk p.*.upvalues + @as(usize, @intCast(tmp)) else break :blk p.*.upvalues - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*.name;
                    return if (name == @as([*c]TString, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) "(no name)" else @as([*c]u8, @ptrCast(@alignCast(&name.*.contents[@as(usize, @intCast(0))])));
                }
            },
            else => return null,
        }
...
pub fn getupvalref(arg_L: [*c]lua_State, arg_fidx: c_int, arg_n: c_int, arg_pf: [*c][*c]LClosure) callconv(.c) [*c][*c]UpVal {
    var L = arg_L;
    _ = &L;
    var fidx = arg_fidx;
    _ = &fidx;
    ...
    _ = &pf;
    const nullup = struct {
        const static: [*c]const UpVal = null;
    };
    _ = &nullup;
    var f: [*c]LClosure = undefined;
    _ = &f;
    var fi: [*c]TValue = index2value(L, fidx);
    _ = &fi;
    _ = blk: {
    ...
    if ((@as(c_int, 1) <= n) and (n <= f.*.p.*.sizeupvalues)) return @as([*][*c]UpVal, @ptrCast(&f.*.upvals)) + @as(usize, @intCast(n - @as(c_int, 1))) else return @as([*c][*c]UpVal, @ptrCast(@constCast(@volatileCast(&nullup.static))));
    return null;
}
...
pub inline fn lua_pcall_inline(L: anytype, n: anytype, r: anytype, f: anytype) @TypeOf(lua_pcallk(L, n, r, f, @as(c_int, 0), NULL)) {
    _ = &L;
    _ = &n;
    _ = &r;
    _ = &f;
...
pub inline fn lua_tostring_inline(L: anytype, i: anytype) @TypeOf(lua_tolstring(L, i, NULL)) {
    _ = &L;
    _ = &i;
...
pub inline fn isvalid(L: anytype, o: anytype) @TypeOf(!(ttisnil(o) != 0) or (o != (&G(L).*.nilvalue))) {
    _ = &L;
    _ = &o;
    return !(ttisnil(o) != 0) or (o != (&G(L).*.nilvalue));
}
pub inline fn ispseudo(i: anytype) @TypeOf(i <= LUA_REGISTRYINDEX) {
    _ = &i;
    return i <= LUA_REGISTRYINDEX;
}
pub inline fn isupvalue(i: anytype) @TypeOf(i < LUA_REGISTRYINDEX) {
    _ = &i;
    return i < LUA_REGISTRYINDEX;
}
pub inline fn getGtable(L: anytype) @TypeOf(&hvalue(&G(L).*.l_registry).*.array[@as(usize, @intCast(LUA_RIDX_GLOBALS - @as(c_int, 1)))]) {
    _ = &L;
    return &hvalue(&G(L).*.l_registry).*.array[@as(usize, @intCast(LUA_RIDX_GLOBALS - @as(c_int, 1)))];
}
pub inline fn checkresults(L: anytype, na: anytype, nr: anytype) @TypeOf(api_check(L, (nr == LUA_MULTRET) or ((L.*.ci.*.top.p - L.*.top.p) >= (nr - na)), "results from function overflow current stack size")) {
    _ = &L;
    _ = &na;
    _ = &nr;
    return api_check(L, (nr == LUA_MULTRET) or ((L.*.ci.*.top.p - L.*.top.p) >= (nr - na)), "results from function overflow current stack size");
}
