...
pub export const luaT_typenames_: [12][*c]const u8 = .{
    "no value",
    "nil",
    "boolean",
    &udatatypename,
...
pub export fn luaT_objtypename(arg_L: [*c]lua_State, arg_o: [*c]const TValue) [*c]const u8 {
    var L = arg_L;
    _ = &L;
    var o = arg_o;
    _ = &o;
    ...
    _ = &mt;
    if (((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == ((@as(c_int, 5) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) and ((blk: {
        const tmp = (blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.h;
            };
        }).*.metatable;
        mt = tmp;
        break :blk tmp;
    }) != @as([*c]Table, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or ((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) == ((@as(c_int, 7) | (@as(c_int, 0) << @intCast(4))) | (@as(c_int, 1) << @intCast(6)))) and ((blk: {
        const tmp = (blk_1: {
            _ = @as(c_int, 0);
            break :blk_1 blk_2: {
                _ = @as(c_int, 0);
                break :blk_2 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.u;
            };
        }).*.metatable;
        mt = tmp;
        break :blk tmp;
    }) != @as([*c]Table, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))))) {
        var name: [*c]const TValue = luaH_getshortstr(mt, luaS_new(L, "__name"));
        _ = &name;
        if ((@as(c_int, @bitCast(@as(c_uint, name.*.tt_))) & @as(c_int, 15)) == @as(c_int, 4)) return @as([*c]u8, @ptrCast(@alignCast(&(blk: {
            _ = @as(c_int, 0);
            break :blk blk_1: {
                _ = @as(c_int, 0);
                break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(name.*.value_.gc))).*.ts;
            };
        }).*.contents[@as(usize, @intCast(0))])));
    }
    return luaT_typenames_[@as(c_uint, @intCast((@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) + @as(c_int, 1)))];
}
pub export fn luaT_gettm(arg_events: [*c]Table, arg_event: TMS, arg_ename: [*c]TString) [*c]const TValue {
    ...
    var ename = arg_ename;
    _ = &ename;
    var tm: [*c]const TValue = luaH_getshortstr(events, ename);
    _ = &tm;
    _ = @as(c_int, 0);
    if ((@as(c_int, @bitCast(@as(c_uint, tm.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
        events.*.flags |= @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(lu_byte, @bitCast(@as(u8, @truncate(@as(c_uint, 1) << @intCast(event))))))))))));
        return null;
    } else return tm;
    return null;
}
pub export fn luaT_gettmbyobj(arg_L: [*c]lua_State, arg_o: [*c]const TValue, arg_event: TMS) [*c]const TValue {
    var L = arg_L;
    _ = &L;
    var o = arg_o;
    _ = &o;
        ...
        switch (@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)) {
            @as(c_int, 5) => {
                mt = (blk: {
                    ...
                    break :blk blk_1: {
                        _ = @as(c_int, 0);
                        break :blk_1 &@as([*c]union_GCUnion, @ptrCast(@alignCast(o.*.value_.gc))).*.h;
                    };
                }).*.metatable;
                break;
            },
            @as(c_int, 7) => {
                ...
                mt = L.*.l_G.*.mt[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, o.*.tt_))) & @as(c_int, 15)))];
            },
        }
        break;
    }
    return if (mt != null) luaH_getshortstr(mt, L.*.l_G.*.tmname[event]) else @as([*c]const TValue, @ptrCast(@alignCast(&L.*.l_G.*.nilvalue)));
}
pub export fn luaT_init(arg_L: [*c]lua_State) void {
    var L = arg_L;
    _ = &L;
    const luaT_eventname = struct {
        const static: [25][*c]const u8 = [25][*c]const u8{
            "__index",
            "__newindex",
            "__gc",
            "__mode",
    ...
    _ = &i;
    {
        i = 0;
        while (i < TM_N) : (i += 1) {
            L.*.l_G.*.tmname[@as(c_uint, @intCast(i))] = luaS_new(L, luaT_eventname.static[@as(c_uint, @intCast(i))]);
            luaC_fix(L, blk: {
                _ = @as(c_int, 0);
                break :blk &@as([*c]union_GCUnion, @ptrCast(@alignCast(L.*.l_G.*.tmname[@as(c_uint, @intCast(i))]))).*.gc;
            });
        }
    }
}
pub export fn luaT_callTM(arg_L: [*c]lua_State, arg_f: [*c]const TValue, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_p3: [*c]const TValue) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    var p3 = arg_p3;
    _ = &p3;
    var func: StkId = L.*.top.p;
    _ = &func;
    {
        var io1: [*c]TValue = &func.*.val;
        _ = &io1;
        var io2: [*c]const TValue = f;
        _ = &io2;
    ...
    {
        var io1: [*c]TValue = &(func + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val;
        _ = &io1;
        var io2: [*c]const TValue = p1;
        _ = &io2;
        io1.*.value_ = io2.*.value_;
        _ = blk: {
            const tmp = io2.*.tt_;
    ...
    {
        var io1: [*c]TValue = &(func + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val;
        _ = &io1;
        var io2: [*c]const TValue = p2;
        _ = &io2;
        io1.*.value_ = io2.*.value_;
        _ = blk: {
            const tmp = io2.*.tt_;
    ...
    {
        var io1: [*c]TValue = &(func + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))))).*.val;
        _ = &io1;
        var io2: [*c]const TValue = p3;
        _ = &io2;
        io1.*.value_ = io2.*.value_;
        _ = blk: {
            const tmp = io2.*.tt_;
    ...
    L.*.top.p = func + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 4)))));
    if (!((@as(c_int, @bitCast(@as(c_uint, L.*.ci.*.callstatus))) & ((@as(c_int, 1) << @intCast(1)) | (@as(c_int, 1) << @intCast(3)))) != 0)) {
        luaD_call(L, func, @as(c_int, 0));
    } else {
        luaD_callnoyield(L, func, @as(c_int, 0));
    }
}
pub export fn luaT_callTMres(arg_L: [*c]lua_State, arg_f: [*c]const TValue, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_res: StkId) void {
    var L = arg_L;
    _ = &L;
    var f = arg_f;
    _ = &f;
    ...
    var res = arg_res;
    _ = &res;
    var result: ptrdiff_t = @divExact(@as(c_long, @bitCast(@intFromPtr(@as([*c]u8, @ptrCast(@alignCast(res)))) -% @intFromPtr(@as([*c]u8, @ptrCast(@alignCast(L.*.stack.p)))))), @sizeOf(u8));
    _ = &result;
    var func: StkId = L.*.top.p;
    _ = &func;
    {
    ...
    L.*.top.p += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))));
    if (!((@as(c_int, @bitCast(@as(c_uint, L.*.ci.*.callstatus))) & ((@as(c_int, 1) << @intCast(1)) | (@as(c_int, 1) << @intCast(3)))) != 0)) {
        luaD_call(L, func, @as(c_int, 1));
    } else {
        luaD_callnoyield(L, func, @as(c_int, 1));
    }
    res = @as(StkId, @ptrFromInt(@intFromPtr(L.*.stack.p) + @as(usize, @bitCast(@as(isize, @intCast(result))))));
    {
...
pub export fn luaT_trybinTM(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_res: StkId, arg_event: TMS) void {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
    ...
    var event = arg_event;
    _ = &event;
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(!(callbinTM(L, p1, p2, res, event) != 0)) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
        while (true) {
            switch (event) {
                @as(c_uint, @bitCast(@as(c_int, 13))), @as(c_uint, @bitCast(@as(c_int, 14))), @as(c_uint, @bitCast(@as(c_int, 15))), @as(c_uint, @bitCast(@as(c_int, 16))), @as(c_uint, @bitCast(@as(c_int, 17))), @as(c_uint, @bitCast(@as(c_int, 19))) => {
                    {
                        if (((@as(c_int, @bitCast(@as(c_uint, p1.*.tt_))) & @as(c_int, 15)) == @as(c_int, 3)) and ((@as(c_int, @bitCast(@as(c_uint, p2.*.tt_))) & @as(c_int, 15)) == @as(c_int, 3))) {
...
pub export fn luaT_tryconcatTM(arg_L: [*c]lua_State) void {
    var L = arg_L;
    _ = &L;
    var top: StkId = L.*.top.p;
    _ = &top;
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(!(callbinTM(L, &(top - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val, &(top - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val, top - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))), @as(c_uint, @bitCast(TM_CONCAT))) != 0)) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
        luaG_concaterror(L, &(top - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*.val, &(top - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*.val);
    }
}
pub export fn luaT_trybinassocTM(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_flip: c_int, arg_res: StkId, arg_event: TMS) void {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
...
pub export fn luaT_trybiniTM(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_i2: lua_Integer, arg_flip: c_int, arg_res: StkId, arg_event: TMS) void {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
...
pub export fn luaT_callorderTM(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_event: TMS) c_int {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
    ...
    var event = arg_event;
    _ = &event;
    if (callbinTM(L, p1, p2, L.*.top.p, event) != 0) return @intFromBool(!((@as(c_int, @bitCast(@as(c_uint, (&L.*.top.p.*.val).*.tt_))) == (@as(c_int, 1) | (@as(c_int, 0) << @intCast(4)))) or ((@as(c_int, @bitCast(@as(c_uint, (&L.*.top.p.*.val).*.tt_))) & @as(c_int, 15)) == @as(c_int, 0))));
    luaG_ordererror(L, p1, p2);
    return 0;
}
pub export fn luaT_callorderiTM(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_v2: c_int, arg_flip: c_int, arg_isfloat: c_int, arg_event: TMS) c_int {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
    ...
    var aux: TValue = undefined;
    _ = &aux;
    var p2: [*c]const TValue = undefined;
    _ = &p2;
    if (isfloat != 0) {
        {
            var io: [*c]TValue = &aux;
            _ = &io;
            io.*.value_.n = @as(lua_Number, @floatFromInt(v2));
            _ = blk: {
        ...
        var io: [*c]TValue = &aux;
        _ = &io;
        io.*.value_.i = @as(lua_Integer, @bitCast(@as(c_longlong, v2)));
        _ = blk: {
            const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 3) | (@as(c_int, 0) << @intCast(4))))));
            io.*.tt_ = tmp;
            break :blk tmp;
...
pub export fn luaT_adjustvarargs(arg_L: [*c]lua_State, arg_nfixparams: c_int, arg_ci: [*c]CallInfo, arg_p: [*c]const Proto) void {
    var L = arg_L;
    _ = &L;
    var nfixparams = arg_nfixparams;
    _ = &nfixparams;
    var ci = arg_ci;
    _ = &ci;
    var p = arg_p;
    ...
    var i: c_int = undefined;
    _ = &i;
    var actual: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(L.*.top.p) -% @intFromPtr(ci.*.func.p))), @sizeOf(StackValue)))))) - @as(c_int, 1);
    _ = &actual;
    var nextra: c_int = actual - nfixparams;
    _ = &nextra;
    ci.*.u.l.nextraargs = nextra;
    if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(@divExact(@as(c_long, @bitCast(@intFromPtr(L.*.stack_last.p) -% @intFromPtr(L.*.top.p))), @sizeOf(StackValue)) <= @as(c_long, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, p.*.maxstacksize))) + @as(c_int, 1))))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
        _ = @as(c_int, 0);
        _ = luaD_growstack(L, @as(c_int, @bitCast(@as(c_uint, p.*.maxstacksize))) + @as(c_int, 1), @as(c_int, 1));
        _ = @as(c_int, 0);
    } else {
        _ = @as(c_int, 0);
    }
    {
        ...
        _ = &io1;
        var io2: [*c]const TValue = &ci.*.func.p.*.val;
        _ = &io2;
        io1.*.value_ = io2.*.value_;
        _ = blk: {
            const tmp = io2.*.tt_;
        ...
        while (i <= nfixparams) : (i += 1) {
            {
                ...
                _ = &io1;
                var io2: [*c]const TValue = &(ci.*.func.p + @as(usize, @bitCast(@as(isize, @intCast(i))))).*.val;
                _ = &io2;
                io1.*.value_ = io2.*.value_;
                _ = blk: {
                    const tmp = io2.*.tt_;
            ...
            _ = blk: {
                ...
                (&(ci.*.func.p + @as(usize, @bitCast(@as(isize, @intCast(i))))).*.val).*.tt_ = tmp;
                break :blk tmp;
            };
        }
    }
    ci.*.func.p += @as(usize, @bitCast(@as(isize, @intCast(actual + @as(c_int, 1)))));
    ci.*.top.p += @as(usize, @bitCast(@as(isize, @intCast(actual + @as(c_int, 1)))));
    _ = @as(c_int, 0);
}
pub export fn luaT_getvarargs(arg_L: [*c]lua_State, arg_ci: [*c]CallInfo, arg_where: StkId, arg_wanted: c_int) void {
    var L = arg_L;
    _ = &L;
    var ci = arg_ci;
    _ = &ci;
    ...
    _ = &nextra;
    if (wanted < @as(c_int, 0)) {
        wanted = nextra;
        if (__builtin_expect(@as(c_long, @intFromBool(@intFromBool(@divExact(@as(c_long, @bitCast(@intFromPtr(L.*.stack_last.p) -% @intFromPtr(L.*.top.p))), @sizeOf(StackValue)) <= @as(c_long, @bitCast(@as(c_long, nextra)))) != @as(c_int, 0))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) {
            var t__: ptrdiff_t = @divExact(@as(c_long, @bitCast(@intFromPtr(@as([*c]u8, @ptrCast(@alignCast(where)))) -% @intFromPtr(@as([*c]u8, @ptrCast(@alignCast(L.*.stack.p)))))), @sizeOf(u8));
            _ = &t__;
            {
            ...
            _ = luaD_growstack(L, nextra, @as(c_int, 1));
            where = @as(StkId, @ptrFromInt(@intFromPtr(L.*.stack.p) + @as(usize, @bitCast(@as(isize, @intCast(t__))))));
        } else {
            _ = @as(c_int, 0);
        }
        L.*.top.p = where + @as(usize, @bitCast(@as(isize, @intCast(nextra))));
    }
    {
        i = 0;
        while ((i < wanted) and (i < nextra)) : (i += 1) {
            var io1: [*c]TValue = &(where + @as(usize, @bitCast(@as(isize, @intCast(i))))).*.val;
            _ = &io1;
            var io2: [*c]const TValue = &((ci.*.func.p - @as(usize, @bitCast(@as(isize, @intCast(nextra))))) + @as(usize, @bitCast(@as(isize, @intCast(i))))).*.val;
            _ = &io2;
            io1.*.value_ = io2.*.value_;
            _ = blk: {
                const tmp = io2.*.tt_;
    ...
    while (i < wanted) : (i += 1) {
        _ = blk: {
            const tmp = @as(lu_byte, @bitCast(@as(i8, @truncate(@as(c_int, 0) | (@as(c_int, 0) << @intCast(4))))));
            (&(where + @as(usize, @bitCast(@as(isize, @intCast(i))))).*.val).*.tt_ = tmp;
            break :blk tmp;
        };
    }
}
...
pub const udatatypename: [8:0]u8 = "userdata".*;
pub fn callbinTM(arg_L: [*c]lua_State, arg_p1: [*c]const TValue, arg_p2: [*c]const TValue, arg_res: StkId, arg_event: TMS) callconv(.c) c_int {
    var L = arg_L;
    _ = &L;
    var p1 = arg_p1;
    _ = &p1;
    ...
    var event = arg_event;
    _ = &event;
    var tm: [*c]const TValue = luaT_gettmbyobj(L, p1, event);
    _ = &tm;
    if ((@as(c_int, @bitCast(@as(c_uint, tm.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) {
        tm = luaT_gettmbyobj(L, p2, event);
    }
    if ((@as(c_int, @bitCast(@as(c_uint, tm.*.tt_))) & @as(c_int, 15)) == @as(c_int, 0)) return 0;
