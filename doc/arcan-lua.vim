...
syn keyword luaFunc switch_appl
...
syn keyword luaFunc default_movie_queueopts
syn keyword luaFunc capture_audio
syn keyword luaFunc system_load
syn keyword luaFunc pause_audio
...
syn keyword luaFunc switch_theme
...
syn keyword luaFunc target_postfilter_args
...
syn keyword luaFunc resume_movie
...
syn keyword luaFunc instance_image
...
syn keyword luaFunc target_pointsize
...
syn keyword luaFunc play_movie
...
syn keyword luaFunc target_linewidth
...
syn keyword luaFunc target_postfilter
...
syn keyword luaFunc default_movie_queueopts_override
...
syn keyword luaFunc pause_movie
syn keyword luaFunc raw_surface
syn keyword luaFunc image_borderscan
...
syn keyword luaConstant THEME_RESOURCE
...
syn keyword luaConstant LIBPATH
syn keyword luaConstant INTERP_EXPIN
syn keyword luaConstant POSTFILTER_OFF
syn keyword luaConstant APPL_RESOURCE
syn keyword luaConstant THEMEPATH
...
syn keyword luaConstant BINPATH
...
syn keyword luaConstant POSTFILTER_NTSC
...
syn keyword luaConstant RESOURCEPATH
...
syn keyword luaConstant THEMENAME
...
syn keyword luaConstant INTERNALMODE
