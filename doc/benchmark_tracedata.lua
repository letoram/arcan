...
-- @inargs: string:subsystem, string:message, int:quantity
-- @inargs: string:subsystem, string:message, int:quantity=1, int:trigger=TRACE_TRIGGER_ONESHOT
-- @inargs: string:subsystem, string:message, int:quantity=1, int:trigger=TRACE_TRIGGER_ONESHOT, int:level=TRACE_PATH_DEFAULT
-- @outargs:
-- @longdescr:
...
-- arguments are 'subsystem' (caller defined), 'message' (caller defined), quantity
-- indicator, trigger (from the set of TRACE_TRIGGER_ONESHOT, TRACE_TRIGGER_ENTER,
